---
name: UI Extraction & React Replication
description: Systematically extract any UI page (screenshot + URL) and produce exact, functional React component implementations using Catalyst/Atlaskit. Complete with types, mock data, and route integration.
version: 1.0
status: production
keywords:
  - ui-extract
...
This skill comes with comprehensive supporting docs:

- **extraction-protocol.md** — Step-by-step 7-phase protocol with DevTools commands
- **component-mapping-guide.md** — How to map every UI element to Atlaskit (20+ examples)
- **validation-checklist.md** — Final QA checklist (80+ items for visual, functional, accessibility)

**Location:** `/skills/ui-extraction/` (in Catalyst repo)
