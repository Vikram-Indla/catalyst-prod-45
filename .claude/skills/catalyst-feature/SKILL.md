...
description: >-
  ...
  this repo. Enforces the Catalyst Operating Contract (CLAUDE.md): Feature Work
...
| Artifact | Path |
|---|---|
| Operating contract (precedence, gates, bans) | `CLAUDE.md` |
...
2. Read `CLAUDE.md` and `docs/ways-of-working/*`.
...
file staging only (never `git add -A`). The contract in `CLAUDE.md` wins on any
