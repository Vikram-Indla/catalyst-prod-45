...
| `ui-refactor` | `gitmerge`, `ads-validator` | `save-memory`, `jira-compare`, `design-intelligence` | gitmerge for branch hygiene; ads-validator if the refactor touches styles; design-intelligence if any visual slot changes. |
