...
-- Replace the fake ph_resources-based resource utilization view
-- with real data from Jira issues + user mapping + profiles + resource_inventory
...
SELECT
  COALESCE(m.catalyst_profile_id, gen_random_uuid()) AS id,
