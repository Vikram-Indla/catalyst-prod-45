-- FIX 1: Replace the status_type CHECK constraint
ALTER TABLE notifications
  DROP CONSTRAINT IF EXISTS notifications_status_type_check;

ALTER TABLE notifications
  ADD CONSTRAINT notifications_status_type_check
  CHECK (status_type IN ('gray', 'blue', 'green', 'active', 'done', 'default'));

-- FIX 2: Rebuild trigger with correct column for tm_cycle_scope
