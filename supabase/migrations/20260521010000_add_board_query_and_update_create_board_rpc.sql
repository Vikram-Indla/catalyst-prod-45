-- Migration: add board_query column + extend create_board RPC with board_type + board_query
-- 2026-05-21: Board CRUD feature — each board now carries a JQL-style query that
-- defines which issues appear on it, enabling multiple boards with different views.

ALTER TABLE public.boards
  ADD COLUMN IF NOT EXISTS board_query TEXT DEFAULT NULL;
