DROP VIEW IF EXISTS public.ph_ideas_listing CASCADE;

CREATE VIEW public.ph_ideas_listing AS
SELECT i.id,
    i.idea_key,
    i.title,
    i.description,
...
GRANT SELECT ON public.ph_ideas_listing TO anon, authenticated;