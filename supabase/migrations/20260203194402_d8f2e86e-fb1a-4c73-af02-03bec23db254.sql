-- ═══════════════════════════════════════════════════════════════════════════════
-- TASK¹⁰ DATABASE SCHEMA — COMPLETE REBUILD V3.0
-- ═══════════════════════════════════════════════════════════════════════════════
...
CREATE TRIGGER trigger_t10_lists_updated BEFORE UPDATE ON t10_lists FOR EACH ROW EXECUTE FUNCTION update_t10_updated_at();

DROP TRIGGER IF EXISTS trigger_t10_weeks_updated ON t10_weeks;
CREATE TRIGGER trigger_t10_weeks_updated BEFORE UPDATE ON t10_weeks FOR EACH ROW EXECUTE FUNCTION update_t10_updated_at();

DROP TRIGGER IF EXISTS trigger_t10_items_updated ON t10_items;
CREATE TRIGGER trigger_t10_items_updated BEFORE UPDATE ON t10_items FOR EACH ROW EXECUTE FUNCTION update_t10_updated_at();
