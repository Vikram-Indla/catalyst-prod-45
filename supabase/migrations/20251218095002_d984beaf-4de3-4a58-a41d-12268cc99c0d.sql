-- Seed Workbench Test Data - skipped on fresh install if parent program doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM public.programs WHERE id = 'b2c3d4e5-f6a7-8901-bcde-f12345678901') THEN
    RETURN;
  END IF;
