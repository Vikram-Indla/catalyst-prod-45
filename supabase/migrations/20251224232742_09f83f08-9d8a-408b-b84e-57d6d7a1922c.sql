...
-- Insert the default project only if parent program exists (no-op on fresh install)
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM public.programs WHERE id = 'b2c3d4e5-f6a7-8901-bcde-f12345678901') THEN
