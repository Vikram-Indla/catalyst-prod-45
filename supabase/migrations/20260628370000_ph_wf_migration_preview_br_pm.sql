-- Extend ph_wf_migration_preview to A-lite entities business_request
-- (business_requests.process_step) + product_milestone (product_milestones.status).
-- Read-only, SECURITY DEFINER. Additive over the release fn.
