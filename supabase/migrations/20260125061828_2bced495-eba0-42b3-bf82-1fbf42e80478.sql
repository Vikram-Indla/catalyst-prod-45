...
-- ============================================================================
-- VIEW: v_tm_test_cycle_list_metrics
-- Single source of truth for test cycle list with metrics derived from
-- authoritative tables (tm_cycle_scope, tm_test_runs)
-- ============================================================================

CREATE OR REPLACE VIEW public.v_tm_test_cycle_list_metrics AS
SELECT
  c.id,
  c.project_id,
  c.cycle_key,
...
-- Grant select to authenticated users (inherits RLS from base tables)
GRANT SELECT ON public.v_tm_test_cycle_list_metrics TO authenticated;

COMMENT ON VIEW public.v_tm_test_cycle_list_metrics IS 'Authoritative view for test cycle list with metrics derived from tm_cycle_scope and tm_test_runs';
