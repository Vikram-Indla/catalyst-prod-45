-- ============================================================================
-- DOCINTEL — search RPC guard fix: skip membership assert for service-role
-- callers (auth.uid() IS NULL). Fixes docintel-generate calling the RPC via the
-- service client after its own requireMember check. CAT-DOCINTEL-...-001
-- ============================================================================
