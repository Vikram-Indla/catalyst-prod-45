...
serve(async (req) => {
  ...
  // ── Auth guard ── this repo deploys with --no-verify-jwt, so every
  // function must check auth itself; this one was previously unauthenticated
  // and could mass-delete kb_query_log/kb_cache rows for anyone with the URL.
