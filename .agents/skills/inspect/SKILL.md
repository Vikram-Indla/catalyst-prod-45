...
version: 1.0.0
author: React Council × Design Systems × Codex, 2026-05-19
metadata:
...
1. **Always read AGENTS.md first** — banned columns, ADS token rules, 
...
- **AGENTS.md** — Project guardrails, banned columns, design-system rules
...
- [ ] Read AGENTS.md (banned columns, token rules, jira-compare lessons)
