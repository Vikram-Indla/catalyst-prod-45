...
author: Vikram × Codex, 2026-06-11
metadata:
...
| **[2026-06-13] Writing data hook column names from memory or session context** | **Run `information_schema.columns` on EVERY destination table before writing any SELECT. Session summaries and context documents are not authoritative for column names. Violation = AGENTS.md Assumption Class 2.** |
