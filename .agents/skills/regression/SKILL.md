...
author: "Vikram x Codex, 2026-06-18"
metadata:
...
5. **Verify functionally, never by screenshot** (AGENTS.md P0): DOM/`getComputedStyle`, Supabase
...
1. Append a AGENTS.md lesson for any new failure class (with the corrected diagnostic step).
...
- **Zero-assumption / silence-over-lie** (AGENTS.md): never render a plausible-wrong default.
