...
export const WIT_STYLES: Record<string, { bg: string; color: string }> = {
  ...
  Task: { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' },
...
export const R360_TOKENS = {
  ...
  ink3: 'var(--cp-ink-2, var(--cp-ink-2, #334155))',
...
export const R360_TYPE_COLORS: Record<string, { bg: string; color: string }> = {
  bug:     { bg: 'var(--ds-background-danger, #FEF2F2)', color: '#E5493A' },
  task:    { bg: 'var(--ds-background-selected, #EFF6FF)', color: '#4BADE8' },
