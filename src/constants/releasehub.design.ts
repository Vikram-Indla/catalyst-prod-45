...
// GREY:  bg=var(--cp-lozenge-grey-bg, #DFE1E6) text=#253858 → NEW, ARCHIVED, NOT_STARTED
...
export const RISK_BADGE: Record<string, { bg: string; text: string }> = {
  standard: { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))', text: '#42526E' },
  low: { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))', text: '#42526E' },
  ...
  medium: { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))', text: '#42526E' },
};
