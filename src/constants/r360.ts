export const R360 = {
  ...
  ink1: '#020617', ink2: 'var(--fg-1, var(--cp-ink-1, #0F172A))', ink3: 'var(--ds-text-subtle, #334155)', ink4: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))',
...
export const R360_STATUS_DEFAULT: StatusDisplay = { category:'to_do', label:'Unknown', color:'var(--ds-text-subtle, #334155)', bg:'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', dot:'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))' };
