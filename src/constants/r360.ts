export const R360 = {
  primary: '#2563EB', primaryHover: '#1D4ED8', primaryLight: 'var(--tint-blue, #EFF6FF)', primaryDark: '#1E3A5F',
  success: '#16A34A', successLight: 'var(--tint-green, #F0FDF4)', successText: '#14532D',
...
export const R360_STATUS_MAP: Record<string, StatusDisplay> = {
  ...
  'In Progress':    { category:'in_progress', label:'In Progress', color:'#1E3A5F', bg:'var(--tint-blue, #EFF6FF)', dot:'#2563EB' },
  'In Development': { category:'in_progress', label:'In Progress', color:'#1E3A5F', bg:'var(--tint-blue, #EFF6FF)', dot:'#2563EB' },
  'Under Implementation': { category:'in_progress', label:'In Progress', color:'#1E3A5F', bg:'var(--tint-blue, #EFF6FF)', dot:'#2563EB' },
  ...
  'Technical validation': { category:'in_progress', label:'Validation', color:'#1E3A5F', bg:'var(--tint-blue, #EFF6FF)', dot:'#2563EB' },
  'Ready for Development': { category:'to_do', label:'Ready',      color:'#78350F', bg:'#FFFBEB', dot:'#D97706' },
  'Done':           { category:'done',        label:'Done',        color:'#14532D', bg:'var(--tint-green, #F0FDF4)', dot:'#16A34A' },
  'Closed':         { category:'done',        label:'Done',        color:'#14532D', bg:'var(--tint-green, #F0FDF4)', dot:'#16A34A' },
  'Resolved':       { category:'done',        label:'Done',        color:'#14532D', bg:'var(--tint-green, #F0FDF4)', dot:'#16A34A' },
  'Blocked':        { category:'blocked',     label:'Blocked',     color:'#7F1D1D', bg:'var(--tint-red, #FEF2F2)', dot:'#EF4444' },
  'hold':           { category:'blocked',     label:'On Hold',     color:'#7F1D1D', bg:'var(--tint-red, #FEF2F2)', dot:'#EF4444' },
  'Hold':           { category:'blocked',     label:'On Hold',     color:'#7F1D1D', bg:'var(--tint-red, #FEF2F2)', dot:'#EF4444' },
  'On Hold':        { category:'blocked',     label:'On Hold',     color:'#7F1D1D', bg:'var(--tint-red, #FEF2F2)', dot:'#EF4444' },
};
