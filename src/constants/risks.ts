...
export const ROAM_BADGE_COLORS: Record<RoamStatus, { bg: string; text: string }> = {
  ...
  Owned: { bg: 'bg-[var(--ds-background-information)]', text: 'text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]' },          // Blue (primary)
  Accepted: { bg: 'bg-[var(--ds-background-success)]', text: 'text-[var(--ds-icon-information)]' },      // Teal (success)
  Mitigated: { bg: 'bg-[var(--ds-background-warning)]', text: 'text-[var(--ds-text-warning)]' }       // Orange (warning)
};
