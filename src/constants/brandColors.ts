...
export const CATALYST_BRAND_COLORS = [
  { value: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))', label: 'Blue', token: 'brand-primary' },
  { value: '#0d9488', label: 'Teal', token: 'brand-teal' },
  { value: '#6b7280', label: 'Gray', token: 'secondary-grey' },
  { value: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748b))', label: 'Slate', token: 'secondary-slate' },
...
export const DEFAULT_THEME_COLOR = 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))';
