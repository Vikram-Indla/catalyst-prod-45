...
export function CalendarGrid({
  ...
  return (
    <div className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] rounded-xl border border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] overflow-hidden">
      ...
      >
        <div className="p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] border-r border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]">
        ...
        {columns.map((col, i) => (
          <div
            ...
            className={cn(
              ...
              col.isWeekend ? "bg-[var(--ds-surface-sunken,#f8fafc)] dark:bg-[var(--ds-surface-sunken,var(--cp-ink-1, #161A1D))]" : "bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))]"
            )}
          >
          ...
          {columns.map((col, i) => (
            <div
              ...
              className={cn(
                ...
                col.isWeekend && "bg-[var(--ds-surface-sunken,#f8fafc)] dark:bg-[var(--ds-surface-sunken,var(--cp-ink-1, #161A1D))]"
              )}
            />
          ))}
        </div>
      ...
      {releases.length === 0 && (
        <div className="p-12 text-center">
          <p className="text-slate-500 dark:text-[var(--ds-text-subtlest,#A1A1A1)]">No releases in this time period</p>
        </div>
      )}
    </div>
  );
