  ...
  return (
    <div className="flex flex-col items-center p-5 bg-card border border-border rounded-lg">
      ...
      <div className="grid grid-cols-4 gap-2 mt-4 w-full">
        ...
        <StatusItem icon={Ban} count={blockedTests} label="Blocked" color="var(--ds-text-warning, #F59E0B)" />
        <StatusItem icon={Circle} count={notRunTests} label="Not Run" color="var(--ds-text-subtlest, #94A3B8)" />
      </div>
    </div>
  );
}
