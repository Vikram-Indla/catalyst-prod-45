    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="sm"
          className={cn(
            "h-[34px] text-xs font-medium bg-white",
    ...
    <div className="flex items-center gap-2 mb-4 flex-wrap">
      ...
      <div className="relative min-w-[180px] max-w-[240px]">
        ...
        <Input
          ...
          className="pl-8 h-[34px] text-xs bg-white"
        />
      </div>
      ...
      {/* Clear */}
      {activeFilterCount > 0 && (
        <Button variant="ghost" size="sm" onClick={onClearFilters} className="h-[34px] text-xs text-slate-500">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline" size="sm" className="h-[34px] text-xs bg-white">
