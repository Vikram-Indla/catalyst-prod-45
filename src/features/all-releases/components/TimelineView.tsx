    ...
    <div className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] rounded-xl border border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] shadow-sm overflow-hidden">
        ...
        <div className="flex border-b border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] bg-slate-50 dark:bg-[#111111]">
          ...
          <div className="flex-1 flex">
            {columns.map((col, i) => (
              <div key={i} className="flex-1 px-1 py-2.5 text-center border-r border-slate-100 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] last:border-r-0">
        ...
        {releases.map((release) => {
          ...
          return (
            <div
              key={release.id}
              className="flex border-b border-slate-100 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] last:border-b-0 hover:bg-slate-50/50 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] cursor-pointer transition-colors"
              style={{ height: '42px' }}
            ...
            >
              {/* Release Label */}
              <div className="w-[240px] shrink-0 px-3 flex items-center gap-2.5 border-r border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]">
                <div
              ...
              <div className="flex-1 relative">
                ...
                <div className="absolute inset-0 flex pointer-events-none">
                  {columns.map((_, i) => (
                    <div key={i} className="flex-1 border-r border-dashed border-slate-100 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] last:border-r-0" />
                  ))}
                </div>
