...
export const HEALTH_THRESHOLDS: Record<HealthLevel, { min: number; color: string; borderColor: string; bgColor: string }> = {
  healthy: { min: 85, color: 'var(--ds-text-success, var(--ds-text-success, #22c55e))', borderColor: 'border-l-green-500', bgColor: 'bg-white' },
  ...
  critical: { min: 0, color: 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))', borderColor: 'border-l-red-500', bgColor: 'bg-red-50' },
};
