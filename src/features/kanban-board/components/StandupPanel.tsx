...
export const StandupPanel: React.FC<Props> = ({ issues, avatars, onPersonChange, onTimerSet }) => {
  ...
  return (
    <aside style={{ width: 280, minWidth: 280, flexShrink: 0, border: `1px solid ${token('color.border', '#091E4224')}`, display: 'flex', flexDirection: 'column', background: token('elevation.surface', '#FFFFFF'), overflowY: 'auto' }}>
