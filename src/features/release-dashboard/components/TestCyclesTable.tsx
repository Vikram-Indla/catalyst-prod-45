            ...
            >
                  ...
                  <div className="w-16 h-1.5 bg-slate-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: cycle.status === 'blocked' ? 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))' : '#0d9488',
                      }}
                    />
                  </div>
              ...
              <td className="py-2">
                <div
                  ...
                  style={{ backgroundColor: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' }}
                >
