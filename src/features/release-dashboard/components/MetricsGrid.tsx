  ...
  const cards = [
    {
      ...
      icon: Package,
      iconBg: 'var(--ds-background-selected, var(--ds-background-selected, #eff6ff))',
      ...
      {cards.map((card, i) => (
        ...
        >
          <div className="flex items-start justify-between">
            ...
            {card.trend && (
              <div className={`flex items-center text-xs ${card.trend.direction === 'up' ? 'text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))]' : 'text-[#0d9488]'}`}>
