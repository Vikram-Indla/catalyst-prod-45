  ...
  return (
    ...
    >
          ...
          return (
            <div key={i} className="flex-1 flex flex-col items-center">
              <div className="w-full flex flex-col-reverse" style={{ height: '100px' }}>
                ...
                <div className="w-full" style={{ height: `${failedH}%`, backgroundColor: '#ef4444' }} />
                <div className="w-full" style={{ height: `${blockedH}%`, backgroundColor: '#d97706' }} />
              </div>
      ...
      <div className="flex items-center gap-4 mt-3 text-xs text-slate-500">
        ...
        <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-sm bg-[#ef4444]" />Failed</span>
        <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-sm bg-[#d97706]" />Blocked</span>
      </div>
    </motion.div>
  );
}
