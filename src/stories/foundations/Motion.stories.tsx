...
function MotionExamples() {
  ...
  const boxBase: React.CSSProperties = {
    ...
    fontSize: 'var(--ds-font-size-300)', fontWeight: 500, color: 'var(--ds-text, #172B4D)', cursor: 'pointer', border: '1px solid var(--ds-border, #DFE1E6)',
  };

  return (
    <div style={{ padding: 24, fontFamily: 'Atlassian Sans, -apple-system, sans-serif' }}>
      <h1 style={{ fontSize: 'var(--ds-font-size-800)', fontWeight: 653, color: 'var(--ds-text, #172B4D)', margin: '0 0 8px' }}>Motion</h1>
      <p style={{ fontSize: 'var(--ds-font-size-400)', color: 'var(--ds-text-subtle, #42526E)', margin: '0 0 32px' }}>
        Enterprise transitions: 150ms ease for hover states. No spinning, no pulsing, no particle effects.
      </p>

      <h2 style={{ fontSize: 'var(--ds-font-size-500)', fontWeight: 653, color: 'var(--ds-text, #172B4D)', margin: '0 0 16px' }}>Hover brightness (approved)</h2>
      ...
      <h2 style={{ fontSize: 'var(--ds-font-size-500)', fontWeight: 653, color: 'var(--ds-text, #172B4D)', margin: '0 0 16px' }}>Opacity fade (approved)</h2>
      <div style={{ display: 'flex', gap: 16, marginBlockEnd: 32 }}>
      ...
      <h2 style={{ fontSize: 'var(--ds-font-size-500)', fontWeight: 653, color: 'var(--ds-text, #172B4D)', margin: '0 0 16px' }}>Background transition (approved)</h2>
