...
export const MOCK_BOARD_COLUMNS: BoardColumn[] = [
  { id: 'col-backlog', name: 'Backlog', slug: 'backlog', color: '#9ca3af', position: 1, is_completed_status: false, is_system: true, task_count: 3 },
  { id: 'col-planned', name: 'Planned', slug: 'planned', color: '#2563eb', position: 2, is_completed_status: false, task_count: 2 },
  { id: 'col-in-progress', name: 'In progress', slug: 'in-progress', color: '#d97706', position: 3, is_completed_status: false, task_count: 4 },
  { id: 'col-review', name: 'Review', slug: 'review', color: '#0d9488', position: 4, is_completed_status: false, task_count: 1 },
  { id: 'col-done', name: 'Done', slug: 'done', color: '#10b981', position: 5, is_completed_status: true, is_done: true, task_count: 5 },
];
...
export const MOCK_BOARD_TASKS: BoardTask[] = [
  {
    ...
    status_color: '#d97706', status_position: 3, is_completed_status: false,
    workstream_id: 'ws-platform', workstream_name: 'Platform', workstream_slug: 'platform', workstream_color: '#2563eb',
  ...
  },
  {
    ...
    status_color: '#0d9488', status_position: 4, is_completed_status: false,
    workstream_id: 'ws-ai', workstream_name: 'CATY AI', workstream_slug: 'ai', workstream_color: '#8b5cf6',
  ...
  },
  {
    ...
    status_color: '#9ca3af', status_position: 1, is_completed_status: false,
...
export const MOCK_PLANNER_TASKS: PlannerTask[] = [
  {
    ...
    teamId: 'ws-platform', teamName: 'Platform', teamColor: '#2563eb',
  ...
  },
  {
    ...
    teamId: 'ws-ai', teamName: 'CATY AI', teamColor: '#8b5cf6',
