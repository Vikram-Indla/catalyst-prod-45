    ...
    <div style={{ padding: 24, maxWidth: 1000 }}>
      <DuplicateCard
        ...
        duplicates={[
          ...
          { name: 'OkrStatusPill', source: 'src/components/shared/okr-pills/OkrStatusPill.tsx', consumers: 3, status: 'keep', adsCloseness: 'partial', breakageRisk: 'OKR-specific statuses (on-track/at-risk/off-track) — different domain' },
