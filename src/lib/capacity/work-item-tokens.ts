...
export const CategoryColors = {
  ...
  program: { border: 'var(--ds-link)', bg: 'var(--ds-background-information, rgba(37, 99, 235, 0.08))', text: 'var(--ds-link)' },
  project: { border: 'var(--ds-chart-teal-bold)', bg: 'var(--ds-background-success, rgba(13, 148, 136, 0.08))', text: 'var(--ds-chart-teal-bold)' },
  product: { border: 'var(--ds-background-success-bold)', bg: 'var(--ds-background-success-bold, rgba(34, 197, 94, 0.08))', text: 'var(--ds-background-success-bold, var(--ds-background-success-bold))' },
} as const;
...
export const WorkItemColors: Record<string, { bg: string; text: string; ring: string }> = {
  ...
  epic: { bg: 'var(--ds-background-information, rgba(37, 99, 235, 0.12))', text: 'var(--ds-link)', ring: 'var(--ds-link)' },
  feature: { bg: 'var(--ds-background-success, rgba(13, 148, 136, 0.12))', text: 'var(--ds-chart-teal-bold)', ring: 'var(--ds-chart-teal-bold)' },
  story: { bg: 'rgba(139, 115, 85, 0.12)', text: 'var(--ds-text-subtle)', ring: 'var(--ds-text-subtle)' },
  defect: { bg: 'var(--ds-background-danger-bold, rgba(220, 38, 38, 0.12))', text: 'var(--ds-background-danger-bold)', ring: 'var(--ds-background-danger-bold)' },
  incident: { bg: 'var(--ds-background-danger-bold, rgba(220, 38, 38, 0.12))', text: 'var(--ds-background-danger-bold)', ring: 'var(--ds-background-danger-bold)' },
  business_request: { bg: 'var(--ds-background-success-bold, rgba(34, 197, 94, 0.12))', text: 'var(--ds-background-success-bold, var(--ds-background-success-bold))', ring: 'var(--ds-background-success-bold, var(--ds-background-success-bold))' },
};
