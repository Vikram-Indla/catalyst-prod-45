...
export const WorkItemColors: Record<string, { bg: string; text: string; ring: string }> = {
  ...
  business_request: { bg: 'var(--ds-background-success-bold, rgba(34, 197, 94, 0.12))', text: 'var(--ds-background-success-bold, #1F845A)', ring: 'var(--ds-background-success-bold, #1F845A)' },
};
