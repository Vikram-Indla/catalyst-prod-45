...
const PAUSE: Record<TheatreEventType, number> = {
  ...
  item_created: 3500,
  branch_created: 4500,
  status_transition: 3500,
  assignee_handover: 4000,
  sprint_assigned: 4000,
  release_assigned: 4000,
  regression_started: 5500,
  boomerang_returned: 5500,
  hold_started: 3500,
  hold_released: 3500,
  late_item_added: 4500,
  item_completed: 4000,
  branch_completed: 5000,
  final_map_formed: 6000,
