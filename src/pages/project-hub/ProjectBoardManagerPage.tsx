...
export default function ProjectBoardManagerPage() {
  ...
  if (isLoading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
        <div className="animate-spin rounded-full h-8 w-8 border-b-2" style={{ borderColor: 'var(--ds-text-brand, #2563EB)' }} />
      </div>
    );
  }
  ...
  return <BoardManagerPage projectIdOverride={project.id} basePath={`/project/${key}/boards`} />;
}
