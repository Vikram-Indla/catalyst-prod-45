...
export default function NativeFeatureBacklogPage() {
  ...
  if (!project) {
    return <div className="h-full flex items-center justify-center" style={{ background: 'var(--bg-0)' }}><span style={{ color: 'var(--ds-text-danger, #DC2626)', fontSize: 13 }}>Project not found</span></div>;
  }
