  ...
  return (
    ...
    >
      ...
      <span style={{
        ...
        fontFamily: 'var(--ds-font-family-monospaced)', flexShrink: 0,
      }}>
        {count}
      </span>
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, fontWeight: 600, color: tk.textPrimary, marginBottom: 8, fontFamily: 'var(--ds-font-family-heading)' }}>
          Delete column
        </div>
        <div style={{ fontSize: 13, color: tk.textSecondary, marginBottom: 16, fontFamily: 'var(--ds-font-family-body)' }}>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            style={{
              ...
              color: tk.textSecondary, fontSize: 13, fontFamily: 'var(--ds-font-family-body)',
            }}
          >
            <ArrowLeft size={16} />
            Back to board
