            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  fontSize: 12, fontFamily: 'var(--ds-font-family-body)', color: isDark ? '#EDEDED' : '#0F172A',
                }}
              />
            </div>
          </div>
            ...
            return (
              <label
                ...
                style={{
                  ...
                  cursor: 'pointer', fontSize: 13, color: isDark ? '#EDEDED' : '#0F172A', fontFamily: 'var(--ds-font-family-body)',
...
export default function HierarchyPage() {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', background: isDark ? '#0A0A0A' : '#F8FAFC', fontFamily: 'var(--ds-font-family-body)' }}>
      {/* PAGE HEADER */}
      ...
      <div style={{
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              fontSize: 13, fontFamily: 'var(--ds-font-family-body)', color: isDark ? '#EDEDED' : '#0F172A',
        ...
        <button
          ...
          style={{
            ...
            fontSize: 13, fontWeight: 500, fontFamily: 'var(--ds-font-family-body)',
        ...
        <div style={{ overflowY: 'auto', minHeight: 0, height: '100%' }}>
          {isLoading ? (
            ...
            <div style={{ border: `1px solid ${isDark ? '#2E2E2E' : '#E2E8F0'}`, borderRadius: 8, background: isDark ? '#1A1A1A' : '#FFFFFF', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 200, gap: 12, padding: 24, textAlign: 'center' }}>
              ...
              <button onClick={() => refetch()} style={{ height: 32, padding: '0 14px', fontSize: 13, fontWeight: 600, fontFamily: 'var(--ds-font-family-body)', color: '#FFFFFF', background: '#2563EB', border: 'none', borderRadius: 6, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div style={{ border: `1px solid ${isDark ? '#2E2E2E' : '#E2E8F0'}`, borderRadius: 8, background: isDark ? '#1A1A1A' : '#FFFFFF', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 300, gap: 12, textAlign: 'center', padding: 48 }}>
              ...
              {(search || activeFilterCount > 0) && (
                <button onClick={handleClearAllFilters} style={{
                  height: 32, padding: '0 14px', fontSize: 12, fontWeight: 500, fontFamily: 'var(--ds-font-family-body)',
