              ...
              <>
                ...
                {childItems.length > 0 && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '10px 0 10px 24px' }}>
                    ...
                    <span style={{ fontSize: 12, color: '#626F86', fontFamily: 'var(--cp-font-mono)' }}>
                      {pctDone}% Done
                    </span>
                  </div>
                )}
                ...
                <div style={{ marginLeft: 24 }}>
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr>
                        <th style={{ textAlign: 'left', padding: '8px 8px', fontSize: 12, fontWeight: 700, color: '#44546F', borderBottom: '2px solid #DFE1E6', fontFamily: 'var(--cp-font-body)' }}>
                          Work
                        </th>
                      </tr>
                    </thead>
