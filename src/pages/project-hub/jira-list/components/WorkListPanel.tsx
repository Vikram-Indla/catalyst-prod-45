  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        padding: '8px 12px', borderBottom: '1px solid var(--cp-border-default, var(--ds-border, #DFE1E6))', background: 'transparent',
        flexWrap: 'nowrap',
      }}>
        <div style={{
          display: 'flex', alignItems: 'center', gap: 6, flex: 1, minWidth: 0,
          border: '1px solid var(--cp-border-default, var(--ds-border, #DFE1E6))', borderRadius: 6, padding: '0 8px', height: 32,
        ...
        <button style={{
          height: 32, padding: '0 10px', border: '1px solid var(--cp-border-default, var(--ds-border, #DFE1E6))',
          ...
          return (
            <div
              ...
              style={{
                ...
                //   - NO hard border (was 1px/var(--ds-border, #DFE1E6))
        ...
        <div style={{
          ...
          {pageSize < filtered.length && (
            <button
              ...
              style={{
                background: 'transparent', border: '1px solid var(--cp-border-default, var(--ds-border, #DFE1E6))',
