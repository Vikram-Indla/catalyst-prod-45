...
export default function KanbanBoardPage() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0" style={{ background: tk.pageBg }}>
      ...
      {canArchive && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 16px', borderBottom: '1px solid #DFE1E6', background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #FAFBFC))' }}>
          <Button
