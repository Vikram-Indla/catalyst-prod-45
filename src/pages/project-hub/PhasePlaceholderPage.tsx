  ...
  return (
    <div className="ph-content-wrapper" style={{ fontFamily: 'var(--cp-font-body)' }}>
      <div className="ph-inner-content">
        ...
        >
          <Icon size={48} color="var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))" strokeWidth={1.25} />
          <h3 style={{ fontSize: 18, fontWeight: 600, color: 'var(--fg-1, #0F172A)', marginTop: 16, fontFamily: 'var(--cp-font-heading)' }}>
            {title}
          </h3>
          <p style={{ fontSize: 14, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', marginTop: 4, textAlign: 'center', maxWidth: 400 }}>
            {description}
          </p>
          <span
            className="inline-flex items-center gap-1 mt-4 rounded-full"
            style={{ fontSize: 11, fontWeight: 500, padding: '4px 12px', background: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' }}
          >
            Coming in {phase}
          </span>
        </div>
