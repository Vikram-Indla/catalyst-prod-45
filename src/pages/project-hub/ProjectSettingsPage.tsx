    ...
    <div className="ph-content-wrapper" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="ph-inner-content">
        <div className="flex items-center gap-1.5 mb-5">
          <span className="cursor-pointer hover:underline" style={{ fontSize: 13, color: 'var(--fg-3, #64748B)' }} onClick={() => navigate('/project-hub/projects')}>ProjectHub</span>
          <ChevronRight size={12} color="#94A3B8" />
          <span className="cursor-pointer hover:underline" style={{ fontSize: 13, color: 'var(--fg-3, #64748B)' }} onClick={() => navigate(`/project-hub/${key}/dashboard`)}>
        ...
        <div className="mt-5">
          ...
          {!project && !isLoading && (
            <div style={{ fontSize: 13, color: 'var(--fg-4, #94A3B8)', textAlign: 'center', padding: '40px 0' }}>Project not found.</div>
          )}
        </div>
      </div>
    </div>
