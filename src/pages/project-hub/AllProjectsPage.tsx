...
export default function AllProjectsPage() {
  ...
  return (
    <div className="flex flex-col h-full font-body antialiased">
      <CatalystPageHeader
        title="All Projects"
        actions={
      ...
      <div className="flex-1 overflow-auto px-6 py-3 bg-slate-50 dark:!bg-[#0A0A0A] text-foreground">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="font-semibold text-lg text-slate-800 dark:text-slate-200 mb-1" style={{ fontFamily: 'var(--ds-font-family-heading)' }}>No projects yet</h3>
          ...
          <div className="flex flex-1 flex-col items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 px-10 py-20 text-center bg-white dark:!bg-[#0A0A0A]">
            ...
            <h3 className="mt-4 text-lg font-semibold text-foreground" style={{ fontFamily: 'var(--ds-font-family-heading)' }}>
