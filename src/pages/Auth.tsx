...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div 
        className="hidden lg:flex relative w-full lg:w-[45%] flex-col justify-start p-6 sm:p-8 md:p-12 lg:p-16 overflow-hidden min-h-[40vh] lg:min-h-screen bg-white dark:bg-[#1A1A1A]"
      ...
      <div className="relative w-full lg:w-[55%] p-6 sm:p-8 md:p-12 lg:p-16 bg-white dark:bg-[#1A1A1A]">
                    ...
                    <div className="flex items-center justify-between">
                      <label className="flex items-center gap-2 cursor-pointer">
                        <input 
                          ...
                          className="w-4 h-4 rounded border-2 cursor-pointer appearance-none transition-all checked:bg-brand-primary checked:border-brand-primary border-gray-300 bg-white dark:bg-[#1A1A1A]"
                          style={{
