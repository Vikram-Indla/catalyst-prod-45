    ...
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 320px' }}>
        ...
        <div className="space-y-5">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      methodology === opt.key
                        ...
                        : 'border-[hsl(var(--border))] hover:border-zinc-300 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]'
                    )}
                  >
          ...
          {config.showUpload && (
            <div>
              ...
              {uploadedFile ? (
                <div className="flex items-center gap-3 p-4 rounded-lg border border-[hsl(var(--border))] bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]">
        ...
        <div className="relative">
          <div
            className="sticky top-20 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] border border-[hsl(var(--border))] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-xl p-6 space-y-4"
          >
