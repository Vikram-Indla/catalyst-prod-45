    ...
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid gap-6" style={{ gridTemplateColumns: '1fr 320px' }}>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={cn(
                'w-full h-10 px-3 text-sm rounded-lg border border-[hsl(var(--border))] bg-white dark:bg-[#1A1A1A] dark:border-[rgba(255,255,255,0.08)] dark:text-[#EDEDED]',
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      methodology === opt.key
                        ...
                        : 'border-[hsl(var(--border))] hover:border-zinc-300 bg-white dark:bg-[#1A1A1A] dark:border-[rgba(255,255,255,0.08)]'
                    )}
                  >
          ...
          {config.showTextInput && (
            <div>
              ...
              <textarea
                ...
                className={cn(
                  'w-full min-h-[160px] p-3 text-[13px] leading-relaxed rounded-lg border border-[hsl(var(--border))] bg-white dark:bg-[#1A1A1A] dark:border-[rgba(255,255,255,0.08)] dark:text-[#EDEDED] resize-y',
                  'focus:outline-none focus:border-blue-500 focus:ring-[3px] focus:ring-blue-500/10',
                  'placeholder:text-muted-foreground',
          ...
          {config.showUpload && (
            <div>
              ...
              {uploadedFile ? (
                <div className="flex items-center gap-3 p-4 rounded-lg border border-[hsl(var(--border))] bg-white dark:bg-[#1A1A1A] dark:border-[rgba(255,255,255,0.08)]">
        ...
        <div className="relative">
          <div
            className="sticky top-20 bg-white dark:bg-[#1A1A1A] border border-[hsl(var(--border))] dark:border-[rgba(255,255,255,0.08)] rounded-xl p-6 space-y-4"
          >
