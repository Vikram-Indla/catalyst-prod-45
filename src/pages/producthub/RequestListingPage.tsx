...
export default function RequestListingPage() {
  ...
  const filterCategories = useMemo<FilterCategory[]>(() => {
    ...
    const roadmapOptions = [
      {
        ...
        iconNode: (
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M2 3.5C2 3.22 2.22 3 2.5 3H5.5C5.78 3 6 3.22 6 3.5V6.5C6 6.78 5.78 7 5.5 7H2.5C2.22 7 2 6.78 2 6.5V3.5Z" fill="var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))" opacity="0.9"/>
            <path d="M7 4.5C7 4.22 7.22 4 7.5 4H13.5C13.78 4 14 4.22 14 4.5V5.5C14 5.78 13.78 6 13.5 6H7.5C7.22 6 7 5.78 7 5.5V4.5Z" fill="var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))" opacity="0.5"/>
            <path d="M2 9.5C2 9.22 2.22 9 2.5 9H5.5C5.78 9 6 9.22 6 9.5V12.5C6 12.78 5.78 13 5.5 13H2.5C2.22 13 2 12.78 2 12.5V9.5Z" fill="var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))" opacity="0.9"/>
            <path d="M7 10.5C7 10.22 7.22 10 7.5 10H11.5C11.78 10 12 10.22 12 10.5V11.5C12 11.78 11.78 12 11.5 12H7.5C7.22 12 7 11.78 7 11.5V10.5Z" fill="var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))" opacity="0.5"/>
          </svg>
        ),
      },
      {
    ...
    const LOZENGE_COLORS: Record<string, { bg: string; color: string }> = {
      grey:  { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))', color: 'var(--ds-text, #253858)' },
