...
const ROADMAP_COLS = [
  { key: null, label: 'NO QUARTER', borderColor: 'transparent', textColor: 'rgba(237,237,237,0.40)' },
  { key: 'Q1', label: 'Q1 2026', borderColor: '#F87171', textColor: '#F87171' },
  { key: 'Q2', label: 'Q2 2026', borderColor: '#7DB8FC', textColor: '#7DB8FC' },
            ...
            return (
              <div key={col.label} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', height: 50 }}>
                  ...
                  <span style={{ fontSize: '10px', fontFamily: "'JetBrains Mono', monospace", fontWeight: 700, background: isDark ? 'rgba(255,255,255,0.06)' : '#1A1A1A', borderRadius: '100px', padding: '0 6px', height: 18, display: 'inline-flex', alignItems: 'center', color: dk.t3 }}>{colIdeas.length}</span>
                </div>
                {colIdeas.length === 0 && (
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '4px', flexWrap: 'wrap' }}>
        ...
        {idea.theme && <span style={{ background: isDark ? 'rgba(255,255,255,0.06)' : '#1A1A1A', color: dk.t2, padding: '1px 6px', borderRadius: '4px', fontSize: '11px', fontWeight: 500, maxWidth: '160px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', border: isDark ? `1px solid ${dk.border}` : 'none' }}>{idea.theme}</span>}
      </div>
