...
export default function CreateDriveModal({ open, onClose }: CreateDriveModalProps) {
  ...
  const labelStyle: React.CSSProperties = {
    fontSize: '11px', fontWeight: 600, color: isDark ? '#A09890' : '#475569',
  ...
  const inputStyle: React.CSSProperties = {
    ...
    padding: '10px 12px', fontSize: '14px', color: isDark ? '#F5F3F0' : '#0F172A', outline: 'none',
  ...
  return (
    ...
    >
      <div style={{
        width: '640px', maxHeight: '90vh', background: isDark ? '#232019' : '#FFFFFF',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: isDark ? '#F5F3F0' : '#0F172A', margin: 0, fontFamily: 'Inter, sans-serif' }}>
            Create Innovation Drive
          </h3>
          <button
            onClick={onClose}
            style={{
              background: 'none', border: 'none', cursor: 'pointer', color: isDark ? '#6B6560' : '#64748B',
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              {ICON_OPTIONS.map(({ name, Icon }) => {
                ...
                return (
                  ...
                  >
                    <Icon size={20} strokeWidth={1.75} color={isSelected ? '#2563EB' : (isDark ? '#A09890' : '#334155')} />
                  </button>
                );
              })}
            </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: isSelected
                        ? (isActive ? (isDark ? '#86EFAC' : '#15803D') : (isDark ? '#A09890' : '#64748B'))
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  <CalendarIcon size={16} style={{ color: isDark ? '#6B6560' : '#64748B', flexShrink: 0 }} />
                  <span style={{ fontWeight: 500, color: isDark ? '#F5F3F0' : '#0F172A' }}>{format(deadline, 'MMM d, yyyy')}</span>
                </button>
              </PopoverTrigger>
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: targetCount <= 1 ? (isDark ? '#6B6560' : '#CBD5E1') : (isDark ? '#A09890' : '#334155'),
              ...
              <input
                ...
                style={{
                  ...
                  textAlign: 'center', fontSize: '16px', fontWeight: 600, color: isDark ? '#F5F3F0' : '#0F172A', outline: 'none',
                  fontFamily: 'Inter, sans-serif', background: isDark ? 'transparent' : '#FFFFFF',
                }}
              />
              <button
                ...
                style={{
                  ...
                  color: targetCount >= 50 ? (isDark ? '#6B6560' : '#CBD5E1') : (isDark ? '#A09890' : '#334155'),
                  fontSize: '18px', fontWeight: 500,
                }}
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: isDark ? '#A09890' : '#475569', background: 'transparent', border: 'none',
              borderRadius: '8px', cursor: 'pointer', fontFamily: 'Inter, sans-serif',
            }}
            onMouseEnter={(e) => { e.currentTarget.style.color = isDark ? '#F5F3F0' : '#0F172A'; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = isDark ? '#A09890' : '#475569'; }}
          >
            Cancel
          </button>
          <button
