      ...
      <div style={{
        ...
        <div style={{ overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            <input
              style={{ ...inputStyle, ...(touched.title && errors.title ? { borderColor: 'var(--ds-text-danger, #EF4444)' } : {}) }}
          ...
          <div>
            ...
            <textarea
              ...
              style={{
                ...
                ...(touched.description && errors.description ? { borderColor: 'var(--ds-text-danger, #EF4444)' } : {}),
              }}
                ...
                return (
                  ...
                  >
                    <span style={{
                      ...
                      background: isSelected
                        ? (isActive ? 'var(--ds-text-success, var(--cp-success, #16A34A))' : 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))')
          ...
          <div>
            ...
            <div style={{
              ...
              border: `1.5px solid ${'var(--cp-border-strong, #CBD5E1)'}`, borderRadius: '8px', overflow: 'hidden',
            }}>
              <button
                type="button"
