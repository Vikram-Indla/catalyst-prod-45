...
export default function CreateDriveModal({ open, onClose }: CreateDriveModalProps) {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    fontFamily: 'var(--ds-font-family-body)', background: isDark ? 'transparent' : '#FFFFFF',
  };
    ...
    >
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: isDark ? '#EDEDED' : '#0F172A', margin: 0, fontFamily: 'var(--ds-font-family-body)' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '8px', cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)',
            }}
          ...
          <button
            ...
            style={{
              ...
              transition: 'background 150ms ease', fontFamily: 'var(--ds-font-family-body)',
            }}
