...
const focusHandlersLight = {
  ...
  onBlur: (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    e.currentTarget.style.borderColor = 'var(--ds-border, var(--cp-border, #E2E8F0))';
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <div>
              ...
              <input
                ...
                style={{ ...inputBase, borderColor: titleError ? 'var(--ds-text-danger, #EF4444)' : 'var(--ds-border, var(--cp-border, #E2E8F0))' }}
                {...focusHandlers}
              />
            ...
            <div>
              ...
              <textarea
                ...
                style={{
                  ...
                  borderColor: descError ? 'var(--ds-text-danger, #EF4444)' : 'var(--ds-border, var(--cp-border, #E2E8F0))',
                }}
                {...focusHandlers}
              />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div>
                ...
                <Select value={ideaType} onValueChange={setIdeaType}>
                  <SelectTrigger className="h-[44px] border-[var(--ds-border,var(--cp-border, #E2E8F0))] rounded-lg text-sm">
              ...
              <div style={{
                ...
                {tags.map(tag => (
                  <span key={tag} style={{
                    ...
                    padding: '2px 8px', background: 'var(--cp-bg-sunken, #F1F5F9)', border: `1px solid ${'var(--cp-border, var(--cp-border, #E2E8F0))'}`,
          ...
          <div style={{
            padding: '16px 32px',
            borderTop: `1px solid ${'var(--cp-border, var(--cp-border, #E2E8F0))'}`,
            display: 'flex',
