        ...
        return (
          <div key={col.status} style={{ minWidth: '280px', width: '280px', flexShrink: 0 }}>
            ...
            <div style={{
              ...
              <span style={{
                fontSize: '10px', fontFamily: 'var(--ds-font-family-monospaced)', fontWeight: 700,
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
        <span style={{
          fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '11px', fontWeight: 600,
          color: dk.blueKey,
        }}>
          {idea.key}
        </span>
        <span style={{
          fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '9px', fontWeight: 800,
      ...
      <div style={{ borderTop: `1px solid ${dk.divider}`, paddingTop: '8px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: '11px', fontWeight: 700, color: dk.t2, fontFamily: 'var(--ds-font-family-monospaced)' }}>
