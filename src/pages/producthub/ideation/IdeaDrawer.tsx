...
export default function IdeaDrawer({ ideaKey, onClose, onConvert }: Props) {
  ...
  if (isLoading) return (
    <>
      ...
      <div style={{ position: 'fixed', top: 0, right: 0, bottom: 0, width: '560px', background: isDark ? '#1A1A1A' : '#FFFFFF', zIndex: 201, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '13px', fontWeight: 700, color: dk.blueKey }}>
            {rawIdea.idea_key}
          </span>
          <button
        ...
        <div style={{ padding: '16px 20px 12px', flexShrink: 0 }}>
          <h2 style={{ fontSize: '18px', fontWeight: 650, color: dk.t1, margin: 0, lineHeight: 1.3, fontFamily: 'var(--ds-font-family-heading)' }}>
            {rawIdea.title}
          </h2>
        ...
        <div style={{ flex: 1, overflowY: 'auto', scrollbarWidth: 'thin' }}>
            ...
            <div style={{ padding: '0 20px 16px' }}>
              <div style={{ background: isDark ? 'rgba(22,163,74,0.08)' : '#F0FDF4', border: `0.75px solid ${isDark ? 'rgba(22,163,74,0.20)' : '#BBF7D0'}`, borderRadius: '6px', padding: '14px' }}>
                ...
                <div style={{ background: isDark ? '#1F1F1F' : '#FFFFFF', border: `0.75px solid ${isDark ? 'rgba(22,163,74,0.20)' : '#BBF7D0'}`, borderRadius: '4px', padding: '10px 12px' }}>
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '13px', fontWeight: 700, color: '#11853D' }}>
          ...
          <div style={{ padding: '16px 20px', borderBottom: `0.75px solid ${dk.divider}` }}>
            ...
            {canEdit ? (
              <textarea value={localDescription} onChange={(e) => setLocalDescription(e.target.value)} rows={4}
                ...
                style={{ width: '100%', borderRadius: '4px', border: `0.75px solid ${isDark ? '#454545' : 'rgba(15,23,42,0.14)'}`, padding: '8px 12px', fontSize: '13px', color: dk.t1, resize: 'vertical', fontFamily: 'var(--ds-font-family-body)', outline: 'none', background: isDark ? 'transparent' : '#FFFFFF' }}
              />
            ) : (
          ...
          <div style={{ padding: '16px 20px', borderBottom: `0.75px solid ${dk.divider}` }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '16px' }}>
              <span style={{ fontSize: '28px', fontWeight: 700, fontFamily: 'var(--ds-font-family-monospaced)', color: composite > 0 ? dk.t1 : dk.t3 }}>
                {composite.toFixed(2)}
              </span>
            ...
            {dimensions.map((dim) => (
              <div key={dim.letter} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px' }}>
                ...
                <span style={{
                  fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '13px', fontWeight: 650,
