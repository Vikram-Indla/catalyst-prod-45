...
export const TYPE_CONFIG: Record<IdeaType, { bg: string; text: string; label: string }> = {
  opportunity:  { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', text: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Opportunity' },
  solution:     { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', text: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Solution' },
  feature:      { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', text: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Feature' },
  improvement:  { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', text: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Improvement' },
  problem:      { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', text: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Problem' },
};
...
export const QUARTER_BADGE: Record<string, { bg: string; text: string }> = {
  Q1: { bg: 'var(--ds-text-danger, #991B1B)', text: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))' },
  Q2: { bg: '#1E40AF', text: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))' },
  Q3: { bg: '#115E59', text: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))' },
  Q4: { bg: '#78350F', text: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))' },
};
...
export function getImpactColor(score: number) {
  ...
  if (score >= 2.0) return { gradient: 'linear-gradient(90deg, var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B))), var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8)))', text: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))' };
