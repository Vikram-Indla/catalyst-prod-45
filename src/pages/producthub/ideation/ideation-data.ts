...
export const PRIORITY_CONFIG: Record<string, { bg: string; text: string; border: string }> = {
  P1: { bg: 'var(--ds-surface-sunken, #F1F5F9)', text: 'var(--ds-text-subtle, #334155)', border: 'var(--bd-default, var(--cp-border, #E2E8F0))' },
  P2: { bg: 'var(--ds-surface-sunken, #F1F5F9)', text: 'var(--ds-text-subtle, #334155)', border: 'var(--bd-default, var(--cp-border, #E2E8F0))' },
  P3: { bg: 'var(--ds-surface-sunken, #F1F5F9)', text: 'var(--ds-text-subtle, #334155)', border: 'var(--bd-default, var(--cp-border, #E2E8F0))' },
  P4: { bg: 'var(--ds-surface-sunken, #F1F5F9)', text: 'var(--ds-text-subtle, #334155)', border: 'var(--bd-default, var(--cp-border, #E2E8F0))' },
};
...
export function getImpactColor(score: number) {
  ...
  if (score >= 2.0) return { gradient: 'linear-gradient(90deg, var(--ds-text-subtlest, var(--cp-ink-3, #64748B)), var(--ds-text-subtlest, #94A3B8))', text: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))' };
  return { gradient: 'linear-gradient(90deg, var(--ds-text-disabled, #CBD5E1), var(--bd-default, var(--cp-border, #E2E8F0)))', text: 'var(--ds-text-subtlest, #94A3B8)' };
}
