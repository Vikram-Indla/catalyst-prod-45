...
export function getImpactColor(score: number) {
  ...
  return { gradient: 'linear-gradient(90deg, var(--ds-text-disabled, #CBD5E1), var(--bd-default, var(--cp-border, var(--cp-bg-sunken, #E2E8F0))))', text: 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))' };
}
