              ...
              return (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    ...
                    <div style={{
                      width: 36, height: 50, borderRadius: 8, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))', border: `1px solid ${dk.border}`,
                  ...
                  <div style={{ borderTop: `1px solid ${dk.divider}`, paddingTop: '12px' }}>
                    ...
                    <div style={{ height: 6, borderRadius: 4, background: 'var(--cp-border-lt, var(--cp-bg-sunken, #F1F5F9))', overflow: 'hidden', border: `1px solid ${dk.border}` }}>
                      <div style={{
