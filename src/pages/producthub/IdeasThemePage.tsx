        ...
        {isLoading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
            {themes.map(theme => {
              ...
              const barColor = convRate >= 100 ? 'var(--ds-text-success, var(--cp-success))' : 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))';
              return (
                <div key={theme.theme} onClick={() => navigate(`/product/ideas/backlog?theme=${encodeURIComponent(theme.theme)}`)}
                  style={{
                    background: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated)))', border: `1px solid ${isDark ? 'var(--ds-border-bold)' : dk.border}`, borderRadius: '8px',
                    padding: '16px', cursor: 'pointer', transition: 'all 0.15s', minHeight: '180px',
                    display: 'flex', flexDirection: 'column',
                  }}
                  onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    ...
                    <div style={{
                      width: 36, height: 50, borderRadius: 8, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken)))', border: `1px solid ${dk.border}`,
                  ...
                  <div style={{ borderTop: `1px solid ${dk.divider}`, paddingTop: '12px' }}>
                    ...
                    <div style={{ height: 6, borderRadius: 4, background: 'var(--cp-border-lt, var(--cp-bg-sunken, var(--cp-bg-sunken)))', overflow: 'hidden', border: `1px solid ${dk.border}` }}>
                      <div style={{
