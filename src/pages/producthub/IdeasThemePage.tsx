            ...
            {themes.map(theme => {
              ...
              return (
                <div key={theme.theme} onClick={() => navigate(`/product/ideas/backlog?theme=${encodeURIComponent(theme.theme)}`)}
                  style={{
                    background: isDark ? '#0A0A0A' : '#FFFFFF', border: `1px solid ${isDark ? 'rgba(255,255,255,0.14)' : dk.border}`, borderRadius: '8px',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                    ...
                    <div style={{
                      width: 36, height: 50, borderRadius: 8, background: isDark ? 'rgba(255,255,255,0.06)' : '#1A1A1A', border: `1px solid ${dk.border}`,
                  ...
                  <div style={{ borderTop: `1px solid ${dk.divider}`, paddingTop: '12px' }}>
                    ...
                    <div style={{ height: 6, borderRadius: 4, background: isDark ? 'rgba(255,255,255,0.08)' : '#1A1A1A', overflow: 'hidden', border: `1px solid ${dk.border}` }}>
                      <div style={{
