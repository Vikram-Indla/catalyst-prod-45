            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                {feature.epic.epic_key && (
                  <>
                    <span className="font-mono text-sm font-medium text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:text-[var(--ds-background-brand-bold-hovered)] transition-colors">
                      {feature.epic.epic_key}
                    </span>
        ...
        <div className="space-y-2">
          {MOCK_STORIES.map((story) => (
            ...
            >
              ...
              <span className="font-mono text-xs font-medium text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:text-[var(--ds-background-brand-bold-hovered)] transition-colors">
                {story.key}
              </span>
