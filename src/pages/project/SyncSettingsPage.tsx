...
function ConnectionStatusCard({ projectId }: { projectId: string }) {
  ...
  if (isLoading) {
    return (
      <Card className="border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)]">
          ...
          <Table>
            ...
            <TableBody>
              {mappings.map((m) => (
                <TableRow
                  key={m.id}
                  className="h-9 border-b border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)]"
                  style={{ maxHeight: 36 }}
                >
          ...
          <Table>
            ...
            <TableBody>
              {events.map((evt) => (
                <TableRow
                  key={evt.id}
                  className="h-9 border-b border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] hover:bg-[rgba(0,0,0,0.04)] dark:hover:bg-[rgba(255,255,255,0.04)]"
                  style={{ maxHeight: 36 }}
                >
