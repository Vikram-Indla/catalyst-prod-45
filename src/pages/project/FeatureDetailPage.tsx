        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="font-mono text-sm font-medium text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:text-[var(--ds-background-brand-bold-hovered)] cursor-pointer hover:underline transition-colors">
