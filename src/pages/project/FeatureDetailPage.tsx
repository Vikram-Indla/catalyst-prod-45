        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="font-mono text-sm font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:text-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))] cursor-pointer hover:underline transition-colors">
