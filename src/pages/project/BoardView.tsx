          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-xs font-medium bg-[var(--ds-background-information-bold, rgba(59,130,246,0.1))] text-[var(--ds-text-brand,#3b82f6)]">
                  Features
                </span>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Button className="bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white">
