        ...
        <>
            ...
            {releases.slice(0, 8).map((r: any) => {
              ...
              return (
                <button key={r.id} onClick={() => toggleSelect(r.id)}
                  className={`bg-white dark:bg-[#1A1A1A] rounded-lg border p-3 text-left transition-all ${isSelected ? 'border-[#0D9488] border-2 ring-2 ring-[#0D9488]/20' : 'border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] hover:border-[#C9D3E0]'}`}
          ...
          {selectedReleases.length >= 2 ? (
            <div className="space-y-4">
              ...
              {radarData.length > 0 && (
                <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] p-4">
            ...
            <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] p-8 text-center text-[#94A3B8] text-[13px]">
