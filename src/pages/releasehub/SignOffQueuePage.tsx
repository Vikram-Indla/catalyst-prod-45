          ...
          {actionModal && (
            <div className="space-y-4">
              <div className="rounded-[6px] p-3" style={{ background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))' }}>
                <p className="text-[12px] mb-1" style={{ color: 'var(--cp-text-tertiary, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))' }}>Gate: <span className="font-bold" style={{ color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' }}>{actionModal.signoff.signoff_role || actionModal.signoff.stage}</span></p>
