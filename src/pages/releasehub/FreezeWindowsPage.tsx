          ...
          <div className="space-y-3 py-2">
            <div>
              ...
              <input type="text" value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))}
                ...
                className="h-9 w-full px-3 rounded border border-[var(--ds-border, #E2E8F0)] dark:border-[var(--ds-border, #2E2E2E)] bg-white dark:bg-[var(--ds-surface-raised, #1A1A1A)] dark:text-[var(--ds-text, #EDEDED)] text-[13px] placeholder:text-[var(--ds-text-subtlest, #94A3B8)] focus:outline-none focus:ring-2 focus:ring-[var(--ds-text-brand, #2563EB)]/20 focus:border-[var(--ds-text-brand, #2563EB)]" />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input type="date" value={form.start_date} onChange={e => setForm(f => ({ ...f, start_date: e.target.value }))}
                  className="h-9 w-full px-3 rounded border border-[var(--ds-border, #E2E8F0)] dark:border-[var(--ds-border, #2E2E2E)] bg-white dark:bg-[var(--ds-surface-raised, #1A1A1A)] dark:text-[var(--ds-text, #EDEDED)] text-[13px] focus:outline-none focus:ring-2 focus:ring-[var(--ds-text-brand, #2563EB)]/20 focus:border-[var(--ds-text-brand, #2563EB)]" />
              </div>
              <div>
