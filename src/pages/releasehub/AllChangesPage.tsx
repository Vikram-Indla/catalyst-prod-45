  ...
  return (
    <div className="relative">
      <button onClick={() => setOpen(!open)} className="h-9 px-3 rounded-md text-[13px] font-medium flex items-center gap-1.5 min-w-[140px]"
        style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, background: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', color: isDark ? '#A1A1A1' : '#475569' }}>
        ...
        return (
          <div key={col.key} className="rounded-lg" style={{ background: isDark ? 'var(--cp-bg-surface, #242528)' : '#F1F5F9', minHeight: 200 }}>
            <div className="px-3 py-2 flex items-center gap-2">
              ...
              <span className="text-[10px] font-bold rounded-full px-1.5" style={{ color: isDark ? '#878787' : '#94A3B8', background: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF' }}>{items.length}</span>
            </div>
