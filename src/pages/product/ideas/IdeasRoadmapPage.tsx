    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          justifyContent: 'center', gap: 12, color: 'var(--cp-text-tertiary, var(--cp-ink-3, #64748B))',
        }}>
          <div style={{ fontSize: 40, opacity: 0.3 }}>💡</div>
          <div style={{ fontSize: 14, fontWeight: 600, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' }}>No ideas in backlog yet</div>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        {isLoading ? (
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: 'var(--cp-text-tertiary, var(--cp-ink-3, #64748B))', maxWidth: 340, lineHeight: 1.5 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: 'var(--cp-text-tertiary, var(--cp-ink-3, #64748B))' }}>No ideas match the current filters</div>
            <button
