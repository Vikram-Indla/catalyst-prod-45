...
function SkeletonCard({ isDark }: { isDark?: boolean }) {
  return <div style={{ height: 80, background: isDark ? '#111111' : '#F1F5F9', borderRadius: 8, animation: 'shimmer 1.5s infinite' }} />;
}
    ...
    <div style={{ display: 'flex', gap: 12, padding: 16, flex: 1 }}>
      {[1, 2, 3, 4, 5].map(col => (
        <div key={col} style={{
          ...
          <div style={{ height: 20, width: 100, background: isDark ? '#111111' : '#F1F5F9', borderRadius: 4, marginBottom: 8 }} />
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          justifyContent: 'center', gap: 12, color: isDark ? '#666666' : '#64748B',
        }}>
          <div style={{ fontSize: 40, opacity: 0.3 }}>💡</div>
          <div style={{ fontSize: 14, fontWeight: 600, color: isDark ? '#888888' : '#334155' }}>No ideas in backlog yet</div>
          <div style={{ fontSize: 13, color: isDark ? '#666666' : '#94A3B8' }}>Add ideas from the Ideas list to get started.</div>
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        {isLoading ? (
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: isDark ? '#666666' : '#64748B', maxWidth: 340, lineHeight: 1.5 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 14, color: isDark ? '#666666' : '#64748B' }}>No ideas match the current filters</div>
            <button
