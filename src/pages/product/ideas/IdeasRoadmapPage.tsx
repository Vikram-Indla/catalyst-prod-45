  ...
  if (isError) {
    return (
      <div style={{
        ...
        justifyContent: 'center', gap: 12, background: isDark ? '#0A0A0A' : '#FFFFFF', fontFamily: 'var(--ds-font-family-body)',
      }}>
  ...
  if (!isLoading && ideas.length === 0) {
    return (
      <div style={{
        ...
        background: isDark ? '#0A0A0A' : '#FFFFFF', fontFamily: 'var(--ds-font-family-body)',
      }}>
