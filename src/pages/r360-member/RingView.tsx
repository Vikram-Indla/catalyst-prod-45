                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px', flexWrap: 'wrap' }}>
                      ...
                      <span style={{ fontSize: '10px', fontWeight: 700, padding: '2px 6px', borderRadius: '4px', background: isDark ? 'var(--cp-bg-surface, #242528)' : '#F1F5F9', color: 'var(--cp-text-tertiary, #64748B)' }}>{item.project_key}</span>
    ...
    <div ref={canvasRef} className="r3-ring-canvas" style={{ marginTop: '8px', overflow: 'visible', position: 'relative' }}>
      ...
      {nonDone.length > PAGE_SIZE && (
        <div style={{
          ...
          fontSize: '11px', fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', background: isDark ? 'var(--cp-bg-page, #1F1F21)' : '#F8FAFC',
