                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px', flexWrap: 'wrap' }}>
                      <span style={{ fontSize: '11.5px', fontWeight: 600, color: '#2563EB', fontFamily: 'var(--ds-font-family-monospaced)' }}>{item.item_key}</span>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {avatarUrl ? (
              ...
              <span style={{ fontSize: '22px', fontWeight: 700, color: 'white', fontFamily: 'var(--ds-font-family-heading)' }}>{initials(name)}</span>
            )}
          </div>

          {/* Name + Role */}
          <div style={{ fontSize: '16px', fontWeight: 650, color: isDark ? '#EDEDED' : '#0F172A', fontFamily: 'var(--ds-font-family-heading)' }}>{name}</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px', fontSize: '13px' }}>
            ...
            <span style={{ color: isDark ? '#878787' : '#94A3B8' }}>&middot;</span>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '5px' }}>
                      <span style={{ fontSize: '12px', fontWeight: 600, color: '#2563EB', fontFamily: 'var(--ds-font-family-monospaced)' }}>{item.item_key}</span>
                      <span style={{ fontSize: '10px', fontWeight: 700, padding: '2px 6px', borderRadius: '4px', background: isDark ? '#1A1A1A' : '#F1F5F9', color: isDark ? '#878787' : '#64748B' }}>{item.project_key}</span>
                      <span style={{ marginLeft: 'auto', fontSize: '10px', fontWeight: 600, padding: '1px 6px', borderRadius: '4px', background: isDark ? '#0A0A0A' : '#F8FAFC', color: item.age_days > 30 ? '#D97706' : '#64748B', fontFamily: 'var(--ds-font-family-monospaced)' }}>{item.age_days}d</span>
                    </div>
                    {/* Row 3 -- full title */}
    ...
    <div ref={canvasRef} className="r3-ring-canvas" style={{ marginTop: '8px', overflow: 'visible', position: 'relative' }}>
      ...
      {nonDone.length > PAGE_SIZE && (
        <div style={{
          ...
          fontFamily: 'var(--ds-font-family-monospaced)', zIndex: 8,
        }}>
          <button
