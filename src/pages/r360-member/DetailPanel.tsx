      ...
      <div className="r3-panel r3-panel--open">
        ...
        <div className="r3-panel-header">
          ...
          <div className="r3-panel-pills">
            ...
            <span style={{ fontSize: 10.5, fontWeight: 600, padding: '2px 8px', borderRadius: 4, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' }}>{item.priority}</span>
        ...
        <div className="r3-panel-body">
          ...
          <div className="r3-meta">
            ...
            <div className="r3-meta-cell">
              ...
              <div style={{ fontSize: 11, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' }}>{formatDate(item.created_at)}</div>
            </div>
            <div className="r3-meta-cell">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div style={{ width: 60, height: 4, borderRadius: 4, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))', overflow: 'hidden' }}>
          ...
          {item.parent_key && (
            <div className="r3-hierarchy">
              ...
              <div className="r3-hier-item" style={{ padding: '6px 8px' }}>
                ...
                <span style={{ fontSize: 12, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{item.parent_title}</span>
              </div>
