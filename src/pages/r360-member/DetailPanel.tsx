      ...
      <div className="r3-panel r3-panel--open">
        ...
        <div className="r3-panel-header">
          ...
          <div className="r3-panel-pills">
            ...
            <span style={{ fontSize: 10.5, fontWeight: 600, padding: '2px 8px', borderRadius: 4, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))' }}>{item.priority}</span>
