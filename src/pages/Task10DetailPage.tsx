...
function SortablePriorityCard({ 
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={`
        flex items-center gap-4 p-4 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-xl cursor-pointer
...
function SidePanel({
  ...
  return (
    <>
      ...
      {/* PANEL */}
      <div className="fixed top-0 right-0 w-[440px] h-full bg-white dark:bg-[#111111] shadow-2xl z-50 flex flex-col animate-in slide-in-from-right duration-200">
        {/* HEADER */}
...
export default function Task10DetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc]">
      {/* HEADER */}
      <header className="flex items-center justify-between px-6 py-3 bg-white dark:bg-[#111111] border-b border-gray-200 dark:border-[rgba(255,255,255,0.08)]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6">
        {/* AI SUGGESTIONS */}
        <div className="mb-5 p-5 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-xl">
        ...
        {/* ADD INPUT */}
        <div className="mb-5">
          <div className="flex items-center bg-white dark:bg-[#111111] border-2 border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-xl overflow-hidden transition-all focus-within:border-blue-500 focus-within:shadow-lg focus-within:shadow-blue-500/10">
        ...
        {bufferItems.length > 0 && (
          <div className="mt-6 p-5 bg-gray-50 border border-dashed border-gray-300 rounded-xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="px-2 py-0.5 text-xs font-semibold text-gray-500 dark:text-[#888888] bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded">{bufferItems.length}</span>
            </div>
            <div className="space-y-2">
              {bufferItems.map((item) => (
                <div key={item.id} className="flex items-center gap-4 p-4 bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-xl">
      ...
      {showCheckoutModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <div className="w-[420px] bg-white dark:bg-[#111111] rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="flex gap-3 p-5 bg-gray-50 border-t border-gray-200">
              <button onClick={() => setShowCheckoutModal(false)} className="flex-1 py-3 text-sm font-medium text-gray-700 dark:text-[#888888] bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-lg hover:bg-gray-50 dark:hover:bg-[#1A1A1A]">
                Cancel
              </button>
              <button
      ...
      {showDeleteModal && selectedItem && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-[60]">
          <div className="w-[400px] bg-white dark:bg-[#111111] rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="flex gap-3 p-5 bg-gray-50 border-t border-gray-200">
              <button onClick={() => setShowDeleteModal(false)} className="flex-1 py-3 text-sm font-medium text-gray-700 dark:text-[#888888] bg-white dark:bg-[#111111] border border-gray-200 dark:border-[rgba(255,255,255,0.08)] rounded-lg hover:bg-gray-50 dark:hover:bg-[#1A1A1A]">
                Cancel
              </button>
              <button
