    ...
    <div className="flex flex-col h-full" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <main className="flex-1 overflow-hidden flex flex-col px-6 py-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="relative w-full max-w-md">
            ...
            <Input
              ...
              className="pl-9 h-9 bg-white dark:bg-[#232019] border-border"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            {/* View Toggle */}
            <div className="flex items-center border border-border rounded-md overflow-hidden bg-white dark:bg-[#232019]">
              <button
            ...
            <Button
              ...
              className={cn(
                "h-8 w-8 border-border bg-white dark:bg-[#232019] dark:border-[rgba(255,255,255,0.08)]",
            ...
            <Button
              ...
              className="h-8 w-8 border-border bg-white dark:bg-[#232019]"
              title="Export"
            >
        ...
        <div className="flex-1 flex flex-col min-h-0">
          {isLoading ? (
            <div className="bg-white dark:bg-[#232019] border border-border rounded-lg shadow-sm p-8 space-y-4">
              {Array.from({ length: 5 }).map((_, i) => (
                <Skeleton key={i} className="h-12 w-full" />
              ))}
            </div>
          ) : viewMode === 'kanban' ? (
            <div className="bg-white dark:bg-[#232019] border border-border rounded-lg shadow-sm flex-1 overflow-auto">
            ...
            <div className="flex flex-col flex-1 min-h-0">
              ...
              {/* Pagination */}
              <div className="flex items-center justify-between px-4 py-4 border-t border-border bg-white dark:bg-[#232019]">
            ...
            <div className="bg-white dark:bg-[#232019] border border-border rounded-lg shadow-sm flex flex-col items-center justify-center py-16 text-center">
