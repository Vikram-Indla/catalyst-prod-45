    ...
    <div className="h-full flex flex-col" style={{ padding: 'var(--s6)' }}>
      <div className="flex items-center gap-3 mb-6" style={{ height: 'var(--toolbar-h)' }}>
        <div className="relative flex-1 max-w-md">
          ...
          <Input placeholder="Search success criteria..." className="pl-9" style={{ height: 'var(--grid-row)' }} />
        </div>
      ...
      <Card className="p-8 text-center">
        ...
        <p className="text-muted-foreground">Define and track success criteria</p>
      </Card>
    </div>
  );
}
