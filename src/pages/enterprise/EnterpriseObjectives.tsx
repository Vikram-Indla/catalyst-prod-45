    ...
    <div className="h-full flex flex-col" style={{ padding: 'var(--s6)' }}>
      <div className="flex items-center gap-3 mb-6" style={{ height: 'var(--toolbar-h)' }}>
        <div className="relative flex-1 max-w-md">
          ...
          <Input placeholder="Search objectives..." className="pl-9" style={{ height: 'var(--grid-row)' }} />
        </div>
        <Button size="sm"><Plus className="h-4 w-4 mr-2" />New Objective</Button>
      </div>

      <Card className="p-8 text-center">
        <h2 className="text-xl font-semibold mb-2">Enterprise Objectives</h2>
