...
export const TIMELINE_PROJECT_COLORS: Record<string, { bg: string; text: string }> = {
  'Senaei BAU': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Senaei': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Innovation Platform': { bg: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1d4ed8))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Innovation': { bg: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1d4ed8))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Inspection Project': { bg: '#0d9488', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Inspection': { bg: '#0d9488', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'International Relations': { bg: '#0f766e', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'International': { bg: '#0f766e', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'MIM Website': { bg: '#14b8a6', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'MIM': { bg: '#14b8a6', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Senaei OPS': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Sectorial Services': { bg: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748b))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Sectorial': { bg: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748b))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Tahommena': { bg: '#0d9488', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Data Platform': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'Data': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
  'ICP': { bg: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' },
};
...
export const getTimelineProjectColor = (name: string) => {
  ...
  return key ? TIMELINE_PROJECT_COLORS[key] : { bg: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748b))', text: 'var(--ds-surface, var(--ds-surface, #ffffff))' };
};
