        ...
        {Object.entries(groupedByDepartment).map(([deptName, deptResources]) => {
          ...
          return (
            ...
            <div key={deptName} className="space-y-3 pb-4 border-b border-border last:border-b-0">
              ...
              <div
                className="flex items-center justify-between px-5 py-4 border border-[var(--ds-border)] rounded-xl cursor-pointer hover:shadow-md transition-all"
                style={{
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-lg font-bold text-[var(--ds-surface)]">{deptName}</span>
                    <div className="flex items-center gap-4 mt-1">
                      {availableCount > 0 && (
                        <span className="text-sm text-[var(--ds-text-subtle)] flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-5">
                  <div className="flex flex-col items-end gap-1">
                    <span className="text-xs font-medium text-[var(--ds-text-subtlest)]">Avg: {avgUtil}%</span>
                    <div className="w-32 h-2 bg-[var(--ds-border)] rounded-full overflow-hidden">
                      <div
                  ...
                  {expanded
                    ? <ChevronUp className="w-5 h-5 text-[var(--ds-text-subtlest)]" />
                    : <ChevronDown className="w-5 h-5 text-[var(--ds-text-subtlest)]" />
                  }
                </div>
              </div>
