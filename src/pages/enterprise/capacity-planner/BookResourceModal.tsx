...
import { Search, Plus, Check, Trash2, AlertTriangle } from '@/lib/atlaskit-icons';
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isSelected ? 'bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/10 border-l-2 border-l-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]' : 'hover:bg-muted/50'
                        )}
                      >
                        <div
                          className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] text-white"
                        >
                          {initials}
                        </div>
                        ...
                        {isSelected && (
                          <div className="w-5 h-5 rounded-full bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] flex items-center justify-center">
          ...
          <div className="border-t border-border pt-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <Button
                ...
                className="gap-1 h-8 text-xs bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:bg-[var(--ds-background-brand-bold-hovered)] text-white"
              >
            ...
            <div className="space-y-4">
              {bookingAllocations.map((alloc, index) => {
                ...
                const color = assignmentName ? getAssignmentColor(assignmentName) : 'var(--ds-text-subtlest)';
            ...
            {(() => {
              ...
              const statusColor = isOver ? 'var(--ds-text-warning)' : total === 100 ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'var(--ds-icon-information)';
              const statusBg = isOver ? 'var(--ds-background-warning)' : total === 100 ? 'var(--ds-background-information)' : 'var(--ds-background-success)';
