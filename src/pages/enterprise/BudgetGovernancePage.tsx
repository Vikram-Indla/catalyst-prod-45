        ...
        <div className="bg-card border-b border-border">
          ...
          <div className="flex items-center justify-between px-5 h-16 border-b border-border/40">
            ...
            <Button 
              ...
              size="sm"
              className="h-10 px-6 text-sm gap-2 bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white shadow-md font-semibold"
            >
