...
function ContentCard({ 
  ...
  return (
    <div className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] rounded-lg border border-gray-200 dark:border-[var(--ds-border,var(--cp-ink-1))] shadow-sm">
      <div className="px-4 py-2.5 border-b border-gray-100 dark:border-[var(--ds-border,var(--cp-ink-1))] flex items-center justify-between">
...
export default function DefectDetailPage() {
  ...
  return (
    <div className="h-full w-full bg-gray-50 dark:bg-[var(--ds-surface)] overflow-auto">
      
      {/* ═══════════════════════════════════════════════════════════════════ */}
      {/* HEADER - Full Width, Dense                                          */}
      {/* ═══════════════════════════════════════════════════════════════════ */}
      <header className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-b border-gray-200 dark:border-[var(--ds-border,var(--cp-ink-1))] shadow-sm">
          ...
          <div className="flex items-center justify-between h-11 border-b border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-44 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))]">
