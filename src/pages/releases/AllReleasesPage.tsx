  ...
  return (
    ...
    >
      ...
      <td style={{ ...cellStyle, minWidth: '280px' }}>
        <span style={{ display: 'inline-block', padding: '2px 6px', background: '#f1f5f9', color: '#94a3b8', border: '1px solid #e2e8f0', borderRadius: '4px', fontSize: '11px', fontWeight: 500, fontFamily: 'var(--cp-font-mono)', marginRight: '6px', verticalAlign: 'middle' }}>{r.version}</span>
      ...
      <td style={{ ...cellStyle, width: '130px' }}>
        <div className="flex items-center gap-2">
          ...
          <span style={{ fontSize: '13px', fontWeight: 500, color: '#64748b', fontFamily: 'var(--cp-font-mono)' }}>{r.progress}%</span>
        </div>
      </td>
      <td style={cellStyle}>
        <div className="flex items-center gap-2">
          ...
          <span style={{ fontSize: '13px', fontWeight: testRatio < 0.8 ? 600 : 400, color: '#64748b', fontFamily: 'var(--cp-font-mono)' }}>{r.testsPass}/{r.testsTotal}</span>
        </div>
      </td>
      <td style={{ ...cellStyle, width: '72px', fontSize: '14px', fontWeight: 600, color: r.defects >= 20 ? '#ef4444' : r.defects >= 10 ? '#d97706' : r.defects > 0 ? '#10b981' : '#94a3b8', fontFamily: 'var(--cp-font-mono)' }}>
      ...
      <td style={{ ...cellStyle, width: '80px' }}>
        {r.status === 'released' ? (
          ...
          <span style={{ fontSize: '13px', fontWeight: r.daysRemaining <= 7 ? 600 : 500, color: r.daysRemaining <= 7 ? '#ef4444' : r.daysRemaining <= 14 ? '#d97706' : '#64748b', fontFamily: 'var(--cp-font-mono)' }}>
