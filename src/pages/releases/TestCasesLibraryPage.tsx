...
function TableSkeleton({ rows = 6 }: { rows?: number }) {
  return (
    <div className="bg-white dark:bg-[#232019] rounded-xl border border-gray-200 dark:border-[rgba(255,255,255,0.08)] overflow-hidden">
      <table className="w-full">
        <thead className="bg-gray-50 dark:bg-[#1A1714] border-b border-gray-200 dark:border-[rgba(255,255,255,0.08)]">
          <tr>
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col h-full min-h-0">
        {/* Header - Sticky */}
        <header className="flex-shrink-0 bg-white dark:bg-[#232019] border-b border-gray-200 dark:border-[rgba(255,255,255,0.08)] sticky top-0 z-20">
        ...
        <main className="flex-1 overflow-hidden">
          <div className="h-full flex gap-4 px-6 py-4">
            {/* Left: Folder Sidebar */}
            <aside className="w-56 flex-shrink-0 bg-white dark:bg-[#232019] rounded-xl border border-gray-200 dark:border-[rgba(255,255,255,0.08)] flex flex-col overflow-hidden">
              {/* Header */}
            ...
            <div className="flex-1 min-w-0 flex flex-col">
              <AnimatePresence mode="wait">
                ...
                {!isLoading && !hasError && !isEmpty && (
                  ...
                  >
                    <div className="bg-white dark:bg-[#232019] rounded-xl border border-gray-200 dark:border-[rgba(255,255,255,0.08)] overflow-hidden flex-1 flex flex-col">
                      <div className="overflow-auto flex-1">
                        <table className="w-full" role="grid">
                          <thead className="bg-gray-50 dark:bg-[#1A1714] border-b border-gray-200 dark:border-[rgba(255,255,255,0.08)] sticky top-0 z-10">
                            <tr>
