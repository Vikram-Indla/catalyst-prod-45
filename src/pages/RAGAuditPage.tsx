  ...
  return (
    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, marginTop: 8 }}>
      <thead>
        <tr>
          {keys.map((k) => (
            <th key={k} style={{ textAlign: "left", padding: "4px 8px", borderBottom: "1px solid var(--bd-default, var(--cp-border, #E2E8F0))", color: "var(--ds-text-subtlest, var(--cp-ink-3, #64748B))", fontWeight: 600 }}>{k}</th>
          ))}
        </tr>
      </thead>
      <tbody>
