            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" size="sm" className="gap-2 text-[13px] bg-card">
                  ...
                  Filters
                  {activeFilterCount > 0 && (
                    <span className="ml-1 px-1.5 py-0.5 bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] text-white text-[10px] font-semibold rounded-full">
                      {activeFilterCount}
                    </span>
                  )}
