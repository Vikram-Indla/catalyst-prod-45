...
function useTokens(dk: boolean) {
  return useMemo(() => ({
    ...
    pillHoverBg:  dk ? '#1A1A1A' : 'rgba(255,255,255,0.10)',
    pillHoverText: dk ? '#EDEDED' : 'rgba(237,237,237,0.93)',
    typePillBg:       dk ? '#1A1A1A' : '#1A1A1A',
    typePillActiveBg: dk ? '#1A1A1A' : '#FFFFFF',
    shimmerFrom:  dk ? '#1A1A1A' : '#1A1A1A',
    shimmerMid:   dk ? '#1A1A1A' : 'rgba(255,255,255,0.10)',
    tooltipBg:    dk ? '#1A1A1A' : '#1e293b',
    tooltipText:  dk ? '#EDEDED' : '#f1f5f9',
    divider:      dk ? 'rgba(255,255,255,0.06)' : 'rgba(255,255,255,0.10)',
