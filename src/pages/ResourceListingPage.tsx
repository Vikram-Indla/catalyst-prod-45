...
function useTokens(dk: boolean) {
  return useMemo(() => ({
    ...
    border:       dk ? 'var(--ds-border, #2E2E2E)' : 'var(--ds-border, #E2E8F0)',
    ...
    text1:        dk ? 'var(--ds-text, #EDEDED)' : 'var(--ds-text, #0F172A)',
    text2:        dk ? 'var(--ds-text-subtlest, #A1A1A1)' : 'var(--ds-text-subtle, #475569)',
    text3:        dk ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, #94A3B8)',
    ...
    badgeBg:      dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, #F1F5F9)',
    ...
    pillHoverBg:  dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, #F1F5F9)',
    ...
    shimmerFrom:  dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, #F1F5F9)',
    shimmerMid:   dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-border, #E2E8F0)',
    tooltipBg:    dk ? 'var(--ds-surface-raised, #1A1A1A)' : '#1e293b',
    tooltipText:  dk ? 'var(--ds-text, #EDEDED)' : 'var(--ds-surface-sunken, #f1f5f9)',
    divider:      dk ? 'var(--ds-border, #292929)' : 'var(--ds-border, #E2E8F0)',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: isActive ? `1.5px solid ${isDark ? 'var(--ds-text, #EDEDED)' : '#111'}` : `1px solid ${t.pillBorder}`,
                  background: isActive ? t.typePillActiveBg : 'transparent',
                  color: isActive ? (isDark ? 'var(--ds-text, #EDEDED)' : '#111') : t.text2,
                }}
                onMouseEnter={e => {
                  if (!isActive) {
