...
function useTokens(dk: boolean) {
  return useMemo(() => ({
    ...
    badgeBg:      dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
    ...
    pillHoverBg:  dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
    ...
    shimmerFrom:  dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
    shimmerMid:   dk ? 'var(--ds-surface-raised, #1A1A1A)' : 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))',
