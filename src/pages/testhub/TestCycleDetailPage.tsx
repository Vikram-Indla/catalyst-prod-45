              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {filteredTestCases.map((ctc, index) => {
                    ...
                    const priority = priorityConfig[ctc.priority?.toLowerCase() || ''] || priorityConfig.medium;
                    ...
                    return (
                      <tr key={ctc.id} style={{ borderBottom: index < filteredTestCases.length - 1 ? '1px solid #F1F5F9' : 'none', backgroundColor: isSelected ? '#EFF6FF' : 'transparent' }}>
                        ...
                        <td style={{ padding: '14px 16px' }}>
                          <span style={{ fontSize: 12, fontWeight: 500, color: priority.color, backgroundColor: priority.bg, padding: '4px 8px', borderRadius: 4, textTransform: 'capitalize' as const }}>{ctc.priority || 'Medium'}</span>
                        </td>
                        <td style={{ padding: '14px 16px' }}>
                          <button
                            onClick={(e) => {
