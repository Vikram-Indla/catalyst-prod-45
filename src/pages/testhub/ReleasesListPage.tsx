        ...
        return (
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
              ...
              {r.vehicle && (
                <span style={{ padding: '2px 8px', borderRadius: 6, backgroundColor: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', fontSize: 11, fontWeight: 500 }}>
                  {r.vehicle.name}
                </span>
              )}
            </div>
