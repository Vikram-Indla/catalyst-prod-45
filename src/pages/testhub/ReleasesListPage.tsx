    ...
    <div className="th-page-content" style={{ flex: 1, padding: '24px 32px', overflow: 'auto' }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 20, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <select
          ...
          style={{ height: 38, padding: '8px 12px', border: '1px solid var(--bd-default, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))', borderRadius: 8, fontSize: 13, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', background: 'var(--bg-app, #fff)', cursor: 'pointer' }}
        >
