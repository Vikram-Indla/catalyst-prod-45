...
const TYPE_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  other: { label: 'Other', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))' },
};
...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  inactive: { label: 'Inactive', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))' },
