    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: isDark ? '#0A0A0A' : '#F8FAFC' }}>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 14, color: isDark ? '#888888' : '#64748B', margin: '4px 0 0' }}>Manage and monitor test environments</p>
            </div>
          </div>
        </div>
        <button
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
          <div style={{ backgroundColor: isDark ? '#111111' : '#FFF', borderRadius: 12, padding: 20, border: `1px solid ${isDark ? 'rgba(255,255,255,0.08)' : '#E2E8F0'}` }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div>
                <p style={{ fontSize: 12, color: isDark ? '#888888' : '#64748B', margin: 0, textTransform: 'uppercase' }}>Total</p>
        ...
        <div style={{ position: 'relative', flex: '1 1 300px', maxWidth: 400 }}>
          ...
          <input
            ...
            style={{
              ...
              border: `1.5px solid ${isDark ? 'rgba(255,255,255,0.08)' : '#E2E8F0'}`, borderRadius: 10, fontSize: 14, backgroundColor: isDark ? '#111111' : '#FFFFFF', color: isDark ? '#EDEDED' : undefined,
            }}
          />
        </div>
      ...
      {isLoading ? (
        ...
        <div style={{ backgroundColor: isDark ? '#111111' : '#FFFFFF', borderRadius: 12, padding: 60, textAlign: 'center', border: `1px solid ${isDark ? 'rgba(255,255,255,0.08)' : '#E2E8F0'}` }}>
          <Server size={48} style={{ color: isDark ? '#666666' : '#CBD5E1', marginBottom: 16 }} />
          <p style={{ fontSize: 16, color: isDark ? '#888888' : '#64748B', margin: 0 }}>No environments found</p>
          <p style={{ fontSize: 14, color: isDark ? '#666666' : '#94A3B8', margin: '8px 0 0' }}>Add an environment to get started</p>
        </div>
      ) : (
          ...
          {filteredEnvironments.map((env) => {
            ...
            return (
              <div
                ...
                style={{
                  backgroundColor: isDark ? '#111111' : '#FFFFFF', borderRadius: 12, padding: 20,
              ...
              >
                ...
                {env.url && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, color: isDark ? '#888888' : '#64748B', marginBottom: 12, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 12, borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.05)' : '#F1F5F9'}` }}>
                  ...
                  <div style={{ fontSize: 12, color: isDark ? '#666666' : '#94A3B8' }}>Checked: {formatDate(env.last_health_check)}</div>
                </div>
              </div>
            );
          })}
