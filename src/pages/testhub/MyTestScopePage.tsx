...
import { RefreshCw, Play, Filter, UserCheck, Clock, AlertTriangle } from '@/lib/atlaskit-icons';
    ...
    <div style={{ padding: '20px 24px', minHeight: '100%' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{
            fontSize: 12, fontWeight: 600, color: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', backgroundColor: 'var(--ds-surface-sunken, #F1F5F9)',
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, color: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))' }}>
                    ...
                    {isOverdue(first.planned_end) && (
                      <AlertTriangle size={13} style={{ color: 'var(--ds-text-danger, #EF4444)' }} />
                    )}
                  </div>
                </div>
