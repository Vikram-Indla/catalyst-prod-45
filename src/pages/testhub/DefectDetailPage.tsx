  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {defect.source_test_run_id ? (
            <div style={{ background: 'var(--ds-surface-sunken, #F8FAFC)', border: '1px solid var(--cp-border, var(--cp-bg-sunken, #E2E8F0))', borderRadius: 6, padding: '12px 14px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                <span style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))' }}>
                  Execution Evidence
                </span>
