...
const statusConfigLight: Record<string, { icon: any; color: string; bg: string; label: string }> = {
  not_run: { icon: Clock, color: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', bg: 'var(--ds-surface-sunken, #F1F5F9)', label: 'Not Run' },
  ...
  skipped: { icon: SkipForward, color: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', bg: 'var(--ds-surface-sunken, #F8FAFC)', label: 'Skipped' },
};
