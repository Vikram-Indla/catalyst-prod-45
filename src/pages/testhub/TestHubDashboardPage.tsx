             ...
             <div style={{ flexShrink: 0 }}>
               <div style={{
                 ...
                 <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                   ...
                   <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--cp-text-tertiary, var(--cp-ink-3, #64748B))', background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))', padding: '2px 8px', borderRadius: 10 }}>
