    ...
    return (
      <div style={{ height: 'calc(100vh - 44px)', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: 'var(--cp-bg-page, #F8FAFC)', padding: '12px 16px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 12, flexShrink: 0, marginBottom: 12 }}>
          {[...Array(6)].map((_, i) => (
            <div key={i} className="animate-pulse" style={{ height: 130, background: 'var(--cp-border, var(--cp-border, #E2E8F0))', borderRadius: 8 }} />
          ))}
        </div>
        <div className="animate-pulse" style={{ height: 48, background: 'var(--cp-border, var(--cp-border, #E2E8F0))', borderRadius: 8, marginBottom: 12, flexShrink: 0 }} />
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 320px', gap: 12, flex: 1, minHeight: 0 }}>
          {[...Array(3)].map((_, i) => (
            <div key={i} className="animate-pulse" style={{ height: '100%', background: 'var(--cp-border, var(--cp-border, #E2E8F0))', borderRadius: 8 }} />
          ))}
        </div>
      </div>
    );
      ...
      <CatalystPageHeader title="TestHub Dashboard" actions={
        <>
          ...
          <button onClick={fetchDashboardData} style={{
            ...
            color: 'var(--cp-text-primary, #0F172A)', background: 'var(--cp-bg-elevated, #FFFFFF)', border: `1px solid ${'var(--cp-border, var(--cp-border, #E2E8F0))'}`,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 320px', gap: 12, flex: 1, minHeight: 0 }}>
          ...
          <Card title="Active Cycles" badge={String(activeCycles.length)} onViewAll={() => navigate('/testhub/cycles')}>
           ...
           <div style={{
             ...
             <div style={{ borderTop: `1px dashed ${'var(--cp-border, var(--cp-border, #E2E8F0))'}`, flexShrink: 0 }} />
...
function QuickBtn({ label, onClick }: { label: string; onClick: () => void }) {
  ...
  return (
    <button className="c10-qbtn" onClick={onClick} style={{
      ...
      color: 'var(--cp-text-secondary, #334155)', background: 'var(--cp-bg-elevated, #FFFFFF)', border: `1px solid ${'var(--cp-border, var(--cp-border, #E2E8F0))'}`,
