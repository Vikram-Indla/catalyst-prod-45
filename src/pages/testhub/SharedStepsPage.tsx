    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: 'var(--cp-bg-page, #F8FAFC)' }}>
      <TestHubPageHeader title="Shared Steps Library" subtitle="Reusable test steps for consistency across test cases">
            <button onClick={handleRefresh} title="Refresh" style={{
              width: 40, height: 40, padding: 0, border: `1.5px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8,
              backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', color: 'var(--cp-text-tertiary, #64748B)', cursor: 'pointer',
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        {/* Category Sidebar */}
        <div style={{
          width: 260, backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', borderRight: `1px solid ${'var(--cp-border, #E2E8F0)'}`,
          display: 'flex', flexDirection: 'column', overflow: 'hidden',
        }}>
          {/* Sidebar Header */}
          <div style={{
            padding: '16px 16px 12px', borderBottom: `1px solid ${'var(--cp-bg-sunken, #F1F5F9)'}`,
            display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          }}>
            <h2 style={{
              fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase',
            ...
            <button onClick={() => setIsCreateCategoryModalOpen(true)} title="Add category" style={{
              width: 28, height: 28, padding: 0, border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 6,
              backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', color: 'var(--cp-text-tertiary, #64748B)', cursor: 'pointer',
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: 8 }}>
            ...
            <CategorySidebarItem
              label="All Steps"
              icon={<Folder size={16} style={{ color: !selectedCategoryId ? 'var(--ds-text-brand, #2563EB)' : ('var(--cp-text-tertiary, #64748B)') }} />}
              count={totalCount}
              isSelected={!selectedCategoryId}
              selectedColor="var(--ds-text-brand, #2563EB)"
              onClick={() => setSelectedCategoryId(null)}
              isDark={isDark}
            />

            <div style={{ height: 1, backgroundColor: 'var(--cp-bg-sunken, #F1F5F9)', margin: '8px 0' }} />

            {categories.map(cat => (
              <CategorySidebarItem
                key={cat.id}
                label={cat.name}
                icon={getCategoryIcon(cat.icon, selectedCategoryId === cat.id ? cat.color : ('var(--cp-text-tertiary, #64748B)'))}
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {/* Toolbar */}
          <div style={{
            padding: '16px 24px', backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', borderBottom: `1px solid ${'var(--cp-border, #E2E8F0)'}`,
            ...
            <div style={{ position: 'relative', flex: 1, maxWidth: 400 }}>
              ...
              <input
                ...
                style={{
                  ...
                  border: `1.5px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8, fontSize: 14,
            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  border: `1.5px solid ${activeFilters.length > 0 ? 'var(--ds-text-brand, #2563EB)' : ('var(--cp-border, #E2E8F0)')}`,
                  borderRadius: 8,
              ...
              >
                ...
                {activeFilters.length > 0 && (
                  <span style={{
                    width: 20, height: 20, borderRadius: '50%', backgroundColor: 'var(--ds-text-brand, #2563EB)',
              ...
              {isFilterOpen && (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8,
                    boxShadow: isDark ? '0 10px 40px rgba(0,0,0,0.4)' : '0 10px 40px rgba(0,0,0,0.12)', zIndex: 200, overflow: 'hidden',
                  }}
                >
                  <div style={{
                    padding: '12px 16px', borderBottom: `1px solid ${'var(--cp-bg-sunken, #F1F5F9)'}`,
                    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
                  }}>
                    ...
                    {activeFilters.length > 0 && (
                      <button onClick={() => setActiveFilters([])} style={{
                        background: 'none', border: 'none', color: 'var(--ds-text-brand, #2563EB)', fontSize: 12,
            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  height: 40, padding: '0 14px', border: `1.5px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8,
            ...
            {/* View Toggle */}
            <div style={{ display: 'flex', border: `1.5px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8, overflow: 'hidden' }}>
              <button onClick={() => setViewMode('list')} title="List view" style={{
                ...
                color: viewMode === 'list' ? 'var(--ds-text-brand, #2563EB)' : ('var(--cp-text-tertiary, #64748B)'), cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
                <List size={18} />
              </button>
              <button onClick={() => setViewMode('card')} title="Card view" style={{
                ...
                color: viewMode === 'card' ? 'var(--ds-text-brand, #2563EB)' : ('var(--cp-text-tertiary, #64748B)'), cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
                <LayoutGrid size={18} />
              </button>
            ...
            <span style={{ fontSize: 13, color: 'var(--cp-text-tertiary, #64748B)', fontFamily: 'var(--cp-font-body)' }}>
          ...
          <div style={{ flex: 1, padding: 24, overflowY: 'auto' }}>
            {loading ? (
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 300 }}>
                <div style={{
                  width: 40, height: 40, border: `3px solid ${'var(--cp-border, #E2E8F0)'}`, borderTopColor: 'var(--ds-text-brand, #2563EB)',
              ...
              <div style={{ backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)', border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 12, overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'var(--cp-font-body)' }}>
                  <thead>
                    <tr style={{ borderBottom: `1px solid ${'var(--cp-border, #E2E8F0)'}`, backgroundColor: 'var(--cp-bg-page, #F8FAFC)' }}>
                      <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Name</th>
                      <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Category</th>
                      <th style={{ padding: '12px 16px', textAlign: 'center', fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase', letterSpacing: '0.05em', width: 80 }}>Variables</th>
                      <th style={{ padding: '12px 16px', textAlign: 'center', fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase', letterSpacing: '0.05em', width: 70 }}>Used</th>
                      <th style={{ padding: '12px 16px', textAlign: 'center', fontSize: 11, fontWeight: 600, color: 'var(--cp-text-tertiary, #64748B)', textTransform: 'uppercase', letterSpacing: '0.05em', width: 80 }}>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
                    {sharedSteps.map((step, index) => {
                      ...
                      return (
                        <tr
                          ...
                          style={{
                            borderBottom: index < sharedSteps.length - 1 ? `1px solid ${'var(--cp-bg-sunken, #F1F5F9)'}` : 'none',
                        ...
                        >
                          <td style={{ padding: '12px 16px' }}>
                            ...
                            {step.description && (
                              <div style={{ fontSize: 12, color: 'var(--cp-text-tertiary, #64748B)', marginTop: 2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 400 }}>
                                {step.description}
                              </div>
                            )}
                          </td>
                          <td style={{ padding: '12px 16px' }}>
                            {step.category ? (
                              <span style={{
                                ...
                                backgroundColor: 'var(--cp-bg-sunken, #F1F5F9)', borderRadius: 4, fontSize: 11,
                          ...
                          <td style={{ padding: '12px 16px', textAlign: 'center' }}>
                            {variables.length > 0 ? (
                              <span style={{ padding: '2px 8px', backgroundColor: 'var(--cp-primary-light, #EFF6FF)', borderRadius: 12, fontSize: 12, fontWeight: 600, color: 'var(--ds-text-brand, #2563EB)' }}>
                                {variables.length}
                              </span>
                            ) : (
                              <span style={{ color: 'var(--cp-text-muted, #94A3B8)', fontSize: 13 }}>—</span>
                          ...
                          <td style={{ padding: '12px 16px', textAlign: 'center' }} onClick={(e) => e.stopPropagation()}>
                            <button onClick={() => setEditingStep(step)} title="Edit" style={{
                              ...
                              backgroundColor: 'transparent', color: 'var(--cp-text-tertiary, #64748B)', cursor: 'pointer',
                              display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
                            }}>
                              <Pencil size={14} />
                            </button>
  ...
  return (
    ...
    >
      <div style={{
        ...
        backgroundColor: isSelected ? `${selectedColor}25` : ('var(--cp-bg-sunken, #F1F5F9)'),
        display: 'flex', alignItems: 'center', justifyContent: 'center',
      }}>
        {icon}
      </div>
...
function SharedStepCard({ step, onView, onEdit, onDuplicate, onDelete, isDark = false }: {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
        ...
        {cat && (
          ...
          <span style={{
            ...
            fontSize: 11, fontWeight: 600, color: 'var(--ds-text-brand, #2563EB)', fontFamily: 'var(--cp-font-body)',
          }}>
        ...
        <div ref={menuRef} style={{ position: 'relative' }}>
          ...
          {menuOpen && (
            <div
              onClick={(e) => e.stopPropagation()}
              style={{
                position: 'absolute', right: 0, top: 36, width: 160, backgroundColor: 'var(--cp-bg-elevated, #FFFFFF)',
                borderRadius: 8, border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, boxShadow: isDark ? '0 8px 24px rgba(0,0,0,0.4)' : '0 8px 24px rgba(0,0,0,0.12)',
                padding: 4, zIndex: 50,
              }}
            >
              ...
              <div style={{ height: 1, backgroundColor: 'var(--cp-bg-sunken, #F1F5F9)', margin: '4px 0' }} />
      ...
      {step.description && (
        <p style={{
          fontFamily: 'var(--cp-font-body)', fontSize: 13, color: 'var(--cp-text-tertiary, #64748B)', margin: '0 0 12px',
      ...
      <div style={{ marginBottom: 12 }}>
        <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', color: 'var(--cp-text-tertiary, #64748B)' }}>
          Action
        </span>
        <p style={{
      ...
      {/* Variables */}
      {variables.length > 0 && (
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, paddingTop: 12, borderTop: `1px solid ${'var(--cp-bg-sunken, #F1F5F9)'}` }}>
          {variables.map((v, i) => (
            <span key={i} style={{
              padding: '2px 8px', backgroundColor: 'var(--cp-bg-sunken, #F1F5F9)', borderRadius: 4,
              fontFamily: 'monospace', fontSize: 11, color: 'var(--cp-text-tertiary, #64748B)',
            }}>
              {`{{${v.name}}}`}
            </span>
          ))}
