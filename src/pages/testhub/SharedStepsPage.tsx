    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: isDark ? '#0A0A0A' : '#F8FAFC' }}>
      <TestHubPageHeader title="Shared Steps Library" subtitle="Reusable test steps for consistency across test cases">
            ...
            <button onClick={() => setCreateModalOpen(true)} style={{
              ...
              boxShadow: '0 2px 8px rgba(37,99,235,0.25)', fontFamily: 'var(--ds-font-family-body)',
            }}>
              <Plus size={18} />
              Create Shared Step
            </button>
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              letterSpacing: '0.05em', margin: 0, fontFamily: 'var(--ds-font-family-body)',
            }}>Categories</h2>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', flex: 1, maxWidth: 400 }}>
              ...
              <input
                ...
                style={{
                  ...
                  color: isDark ? '#EDEDED' : '#0F172A', backgroundColor: isDark ? '#0A0A0A' : '#FFFFFF', fontFamily: 'var(--ds-font-family-body)',
                }}
              />
            </div>
            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  display: 'inline-flex', alignItems: 'center', gap: 8, fontFamily: 'var(--ds-font-family-body)',
                }}
              >
                <Filter size={16} />
                Filter
              ...
              {isFilterOpen && (
                ...
                >
                  <div style={{
                    ...
                    <span style={{ fontSize: 12, fontWeight: 600, color: isDark ? '#A1A1A1' : '#64748B', fontFamily: 'var(--ds-font-family-body)' }}>Filter by Category</span>
                    {activeFilters.length > 0 && (
                      <button onClick={() => setActiveFilters([])} style={{
                        background: 'none', border: 'none', color: '#2563EB', fontSize: 12,
                        fontWeight: 500, cursor: 'pointer', padding: 0, fontFamily: 'var(--ds-font-family-body)',
                      }}>
                        Clear all
                      </button>
                    )}
                    ...
                    {categories.map((cat) => {
                      ...
                      return (
                        <label key={cat.id} style={{
                          ...
                          borderRadius: 8, cursor: 'pointer', fontSize: 14, color: isDark ? '#EDEDED' : '#334155', fontFamily: 'var(--ds-font-family-body)',
                  ...
                  <div style={{ padding: '8px 12px', borderTop: `1px solid ${isDark ? '#292929' : '#F1F5F9'}` }}>
                    <button onClick={() => setIsFilterOpen(false)} style={{
                      ...
                      fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)',
                    }}>
                      Apply Filter
                    </button>
                  </div>
            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 8, fontFamily: 'var(--ds-font-family-body)',
                }}
              >
                <ArrowUpDown size={16} />
                Sort
            ...
            <span style={{ fontSize: 13, color: isDark ? '#878787' : '#64748B', fontFamily: 'var(--ds-font-family-body)' }}>
          ...
          <div style={{ flex: 1, padding: 24, overflowY: 'auto' }}>
            {loading ? (
              ...
              <div style={{
                ...
                <p style={{ fontSize: 16, fontWeight: 500, margin: '0 0 8px', fontFamily: 'var(--ds-font-family-body)' }}>
                  {searchQuery || selectedCategoryId || activeFilters.length > 0 ? 'No matching shared steps' : 'No shared steps yet'}
                </p>
                <p style={{ fontSize: 14, margin: 0, fontFamily: 'var(--ds-font-family-body)' }}>
  ...
  return (
    ...
    >
      ...
      <span style={{
        ...
        color: isSelected ? selectedColor : (isDark ? '#A1A1A1' : '#334155'), fontFamily: 'var(--ds-font-family-body)',
...
function SharedStepCard({ step, onView, onEdit, onDuplicate, onDelete, isDark = false }: {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
        ...
        {cat && (
            <span style={{
              display: 'inline-flex', alignItems: 'center', gap: 4, padding: '2px 8px',
              backgroundColor: isDark ? '#1A1A1A' : '#F1F5F9', borderRadius: 4, fontSize: 11,
              fontWeight: 600, color: isDark ? '#A1A1A1' : '#374151', fontFamily: 'var(--ds-font-family-body)',
            }}>
              {cat.name}
            </span>
          )}
          <span style={{
            ...
            fontSize: 11, fontWeight: 600, color: '#2563EB', fontFamily: 'var(--ds-font-family-body)',
          }}>
      ...
      {/* Name */}
      <h3 style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 15, fontWeight: 600, color: isDark ? '#EDEDED' : '#0F172A', margin: '0 0 4px' }}>
        {step.name}
      </h3>
      ...
      {step.description && (
        <p style={{
          fontFamily: 'var(--ds-font-family-body)', fontSize: 13, color: isDark ? '#878787' : '#64748B', margin: '0 0 12px',
      ...
      <div style={{ marginBottom: 12 }}>
        <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.06em', color: isDark ? '#878787' : '#64748B' }}>
          Action
        </span>
        <p style={{
          fontFamily: 'var(--ds-font-family-body)', fontSize: 13, color: isDark ? '#A1A1A1' : '#334155', margin: '4px 0 0',
          display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden',
          lineHeight: 1.6,
        }}>
