    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: isDark ? 'var(--cp-bg-page, #1F1F21)' : '#F8FAFC' }}>
      <TestHubPageHeader title="Shared Steps Library" subtitle="Reusable test steps for consistency across test cases">
            <button onClick={handleRefresh} title="Refresh" style={{
              ...
              backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', color: 'var(--cp-text-tertiary, #64748B)', cursor: 'pointer',
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
        {/* Category Sidebar */}
        <div style={{
          width: 260, backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', borderRight: `1px solid ${'var(--cp-border, #E2E8F0)'}`,
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {/* Toolbar */}
          <div style={{
            padding: '16px 24px', backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', borderBottom: `1px solid ${'var(--cp-border, #E2E8F0)'}`,
            ...
            <div style={{ position: 'relative', flex: 1, maxWidth: 400 }}>
              ...
              <input
                ...
                style={{
                  ...
                  color: 'var(--cp-text-primary, #0F172A)', backgroundColor: isDark ? 'var(--cp-bg-page, #1F1F21)' : '#FFFFFF', fontFamily: 'var(--cp-font-body)',
                }}
              />
            </div>
              ...
              {isFilterOpen && (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 8,
            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', color: 'var(--cp-text-secondary, #334155)', fontSize: 14, fontWeight: 500,
          ...
          <div style={{ flex: 1, padding: 24, overflowY: 'auto' }}>
            {loading ? (
              ...
              <div style={{ backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', border: `1px solid ${'var(--cp-border, #E2E8F0)'}`, borderRadius: 12, overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'var(--cp-font-body)' }}>
                  <thead>
                    <tr style={{ borderBottom: `1px solid ${'var(--cp-border, #E2E8F0)'}`, backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#F8FAFC' }}>
