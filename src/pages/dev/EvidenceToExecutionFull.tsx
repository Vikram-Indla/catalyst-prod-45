...
export default function EvidenceToExecutionFull() {
  ...
  if (stage === 'br-view') {
    return (
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', minHeight: '100vh', backgroundColor: 'var(--ds-surface, #FFFFFF)' }}>
        {/* Left Content */}
  ...
  if (stage === 'evidence-modal') {
    return (
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', minHeight: '100vh', backgroundColor: 'var(--ds-surface, #FFFFFF)' }}>
        <div style={{ borderRight: '1px solid var(--ds-border, #DFE1E6)', padding: '32px' }}>
          ...
          <div style={{ padding: '32px' }}>
            ...
            {selectedTab === 'Comments Intelligence' && (
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {[
                    { type: 'Decision', color: 'var(--ds-link, #0052CC)', text: 'Arabic + English support mandatory', author: 'Vikram' },
                    { type: 'Scope Change', color: 'var(--ds-text-warning, #974F0C)', text: 'Add phone OTP verification', author: 'Abdullah' },
                    { type: 'Clarification', color: 'var(--ds-text-success, #216E4E)', text: 'Identity verification requirements?', author: 'Aisha' },
                    { type: 'Unresolved', color: 'var(--ds-text-warning, #974F0C)', text: 'Who owns approval workflow?', author: 'Marcus' },
                    { type: 'Contradiction', color: 'var(--ds-text-danger, #AE2A19)', text: '24 hours vs 3-5 business days', author: 'Priya' },
                    { type: 'Test', color: 'var(--ds-background-discovery-bold, #6E5DC6)', text: 'Test in Arabic and English?', author: 'James' },
                  ].map((c, i) => (
                    <div
                      key={i}
                      style={{
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {[
                    ...
                    <div key={i} style={{ padding: '12px', backgroundColor: 'var(--ds-surface-sunken, #F7F8F9)', borderRadius: '4px', display: 'flex', gap: '12px', alignItems: 'center' }}>
                      <div
                        style={{
                          backgroundColor: issue.severity === 'P0' ? 'var(--ds-text-danger, #AE2A19)' : issue.severity === 'P1' ? 'var(--ds-text-warning, #974F0C)' : 'var(--ds-background-discovery-bold, #6E5DC6)',
                          color: 'var(--ds-text-inverse, #FFFFFF)',
                          padding: '2px 8px',
                          borderRadius: '3px',
                          fontSize: '11px',
                  ...
                  {[
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: '4px',
                        border: `1px solid ${source.included ? '#4CE97' : 'var(--ds-border, #DFE1E6)'}`,
                        display: 'flex',
                        alignItems: 'center',
                        gap: '12px',
                      }}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', minHeight: '100vh', backgroundColor: 'var(--ds-surface, #FFFFFF)' }}>
        <div style={{ padding: '32px', borderRight: '1px solid var(--ds-border, #DFE1E6)' }}>
          ...
          {generateStage === 'project-select' && (
            <div>
              <p style={{ color: 'var(--ds-icon-subtle, #626F86)', marginBottom: '24px' }}>Select the destination project where these work items will be created.</p>
              <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    backgroundColor: selectedProject ? 'var(--ds-link, #0052CC)' : 'var(--ds-border, #DFE1E6)',
                    color: 'var(--ds-text-inverse, #FFFFFF)',
                    border: 'none',
                    borderRadius: '4px',
          ...
          {generateStage === 'success' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--ds-icon-subtle, #626F86)', marginBottom: '20px' }}>
