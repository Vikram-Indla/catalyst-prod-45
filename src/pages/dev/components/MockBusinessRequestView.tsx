...
export function MockBusinessRequestView({
  ...
  return (
    <div style={{ padding: 0 }}>
      ...
      <div style={{ backgroundColor: '#FFFFFF', borderBottom: '1px solid #DFE1E6', padding: '24px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 0 }}>
        {/* Main content */}
        <div style={{ padding: 32, borderRight: '1px solid #DFE1E6' }}>
          <Tabs id="br-tabs" onChange={setSelectedTab} selected={selectedTab}>
            ...
            <TabPanel>
              <div style={{ paddingTop: 16 }}>
                ...
                <p style={{ margin: '0 0 16px 0', color: '#172B4D', fontSize: '14px' }}>
                ...
                <ul style={{ margin: '0 0 16px 0', paddingLeft: 20, color: '#172B4D', fontSize: '14px' }}>
        ...
        {/* Right sidebar */}
        <div style={{ padding: 16, backgroundColor: '#F7F8F9' }}>
          <Stack space="space.150">
            <div>
...
function AttachmentItem({
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: '13px', fontWeight: 500, color: '#172B4D' }}>
          {name}
        </div>
