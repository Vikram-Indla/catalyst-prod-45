        ...
        >
          {stage === 'project-select' && (
            <div style={{ padding: '24px 0' }}>
              ...
              />
              <div style={{ marginTop: 16, padding: '12px', backgroundColor: '#DFFCF0', borderRadius: '4px' }}>
                <strong>Evidence Summary:</strong>
                <div style={{ fontSize: '13px', marginTop: 8, color: '#172B4D' }}>
          ...
          {stage === 'preview' && (
            <div style={{ padding: '24px 0' }}>
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ fontSize: '13px', color: '#626F86', marginTop: 4 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, maxHeight: '400px', overflowY: 'auto' }}>
                {items.map((item) => (
                  <div
                    ...
                    style={{
                      padding: '12px',
                      backgroundColor: item.approved ? '#DFFCF0' : '#F7F8F9',
                      borderRadius: '4px',
                      border: `1px solid ${item.approved ? '#4BCE97' : '#DFE1E6'}`,
                  ...
                  >
                    ...
                    <div style={{ fontSize: '12px', color: '#626F86', marginLeft: 30 }}>
          ...
          {stage === 'success' && (
            <div style={{ padding: '24px 0', textAlign: 'center' }}>
              ...
              <p style={{ color: '#626F86', marginBottom: 20 }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ color: '#216E4E', fontWeight: 500 }}>
                    In production, these items would now be created as drafts in your project.
                  </span>
                </div>
              </div>
              <p style={{ fontSize: '12px', color: '#626F86' }}>
