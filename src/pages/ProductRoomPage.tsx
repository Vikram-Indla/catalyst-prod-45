...
const Sidebar: React.FC<{ activeItem: string }> = ({ activeItem }) => {
  const navItems = [
    ...
    { id: 'requests', label: 'Business Requests', icon: Target },
    { id: 'epics', label: 'Epics', icon: Target },
    { id: 'roadmap', label: 'Roadmap', icon: Calendar },
    { id: 'settings', label: 'Settings', icon: Settings },
  ];

  return (
    <div className="w-64 bg-white border-r-2 border-gray-100 flex flex-col h-full">
      {/* Logo */}
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-gray-900">MDT</div>
          ...
          {navItems.map(item => (
            <li key={item.id}>
              <button
                ...
                style={activeItem === item.id ? { backgroundColor: COLORS.goldLight } : {}}
              >
