...
export default function ReqAssistGenerate() {
  ...
  return (
    <div style={{ background: '#FFFFFF', minHeight: '100%', padding: '32px' }}>
      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 6, padding: 24, marginBottom: 20 }}>
        ...
        <textarea
          className="ra-generate-textarea"
          value={text}
          onChange={(e) => {
          ...
          onFocus={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 0 0 2px rgba(37,99,235,0.10)';
          }}
          onBlur={(e) => {
      ...
      <style>{`
        ...
        .ra-generate-textarea::placeholder {
          color: #9CA3AF;
          font-size: 14px;
          opacity: 1;
        }
