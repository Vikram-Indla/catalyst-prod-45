...
function SimpleDateInput({ label, value, onChange, helperText, isDark }: {
  ...
  return (
    <div style={{ flex: 1, minWidth: 200 }}>
      <label style={{
        fontSize: 11, fontWeight: 700, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', marginBottom: 4,
      ...
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{
            ...
            color: isDark ? 'var(--ds-text, var(--cp-bg-neutral, #EDEDED))' : 'var(--ds-text, var(--cp-ink-1, #0F172A))', fontFamily: 'var(--cp-font-body)',
          }}
        />
      </div>
      <div style={{ fontSize: 10, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))', marginTop: 4 }}>{helperText}</div>
    </div>
  );
}
...
export default function WikiTemplatesPage() {
  ...
  return (
    <div style={{
      ...
      background: isDark ? 'var(--cp-bg-page, #1F1F21)' : 'var(--ds-surface-sunken, #F8FAFC)',
      ...
      <h1 style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 18, fontWeight: 700, marginBottom: 8, color: isDark ? 'var(--ds-text, var(--cp-bg-neutral, #EDEDED))' : 'var(--ds-text, var(--cp-ink-1, #0F172A))' }}>Article Templates</h1>
      ...
      <div style={{
        ...
        <button onClick={() => setShowScheduling(!showScheduling)} style={{
          fontSize: 12, fontWeight: 650, color: isDark ? 'var(--ds-text, var(--cp-bg-neutral, #EDEDED))' : 'var(--ds-text, var(--cp-ink-1, #0F172A))', background: 'transparent',
          ...
          Content Scheduling
          <span style={{ fontSize: 10, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))', fontWeight: 500, marginLeft: 'auto' }}>
          ...
          return (
            <div key={t.id} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                ...
                <div>
                  <div style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 13, fontWeight: 600, color: isDark ? 'var(--ds-text, var(--cp-bg-neutral, #EDEDED))' : 'var(--ds-text, var(--cp-ink-1, #0F172A))' }}>{t.name}</div>
              ...
              <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap', marginBottom: 12 }}>
                ...
                {sections.length > 4 && <span style={{ fontSize: 9, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))' }}>+{sections.length - 4} more</span>}
              </div>
              <button
