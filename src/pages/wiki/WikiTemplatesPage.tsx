      ...
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{
            ...
            color: isDark ? 'var(--ds-text, #EDEDED)' : 'var(--ds-text, #0F172A)', fontFamily: 'var(--cp-font-body)',
          }}
        />
      </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={() => setShowScheduling(!showScheduling)} style={{
          fontSize: 12, fontWeight: 650, color: isDark ? 'var(--ds-text, #EDEDED)' : 'var(--ds-text, #0F172A)', background: 'transparent',
