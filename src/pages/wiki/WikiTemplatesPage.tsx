...
function SimpleDateInput({ label, value, onChange, helperText, isDark }: {
  ...
  return (
    <div style={{ flex: 1, minWidth: 200 }}>
      ...
      <div style={{ fontSize: 10, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, #94A3B8)', marginTop: 4 }}>{helperText}</div>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={() => setShowScheduling(!showScheduling)} style={{
          ...
          Content Scheduling
          <span style={{ fontSize: 10, color: isDark ? 'var(--ds-text-subtlest, #878787)' : 'var(--ds-text-subtlest, #94A3B8)', fontWeight: 500, marginLeft: 'auto' }}>
