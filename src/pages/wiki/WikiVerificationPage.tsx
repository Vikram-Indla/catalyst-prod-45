  ...
  return (
    <div style={{ fontFamily: 'var(--cp-font-body)', color: isDark ? 'var(--ds-text, var(--ds-text, #EDEDED))' : 'var(--ds-text, var(--ds-text, #0F172A))', background: isDark ? 'var(--cp-bg-page, #1F1F21)' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F8FAFC))', minHeight: '100%', padding: '24px 40px 48px' }}>
      <nav style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 24 }}>
        ...
        <span style={{ fontSize: 13, color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', fontWeight: 600 }}>Verification Queue</span>
      </nav>

      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <h1 style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 18, fontWeight: 700, margin: 0 }}>Verification Queue</h1>
          <p style={{ fontSize: 12, color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', marginTop: 4 }}>
        ...
        <button onClick={handleRefreshFreshness} disabled={refreshing} style={{
          ...
          border: `0.75px solid ${isDark ? 'var(--ds-border-bold, var(--ds-border-bold, #454545))' : 'rgba(0,0,0,0.12)'}`, background: isDark ? 'var(--cp-bg-surface, #242528)' : 'var(--ds-surface, var(--ds-surface, #FFFFFF))', color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : 'var(--ds-text-subtle, var(--ds-text-subtle, #334155))',
        ...
        {isLoading ? <div style={{ padding: 32, textAlign: 'center', color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', fontSize: 12 }}>Loading...</div> :
          (queue ?? []).length === 0 ? (
            <div style={{ padding: 48, textAlign: 'center' }}>
              <ShieldCheck size={32} style={{ color: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', margin: '0 auto 12px' }} />
              <div style={{ fontSize: 14, fontWeight: 600, color: isDark ? 'var(--ds-text, var(--ds-text, #EDEDED))' : 'var(--ds-text, var(--ds-text, #0F172A))' }}>All clear!</div>
              <div style={{ fontSize: 12, color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', marginTop: 4 }}>No articles pending review.</div>
            </div>
          ) : (queue ?? []).map((a: any) => {
            ...
            return (
              <div key={a.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, overflow: 'hidden' }}>
                  {stale && <AlertTriangle size={12} style={{ color: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', flexShrink: 0 }} />}
                  <span onClick={() => navigate(`/wiki/${a.slug}`)} style={{
                    fontWeight: 500, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', cursor: 'pointer',
                ...
                <span style={{ fontSize: 11, color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))' }}>{a.author_name || '—'}</span>
                <span style={{
                  fontFamily: 'var(--cp-font-mono)', fontSize: 11, fontWeight: 500,
                  color: stale ? 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' : fresh >= 80 ? 'var(--ds-text-success, var(--ds-text-success, #16A34A))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))',
                }}>{fresh}%</span>
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                  <button onClick={() => handleVerify(a.id)} style={{
                    ...
                    background: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))', cursor: 'pointer',
                  ...
                  <button onClick={() => handleRequestChanges(a.id)} style={{
                    ...
                    border: `0.75px solid ${isDark ? 'var(--ds-border-bold, var(--ds-border-bold, #454545))' : 'rgba(0,0,0,0.12)'}`, background: isDark ? 'var(--cp-bg-surface, #242528)' : 'var(--ds-surface, var(--ds-surface, #FFFFFF))', color: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))',
                    cursor: 'pointer',
