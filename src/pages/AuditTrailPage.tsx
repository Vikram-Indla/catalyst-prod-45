...
function restoreStatus(entry: AuditEntry): { label: string; bg: string; color: string; border: string } {
  ...
  if (deadline < new Date()) {
    return { label: 'EXPIRED', bg: '#F1F5F9', color: '#64748B', border: '#E2E8F0' };
  }
  ...
  return (
    <div style={{
        ...
        <div>
          <button
            ...
            style={{
              ...
              fontSize: 13, color: '#475569', fontFamily: 'var(--cp-font-body)',
              marginBottom: 4,
            }}
          >
          ...
          <div style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 20, fontWeight: 700, color: '#0F172A' }}>
            Audit Trail
          </div>
      ...
      <div style={{
        ...
        >
          <SelectTrigger style={{ width: 160, height: 36, fontSize: 13, border: '1px solid #E2E8F0', borderRadius: 6, background: '#ffffff' }}>
            <SelectValue />
          </SelectTrigger>
        ...
        >
          <SelectTrigger style={{ width: 180, height: 36, fontSize: 13, border: '1px solid #E2E8F0', borderRadius: 6, background: '#ffffff' }}>
            <SelectValue />
          </SelectTrigger>
          <SelectContent style={{ background: '#ffffff' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <input
            ...
            style={{
              ...
              color: '#0F172A', fontFamily: 'var(--cp-font-body)',
            }}
          />
        ...
        <div style={{
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tr style={{ background: '#F8FAFC', borderBottom: '1px solid #E2E8F0' }}>
                {['ITEM', 'CATEGORY', 'CLOSED BY', 'CLOSED', 'REASON', 'RESTORE STATUS', 'RESTORED BY'].map(h => (
                  <th key={h} style={{
                    ...
                    color: '#94A3B8', textAlign: 'left', fontFamily: 'var(--cp-font-body)',
                    whiteSpace: 'nowrap',
                  }}>
                    {h}
                  </th>
            ...
            <tbody>
              {isLoading ? (
                <tr>
                  <td colSpan={7} style={{ padding: 40, textAlign: 'center', fontSize: 13, color: '#94A3B8' }}>
                    Loading audit trail...
                  </td>
                </tr>
              ) : entries.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    {/* CATEGORY */}
                    <td style={{ padding: '8px 12px', fontSize: 13, color: '#64748B', verticalAlign: 'top' }}>
                    ...
                    {/* REASON */}
                    <td style={{
                      padding: '8px 12px', fontSize: 13, color: '#475569',
                    ...
                    <td style={{ padding: '8px 12px', verticalAlign: 'top' }}>
                      {entry.restored_by_name ? (
                        <div>
                          ...
                          {entry.restored_at && (
                            <div style={{ fontSize: 11, color: '#94A3B8', marginTop: 2, paddingLeft: 30 }}>
      ...
      <div style={{
        ...
        padding: '12px 24px', background: '#ffffff', borderTop: '1px solid #E2E8F0',
        flexShrink: 0,
      }}>
