...
import { CheckCircle2, Download, ArrowLeft, Upload, X, Loader2 } from '@/lib/atlaskit-icons';
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-semibold">
            <span className="text-[var(--ds-surface,#0a0a0a)] dark:text-white">Cata</span>
      ...
      <main className="max-w-[720px] mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="space-y-4">
              <div>
                <Label className="text-sm font-medium text-gray-700">
                  Summary <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                </Label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Business Ask <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
                  <Select
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Delivery Platform <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
                  <Select
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div>
              <Label className="text-sm font-medium text-gray-700">
                Description <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
              </Label>
              <Textarea
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Requested by <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
                  <Input
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Email <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Department <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
                  <Select
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700">
                    Business Owner <span className="text-[var(--ds-text-danger,#ef4444)]">*</span>
                  </Label>
                  <Input
