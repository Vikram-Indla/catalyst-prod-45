...
function MetricCard({ label, value, subtitle, icon: Icon, status }: {
  ...
  return (
    <div className="border border-[rgba(15,23,42,0.12)] dark:border-[rgba(255,255,255,0.08)] rounded-md p-4 bg-white dark:bg-[#111111]">
...
function Section({ title, icon: Icon, children }: { title: string; icon: React.ElementType; children: React.ReactNode }) {
  return (
    <section className="border border-[rgba(15,23,42,0.12)] dark:border-[rgba(255,255,255,0.08)] rounded-md bg-white dark:bg-[#111111]">
...
export default function WikiDiagnosticPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFBFC]">
      {/* Header */}
      <div className="bg-white dark:bg-[#111111] border-b border-[rgba(15,23,42,0.12)] dark:border-[rgba(255,255,255,0.08)] px-7 py-4 flex items-center justify-between">
      ...
      <div className="px-7 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded border border-[rgba(15,23,42,0.12)] dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[#111111] text-[#0F172A] hover:bg-[#F4F5F7]"
          >
