 ...
 * Reexport: RolesPermissionsContent from @/components/admin/RolesPermissionsContent
 */
    ...
    <AdminGuard>
      <div className="p-6 space-y-8">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 style={{ fontSize: 20, fontWeight: 653, color: "var(--ds-text, #292A2E)" }} style={{ color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, #172B4D)))' }}>Roles & Permissions</h1>
