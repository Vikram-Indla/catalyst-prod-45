    ...
    <div style={pageContainerStyle}>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginBottom: 12 }}>
          ...
          <span style={{ fontSize: 12, color: 'var(--ds-text-subtle, #44546F)' }}>
            <code>@/components/shared/UserAvatar</code>
          </span>
        </div>
        <div style={{ fontSize: 13, color: 'var(--ds-text-subtle, #44546F)', marginBottom: 12, maxWidth: 800 }}>
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'flex-end', flexWrap: 'wrap' }}>
          {(['xsmall', 'small', 'medium', 'large', 'xlarge'] as const).map(s => (
            <div key={s} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ fontSize: 11, color: 'var(--ds-text-subtle, #44546F)' }}>{s}</span>
            </div>
          ))}
        </div>
      </div>
