      ...
      <td className="px-4 py-3">
        <div className="flex items-center justify-center gap-1">
          ...
          <button
            ...
            className="w-8 h-8 rounded flex items-center justify-center text-muted-foreground hover:bg-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]/10 hover:text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))] transition-colors"
          >
