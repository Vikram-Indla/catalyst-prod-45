  ...
  return (
      <div className="bg-white dark:bg-[#1A1A1A] border border-[var(--bd-default, #E2E8F0)] dark:border-[#1A1A1A] rounded-md overflow-hidden">
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-[var(--bd-default, #E2E8F0)] dark:border-[#1A1A1A]">
  ...
  return (
    <div className="p-6 space-y-6 dark:bg-[#0A0A0A] min-h-screen">
      <div className="flex items-start justify-between">
        <div>
          <h1 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 20, fontWeight: 700 }} className="text-[#0F172A] dark:text-white">
            Jira Sync Audit Log
          </h1>
