  ...
  return (
    ...
    >
      ...
      <div className="px-3 min-w-0">
        <div style={{ fontFamily: 'var(--cp-font-mono)', fontSize: 12, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', fontVariantNumeric: 'tabular-nums' }}>
      ...
      {stats && (
        ...
        >
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <div className="flex-1 h-1.5 rounded-full overflow-hidden" style={{ background: 'var(--cp-border, var(--cp-lozenge-grey-bg, #DFE1E6))' }}>
              <div
