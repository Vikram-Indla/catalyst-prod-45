          ...
          <div className="flex items-start justify-between pb-3">
            <div>
              <h1 className="jira-text-primary"
                style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: '17px', fontWeight: 700, letterSpacing: '-0.3px', margin: 0, lineHeight: 1.3, color: isDark ? '#EDEDED' : '#0F172A' }}>
                Jira User Sync
              </h1>
            ...
            >
              <div className="flex items-center gap-[5px] mb-[4px]">
                ...
                <span className="jira-stat-label"
                  style={{ fontSize: '11px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.03em', fontFamily: 'var(--ds-font-family-body)', color: isDark ? '#878787' : '#64748B' }}>
                  {card.label}
                </span>
              </div>
              <div className="jira-stat-value"
                style={{ fontSize: '28px', fontWeight: 650, lineHeight: 1.1, fontFamily: 'var(--ds-font-family-heading)', color: isDark ? '#EDEDED' : '#0F172A' }}>
                    ...
                    .map(proj => (
                      ...
                      >
                        <span className="jira-chip"
                          style={{
                            fontSize: '10px', fontWeight: 700, fontFamily: 'var(--ds-font-family-monospaced)', padding: '1px 5px', borderRadius: '4px',
                    ...
                    <td style={{ padding: '8px 12px' }}>
                      <div className="flex items-center gap-2">
                        ...
                        <div style={{ minWidth: 0, maxWidth: '220px' }}>
                          ...
                          <div className="jira-text-label" style={{ fontSize: '11px', fontFamily: 'var(--ds-font-family-monospaced)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', color: isDark ? '#878787' : '#6B7280' }}>
                    ...
                    <td style={{ padding: '8px 12px' }}>
                      {isCatalystOnly ? (
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span style={{ fontSize: '11px', fontFamily: 'var(--ds-font-family-monospaced)', whiteSpace: 'nowrap', color: isDark ? '#A1A1A1' : '#64748B' }}>{formatSyncDate(user.last_synced_at)}</span>
                        </div>
                      )}
                    </td>

                    {/* Last Jira Login */}
                    <td style={{ padding: '8px 12px', fontSize: '11px', fontFamily: 'var(--ds-font-family-monospaced)', color: isDark ? '#A1A1A1' : '#64748B' }}>{relativeTime(user.last_jira_login_at)}</td>

                    {/* Last in Catalyst */}
                    <td style={{ padding: '8px 12px', fontSize: '11px', fontFamily: 'var(--ds-font-family-monospaced)', color: isDark ? '#A1A1A1' : '#64748B' }}>{relativeTime(user.last_catalyst_login_at)}</td>
