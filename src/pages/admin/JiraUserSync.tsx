      ...
      <div className="jira-surface flex flex-col flex-1 overflow-hidden mx-5 my-4 rounded-lg"
          ...
          <div className="flex items-start justify-between pb-3">
            <div>
              ...
              <p className="jira-text-secondary"
                style={{ fontSize: '11px', margin: '2px 0 0', color: isDark ? '#888888' : '#64748B' }}>
            ...
            >
              <div className="flex items-center gap-[5px] mb-[4px]">
                ...
                <span className="jira-stat-label"
                  style={{ fontSize: '11px', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.03em', fontFamily: "'Inter', sans-serif", color: isDark ? '#666666' : '#64748B' }}>
                  {card.label}
                </span>
              </div>
              ...
              <div className="jira-stat-sub"
                style={{ fontSize: '11px', marginTop: '4px', color: isDark ? '#666666' : '#94A3B8' }}>
                {card.sub}
              </div>
            </div>
          ))}
        ...
        <div className="jira-toolbar shrink-0 flex items-center gap-[7px] flex-wrap"
          ...
          <div className="relative w-[220px]">
            <Search size={12} className="absolute left-2 top-1/2 -translate-y-1/2" style={{ color: isDark ? '#666666' : '#64748B' }} />
            <input
        ...
        {selected.size > 0 && (
          <div className="jira-selection-bar shrink-0 flex items-center gap-[9px]"
            ...
            <Popover open={assignPopoverOpen} onOpenChange={setAssignPopoverOpen}>
              ...
              >
                <div style={{ padding: '12px 14px 8px' }}>
                  ...
                  <div className="jira-text-secondary" style={{ fontSize: '11px', marginBottom: '8px', color: isDark ? '#888888' : '#64748B' }}>
                  ...
                  <div className="flex items-center gap-1 mb-2">
                    <span style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase', marginRight: '4px', color: isDark ? '#666666' : '#64748B' }}>Level:</span>
                ...
                <div style={{ maxHeight: '200px', overflowY: 'auto', borderTop: `0.75px solid ${isDark ? 'rgba(255,255,255,0.10)' : 'rgba(15,23,42,0.06)'}` }}>
                      ...
                      >
                        <span className="jira-chip"
                          style={{
                            ...
                            color: isDark ? '#888888' : '#374151',
                          }}>
                          {proj.project_key}
                        </span>
                        <span style={{ fontSize: '11px', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', color: isDark ? '#888888' : '#334155' }}>
                  ...
                  {(jiraProjects || []).filter(p => !assignSearch || p.project_key.toLowerCase().includes(assignSearch.toLowerCase())).length === 0 && (
                    <div style={{ padding: '16px', textAlign: 'center', fontSize: '11px', color: isDark ? '#666666' : '#94A3B8' }}>
                      No projects found
                    </div>
                  )}
                </div>
            ...
            <button onClick={clearAll}
              className="ml-auto"
              style={{ padding: '2px 6px', borderRadius: '4px', fontSize: '11px', fontWeight: 500, background: 'transparent', border: 'none', cursor: 'pointer', color: isDark ? '#666666' : '#64748B' }}>
              Clear selection
            </button>
          </div>
        )}
        ...
        <div className="flex-1 overflow-y-auto overflow-x-auto">
          <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '1000px' }}>
            <thead>
              <tr className="jira-table-header" style={{ background: isDark ? '#111111' : '#F1F5F9', borderBottom: `0.75px solid ${isDark ? 'rgba(255,255,255,0.10)' : 'rgba(15,23,42,0.06)'}` }}>
              ...
              {usersLoading ? (
                ...
                <tr>
                  <td colSpan={9} style={{ textAlign: 'center', padding: '60px 20px' }}>
                    {debouncedSearch ? (
                      <>
                        <Search size={24} style={{ color: isDark ? '#666666' : '#94A3B8', margin: '0 auto 10px', display: 'block' }} />
                      ...
                      <>
                        <FolderSearch size={24} style={{ color: isDark ? '#666666' : '#94A3B8', margin: '0 auto 10px', display: 'block' }} />
                      ...
                      <>
                        <Users2 size={32} style={{ color: isDark ? '#666666' : '#94A3B8', margin: '0 auto 10px', display: 'block' }} />
                  ...
                  <tr key={user.id}
                    ...
                    <td style={{ padding: '0 12px' }}>
                      <div className="flex items-center gap-2">
                        ...
                        <div style={{ minWidth: 0, maxWidth: '220px' }}>
                          ...
                          <div className="jira-text-label" style={{ fontSize: '11px', fontFamily: "'JetBrains Mono', monospace", whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', color: isDark ? '#666666' : '#6B7280' }}>
                    ...
                    <td style={{ padding: '0 12px', maxWidth: '200px' }}>
                      <div className="flex gap-1 flex-nowrap overflow-hidden items-center">
                        ...
                        {perms.length > 2 && <span style={{ fontSize: '10px', fontWeight: 500, whiteSpace: 'nowrap', color: isDark ? '#888888' : '#64748B' }}>+{perms.length - 2} more</span>}
                        {perms.length === 0 && <span style={{ fontSize: '10px', color: isDark ? '#666666' : '#94A3B8' }}>—</span>}
                      </div>
                    </td>
                    ...
                    <td style={{ padding: '0 12px' }}>
                      {isCatalystOnly ? (
                        <span style={{ fontSize: '11px', fontStyle: 'italic', color: isDark ? '#666666' : '#94A3B8' }}>Not synced</span>
                      ) : (
                        <div className="flex items-center gap-1">
                          <span style={{ width: '5px', height: '5px', borderRadius: '50%', background: '#16A34A', flexShrink: 0 }} />
                          <span style={{ fontSize: '11px', fontFamily: "'JetBrains Mono', monospace", whiteSpace: 'nowrap', color: isDark ? '#888888' : '#64748B' }}>{formatSyncDate(user.last_synced_at)}</span>
                        </div>
                      )}
                    </td>

                    {/* Last Jira Login */}
                    <td style={{ padding: '0 12px', fontSize: '11px', fontFamily: "'JetBrains Mono', monospace", color: isDark ? '#888888' : '#64748B' }}>{relativeTime(user.last_jira_login_at)}</td>

                    {/* Last in Catalyst */}
                    <td style={{ padding: '0 12px', fontSize: '11px', fontFamily: "'JetBrains Mono', monospace", color: isDark ? '#888888' : '#64748B' }}>{relativeTime(user.last_catalyst_login_at)}</td>
        ...
        <div className="jira-pagination-bg shrink-0 flex items-center justify-between"
          style={{ padding: '9px 16px', borderTop: `0.75px solid ${isDark ? 'rgba(255,255,255,0.10)' : 'rgba(15,23,42,0.06)'}`, background: isDark ? '#0A0A0A' : '#F8FAFC' }}>
          <span style={{ fontSize: '11px', color: isDark ? '#888888' : '#64748B' }}>
          ...
          <div className="flex gap-1 items-center">
            ...
            {getPageNumbers(page, totalPages).map((p, i) =>
              p === '...' ? (
                <span key={`ell-${i}`} style={{ width: '28px', textAlign: 'center', fontSize: '11px', color: isDark ? '#666666' : '#94A3B8' }}>…</span>
              ) : (
                <button
                  key={p}
                  ...
                  style={{
                    ...
                    background: page === p ? '#2563EB' : (isDark ? '#111111' : '#FFFFFF'),
                    color: page === p ? '#FFFFFF' : (isDark ? '#888888' : '#64748B'),
