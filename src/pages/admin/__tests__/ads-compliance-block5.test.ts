 ...
 *
 * AdminLayout must use @atlaskit/icon/core or @atlaskit/icon/glyph for all
 * icons — never lucide-react.
 *
 * AdminOverview.tsx, FeatureFlagsPage.tsx, NotificationTriggers.tsx were
 * removed (route usage audit, 2026-07-08 — orphaned pages, no live route or
 * consumer). ProductSettings.tsx no longer existed even before that.
 *
