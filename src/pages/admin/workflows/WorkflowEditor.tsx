          ...
          {statuses.map(s => (
            ...
            >
              ...
              <div className="flex items-center gap-1 shrink-0">
                {s.is_initial && (
                  <span className="px-1.5 py-0.5 text-[10px] bg-[var(--ds-surface-sunken,#F1F5F9)] text-[var(--ds-text-subtle,#475569)] rounded border border-[var(--ds-border,var(--cp-border, #E2E8F0))]">
                    START
                  </span>
                )}
                {s.is_final && (
