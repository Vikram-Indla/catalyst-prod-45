              ...
              {(['workflows', 'templates'] as const).map((mode) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    boxShadow: pageMode === mode ? `0 1px 2px var(--ds-background-neutral-subtle-pressed)` : 'none',
                    fontFamily: 'inherit',
                ...
                {(['board', 'diagram'] as const).map((mode) => (
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      boxShadow: viewMode === mode ? `0 1px 2px var(--ds-background-neutral-subtle-pressed)` : 'none',
                      fontFamily: 'inherit',
                      textTransform: 'capitalize',
                    }}
                  >
