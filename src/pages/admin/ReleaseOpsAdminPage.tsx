  ...
  return (
    <div
      ...
      style={{
        ...
        background: isDragging || isHovered ? 'var(--ds-background-neutral-subtle-hovered)' : undefined,
    ...
    <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 8, padding: 16, marginBottom: 16 }}>
      ...
      {menuState && menuOption && createPortal(
        <div
          ...
          style={{ position: 'fixed', top: menuState.top, right: menuState.right, background: 'var(--ds-surface-overlay)', border: '1px solid var(--ds-border)', borderRadius: 4, boxShadow: '0 8px 28px var(--ds-shadow-raised)', zIndex: 9999, minWidth: 160, padding: '4px 0' }}
        >
          <button
            role="menuitem"
