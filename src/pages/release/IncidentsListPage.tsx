              ...
              {paginatedIncidents.length === 0 ? (
                ...
                >
                  <td className="px-3 py-2">
                    <span className="font-mono text-xs font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:text-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))]">
