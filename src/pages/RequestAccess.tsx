...
export default function RequestAccess() {
  ...
  if (submissionSuccess) {
    return (
      <div className={cn("min-h-screen bg-[#F6F7F9] flex items-center justify-center p-4", isRTL && "rtl")} dir={isRTL ? 'rtl' : 'ltr'}>
        <div className="max-w-lg w-full bg-white dark:bg-[#232019] rounded-2xl shadow-xl p-8 text-center">
  ...
  return (
    <div className={cn("min-h-screen bg-[#F6F7F9]", isRTL && "rtl")} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      {/* Page Title Section */}
      <div className="bg-white dark:bg-[#232019] border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] shadow-sm">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-6">
        <div className="flex gap-6">
          {/* Left: Form Content */}
          <main className="flex-1 bg-white dark:bg-[#232019] border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] rounded-2xl shadow-[0_6px_16px_rgba(15,23,42,0.06)]">
                  ...
                  {stagedAttachments.length > 0 && (
                    <div className="space-y-2 mt-3">
                      {stagedAttachments.map((attachment) => (
                        <div key={attachment.id} className="flex items-center justify-between gap-3 px-3 py-2.5 border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] rounded-xl bg-white dark:bg-[#232019] text-[13px]">
              ...
              {currentStep === 3 && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between gap-3 px-3 py-2.5 border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] rounded-xl bg-white dark:bg-[#232019] text-[13px]">
            ...
            {/* Actions */}
            <div className="flex justify-between gap-3 p-3.5 border-t border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[#232019] rounded-b-2xl sticky bottom-0">
              <Button
                type="button"
                variant="ghost"
                onClick={handleBack}
          ...
          <aside className="hidden lg:block w-[260px] shrink-0">
            <div className="bg-white dark:bg-[#232019] border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.08)] rounded-2xl shadow-[0_6px_16px_rgba(15,23,42,0.06)] p-5 sticky top-6">
