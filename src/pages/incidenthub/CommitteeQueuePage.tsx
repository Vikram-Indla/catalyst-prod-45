      ...
      <div className="px-6 pt-6 pb-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 18, fontWeight: 700, color: isDark ? '#EDEDED' : '#0F172A' }}>Committee Queue</h1>
          </div>
        ...
        <div style={{ border: isDark ? '1px solid #2E2E2E' : '1px solid rgba(15,23,42,0.12)', borderRadius: 6, overflow: 'hidden' }}>
          ...
          {(!queue || queue.length === 0) && (
            <div className="flex items-center justify-center py-12">
              <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, color: isDark ? '#878787' : '#94A3B8' }}>No committee members assigned.</p>
            </div>
          )}
          ...
          {queue?.map((item: any) => {
            ...
            return (
              ...
              >
                <div className="px-3">
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, color: '#2563EB', backgroundColor: isDark ? 'rgba(37,99,235,0.12)' : '#EFF6FF', padding: '0 4px', borderRadius: 3 }}>
                    {item.incident_key}
                  </span>
                </div>
                <div className="px-3 truncate" style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650, color: isDark ? '#EDEDED' : '#0F172A' }}>
                  {item.title}
                </div>
                ...
                <div className="px-3" style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, color: isDark ? '#878787' : '#64748B' }}>
                ...
                <div className="px-3 flex items-center gap-2">
                  ...
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 10, color: isDark ? '#878787' : '#64748B', whiteSpace: 'nowrap' }}>
                    {approved}/{total}
                  </span>
                </div>
                <div className="px-3">
