  ...
  return (
    <div className="flex-1 overflow-auto" style={{ backgroundColor: pageBg }}>
      ...
      <div className="px-6 pt-2 pb-4">
        {/* Featured AI Card */}
        <div className="p-4 mb-6" style={{ border: `1px solid ${isDark ? 'var(--ds-background-discovery-bold)' : 'var(--ds-background-discovery)'}`, borderRadius: 6, backgroundColor: surfaceBg }}>
