      ...
      <div className="px-6 pt-6 pb-4">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex items-center gap-2">
            <h1 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 18, fontWeight: 700, color: textPrimary }}>Insights</h1>
          ...
          <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, color: textSecondary, marginLeft: 'auto' }}>Pattern analysis and recommendations</p>
        </div>
        ...
        <div className="p-4 mb-6" style={{ border: `1px solid ${isDark ? 'rgba(124,58,237,0.25)' : '#E9D5FF'}`, borderRadius: 6, backgroundColor: surfaceBg }}>
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 14, fontWeight: 650, color: textPrimary, marginBottom: 4 }}>
                Pattern Analysis
              </h3>
              <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 13, color: textBody, lineHeight: 1.6 }}>
                {sev1Count > 0
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-4" style={{ border: `1px solid ${borderColor}`, borderRadius: 6 }}>
            <h3 className="flex items-center gap-2 mb-3" style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 13, fontWeight: 700, color: textPrimary }}>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="p-2.5" style={{
                  ...
                  <h4 style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650, color: isDark ? '#FCA5A5' : '#991B1B', marginBottom: 2 }}>{item.title}</h4>
                  <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: isDark ? '#F87171' : '#B91C1C' }}>{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="p-2.5" style={{
                  ...
                  <h4 style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650, color: isDark ? '#86EFAC' : '#166534', marginBottom: 2 }}>{item.title}</h4>
                  <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: isDark ? '#4ADE80' : '#15803D' }}>{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
