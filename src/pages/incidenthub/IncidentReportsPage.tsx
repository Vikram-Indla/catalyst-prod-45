    ...
    <div className="flex-1 overflow-auto" style={{ backgroundColor: 'var(--bg-app, #FFFFFF)' }}>
      <div className="px-6 pt-6 pb-4">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 18, fontWeight: 700, color: 'var(--fg-1, #0F172A)' }}>Incident Reports</h1>
        </div>
        ...
        {activeTab === 0 && (
          <div>
            <div className="grid grid-cols-3 gap-3 mb-6">
              <div className="p-3" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6 }}>
                <div style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: '#64748B', marginBottom: 4 }}>Total Breaches</div>
                <div style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 22, fontWeight: 700, color: '#DC2626' }}>{breachedCount}</div>
              </div>
              <div className="p-3" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6 }}>
                <div style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: '#64748B', marginBottom: 4 }}>Breach Rate</div>
                <div style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 22, fontWeight: 700, color: '#D97706' }}>
                  {incidents?.length ? `${Math.round((breachedCount / incidents.length) * 100)}%` : '0%'}
                </div>
              </div>
              <div className="p-3" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6 }}>
                <div style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: '#64748B', marginBottom: 4 }}>Avg Age (days)</div>
                <div style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 22, fontWeight: 700, color: 'var(--fg-1, #0F172A)' }}>{avgAge}</div>
              </div>
            </div>
            <div className="p-8 flex items-center justify-center" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6, backgroundColor: isDark ? '#1A1A1A' : '#F1F5F9' }}>
              <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, color: '#64748B' }}>[Chart] SLA Breach trend over time</p>
            </div>
          </div>
        )}
        ...
        {activeTab === 1 && (
          <div className="p-8 flex items-center justify-center" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6, backgroundColor: isDark ? '#1A1A1A' : '#F1F5F9' }}>
            <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, color: '#64748B' }}>[Chart] Incident aging distribution by severity</p>
          </div>
        )}
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              {[
                ...
                <div key={s.label} className="flex items-center gap-2 p-3 flex-1" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6 }}>
                  <div style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: s.color }} />
                  <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 11, color: '#64748B' }}>{s.label}</span>
                  <span className="ml-auto" style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 16, fontWeight: 700, color: s.color }}>{s.count}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {activeTab === 3 && (
          <div className="p-8 flex items-center justify-center" style={{ border: `1px solid ${isDark ? '#2E2E2E' : 'rgba(15,23,42,0.12)'}`, borderRadius: 6, backgroundColor: isDark ? '#1A1A1A' : '#F1F5F9' }}>
            <p style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, color: '#64748B' }}>[Chart] Severity vs Priority heatmap</p>
          </div>
        )}
      </div>
    </div>
