      ...
      <div className="px-6 pt-6 pb-4">
        ...
        {activeTab === 0 && (
          <div>
            ...
            <div className="p-8 flex items-center justify-center" style={{ border: `1px solid ${'var(--cp-border-default, rgba(15,23,42,0.12))'}`, borderRadius: 6, backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#F1F5F9' }}>
