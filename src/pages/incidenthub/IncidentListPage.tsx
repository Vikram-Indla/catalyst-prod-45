    ...
    <div className="flex-1 overflow-auto" style={{ backgroundColor: pageBg }}>
      ...
      <div className="px-6 pt-6 pb-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center rounded-md" style={{ width: 32, height: 32, backgroundColor: 'var(--cp-danger-light, #FEE2E2)' }}>
              <AlertTriangle size={18} style={{ color: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))' }} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="gap-1.5" style={{ backgroundColor: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', borderRadius: 6 }} onClick={() => setShowCreateModal(true)}>
        ...
        <div className="grid grid-cols-5 gap-3 mb-4">
          {[
            { label: 'Critical (SEV-1)', value: stats.sev1, accent: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))' },
            { label: 'High (SEV-2)', value: stats.sev2, accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
            ...
            { label: 'Resolved (7d)', value: stats.resolvedWeek, accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
          ].map(s => (
        ...
        <JiraTable<IncidentRow>
          ...
          emptyView={
            <div className="flex flex-col items-center justify-center py-12">
              ...
              {!search && (
                <Button size="sm" className="mt-3" style={{ backgroundColor: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', borderRadius: 6 }} onClick={() => setShowCreateModal(true)}>
