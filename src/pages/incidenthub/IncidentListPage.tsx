      ...
      <div className="px-6 pb-6">
        <div style={{ border: `1px solid ${borderColor}`, borderRadius: 6, overflow: 'hidden' }}>
          ...
          {paginated.map(item => (
            ...
            >
              ...
              {/* Title */}
              <div className="px-2 truncate" style={{ fontFamily: 'var(--cp-font-body)', fontSize: 13, fontWeight: 650, color: textPrimary }}>
                {item.title || '\u2014'}
              </div>
              ...
              {/* Project */}
              <div className="px-2 truncate" style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: textSecondary }}>
                {item.project_name || '\u2014'}
              </div>
              ...
              <div className="px-2 flex items-center gap-1.5 min-w-0">
                {item.assignee_name ? (
                  <>
                    ...
                    <span className="truncate" style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: textBody }}>
                      {item.assignee_name}
                    </span>
                  </>
                ) : (
                  <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: textMuted }}>Unassigned</span>
                )}
              </div>
              ...
              <div className="px-2 flex items-center gap-1.5 min-w-0">
                {item.reporter_name ? (
                  ...
                  <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: textMuted }}>&mdash;</span>
                )}
              </div>
              {/* Updated */}
              <div className="px-2" style={{ fontFamily: 'var(--cp-font-mono)', fontSize: 11, color: textSecondary }}>
                {formatDate(item.updated_at)}
              </div>
              {/* Parent */}
              <div className="px-2 truncate" style={{ fontFamily: 'var(--cp-font-body)', fontSize: 11 }}>
        ...
        {filtered.length > 0 && (
          <div className="flex items-center justify-between mt-3">
            <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: textSecondary }}>
