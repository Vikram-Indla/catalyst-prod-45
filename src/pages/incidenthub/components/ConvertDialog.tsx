          ...
          <div className="grid grid-cols-3 gap-3">
            {TYPES.map(t => (
              ...
              >
                ...
                <div style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-300)', fontWeight: 650, color: 'var(--fg-1, var(--cp-ink-1, var(--cp-ink-1, #0F172A)))', marginBottom: 2 }}>{t.label}</div>
                <div style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-100)', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))' }}>{t.desc}</div>
              </button>
            ))}
          </div>
        </div>
