...
const SEV_STYLES: Record<string, { bg: string; text: string; border: string; darkBg: string; darkText: string; darkBorder: string }> = {
  ...
  SEV4: { bg: 'var(--ds-surface-sunken, #F1F5F9)', text: 'var(--ds-text-subtle, #475569)', border: 'var(--ds-border, #E2E8F0)', darkBg: 'var(--ds-border, #292929)', darkText: 'var(--ds-text-subtlest, #A1A1A1)', darkBorder: 'var(--ds-border, #2E2E2E)' },
};
