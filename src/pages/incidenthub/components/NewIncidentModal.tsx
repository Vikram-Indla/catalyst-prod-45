    ...
    <Dialog open={open} onOpenChange={v => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-[760px]" style={{ borderRadius: 8, padding: 0 }}>
        <DialogHeader className="px-6 pt-5 pb-3" style={{ borderBottom: '0.75px solid rgba(15,23,42,0.06)' }}>
          <DialogTitle className="flex items-center gap-2" style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 16, fontWeight: 700 }}>
        ...
        <div className="px-6 py-4 space-y-4">
          <div>
            <Label style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650 }}>Title *</Label>
            <Input
              value={title}
              onChange={e => setTitle(e.target.value)}
              placeholder="Brief description of the incident"
              style={{ borderRadius: 4, fontFamily: 'var(--ds-font-family-body)', fontSize: 13, marginTop: 4 }}
            />
          </div>

          <div>
            <Label style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650, marginBottom: 8 }}>Severity *</Label>
          ...
          <div>
            <Label style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 650 }}>Description</Label>
            <Textarea
              value={description}
              onChange={e => setDescription(e.target.value)}
              placeholder="Detailed description of the incident..."
              style={{ borderRadius: 4, fontFamily: 'var(--ds-font-family-body)', fontSize: 13, marginTop: 4, minHeight: 80 }}
            />
          </div>
        </div>
