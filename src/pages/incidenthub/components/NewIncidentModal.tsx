...
const SEV_STYLES: Record<string, { bg: string; border: string; text: string; darkBg: string; darkBorder: string; darkText: string }> = {
  ...
  SEV4: { bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', border: 'var(--ds-border, var(--cp-border, #E2E8F0))', text: 'var(--ds-text-subtle, #475569)', darkBg: 'var(--ds-border, #2E2E2E)', darkBorder: 'var(--ds-border-bold, #454545)', darkText: 'var(--ds-text-subtlest, #A1A1A1)' },
};
