              ...
              {members.map((m: any) => {
                ...
                return (
                  <div key={m.id} className="flex items-center gap-3 p-2" style={{ border: `1px solid ${'var(--cp-border-subtle, rgba(15,23,42,0.08))'}`, borderRadius: 4 }}>
                    <div className="rounded-full flex items-center justify-center shrink-0" style={{ width: 32, height: 32, backgroundColor: 'var(--cp-bg-sunken, var(--cp-border, #E2E8F0))', fontSize: 12, fontWeight: 650, color: 'var(--cp-text-secondary, #475569)' }}>
