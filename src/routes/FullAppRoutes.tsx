...
// 2026-06-01: /backlog → ProductNativeBacklogPage (business_requests data model)
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/producthub/backlog" element={<Navigate to="/product-hub/products" replace />} />
