...
const mockWorkflow: Workflow = {
  ...
  isDefault: true,
  statuses: [
    { id: 'backlog', name: 'Backlog', category: 'todo', color: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))' },
    { id: 'todo', name: 'To Do', category: 'todo', color: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))' },
  ...
  const getStatusById = useCallback(
    (statusId: string) => {
      ...
      return {
        ...
        color: status.color || 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))',
      };
    },
    [workflow]
  );
