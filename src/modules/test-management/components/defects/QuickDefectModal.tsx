...
const SEVERITY_OPTIONS: Array<{
...
}> = [
  {
    ...
    label: 'Critical',
    icon: AlertTriangle,
    color: 'bg-[hsl(var(--danger))] hover:bg-[hsl(var(--danger))]/90 text-white',
  ...
  },
  {
    ...
    label: 'Major',
    icon: AlertCircle,
    color: 'bg-[hsl(var(--warning))] hover:bg-[hsl(var(--warning))]/90 text-white',
  ...
  },
  {
    ...
    label: 'Minor',
    icon: Info,
    color: 'bg-[hsl(var(--info))] hover:bg-[hsl(var(--info))]/90 text-white',
