  ...
  const getSeverityClasses = () => {
    switch (severity) {
      case 'SEV1':
        ...
        return "bg-[rgba(239,68,68,0.08)] text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] dark:bg-[#7f1d1d] dark:text-[var(--ds-border-danger,var(--ds-border-danger, #fca5a5))] dark:border dark:border-[var(--ds-text-danger,var(--ds-text-danger, #991b1b))]";
      case 'SEV2':
        // Amber variant for dark mode
        return "bg-[rgba(245,158,11,0.08)] text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))] dark:bg-[#78350f] dark:text-[#fcd34d] dark:border dark:border-[#92400e]";
      case 'SEV3':
      case 'SEV4':
      default:
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isBreached && "border-l-[3px] border-l-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))]",
        isAtRisk && !isBreached && "border-l-[3px] border-l-[var(--ds-text-warning,var(--ds-text-warning, #f59e0b))]"
      )}
    >
      {/* Row 1: ID + Badges */}
      <div className="flex items-start justify-between mb-1.5">
        <button
          ...
          className="font-mono text-sm font-semibold hover:underline text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]"
        >
        ...
        <div className="flex items-center gap-1.5">
          {incident.is_major_incident && (
            <span className={cn(
              ...
              "bg-[rgba(245,158,11,0.08)] text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]",
      ...
      {/* Row 2: Title */}
      <h4 className="text-sm font-medium leading-snug mb-2.5 text-[var(--ds-surface,var(--ds-surface, #0a0a0a))] dark:text-[#fafafa]">
        {incident.title}
      </h4>
      ...
      <div className="flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
          ...
          {isBreached && (
            <span className="text-xs font-semibold text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] dark:text-[#f87171]">Breached</span>
          )}
          {isAtRisk && (
            <span className="text-xs font-semibold text-[var(--ds-text-warning,var(--ds-text-warning, #f59e0b))] dark:text-[#fbbf24]">At Risk</span>
          )}
        </div>
      ...
      {isInCommittee && (
        <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground mt-2 pt-2 border-t border-border">
          {/* Approvers count */}
          <span className="flex items-center gap-0.5 text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]">
            ...
            <>
              ...
              <Tooltip position="top" content="Edit Committee">
                <button
                  ...
                  className="p-0.5 rounded hover:bg-muted text-muted-foreground hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:hover:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] transition-colors"
                >
