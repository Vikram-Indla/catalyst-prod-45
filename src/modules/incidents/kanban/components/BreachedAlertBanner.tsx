  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <AlertTriangle className="h-5 w-5 text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] dark:text-[#f87171]" />
        <div className="flex items-center gap-2">
          <span className="text-[15px] font-bold text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] dark:text-[#f87171]">
      ...
      <Button 
        ...
        className={cn(
          ...
          "border-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))]",
          "dark:border-[#f87171] dark:text-[#f87171]",
          "hover:bg-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] hover:text-white dark:hover:bg-[#f87171]"
        )}
