              ...
              <DropdownMenuItem key={sev} onClick={() => onSeverityChange(sev)}>
                <div className="flex items-center justify-between w-full">
                  <span className={cn(
                    ...
                    sev === 'SEV1' && 'text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] dark:text-[#f87171]',
                    sev === 'SEV2' && 'text-[var(--ds-text-warning,var(--ds-text-warning, #f59e0b))] dark:text-[#fbbf24]'
                  )}>
                    {sev}
                  </span>
                  <span className="ml-2">
          ...
          <DropdownMenuContent align="start" className="bg-popover">
            ...
            <DropdownMenuItem onClick={() => onStatusChange('breached')}>
              <div className="flex items-center gap-2 w-full">
                <div className="h-2 w-2 rounded-full bg-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))]" />
                <span>Breached</span>
            ...
            <DropdownMenuItem onClick={() => onStatusChange('at_risk')}>
              <div className="flex items-center gap-2 w-full">
                <div className="h-2 w-2 rounded-full bg-[var(--ds-text-warning,var(--ds-text-warning, #f59e0b))]" />
                <span>At Risk</span>
                <span className="ml-auto">
