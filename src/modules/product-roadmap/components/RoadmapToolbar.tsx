    ...
    >
          ...
          {([['gantt', 'Gantt'], ['swimlane', 'Swimlane']] as const).map(([k, l]) => (
            <button
              ...
              style={{
                ...
                color: viewMode === k ? 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' : (isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : (hc ? '#3F3F46' : '#71717A')),
                background: viewMode === k ? ('var(--cp-primary-light, #EFF6FF)') : (isDark ? 'var(--cp-bg-surface, #242528)' : (hc ? '#F0F0F0' : 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))')),
      ...
      <div className="flex items-center gap-2 flex-wrap justify-end">
        ...
        <Tooltip content={hc ? 'Disable high contrast' : 'Enable high contrast (WCAG AAA)'}>
          <Button
            ...
            style={{
              ...
              background: hc ? '#09090B' : 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))',
              color: hc ? 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))' : '#3F3F46',
              fontWeight: 600,
              fontSize: 11,
            }}
          >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 h-9 px-4 font-medium text-sm rounded-lg transition-colors shadow-sm bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))] text-white"
          data-create-button
        >
