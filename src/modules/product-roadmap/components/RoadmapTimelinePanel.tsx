        ...
        return (
          <div
            ...
            style={{
              ...
              borderRight: `1px solid ${isQuarterBoundary ? 'var(--bd-default, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))' : 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))'}`,
              ...
              {groups.map(group => (
                <div key={group.key}>
                  <div style={{ height: 50, background: 'var(--ds-surface-sunken, #FAFBFC)', borderBottom: '1px solid var(--bd-default, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))' }}>
                    <span style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', paddingLeft: 16, lineHeight: '36px' }}>
                      {group.label}
                    </span>
                  </div>
