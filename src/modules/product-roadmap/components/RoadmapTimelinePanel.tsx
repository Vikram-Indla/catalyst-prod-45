      ...
      >
        {position ? (
          ...
          <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
            ...
            <span style={{ fontSize: 12, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))' }}>Outside timeline range</span>
          </div>
        )}
      </div>
    );
        ...
        return (
          <div
            ...
            style={{
              ...
              borderRight: `1px solid ${isQuarterBoundary ? 'var(--bd-default, #E2E8F0)' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))'}`,
        ...
        <ScrollArea className="flex-1 w-full">
          <div style={{ minWidth: totalMinWidth }}>
            ...
            <div className="relative">
              ...
              {groups.map(group => (
                <div key={group.key}>
                  <div style={{ height: 50, background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #FAFBFC))', borderBottom: '1px solid var(--bd-default, #E2E8F0)' }}>
                    <span style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', paddingLeft: 16, lineHeight: '36px' }}>
                      {group.label}
                    </span>
                  </div>
