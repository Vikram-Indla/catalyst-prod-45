...
const BAR_STATUS_COLORS: Record<string, { border: string; bg: string }> = {
  new_request: { border: 'var(--ds-text-brand, var(--ds-text-brand, #3B82F6))', bg: 'rgba(59,130,246,0.12)' },
  draft:       { border: '#737373', bg: 'rgba(115,115,115,0.12)' },
  submitted:   { border: 'var(--ds-text-brand, var(--ds-text-brand, #3B82F6))', bg: 'rgba(59,130,246,0.12)' },
  in_review:   { border: '#8B5CF6', bg: 'rgba(139,92,246,0.12)' },
  approved:    { border: '#06B6D4', bg: 'rgba(6,182,212,0.12)' },
  in_progress: { border: 'var(--ds-text-warning, var(--ds-text-warning, #F59E0B))', bg: 'rgba(245,158,11,0.12)' },
  completed:   { border: '#10B981', bg: 'rgba(16,185,129,0.12)' },
  rejected:    { border: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))', bg: 'rgba(239,68,68,0.12)' },
  cancelled:   { border: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))', bg: 'rgba(239,68,68,0.12)' },
};
              ...
              {TABS.map(tab => (
                <button
                  ...
                  style={{
                    ...
                    color: activeTab === tab.key ? 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' : '#71717a',
                    backgroundColor: 'transparent',
                    border: 'none',
