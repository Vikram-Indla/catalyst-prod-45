    ...
    <div style={{ maxWidth: 900, fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
          ...
          <span style={{
            fontSize: 10, background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', padding: '2px 8px',
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 10, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))' }}>
                  {statuses.length} Jira statuses
                </span>
                <button
                  onClick={() => { setAddingTo(addingTo === category ? null : category); setNewStatus('') }}
                  style={{
                    marginLeft: 'auto', fontSize: 11, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', background: 'none',
                ...
                {statuses.map(status => (
                  <div
                    ...
                    style={{
                      ...
                      color: 'var(--ds-text-subtle, var(--ds-text-subtle, #334155))', fontWeight: 500, cursor: 'grab',
                    }}
                  >
                    <span style={{
                    ...
                    <button
                      ...
                      style={{
                        fontSize: 10, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))', background: 'none',
              ...
              {addingTo === category && (
                <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                  ...
                  <button onClick={() => { setAddingTo(null); setNewStatus('') }} style={{
                    ...
                    background: 'var(--bg-1, #F8FAFC)', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', border: '1px solid var(--bd-default, #E2E8F0)', cursor: 'pointer',
                  }}>Cancel</button>
                </div>
              )}
            </div>
        ...
        <div style={{ borderTop: '1px solid var(--bd-default, #E2E8F0)', paddingTop: 16, marginTop: 8, display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))' }}>
