    ...
    <div style={{ maxWidth: 900, fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={{
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 10, color: 'var(--ds-text-subtlest, #94A3B8)' }}>
                ...
                {statuses.map(status => (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        fontSize: 10, color: 'var(--ds-text-subtlest, #94A3B8)', background: 'none',
        ...
        <div style={{ borderTop: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', paddingTop: 16, marginTop: 8, display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--ds-text-subtlest, #94A3B8)' }}>
