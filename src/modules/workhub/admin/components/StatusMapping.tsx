  ...
  return (
    <div style={{ maxWidth: 900, fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={{
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 10, color: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))' }}>
                ...
                {statuses.map(status => (
                  <div
                    ...
                    style={{
                      ...
                      background: 'var(--bg-1, #F8FAFC)', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))',
                      fontSize: 12, fontFamily: 'var(--cp-font-mono)',
                      color: 'var(--ds-text-subtle, #334155)', fontWeight: 500, cursor: 'grab',
                    }}
                  >
                    <span style={{
                    ...
                    <button
                      ...
                      style={{
                        fontSize: 10, color: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', background: 'none',
              ...
              {addingTo === category && (
                <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                  <input
                    ...
                    autoFocus
                    style={{
                      padding: '5px 10px', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', borderRadius: 4,
        ...
        <div style={{ borderTop: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', paddingTop: 16, marginTop: 8, display: 'flex', gap: 8, alignItems: 'center' }}>
          <button
            onClick={handleSave}
          ...
          <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))' }}>
