    ...
    <div style={{ maxWidth: 900, fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
          ...
          <span style={{
            fontSize: 10, background: 'var(--surface-muted, #F1F5F9)', color: 'var(--fg-3, #64748B)', padding: '2px 8px',
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <span style={{ fontSize: 10, color: 'var(--fg-4, #94A3B8)' }}>
                ...
                {statuses.map(status => (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{
                        fontSize: 10, color: 'var(--fg-4, #94A3B8)', background: 'none',
              ...
              {addingTo === category && (
                <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                  <input
                    ...
                    autoFocus
                    style={{
                      padding: '5px 10px', border: '1px solid var(--divider, #E2E8F0)', borderRadius: 4,
                  ...
                  <button onClick={() => { setAddingTo(null); setNewStatus('') }} style={{
                    ...
                    background: 'var(--surface-subtle, #F8FAFC)', color: 'var(--fg-3, #64748B)', border: '1px solid var(--divider, #E2E8F0)', cursor: 'pointer',
                  }}>Cancel</button>
                </div>
              )}
            </div>
        ...
        <div style={{ borderTop: '1px solid var(--divider, #E2E8F0)', paddingTop: 16, marginTop: 8, display: 'flex', gap: 8, alignItems: 'center' }}>
          <button
            onClick={handleSave}
          ...
          <span style={{ marginLeft: 'auto', fontSize: 11, color: 'var(--fg-4, #94A3B8)' }}>
