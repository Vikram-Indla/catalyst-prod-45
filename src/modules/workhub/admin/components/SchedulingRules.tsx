...
export function SchedulingRules() {
  ...
  return (
    <div style={{ maxWidth: 900, fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={cardStyle}>
        ...
        {priorities.map((p, i) => (
          <div key={i} style={{
            ...
            <div>
              <span style={{ fontSize: 13, fontWeight: 600, color: 'var(--fg-1, var(--cp-ink-1, #0F172A))' }}>{p.label}</span>
      ...
      <div style={cardStyle}>
        <h2 style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 14, fontWeight: 600, color: 'var(--fg-1, var(--cp-ink-1, #0F172A))', margin: '0 0 14px' }}>
          Multi-FixVersion Strategy
        </h2>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <label style={{ fontSize: 13, color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', width: 260 }}>
