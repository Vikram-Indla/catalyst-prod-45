          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 8, fontSize: 11, color: '#92400E', lineHeight: 2 }}>
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: '#F1F5F9', padding: '1px 5px', borderRadius: 2 }}>2026 02</code>
                {' → 2026-02-28  '}
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: '#F1F5F9', padding: '1px 5px', borderRadius: 2 }}>2026 Q1</code>
                {' → 2026-03-31  '}
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: '#F1F5F9', padding: '1px 5px', borderRadius: 2 }}>Release 3.0</code>
                {' → '}
