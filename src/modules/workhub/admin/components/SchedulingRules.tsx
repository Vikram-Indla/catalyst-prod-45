    ...
    <div style={{ maxWidth: 900, fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={cardStyle}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <span style={{
            fontSize: 'var(--ds-font-size-100)', background: 'var(--ds-background-success)', color: 'var(--ds-background-success-bold)', padding: '2px 8px',
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <select
            ...
            style={{
              width: 200, padding: '7px 10px', borderRadius: 6, border: '1px solid var(--bd-default, var(--cp-border, var(--cp-bg-sunken)))',
      ...
      <div style={cardStyle}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <span style={{
            fontSize: 'var(--ds-font-size-100)', background: 'var(--ds-background-warning)', color: 'var(--ds-text-warning, var(--cp-amber))', padding: '2px 8px',
            borderRadius: 4, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '.3px',
          }}>Fallback</span>
        </div>
          ...
          <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <div style={{ marginTop: 8, fontSize: 'var(--ds-font-size-100)', color: 'var(--ds-text-warning)', lineHeight: 2 }}>
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken)))', padding: '1px 5px', borderRadius: 2 }}>2026 02</code>
                {' → 2026-02-28  '}
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken)))', padding: '1px 5px', borderRadius: 2 }}>2026 Q1</code>
                {' → 2026-03-31  '}
                <code style={{ fontFamily: 'var(--cp-font-mono)', background: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken)))', padding: '1px 5px', borderRadius: 2 }}>Release 3.0</code>
                {' → '}
