      ...
      <div style={{ background: 'var(--bg-1, #F8FAFC)', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', borderRadius: '8px', padding: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <select value={intervalMin} onChange={(e) => setIntervalMin(Number(e.target.value))} style={{ height: '50px', padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', fontSize: '12px', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', fontFamily: 'var(--cp-font-body)', background: 'var(--bg-app, #fff)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <select value={fullSyncTime} onChange={(e) => setFullSyncTime(e.target.value)} style={{ height: '50px', padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', fontSize: '12px', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', fontFamily: 'var(--cp-font-body)', background: 'var(--bg-app, #fff)' }}>
          ...
          <div style={{ marginTop: '8px' }}>
            <button onClick={handleSaveSchedule} disabled={updateSchedule.isPending} style={{ padding: '7px 16px', borderRadius: '6px', border: '1px solid var(--bd-default, var(--cp-border, #E2E8F0))', background: 'var(--bg-app, #fff)', color: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', fontSize: '12px', fontWeight: 600, cursor: 'pointer', fontFamily: 'var(--cp-font-body)' }}>
