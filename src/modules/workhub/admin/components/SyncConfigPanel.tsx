          ...
          {selectedProjects.length > 0 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <label style={{
                ...
                letterSpacing: '.4px', fontFamily: 'var(--ds-font-family-body)', display: 'flex', alignItems: 'center', gap: 6,
              }}>
                <Settings2 size={12} />
                      ...
                      <div style={{
                        ...
                        <div>
                          <label style={{
                            ...
                            fontFamily: 'var(--ds-font-family-body)', display: 'block', marginBottom: 6,
                          }}>
                            Timeline Lookback
                          </label>
