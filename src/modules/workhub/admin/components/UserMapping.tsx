        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 13, fontWeight: 700, color: '#92400E' }}>
            ...
            <thead>
              <tr style={{ background: 'var(--bg-1, #F8FAFC)', position: 'sticky', top: 0, zIndex: 2 }}>
                {['#', 'CATALYST RESOURCE', 'DEPT', 'JIRA ACCOUNT (MAPPED)', 'SUGGESTED MATCH', 'ACTION'].map(h => (
                  <th key={h} style={{
                    fontFamily: 'var(--ds-font-family-heading)', fontSize: 9, textTransform: 'uppercase',
                      ...
                      {isMapped && existingJiraMapping ? (
                        <div style={{
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: 9, color: '#64748B', fontFamily: 'var(--ds-font-family-monospaced)' }}>
