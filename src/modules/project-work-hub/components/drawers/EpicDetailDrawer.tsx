        ...
        <div style={{ position: 'sticky', top: 0, zIndex: 10, background: 'var(--bg-app, #FFFFFF)', borderBottom: '0.75px solid rgba(15,23,42,0.06)', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 10 }}>
          {epic ? (
            <>
              ...
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 14, fontWeight: 600, color: 'var(--fg-1, #0F172A)' }}>{epic.issue_key}</span>
            ...
            <div style={{ padding: '16px 20px 0' }}>
              ...
              {editingTitle ? (
                <input value={titleValue} onChange={e => setTitleValue(e.target.value)}
                  ...
                  autoFocus style={{ width: '100%', fontSize: 20, fontWeight: 650, color: 'var(--fg-1, #0F172A)', border: '1.5px solid #2563EB', borderRadius: 4, padding: '4px 8px', outline: 'none', fontFamily: 'var(--ds-font-family-heading)', marginBottom: 8 }}
                />
              ) : (
                <h2 onClick={() => setEditingTitle(true)} style={{ fontSize: 20, fontWeight: 650, color: 'var(--fg-1, #0F172A)', margin: '0 0 8px', cursor: 'text', fontFamily: 'var(--ds-font-family-heading)', lineHeight: 1.3 }}>
                ...
                <>
                  ...
                  <div style={{ marginBottom: 16 }}>
                    ...
                    {editingDesc ? (
                      <textarea value={descValue} onChange={e => setDescValue(e.target.value)}
                        ...
                        autoFocus rows={4}
                        style={{ width: '100%', border: '1.5px solid #2563EB', borderRadius: 4, padding: 8, fontSize: 14, color: 'var(--fg-1, #0F172A)', fontFamily: 'var(--ds-font-family-body)', outline: 'none', resize: 'vertical', minHeight: 80 }}
                      />
                    ) : (
                  ...
                  <div style={{ border: '0.75px solid rgba(15,23,42,0.06)', borderRadius: 6, padding: '8px 16px' }}>
                    ...
                    <DetailRow label="Due Date">
                      <span style={{ ...DETAIL_VALUE, fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 13, color: epic.due_date ? 'var(--fg-1, #0F172A)' : '#94A3B8' }}>
                    ...
                    <DetailRow label="Created">
                      <span style={{ fontSize: 12, color: '#334155', fontFamily: 'var(--ds-font-family-monospaced)' }}>
                    ...
                    <div style={{ borderTop: '0.75px solid var(--bd-default, #E2E8F0)', paddingTop: 16, marginTop: 16 }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                          ...
                          <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, padding: '2px 8px', borderRadius: 4, background: '#F1F5F9', color: '#1E293B' }}>{jiraSyncData.jira_key}</span>
                        </div>
            ...
            return (
              <div key={entry.id} style={{ display: 'flex', gap: 10, padding: '8px 0', borderBottom: '0.75px solid rgba(15,23,42,0.04)' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  {entry.jira_created_at && <div style={{ fontSize: 11, color: '#94A3B8', marginTop: 2, fontFamily: 'var(--ds-font-family-monospaced)' }}>{format(new Date(entry.jira_created_at), 'MMM d, yyyy, hh:mm a')}</div>}
                </div>
              </div>
            );
          })}
