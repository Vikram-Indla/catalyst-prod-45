        ...
        <div id={panelId} className="sp-create-panel" role="listbox" onMouseDown={(e) => e.preventDefault()}>
          ...
          {(existing.length > 0 || searchLoading) && (
            <>
              ...
              <div className="sp-create-section-label">
                <Search size={11} color="#6B778C" />
                <span>Choose existing</span>
                {searchLoading && <Loader2 size={11} className="animate-spin" color="#6B778C" />}
              </div>
              {existing.map((r, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, color: '#1868DB', marginRight: 8 }}>
                      {r.issue_key}
                    </span>
