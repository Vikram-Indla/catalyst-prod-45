  ...
  const trigger = (
    ...
    >
      {displayName ? (
        ...
        <span className="sp-avatar-fallback" style={{ background: 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral)))', color: 'var(--ds-text-subtlest, var(--cp-text-secondary))' }}>
          <UserPlusIcon />
        </span>
      )}
