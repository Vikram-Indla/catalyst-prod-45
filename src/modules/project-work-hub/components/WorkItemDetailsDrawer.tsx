    ...
    <div className="fixed top-0 right-0 bottom-0 w-[480px] bg-background shadow-xl z-[1000] flex flex-col border-l border-border">
      ...
      <Tabs defaultValue="details" className="flex-1 flex flex-col">
        ...
        <TabsContent value="details" className="flex-1 overflow-y-auto p-4">
          ...
          {jiraData?.jira_key && (
            <div className="border-t border-[var(--bd-default, rgba(255,255,255,0.10))] dark:border-[#1A1A1A] pt-4 mt-4">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className="font-mono text-[12px] px-2 py-0.5 rounded bg-[#1A1A1A] text-[rgba(237,237,237,0.93)] dark:bg-[#1A1A1A] dark:text-[#E2D5C3]"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      ...
                      style={{
                        ...
                        backgroundColor:
                          jiraData.jira_sync_status === 'synced' || jiraData.jira_sync_status === 'pushed' ? 'rgba(74,222,128,0.10)' :
                          jiraData.jira_sync_status === 'queued' || jiraData.jira_sync_status === 'approval_pending' ? 'rgba(59,130,246,0.10)' :
                          '#DFE1E6',
                        color:
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[12px] text-[rgba(237,237,237,0.53)] dark:text-[#E2D5C3]">
