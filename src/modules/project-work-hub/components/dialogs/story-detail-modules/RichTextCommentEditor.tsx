      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 8 }}>
        <button
          ...
          style={{
            ...
            background: isEmpty || isSubmitting ? 'var(--ds-surface-sunken, #F4F5F7)' : 'var(--ds-background-brand-bold, var(--cp-primary-60, #0052CC))', color: isEmpty || isSubmitting ? 'var(--ds-text-disabled, #A5ADBA)' : 'var(--ds-surface, #FFF)',
