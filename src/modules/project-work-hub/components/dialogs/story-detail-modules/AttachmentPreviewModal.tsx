    ...
    >
      ...
      >
        {loading || !signedUrl ? (
          ...
          <div className="flex flex-col items-center gap-4 p-12 bg-[#1A1A1A] rounded-lg text-white">
            ...
            <a
              href={signedUrl}
              download={current.file_name}
              className="mt-2 flex items-center gap-2 px-4 h-9 rounded bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-sm font-medium transition-colors"
            >
