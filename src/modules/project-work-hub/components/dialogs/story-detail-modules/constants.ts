...
export const STATUS_STYLES: Record<string, { bg: string; text: string }> = {
  todo:        { bg: 'var(--ds-border, var(--ds-border, #DFE1E6))', text: 'var(--ds-text, var(--ds-text, #253858))' },
...
export const LOZENGE_STYLES: Record<'grey' | 'blue' | 'green', React.CSSProperties> = {
  grey:  { background: 'var(--ds-border, var(--ds-border, #DFE1E6))', color: 'var(--ds-text, var(--ds-text, #253858))' },
...
export const LOZENGE: Record<StatusCategory, React.CSSProperties> = {
  todo:        { background: 'var(--ds-border, var(--ds-border, #DFE1E6))', color: 'var(--ds-text, var(--ds-text, #253858))' },
...
export const PRIORITY_STYLES: Record<string, { color: string; symbol: string }> = {
  ...
  Medium: { color: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', symbol: '—' },
  Low: { color: '#36B37E', symbol: '▼' },
  Lowest: { color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', symbol: '▼▼' },
};
...
export const TEST_RESULT_STYLES: Record<TestResult, React.CSSProperties> = {
  ...
  skipped: { background: 'var(--ds-border, var(--ds-border, #DFE1E6))', color: 'var(--ds-text, var(--ds-text, #253858))' },
  not_run: { background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))' },
};
...
export const LINK_TYPE_STYLES: Record<string, React.CSSProperties> = {
  ...
  'is duplicated by': { background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))' },
  clones:           { background: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', color: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1D4ED8))' },
  'is cloned by':   { background: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', color: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1D4ED8))' },
};
