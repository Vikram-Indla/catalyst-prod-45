  ...
  return (
    <div ref={ref} style={{ position: 'relative', flexShrink: 0 }}>
      <button onClick={() => setOpen(o => !o)} style={{
        ...
        border: '1px solid #DFE1E6', borderRadius: 3, background: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))', cursor: 'pointer',
        fontSize: 13, color: 'var(--ds-text, var(--ds-text, #172B4D))', fontFamily: 'inherit',
      }}>
        <span style={{ display: 'flex', width: 16, height: 16 }}>{current.icon}</span>
        <span>{current.label}</span>
        <ChevronDown size={12} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))" />
      </button>
      {open && (
        <div style={{
          ...
          {TYPE_OPTIONS.map(opt => (
            <div key={opt.key} onClick={() => { onChange(opt.key); setOpen(false); }}
              style={{
                ...
                cursor: 'pointer', fontSize: 13, color: 'var(--ds-text, var(--ds-text, #172B4D))',
                background: opt.key === value ? '#DEEBFF' : 'transparent',
              }}
              onMouseEnter={e => { if (opt.key !== value) (e.currentTarget as HTMLElement).style.background = 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))'; }}
        ...
        <div style={{
          ...
          {STATUS_OPTION_GROUPS.map(group => (
            <div key={group.groupLabel}>
              <div style={{
                fontSize: 10, fontWeight: 700, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', textTransform: 'uppercase',
  ...
  return (
    <button
      ...
      style={{
        ...
        cursor: 'pointer', fontSize: 11, fontWeight: 700, color: isActive ? 'var(--ds-text, var(--ds-text, #172B4D))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, flex: 1, minWidth: 0, overflow: 'hidden' }}>
        ...
        <button
          ...
          style={{
            ...
            fontSize: 12, fontWeight: 500, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', padding: 0, flexShrink: 0,
            textDecoration: 'none',
          }}
        ...
        <span style={{
          fontSize: 13, color: isDone ? 'rgba(9,30,66,0.4)' : 'var(--ds-text, var(--ds-text, #172B4D))',
      ...
      {columns.assignee && (
        <div style={{ width: 80, display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 }}>
          <div style={{
            ...
            fontSize: 11, fontWeight: 700, color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))',
      ...
      <SectionBlock title="Sub-tasks" count={children.length} doneCount={doneCount} defaultExpanded={children.length > 0} headerRight={
        ...
        {creating && children.length > 0 && (
          <div style={{
            ...
            <Sparkles size={16} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))" />
            <span style={{ fontSize: 13, color: 'var(--ds-text, var(--ds-text, #172B4D))', flex: 1 }}>Create suggested work items</span>
            <button style={{
              height: 28, padding: '0 12px', border: '1px solid #DFE1E6', borderRadius: 3,
              background: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))', cursor: 'pointer', fontSize: 13, color: 'var(--ds-text, var(--ds-text, #172B4D))', fontFamily: 'inherit',
            }}>Suggest</button>
          </div>
        )}
        ...
        {children.length > 0 && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0 6px', marginBottom: 2 }}>
            <div style={{ flex: 1, height: 6, borderRadius: 3, background: 'var(--ds-border, var(--ds-border, #DFE1E6))', overflow: 'hidden' }}>
              <div style={{ width: `${donePercent}%`, height: '100%', borderRadius: 3, background: '#36B37E', transition: 'width 0.3s ease' }} />
            </div>
            <span style={{ fontSize: 12, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', flexShrink: 0, fontWeight: 500 }}>{donePercent}% Done</span>
          </div>
        )}
          ...
          <div style={{
            ...
            <input
              ...
              style={{
                ...
                fontSize: 14, color: 'var(--ds-text, var(--ds-text, #172B4D))', fontFamily: 'inherit',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '0 8px', borderLeft: '1px solid #DFE1E6' }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))', cursor: draftSummary.trim() ? 'pointer' : 'not-allowed',
                  color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', opacity: draftSummary.trim() ? 1 : 0.5,
                }}
              >
        ...
        {creating && (
          <div style={{ textAlign: 'right', padding: '6px 0 2px' }}>
            <button onClick={() => { setCreating(false); setDraftSummary(''); }}
              style={{ background: 'none', border: 'none', fontSize: 13, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', cursor: 'pointer', fontFamily: 'inherit' }}>
              Cancel
            </button>
          </div>
        )}
