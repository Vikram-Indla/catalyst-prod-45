    ...
    <ModalTransition>
      {open && (
        <Modal onClose={onClose} width="small">
          ...
          <ModalBody>
            <div style={{ fontSize: 'var(--ds-font-size-400)', color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse)))', lineHeight: 1.5 }}>
              <div style={{ marginBottom: 8, color: 'var(--ds-text-subtle)' }}>
