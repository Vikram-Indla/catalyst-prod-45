...
const WORK_ITEM_ICONS: Record<string, string> = {
  ...
  epic: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><rect fill="#6554C0" width="16" height="16" rx="2"/><path fill="#FFFFFF" d="M11 7H9V3.5C9 3.22 8.78 3 8.5 3H6L6 8.5V10.5L5 13H7V12.5C7 12.22 7.22 12 7.5 12H8L11 7Z"/></svg>`,
