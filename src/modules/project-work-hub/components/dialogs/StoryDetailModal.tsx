...
const WORK_ITEM_ICONS: Record<string, string> = {
  ...
  epic: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><rect fill="#6554C0" width="16" height="16" rx="2"/><path fill="#FFFFFF" d="M10.41 6.82H8.7V4.25C8.7 3.73 8.24 3.3 7.68 3.3H5.75L5.75 9.6H5.75V11.75C5.75 12.27 6.21 12.7 6.77 12.7L10.41 7.15C10.97 7.15 11.43 6.82 11.43 6.82H10.41Z"/></svg>`,
