              ...
              <div style={{ position: 'relative' }}>
                ...
                {showDotsMenu && (
                  <div style={{ position: 'absolute', right: 0, top: 32, background: '#FFF', border: '1px solid #E4E7EC', borderRadius: 8, boxShadow: '0 4px 12px rgba(0,0,0,0.1)', padding: '4px 0', zIndex: 50, minWidth: 180 }}>
                    ...
                    <button onClick={() => { setShowDotsMenu(false); setShowConfirmDelete(true); }} style={{ ...menuItemStyle, color: '#DC2626' }}>Delete ticket</button>
                  </div>
                )}
              </div>
                          ...
                          <div ref={aiDropRef} style={{ position: 'relative' }}>
                            <div
                              ...
                              style={{
                                ...
                                height: 32, padding: '0 10px', border: '1px solid rgba(9,30,66,0.14)',
                                borderRadius: 4, cursor: 'pointer', background: aiDropOpen ? '#F8FAFC' : '#fff',
                                transition: 'border-color 0.12s',
                              }}
                              onMouseEnter={e => (e.currentTarget.style.borderColor = '#2563EB')}
                              onMouseLeave={e => { if (!aiDropOpen) e.currentTarget.style.borderColor = 'rgba(9,30,66,0.14)'; }}
                            >
                              <span style={{ fontSize: 13, color: '#172B4D' }}>
                                {AI_IMPROVE_OPTIONS.find(o => o.value === aiImproveType)?.label ?? 'Select…'}
                              </span>
                            ...
                            {aiDropOpen && (
                              <div style={{
                                ...
                                background: '#fff', border: '1px solid rgba(9,30,66,0.24)', borderRadius: 6,
                                boxShadow: '0 6px 16px rgba(9,30,66,0.15)', zIndex: 60, overflow: 'hidden',
                              }}>
                                {AI_IMPROVE_OPTIONS.map(opt => (
                                  <div key={opt.value}
                                    ...
                                    style={{
                                      display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                                      gap: 6, padding: '8px 12px', cursor: 'pointer', fontSize: 13,
                                      color: '#172B4D',
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  {showStatusDropdown && (
                    <div style={{ position: 'absolute', left: 0, top: '100%', marginTop: 4, background: '#FFF', border: '1px solid #E4E7EC', borderRadius: 8, boxShadow: '0 4px 16px rgba(0,0,0,0.12)', padding: '4px 0', zIndex: 50, width: '100%', maxHeight: 300, overflowY: 'auto' }}>
                      ...
                      <button onClick={() => { setShowStatusDropdown(false); setShowWorkflow(true); }} style={{ ...menuItemStyle, color: '#2563EB', fontSize: 12 }}>View Workflow</button>
                    </div>
                  )}
                </div>
              </div>
