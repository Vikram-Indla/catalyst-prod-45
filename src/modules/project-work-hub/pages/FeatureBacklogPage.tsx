  ...
  return (
    <div className="h-full flex flex-col" style={{ background: tk.pageBg }}>
      <CatalystPageHeader title="Feature Backlog" actions={
        <Button onClick={() => setShowCreate(true)} size="sm" style={{ backgroundColor: 'var(--ds-text-brand, #2563EB)', color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))', borderRadius: 6 }}>
