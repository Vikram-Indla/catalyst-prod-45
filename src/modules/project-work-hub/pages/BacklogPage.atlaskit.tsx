...
export function BacklogPage({ projectId, projectKey, assigneeIds, displayName, baseUrl }: { projectId: string; projectKey: string; assigneeIds?: string[]; displayName?: string; baseUrl?: string }) {
  ...
  // Detail views now navigate to /project/:key/backlog/:issueKey for
  ...
  const rowActions = useMemo<RowAction<BacklogItem>[]>(() => ([
    ...
    { id: 'copy-link', label: 'Copy link', icon: <AkLinkIcon label="" size="small" />,
      onClick: (r) => {
        const url = `${window.location.origin}/project/${projectKey}/backlog?selectedIssue=${r.id}`;
  ...
  return (
    ...
    <AtlaskitPageShell
      ...
      cardBorder="1px solid var(--ds-border, #DFE1E6)"
    ...
    >
      ...
      <div style={{
        ...
        gap: 12,
        alignItems: 'center',
        borderBottom: `1px solid ${'var(--ds-border, var(--ds-border, #DFE1E6))'}`,
      }}>
                ...
                {[1, 2].map((s) => (
                  <React.Fragment key={s}>
                    <span style={{
                      ...
                      background: bulkWizardStep >= s ? '#0C66E4' : 'var(--ds-border, #DFE1E6)',
                    ...
                    {s < 2 && <span style={{ flex: 1, height: 1, background: 'var(--ds-border, #DFE1E6)' }} />}
                  </React.Fragment>
                ))}
              </div>
                  ...
                  {([
                    ...
                    <label
                      ...
                      style={{
                        ...
                        border: `2px solid ${bulkWizardAction === opt.id ? '#0C66E4' : 'var(--ds-border, #DFE1E6)'}`,
        ...
        >
          {[
            ...
            if ((item as any).divider) {
              return <div key={item.id} style={{ height: 1, background: 'var(--ds-border, var(--ds-border, #DFE1E6))', margin: '6px 0' }} />;
            }
            return (
              <button
                key={item.id}
        ...
        >
          ...
          <div style={{ padding: '0 24px 16px', display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div>
              ...
              >
                Type <code style={{ background: token('color.background.neutral', 'var(--ds-border, #DFE1E6)'), padding: '0 4px', borderRadius: 3, fontFamily: 'inherit' }}>{projectKey}</code> to confirm
              </label>
              <Textfield
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: isActive
                          ...
                          : `1px solid ${'var(--ds-border, var(--ds-border, #DFE1E6))'}`,
                        cursor: 'pointer',
                        padding: 0,
                      }}
                    />
    ...
    <>
      ...
      <button
        ...
        style={{
          ...
          padding: '0 12px',
          borderRadius: 3,
          border: `1px solid ${(isOpen || value !== 'none') ? token('color.border.selected', '#0C66E4') : 'var(--ds-border, var(--ds-border, #DFE1E6))'}`,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, minWidth: 220 }}>
      ...
      <input
        ...
        style={{
          ...
          border: '1px solid var(--ds-border, var(--ds-border, #DFE1E6))', borderRadius: 3,
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end', borderTop: '1px solid var(--ds-border, var(--ds-border, #DFE1E6))', paddingTop: 6 }}>
        <button
          type="button"
          onClick={onClose}
          style={{
            border: '1px solid var(--ds-border, var(--ds-border, #DFE1E6))', background: 'transparent',
