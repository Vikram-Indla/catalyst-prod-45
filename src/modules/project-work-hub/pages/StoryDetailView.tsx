      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto" style={{ minWidth: 0 }}>
          <div style={{ maxWidth: 800, padding: '24px 32px' }}>
            {/* Status button with transitions */}
            <div style={{ marginBottom: 16 }}>
              <Popover>
                ...
                <PopoverContent align="start" style={{ width: 300, padding: 0, background: isDark ? '#1A1A1A' : '#FFFFFF', border: `1px solid ${tk.border}`, borderRadius: 6, zIndex: 9999, overflow: 'hidden' }}>
                  {(() => {
