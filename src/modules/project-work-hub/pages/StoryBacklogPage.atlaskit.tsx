    ...
    <Box xcss={pageStyles} ref={containerRef as any}>
      ...
      >
        ...
        {isPanelOpen && (
          ...
          >
            <div style={{ width: 2, height: 40, borderRadius: 1, background: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))' }} />
          </div>
        )}
  ...
  return (
    <button
      ...
      style={{
        ...
        color: active ? '#0055CC' : 'var(--ds-text, var(--cp-text-primary, #172B4D))',
        fontSize: 14,
