...
const COLOR_OPTIONS = [
  { value: 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))', label: 'Blue' },
  { value: 'var(--ds-chart-teal-bold)', label: 'Teal' },
  { value: 'var(--ds-background-discovery-bold)', label: 'Purple' },
  { value: 'var(--quality-high)', label: 'Green' },
  { value: 'var(--ds-text-warning)', label: 'Orange' },
  { value: 'var(--ds-text-danger)', label: 'Red' },
  { value: 'var(--ds-background-discovery-bold)', label: 'Indigo' },
];
...
export function PlannerCreateTeamModal({
  ...
  const [color, setColor] = useState('var(--ds-text-brand, var(--cp-workstream-catalyst-primary))');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setName('');
    setEmoji('📈');
    setColor('var(--ds-text-brand, var(--cp-workstream-catalyst-primary))');
    setMemberIds([]);
    onClose();
  };
