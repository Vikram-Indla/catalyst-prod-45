      ...
      {visibleColumns.has('status') && (
        <td className="w-28 px-3">
          <span
            ...
            style={{
              borderColor: task.status_color ? `${task.status_color}40` : 'var(--ds-border, var(--cp-bg-sunken))',
              color: task.status_color || 'var(--ds-text-subtlest)',
              backgroundColor: 'transparent',
            }}
          >
            <span
              className="w-2 h-2 rounded-full"
              style={{ backgroundColor: task.status_color || 'var(--ds-text-subtlest)' }}
            />
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${task.progress}%`,
                  backgroundColor: task.progress >= 100 ? 'var(--ds-text-success)' : 
                    task.progress >= 50 ? 'var(--ds-text-success)' : 'var(--ds-text-subtlest)',
                }}
              />
            </div>
