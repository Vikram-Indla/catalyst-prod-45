...
export function DailyScorecardView() {
  ...
  if (isLoading) {
    return (
      <div className="h-full flex items-center justify-center bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))]">
  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] min-h-full">
        {/* Main Card */}
                ...
                <div key={team.id} className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-[14px] overflow-hidden hover:border-slate-300 dark:hover:border-[var(--ds-border-bold,#454545)] hover:shadow-lg transition-all">
                  ...
                  <div className="p-5 space-y-2">
                    {team.members.map(member => (
                      <div key={member.id} className="flex items-center gap-3.5 p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] rounded-[10px] hover:bg-slate-100 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] transition-colors">
                        <div 
