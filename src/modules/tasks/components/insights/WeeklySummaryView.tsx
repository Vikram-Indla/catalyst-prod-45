...
export function WeeklySummaryView() {
  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 bg-slate-100 dark:bg-[var(--ds-surface,#0A0A0A)] min-h-full">
            ...
            <div className="p-4 space-y-3">
              {releases.length === 0 ? (
                ...
                releases.slice(0, 5).map((release: any) => (
                  <div key={release.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] rounded-lg hover:bg-slate-100 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] transition-colors">
            ...
            <div className="p-4 space-y-2">
              {incidents.length === 0 ? (
                ...
                incidents.slice(0, 5).map((incident: any) => (
                  <div key={incident.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] rounded-lg hover:bg-slate-100 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] transition-colors">
                    <div className={cn(
            ...
            <div className="p-4 space-y-2">
              {defects.length === 0 ? (
                ...
                defects.slice(0, 5).map((defect: any) => (
                  <div key={defect.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] rounded-lg hover:bg-slate-100 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] transition-colors">
                    <div className={cn(
                      "w-2.5 h-2.5 rounded-full flex-shrink-0",
            ...
            <div className="p-4 space-y-2">
              {stories.length === 0 ? (
                ...
                stories.slice(0, 5).map((story: any) => (
                  <div key={story.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1, #1F1F1F))] rounded-lg hover:bg-slate-100 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] transition-colors">
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-semibold text-slate-800 dark:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))] truncate">
                        {story.title}
                      </div>
