        ...
        {data.map((ws) => {
          ...
          return (
            <button
              ...
              onClick={() => navigate(`/tasks/list?workstream=${ws.workstream_id}`)}
              className={cn(
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div 
                  ...
                  style={{ backgroundColor: ws.workstream_color || 'var(--ds-text-subtlest)' }}
                />
                    ...
                    <div className="flex-1 h-1.5 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden">
                      <div 
                        ...
                        style={{ 
                          ...
                          backgroundColor: ws.workstream_color || 'var(--ds-text-subtlest)'
                        }}
                      />
                    </div>
