...
export function BoardTaskCard({ task, onClick, isDragging }: BoardTaskCardProps) {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={cn(
        'boards-card dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] dark:hover:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] dark:hover:border-[var(--ds-border-bold,#454545)]',
        // Priority left border (NOT floating icon)
