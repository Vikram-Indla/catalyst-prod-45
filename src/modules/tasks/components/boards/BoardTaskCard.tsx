...
// - Task ID: Monospace var(--ds-text-subtlest) (visible, not washed out)
...
export function BoardTaskCard({ task, onClick, isDragging }: BoardTaskCardProps) {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={cn(
        'boards-card dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] dark:border-[var(--ds-border,var(--cp-ink-1))] dark:hover:bg-[var(--ds-surface-raised,var(--cp-ink-1))] dark:hover:border-[var(--ds-border-bold)]',
        // Priority left border (NOT floating icon)
    ...
    >
      ...
      <div className="boards-card__header">
        <span className="boards-card__id dark:text-[var(--ds-text-subtlest)]">{task.key}</span>
      ...
      {/* ========================================
          ...
          ======================================== */}
      <h4 className="boards-card__title dark:text-[var(--ds-text,var(--cp-bg-neutral))]">{task.title}</h4>
