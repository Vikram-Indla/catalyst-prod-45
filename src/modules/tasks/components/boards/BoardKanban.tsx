        ...
        >
          <SortableContext items={columnIds} strategy={horizontalListSortingStrategy}>
            <div className="boards-container">
              ...
              {/* Add Column Button */}
              <button
                className="boards-add-column dark:border-[var(--ds-border,var(--cp-ink-1))] dark:text-[var(--ds-text-subtlest,var(--cp-text-secondary))] dark:hover:bg-[var(--ds-surface-raised,var(--cp-ink-1))] dark:hover:text-[var(--ds-text,var(--cp-bg-neutral))] dark:hover:border-[var(--ds-border-bold)]"
          ...
          <DragOverlay>
            ...
            {activeColumn && (
              <div className="boards-column boards-column--overlay dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))]">
                <div className="boards-column__header">
                  <div className="boards-column__header-left">
                    ...
                    />
                    <h3 className="boards-column__title dark:text-[var(--ds-text,var(--cp-bg-neutral))]">{activeColumn.name}</h3>
                    <span className="boards-column__count dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] dark:text-[var(--ds-text-subtlest)]">{activeColumn.task_count}</span>
                  </div>
                </div>
              </div>
            )}
