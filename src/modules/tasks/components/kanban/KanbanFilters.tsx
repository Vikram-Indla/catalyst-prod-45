...
export function KanbanFilters({ 
  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      ...
      >
        <SelectTrigger className="w-[140px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border-border">
      ...
      >
        <SelectTrigger className="w-[150px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border-border">
      ...
      >
        <SelectTrigger className="w-[160px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border-border">
