    ...
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <div className="relative flex-1 min-w-[180px] max-w-[280px]">
        ...
        <Input
          ...
          className="pl-9 h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-border"
        />
        {filters.search && (
          <button
      ...
      >
        <SelectTrigger className="w-[140px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-border">
      ...
      >
        <SelectTrigger className="w-[150px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-border">
      ...
      >
        <SelectTrigger className="w-[160px] h-9 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-border">
