  ...
  return (
    ...
    >
      <div 
        ...
        style={{ borderColor: isDark ? 'var(--ds-border, var(--ds-border, #2E2E2E))' : 'var(--divider)' }}
      >
        <span 
          className="text-sm font-semibold"
          style={{ color: isDark ? 'var(--ds-text, var(--ds-text, #EDEDED))' : 'var(--text-1)' }}
        >
          Columns
        </span>
        <span 
          className="text-xs"
          style={{ color: isDark ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : 'var(--text-3)' }}
        >
