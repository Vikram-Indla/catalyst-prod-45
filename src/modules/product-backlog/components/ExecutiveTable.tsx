  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <div className="flex gap-3">
        ...
        <button
          onClick={onCreateNew}
          className="h-9 px-4 text-sm font-medium rounded-lg transition-colors shadow-sm bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white flex items-center gap-2"
        >
    ...
    if (column.id === 'id') {
      return (
        <span 
          ...
          className="font-semibold font-mono text-sm cursor-pointer hover:underline transition-colors focus:outline-none text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:text-[var(--ds-text-brand,#60a5fa)] hover:text-[var(--ds-background-brand-bold-hovered,#1d4ed8)] dark:hover:text-[#93c5fd]"
          tabIndex={0}
          role="button"
