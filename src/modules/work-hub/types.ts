...
export const WORK_ITEM_TYPE_CONFIG: Record<WorkItemType, { label: string; color: string }> = {
  FEATURE: { label: 'Epic', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' },
  STORY: { label: 'Story', color: 'var(--ds-text-success, var(--ds-text-success, #16a34a))' },
  SUBTASK: { label: 'Subtask', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' },
  DEFECT: { label: 'Bug', color: 'var(--ds-text-danger, var(--ds-text-danger, #dc2626))' },
  INCIDENT: { label: 'Production Incident', color: 'var(--ds-text-warning, var(--ds-text-warning, #f59e0b))' },
  TASK: { label: 'Task', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' },
};
...
export const PRIORITY_CONFIG: Record<Priority, { label: string; color: string; icon: string }> = {
  ...
  LOWEST: { label: 'Lowest', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', icon: 'chevrons-down' },
  NONE: { label: 'None', color: '#97A0AF', icon: 'minus' },
};

// Status colors
export const STATUS_COLORS: Record<string, string> = {
  'TODO': 'var(--ds-border, var(--ds-border, #e5e7eb))',
  'IN PROGRESS': 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))',
  'DONE': 'var(--ds-text-success, var(--ds-text-success, #16a34a))',
  'READY FOR QA': 'var(--ds-text-warning, var(--ds-text-warning, #f59e0b))',
  'READY FOR PRODUCTION': 'var(--ds-text-success, var(--ds-text-success, #16a34a))',
  'CLOSED': 'var(--ds-text-success, var(--ds-text-success, #16a34a))',
};
