  ...
  return (
    ...
    >
      ...
      <div className="min-w-[140px]">
        <button
          onClick={onClick}
          className="text-[14px] font-medium text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:text-[var(--ds-text-brand)] hover:underline text-left"
        >
          {release.name}
        </button>
      </div>
  ...
  return (
    <div className="h-full flex flex-col bg-card">
      ...
      <div className="px-6 py-4 border-b border-border flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 flex-1">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <Input
              ...
              className="pl-9 h-9 text-[14px] border-border focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
            />
          </div>
        ...
        <Button 
          className="h-9 px-4 text-[14px] font-medium bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:bg-[var(--ds-background-brand-bold-hovered)] text-white gap-2"
        >
