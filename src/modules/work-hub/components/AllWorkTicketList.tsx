          ...
          return (
            <div
              ...
              className={cn(
                ...
                isSelected 
                  ? 'bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/10 border-l-2 border-l-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]' 
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="text-[12px] font-medium text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:text-[var(--ds-text-brand)]">{item.key}</span>
                ...
                {item.parent && (
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <button
                      ...
                      className="text-[10px] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:text-[var(--ds-text-brand)] hover:underline flex items-center gap-0.5"
                    >
                      {item.parent}
