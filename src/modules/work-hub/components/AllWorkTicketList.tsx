            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mb-0.5">
                  <span className="text-[12px] font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]">{item.key}</span>
                ...
                {item.parent && (
                  <div className="flex items-center gap-1 mt-1">
                    ...
                    <button
                      ...
                      className="text-[10px] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] hover:underline flex items-center gap-0.5"
                    >
                      {item.parent}
