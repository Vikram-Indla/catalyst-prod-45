...
export function CreateVersionDialog({ open, onOpenChange, onSave }: CreateVersionDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="sm:max-w-[500px] p-0 gap-0 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))]"
        style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}
      >
        {/* Header */}
        <DialogHeader className="px-6 pt-6 pb-4">
          <DialogTitle className="text-[20px] font-semibold text-[var(--ds-text,var(--cp-text-primary, var(--cp-text-inverse)))]">
            Create version
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="px-6 pb-6 space-y-5">
          ...
          <p className="text-[13px] text-[var(--ds-text-subtlest,var(--cp-text-secondary))]">
            Required fields are marked with an asterisk <span className="text-red-500">*</span>
          </p>

          {/* Name Field */}
          <div className="space-y-1.5">
            <Label className="text-[13px] font-medium text-[var(--ds-text,var(--cp-text-primary, var(--cp-text-inverse)))]">
            ...
            <Input
              ...
              className={cn(
                "h-10 text-sm border-border focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]",
              ...
              <Popover open={startDateOpen} onOpenChange={setStartDateOpen}>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    <CalendarIcon className="h-4 w-4 text-[var(--ds-text-subtlest,var(--cp-text-secondary))]" />
                  </Button>
                </PopoverTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <Select value={driver} onValueChange={setDriver}>
              <SelectTrigger className="h-10 text-sm border-border focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              className="min-h-[100px] text-sm border-border focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] resize-none"
              placeholder=""
            />
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-border flex justify-end gap-2">
          ...
          <Button
            onClick={handleSave}
            className="h-9 px-4 text-sm font-medium bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:bg-[var(--ds-background-brand-bold-hovered)] text-white"
          >
            Save
          </Button>
        </div>
