        ...
        <div className="p-2 border-b border-border">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 h-8 text-[13px] bg-muted border-transparent rounded-md focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:bg-card"
            />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isVisible && "bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/10 dark:bg-[var(--ds-text-brand,var(--ds-text-brand, #3b82f6))]/10"
                )}
                onClick={() => {
              ...
              >
                ...
                {isVisible && <Check className="h-4 w-4 text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]" />}
              </button>
            );
          })}
        </div>
        <div className="p-2 border-t border-border">
          <button className="flex items-center gap-1 text-[13px] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] hover:underline">
            <span>⚙</span>
