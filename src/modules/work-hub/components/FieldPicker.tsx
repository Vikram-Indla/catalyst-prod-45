        ...
        <div className="p-2 border-b border-border">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-8 h-8 text-[13px] bg-muted border-transparent rounded-md focus:border-[#2563eb] focus:bg-card"
            />
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isVisible && "bg-[#2563eb]/10 dark:bg-[#3b82f6]/10"
                )}
                onClick={() => {
              ...
              >
                ...
                {isVisible && <Check className="h-4 w-4 text-[#2563eb] dark:text-[#60a5fa]" />}
              </button>
            );
          })}
        </div>
        <div className="p-2 border-t border-border">
          <button className="flex items-center gap-1 text-[13px] text-[#2563eb] dark:text-[#60a5fa] hover:underline">
            <span>⚙</span>
