  ...
  if (isEditing) {
    return (
      <Input
        ...
        className="h-7 text-sm text-foreground border-[var(--ds-text-brand,#2563eb)] rounded-md bg-background px-1.5 focus:ring-0 focus:ring-offset-0"
      />
    );
  }
  ...
  return (
    <span 
      className={cn(
        ...
        isSelected && "bg-[var(--ds-text-brand,#2563eb)]/10"
      )}
