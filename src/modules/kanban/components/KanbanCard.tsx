  ...
  return (
    <div
      className="
        ...
        bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:bg-[var(--ds-text-brand,#3b82f6)]
        text-white
      "
      style={{
        width: size,
    ...
    >
      ...
      <div className="p-4">
        ...
        <h4 className="
          ...
          group-hover:text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:group-hover:text-[var(--ds-text-brand,#60a5fa)]
          transition-colors
        ">
          {ticket.summary}
        </h4>
