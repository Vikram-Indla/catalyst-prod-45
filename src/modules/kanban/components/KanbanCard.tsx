  ...
  return (
    <div
      className="
        ...
        bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:bg-[var(--ds-text-brand)]
        text-white
      "
      style={{
        width: size,
...
if (compactMode) {
    return (
      <div
        ...
        style={{
          borderLeftWidth: '4px',
          borderLeftColor: department?.color || 'var(--ds-text-disabled)',
    ...
    >
      ...
      <div className="p-4">
        ...
        <h4 className="
          ...
          group-hover:text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:group-hover:text-[var(--ds-text-brand)]
          transition-colors
        ">
          {ticket.summary}
        </h4>
