...
export const KANBAN_COLORS = {
  ...
  goldLight: 'hsl(var(--brand-primary) / 0.7)',
  goldDark: 'hsl(var(--brand-primary))',
...
export const COLUMNS_CONFIG: StatusConfig[] = [
  { id: 'new_request', label: 'New Request', color: 'var(--ds-text-brand)', order: 0 },  // Blue
  { id: 'analyse', label: 'Analyse', color: 'var(--ds-text-warning)', order: 1 },          // Amber
  { id: 'approved', label: 'Approved', color: 'var(--ds-text-success)', order: 2 },        // Green
  { id: 'implement', label: 'Implement', color: 'var(--ds-background-discovery-bold)', order: 3 },      // Purple
  { id: 'closed', label: 'Closed', color: 'var(--ds-text-subtlest)', order: 4 },            // Stone
  { id: 'rejected', label: 'Rejected', color: 'var(--ds-text-danger)', order: 5 },        // Red
  { id: 'on_hold', label: 'On-Hold', color: 'var(--ds-background-warning-bold)', order: 6 },          // Orange
];
