              ...
              return (
                <div key={group.krId} className="border border-[#E1E4E8] dark:border-[#30363D] rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <Target className="h-4 w-4 text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] flex-shrink-0" />
                                ...
                                <tr key={item.id} className="border-b border-[#E1E4E8] dark:border-[#30363D] last:border-0 hover:bg-[#F6F8FA] dark:hover:bg-[#21262D]">
                                  <td className="py-2.5">
                                    <div className="flex items-center gap-2">
                                      <Target className="h-3.5 w-3.5 text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] flex-shrink-0" />
                                      <button
                                        onClick={() => setSelectedWorkItem({ id: item.work_item_id, type: item.type })}
                                        className="truncate text-left hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:underline transition-colors cursor-pointer text-[#24292F] dark:text-[#E6EDF3]"
                                      >
                                        {item.name}
                                      </button>
                                    </div>
                                  ...
                                  <td className="py-2.5 text-center">
                                    {editingItem?.id === item.id ? (
                                      ...
                                      <button
                                        ...
                                        className="text-sm font-medium hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] transition-colors px-2 py-0.5 rounded hover:bg-[#F6F8FA] dark:hover:bg-[#21262D] text-[#24292F] dark:text-[#E6EDF3]"
                                      >
                                  ...
                                  <td className="py-2.5 text-right">
                                    <div className="flex items-center justify-end gap-1">
                                      <Button
                                        variant="ghost"
                                        size="icon"
                                        className="h-7 w-7 text-[#57606A] dark:text-[#8B949E] hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]"
                                        onClick={() => setEditingItem({ id: item.id, value: item.contributionPercent })}
