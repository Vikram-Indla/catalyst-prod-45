...
function getHealthColor(health?: string): string {
  switch (health) {
    ...
    case 'fair': return 'var(--ds-text-warning, var(--ds-text-warning, #D97706))';
    case 'poor': return 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))';
    case 'at_risk': return '#F97316';
    default: return 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))';
  }
}
