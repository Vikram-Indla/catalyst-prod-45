    ...
    <div className="p-6 space-y-6 bg-background">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className={`font-medium bg-white dark:bg-[#0D1117] border-[#E1E4E8] dark:border-[#30363D] text-[#24292F] dark:text-[#E6EDF3] focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:ring-1 focus:ring-[rgba(37,99,235,0.3)] ${!formData.name.trim() ? 'border-destructive' : ''}`}
          required
        />
        {!formData.name.trim() && (
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="bg-white dark:bg-[#0D1117] border-[#E1E4E8] dark:border-[#30363D] text-[#24292F] dark:text-[#E6EDF3] placeholder:text-[#8B949E] dark:placeholder:text-[#6E7681] focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:ring-1 focus:ring-[rgba(37,99,235,0.3)]"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className={`bg-white dark:bg-[#0D1117] border-[#E1E4E8] dark:border-[#30363D] text-[#24292F] dark:text-[#E6EDF3] focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:ring-1 focus:ring-[rgba(37,99,235,0.3)] ${!formData.theme_id ? 'border-destructive' : ''}`}>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="bg-white dark:bg-[#0D1117] border-[#E1E4E8] dark:border-[#30363D] text-[#24292F] dark:text-[#E6EDF3] focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:ring-1 focus:ring-[rgba(37,99,235,0.3)]">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="bg-white dark:bg-[#161B22] border-[#E1E4E8] dark:border-[#30363D]">
