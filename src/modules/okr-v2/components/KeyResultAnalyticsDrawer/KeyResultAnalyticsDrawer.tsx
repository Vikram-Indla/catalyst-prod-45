...
import { X, Shield, Link2, Lightbulb, ChevronDown, ChevronUp, AlertTriangle, ArrowRight, TrendingUp, TrendingDown, Clock, Target, Activity, Calendar } from '@/lib/atlaskit-icons';
    ...
    <div className="p-4 bg-card rounded-xl border border-border space-y-3">
      ...
      {linkedWork.totalWork > 0 && (
        <div className="flex items-center gap-3 text-xs pt-2 border-t border-border">
          ...
          {workItemStatus.inProgress > 0 && <span className="text-brand-primary">{workItemStatus.inProgress} in progress</span>}
