  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn(
        ...
        <div className="h-1 bg-gradient-to-r from-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] via-[#8b5cf6] to-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] flex-shrink-0" />
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-[#333333] bg-gray-50 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1a1a1a))]">
          ...
          <Button onClick={() => updateEpicMutation.mutate()} disabled={!isValid || updateEpicMutation.isPending} className="bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))] text-white px-6">
