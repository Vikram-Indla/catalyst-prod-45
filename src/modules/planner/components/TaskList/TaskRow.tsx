        ...
        <td className="w-28 px-3">
          ...
          >
            <span
              ...
              style={{ backgroundColor: task.status_color || 'var(--ds-text-subtlest, #64748b)' }}
            />
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${task.progress}%`,
                  backgroundColor: task.progress >= 100 ? 'var(--ds-text-success, #22c55e)' : 
                    task.progress >= 50 ? 'var(--ds-text-success, #22c55e)' : 'var(--ds-text-subtlest, #94a3b8)',
                }}
              />
            </div>
