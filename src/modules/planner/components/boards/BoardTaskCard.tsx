...
export function BoardTaskCard({ task, onClick, isDragging }: BoardTaskCardProps) {
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={cn(
        'boards-card dark:bg-[#232019] dark:border-[rgba(255,255,255,0.08)] dark:hover:bg-[#2C2823] dark:hover:border-[rgba(255,255,255,0.15)]',
        // Priority left border (NOT floating icon)
    ...
    >
      ...
      <div className="boards-card__header">
        <span className="boards-card__id dark:text-[#A09890]">{task.key}</span>
      ...
      {/* ========================================
          ...
          ======================================== */}
      <h4 className="boards-card__title dark:text-[#F5F3F0]">{task.title}</h4>
