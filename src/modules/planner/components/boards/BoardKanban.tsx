        ...
        >
          <SortableContext items={columnIds} strategy={horizontalListSortingStrategy}>
            <div className="boards-container">
              ...
              {/* Add Column Button */}
              <button
                className="boards-add-column dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] dark:text-[var(--ds-text-subtlest,var(--cp-text-secondary, #878787))] dark:hover:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] dark:hover:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))] dark:hover:border-[var(--ds-border-bold,#454545)]"
          ...
          <DragOverlay>
            ...
            {activeColumn && (
              <div className="boards-column boards-column--overlay dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))]">
                <div className="boards-column__header">
                  <div className="boards-column__header-left">
                    ...
                    />
                    <h3 className="boards-column__title dark:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))]">{activeColumn.name}</h3>
                    <span className="boards-column__count dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] dark:text-[var(--ds-text-subtlest,#A1A1A1)]">{activeColumn.task_count}</span>
                  </div>
                </div>
              </div>
            )}
