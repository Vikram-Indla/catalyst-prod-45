        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#e2e8f0] dark:border-slate-800 bg-white dark:bg-slate-950 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-lg">
              ...
              <span className="px-4 text-sm font-medium text-[rgba(237,237,237,0.53)] dark:text-slate-300 min-w-[160px] text-center">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === mode
                      ...
                      : "text-[#64748b] dark:text-slate-400 hover:text-[rgba(237,237,237,0.53)] dark:hover:text-slate-300"
                  )}
                >
                                        ...
                                        >
                                          ...
                                          {showTitle && (
                                            <span
                                              ...
                                              style={{ color: wsColors.textDark || 'rgba(237,237,237,0.53)' }}
                                            >
                                              {task.title}
                                            </span>
                                          )}
        ...
        {!isLoading && filteredTasks.length === 0 && (
          <div className="absolute inset-0 flex items-center justify-center bg-white/80 dark:bg-slate-950/80 z-40">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-[rgba(237,237,237,0.53)] dark:text-slate-300 mb-1">
