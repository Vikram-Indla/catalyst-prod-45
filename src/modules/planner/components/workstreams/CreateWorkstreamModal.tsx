        ...
        <div className="ws-modal-body" style={{ padding: '1.25rem', maxHeight: '420px', overflowY: 'auto' }}>
          ...
          {step === 2 && (
            <div className="space-y-4">
              {/* Help Text */}
              <div className="flex items-start gap-2 p-3 rounded-lg" style={{ background: '#eff6ff', border: '1px solid #dbeafe' }}>
                <Info className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#3b82f6' }} />
                <p className="text-xs leading-relaxed" style={{ color: '#4b5563' }}>
                  Select team members from resource inventory. Click the{' '}
                  <Crown className="w-3 h-3 inline" style={{ color: '#f59e0b' }} /> icon to designate a{' '}
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs" style={{ color: '#6b7280' }}>
                  <strong style={{ color: '#3b82f6' }}>{selectedIds.size}</strong> selected
                </span>
              </div>
                ...
                {loadingResources ? (
                  <div className="p-8 text-center" style={{ color: '#9ca3af' }}>
                    <div 
                      ...
                      style={{ border: '2px solid #e5e7eb', borderTopColor: '#3b82f6' }} 
                    />
                      ...
                      >
                          ...
                          >
                            <div
                              ...
                              style={{ 
                                ...
                                background: resource.capacity > 80 ? '#f59e0b' : '#3b82f6'
                              }}
                            />
                          </div>
                        ...
                        {isSelected && (
                          <button
                            ...
                            style={{
                              background: isLead ? '#f59e0b' : 'white',
