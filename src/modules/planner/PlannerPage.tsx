...
export function PlannerPage() {
  ...
  const avatarColors = ['var(--ds-text-brand, var(--ds-text-brand, #2563eb))', '#10b981', '#8b5cf6', 'var(--ds-text-warning, var(--ds-text-warning, #f59e0b))', 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))', '#0d9488'];
