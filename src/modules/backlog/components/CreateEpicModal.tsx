...
import { X, Save } from '@/lib/atlaskit-icons';
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className={cn(
                  ...
                  "focus:ring-2 focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/30 focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]"
                )}
                autoFocus
              />
            </div>
