          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className={cn(
                ...
                activeFiltersCount > 0
                  ? 'border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/5 hover:bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/10'
            ...
            >
              ...
              {activeFiltersCount > 0 && (
                <span className="min-w-5 h-5 px-1.5 rounded-full bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] text-[10px] font-semibold text-white flex items-center justify-center">
                  {activeFiltersCount}
                </span>
              )}
            </button>
