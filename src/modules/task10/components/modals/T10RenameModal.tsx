    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-[#2E2E2E]">
          <h2 className="text-lg font-semibold text-slate-900 dark:text-[#EDEDED]">Rename List</h2>
          <button
            type="button"
        ...
        <div className="px-6 py-5">
          <div className="space-y-2">
            ...
            <input
              ...
              autoFocus
              className="w-full px-4 py-2.5 text-[15px] text-slate-900 dark:text-[#EDEDED] placeholder:text-slate-400 dark:placeholder:text-[#878787] bg-white dark:bg-[#1A1A1A] border border-slate-300 dark:border-[#454545] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
            />
          </div>
        </div>
