...
// ═══════════════════════════════════════════════════════════════════════════
const COLORS = {
  white: 'var(--ds-surface, var(--ds-surface, #ffffff))',
  ...
  blue: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))',
  blue50: 'var(--ds-background-selected, var(--ds-background-selected, #eff6ff))',
  blueDark: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1d4ed8))',
  teal: '#0d9488',
  teal50: '#f0fdfa',
  green: 'var(--ds-text-success, var(--ds-text-success, #22c55e))',
  green50: '#f0fdf4',
  red: 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))',
  red50: 'var(--ds-background-danger, var(--ds-background-danger, #fef2f2))',
};
