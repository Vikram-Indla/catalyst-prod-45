...
export function ReportsView({ changeCards, isLoading }: ReportsViewProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-6">
      ...
      <Card className="p-6 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4">Approval Status</h3>
        <ResponsiveContainer width="100%" height={200}>
      ...
      <Card className="p-6 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-4">Summary</h3>
        <div className="grid grid-cols-2 gap-4">
          <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="text-3xl font-semibold text-gray-900 dark:text-gray-100">{changeCards.length}</div>
          ...
          <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Exceptions</div>
          </div>
          <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div className="text-3xl font-semibold text-gray-900 dark:text-gray-100">{changeCards.filter(c => c.status === 'in_production').length}</div>
            <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">In Production</div>
          </div>
        </div>
      </Card>
    </div>
