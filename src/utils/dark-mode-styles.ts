...
export const LK: DarkTokens = {
  ...
  tableHeaderBg: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
  ...
  chipBg:        'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
  progressTrack: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',
  iconBg:        'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))',

  t1: 'var(--cp-text-primary, var(--cp-ink-1, #0F172A))',
