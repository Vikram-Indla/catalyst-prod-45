...
/* ═══════════════════════════════════════════
   SHARED STYLES
   ═══════════════════════════════════════════ */
const card = 'bg-white dark:bg-[#1A1A1A] border border-zinc-200 dark:border-[var(--cp-ink-1, #2E2E2E)] rounded-lg p-5 shadow-sm';
    ...
    <div className="space-y-5">
      ...
      <div className={`${overallBg} border rounded-xl p-6 flex items-center justify-between`}>
        ...
        <button
          onClick={runChecks}
          disabled={loading}
          className="flex items-center gap-1.5 px-4 py-2 bg-white dark:bg-[#1A1A1A] border border-zinc-200 dark:border-[var(--cp-ink-1, #2E2E2E)] rounded-lg text-xs font-semibold text-zinc-700 dark:text-[#A1A1A1] hover:bg-zinc-50 dark:hover:bg-[#1A1A1A] transition-colors disabled:opacity-50"
        >
                    ...
                    <tr>
                      <td colSpan={12} className="px-0 py-0">
                        <div className="bg-blue-50/60 border-t border-b border-blue-100 px-6 py-4 space-y-3">
                          ...
                          <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-zinc-200 dark:border-[var(--cp-ink-1, #2E2E2E)] p-3">
...
export default function KBAdminPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50" style={{ paddingTop: 48 }}>
      ...
      {/* Tabs */}
      <div className="bg-white dark:bg-[#1A1A1A] border-b border-zinc-200 dark:border-[var(--cp-ink-1, #2E2E2E)] px-6">
