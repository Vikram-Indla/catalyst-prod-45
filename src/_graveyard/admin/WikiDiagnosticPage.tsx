      ...
      <div className="px-7 py-6 space-y-6">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded border border-[rgba(15,23,42,0.12)] dark:border-[var(--cp-ink-1, #2E2E2E)] bg-white dark:bg-[#1A1A1A] text-[var(--cp-ink-1, var(--cp-ink-1, #0F172A))] hover:bg-[#F4F5F7]"
          >
