...
const STATUS_COLORS: Record<string, string> = {
  ...
  skipped: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', backgroundColor: 'hsl(var(--background))', overflow: 'auto' }}>
      ...
      <div style={{ padding: '20px 32px', backgroundColor: 'hsl(var(--card))', borderBottom: '1px solid hsl(var(--border))' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 500, color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', backgroundColor: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', padding: '4px 10px', borderRadius: 6, textTransform: 'capitalize' }}>{cycle.status}</span>
        </div>
      ...
      <div style={{ padding: '24px 32px' }}>
        ...
        {failureReasons.length > 0 && (
          <div style={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: 12, padding: 24, marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16 }}>
              <XCircle size={16} color="var(--ds-text-danger, #EF4444)" />
