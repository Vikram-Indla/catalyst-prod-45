                ...
                <tr key={d.id} className="border-b last:border-b-0" style={{ height: 36, maxHeight: 36 }}>
                  <td className="px-4 py-0">
                    <span
                      ...
                      style={{ fontFamily: 'var(--cp-font-mono)', fontSize: 13, fontWeight: 500, color: 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))', cursor: 'pointer' }}
                    >
                      {d.defect_key}
                    </span>
                  </td>
    ...
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="overview">
                    ...
                    <tbody>
                      {linkedCycles.map(lc => {
                        ...
                        const statusColor = c.status === 'completed' ? 'bg-[#E3FCEF] text-[#006644]'
                          ...
                          : 'bg-[var(--ds-border,var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))] text-[var(--ds-text,#253858)]';
        ...
        <TabsContent value="attachments" className="mt-6">
          <EntityAttachmentsPanel entityType="test_plan" entityId={plan.id} title="Plan Attachments" />
        </TabsContent>
      </Tabs>
