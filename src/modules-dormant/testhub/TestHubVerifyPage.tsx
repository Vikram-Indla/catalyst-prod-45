      ...
      <div style={{ flex: 1, overflow: 'auto', padding: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
          {[
            ...
            { label: 'TOTAL', value: checks.length, bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', color: '#374151' },
          ].map(chip => (
        ...
        {MODULE_DEFS.map(mod => {
          ...
          return (
            <div key={mod.key} style={{
              ...
              {/* Progress bar */}
              <div style={{ width: '100%', height: 4, backgroundColor: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', borderRadius: 2 }}>
