...
import EpicsRecycleBin from "./pages/EpicsRecycleBin";
import EpicsCanceled from "./pages/EpicsCanceled";
        ...
        <NavigationProvider>
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <Route path="/epics/recycle-bin" element={<EpicsRecycleBin />} />
              <Route path="/epics/canceled" element={<EpicsCanceled />} />
