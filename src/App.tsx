...
<Route path="/" element={<Navigate to="/for-you" replace />} />
              ...
              <Route path="/testhub" element={<Suspense fallback={<div className="p-8">Loading...</div>}><TestHubPage /></Suspense>}>
                ...
                <Route path="test-sets/:setId" element={<Suspense fallback={<div className="p-8">Loading...</div>}><TestSetDetailPage /></Suspense>} />
                ...
                <Route path="cycles/:cycleId/report" element={<Suspense fallback={<div className="p-8">Loading...</div>}><CycleReportPage /></Suspense>} />
                <Route path="cycles/:cycleId/execute" element={<Suspense fallback={<div className="p-8">Loading...</div>}><TestHubExecutionPage /></Suspense>} />
                ...
                <Route path="traceability" element={<Suspense fallback={<div className="p-8">Loading...</div>}><TraceabilityPage /></Suspense>} />
                <Route path="environments" element={<Suspense fallback={<div className="p-8">Loading...</div>}><EnvironmentsListPage /></Suspense>} />
