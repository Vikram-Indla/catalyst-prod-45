...
export const border = {
  ...
  // Atlaskit color.border (N40 var(--ds-border, #DFE1E6)) @ 50% alpha — replaces hsl(218 14% 91% / 0.5)
...
export const statusLozenge = {
  grey:  { lightBg: 'var(--ds-border, #DFE1E6)', lightText: '#253858', darkBg: '#2E2E2E', darkText: '#A1A1A1' },
