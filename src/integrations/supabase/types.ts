...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ra_ai_settings: {
        Row: {
          ...
          compliance_validation: boolean | null
          confidence_scoring: boolean | null
          created_at: string | null
          draft_auto_save: boolean | null
          id: string
      ...
      ra_compliance_rules: {
        Row: {
          created_at: string | null
          framework: Database["public"]["Enums"]["ra_compliance_framework"]
          id: string
          is_active: boolean | null
          rule_code: string
      ...
      ra_generated_items: {
        Row: {
          ...
          is_published: boolean | null
          item_number: number
          item_type: Database["public"]["Enums"]["ra_item_type"]
          parent_id: string | null
          sort_order: number | null
          title: string
          updated_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "ra_generated_items_generation_id_fkey"
            columns: ["generation_id"]
            isOneToOne: false
            referencedRelation: "ra_generation_summary"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ra_generated_items_generation_id_fkey"
            columns: ["generation_id"]
            isOneToOne: false
            referencedRelation: "ra_generations"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "ra_generated_items_parent_id_fkey"
            columns: ["parent_id"]
            isOneToOne: false
            referencedRelation: "ra_generated_items"
            referencedColumns: ["id"]
          },
        ]
      }
      ra_generations: {
        Row: {
          ...
          input_word_count: number | null
          max_tokens: number | null
          output_acceptance_criteria: boolean | null
          output_epics: boolean | null
          output_features: boolean | null
          ...
          project_id: string | null
          published_at: string | null
          status: Database["public"]["Enums"]["ra_generation_status"] | null
          temperature: number | null
          title: string
      ...
      ra_templates: {
        Row: {
          ...
          template_type: Database["public"]["Enums"]["ra_template_type"]
          updated_at: string | null
          version: string | null
        }
        Insert: {
      ...
      ra_user_roles: {
        Row: {
          created_at: string | null
          id: string
          role: Database["public"]["Enums"]["ra_user_role"] | null
          updated_at: string | null
          user_id: string
        }
        Insert: {
    ...
    Functions: {
      ...
      has_ra_role_any: {
        Args: { required_roles: Database["public"]["Enums"]["ra_user_role"][] }
        Returns: boolean
      }
      has_role: {
        Args: {
    ...
    Enums: {
      ...
      ra_compliance_framework: "dga" | "nca" | "babok"
      ra_generation_status: "draft" | "processing" | "published" | "failed"
