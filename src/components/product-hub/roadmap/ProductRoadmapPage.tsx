...
import { Download, Maximize2, Minimize2, AlertCircle, RefreshCw, Plus } from '@/lib/atlaskit-icons';
      ...
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center flex-1 gap-4">
          ...
          <button
            ...
            style={{ background: 'var(--ds-text-brand, #2563EB)', color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))', transition: 'opacity 0.15s ease' }}
