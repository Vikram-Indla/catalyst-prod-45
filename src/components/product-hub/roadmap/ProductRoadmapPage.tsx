    ...
    return (
      <div className="flex flex-col h-full" style={{ fontFamily: FONT.body }}>
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-3">
          <div className="flex items-center gap-2 px-4 py-3 rounded-lg" style={{ background: isDark ? 'rgba(220,38,38,0.12)' : 'rgba(248,113,113,0.06)', border: `1px solid ${isDark ? 'rgba(220,38,38,0.25)' : '#FECACA'}` }}>
            <AlertCircle size={18} style={{ color: '#EF4444' }} />
            <span style={{ fontSize: 14, color: isDark ? '#FCA5A5' : '#F87171', fontWeight: 500 }}>
