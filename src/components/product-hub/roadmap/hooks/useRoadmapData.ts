...
const OWNER_PALETTE = ['var(--ds-text-brand, #2563EB)', 'var(--cp-purple-60, #7C3AED)', 'var(--cp-teal-60, #0D9488)', '#EC4899', 'var(--ds-text-warning, #D97706)', 'var(--quality-high, #059669)', '#E11D48', '#6366F1'];
