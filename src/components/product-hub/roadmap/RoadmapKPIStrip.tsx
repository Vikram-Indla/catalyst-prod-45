    ...
    >
      ...
      <div style={cardStyle}>
        ...
        <div className="flex items-baseline gap-2" style={{ marginTop: 4 }}>
          <span style={{ fontFamily: FONT.heading, fontSize: 26, fontWeight: 700, color: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', letterSpacing: '-0.03em' }}>{stats.activeCount}</span>
