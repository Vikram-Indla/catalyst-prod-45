          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' : 'transparent',
                color: isActive ? 'var(--ds-text-inverse, #FFFFFF)' : ink[2],
                border: isActive ? '1px solid #2563EB' : '1px solid transparent',
                cursor: 'pointer',
                transition: 'all 0.15s ease',
              }}
              onMouseEnter={e => { if (!isActive) e.currentTarget.style.background = isDark ? 'var(--ds-border, var(--ds-border, #292929))' : surface.page; }}
