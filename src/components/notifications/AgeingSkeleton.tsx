  ...
  return (
    <div style={{
      ...
      background: isDark
        ...
        : 'linear-gradient(90deg, var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9)) 25%, var(--ds-border, var(--cp-border, #E2E8F0)) 50%, var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9)) 75%)',
