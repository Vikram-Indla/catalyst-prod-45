    ...
    <div style={{
      ...
      {onReply && (
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 500, color: '#64748B', fontFamily: 'var(--ds-font-family-body)' }}
        >
          Reply
        </button>
      )}
      ...
      {onViewThread && (
        <button
          ...
          style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, fontWeight: 500, color: '#2563EB', fontFamily: 'var(--ds-font-family-body)', textDecoration: 'none' }}
