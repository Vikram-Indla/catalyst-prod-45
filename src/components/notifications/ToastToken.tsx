...
export default function ToastToken({ toast: t, onDismiss, onPause, onResume }: ToastTokenProps) {
  ...
  const accentColor = isDueDate ? 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' : 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))';
      ...
      <div style={{ padding: '12px 14px', display: 'flex', gap: 10, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
            ...
            <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', fontWeight: 500, flexShrink: 0 }}>
              {n.entity_key}
            </span>
          </div>
        ...
        <button
          ...
          style={{
            ...
            color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))', flexShrink: 0, borderRadius: 4,
