      ...
      <div style={{ padding: '16px 20px 0' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 24, fontWeight: 600, color: T.text1, margin: 0, lineHeight: 1.2 }}>
              Notifications
            </span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 13, color: T.text2 }}>
                    ...
                    <div key={label}>
                      <button
                        ...
                        style={{
                          ...
                          cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)', fontSize: 13, color: T.text1,
            ...
            return (
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  fontFamily: 'var(--ds-font-family-body)', fontSize: 14, fontWeight: isActive ? 600 : 500,
      ...
      >
        ...
        {hasError ? (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 12 }}>
            <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 14, color: T.text3 }}>
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)', fontSize: 13, fontWeight: 500, color: T.text2,
              }}
            >
              <RefreshCw size={14} />
              Retry
