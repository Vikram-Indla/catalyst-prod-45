          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                background: unreadOnly ? 'var(--ds-text-success, var(--ds-text-success, #16A34A))' : ('var(--cp-text-secondary, #334155)'),
            ...
            >
              <span style={{
                ...
                {unreadOnly ? (
                  <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M1.5 4L3 5.5L6.5 2" stroke="var(--ds-text-success, var(--ds-text-success, #16A34A))" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                ) : (
                  <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M2 2L6 6M6 2L2 6" stroke="var(--ds-text-subtle, var(--ds-text-subtle, #334155))" strokeWidth="1.2" strokeLinecap="round"/></svg>
                )}
              </span>
            </button>
            {/* Open full page */}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: isActive ? 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' : T.text2,
