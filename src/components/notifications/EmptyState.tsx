...
export default function EmptyState({ variant }: EmptyStateProps) {
  ...
  if (variant === 'noWatching') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 8 }}>
        ...
        <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-400)', fontWeight: 600, color: text1 }}>No watched items yet</span>
        <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-300)', color: text3, textAlign: 'center', maxWidth: 280 }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 8 }}>
      ...
      <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-400)', fontWeight: 600, color: text1 }}>No notifications yet</span>
      <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 'var(--ds-font-size-300)', color: text3, textAlign: 'center', maxWidth: 280 }}>
