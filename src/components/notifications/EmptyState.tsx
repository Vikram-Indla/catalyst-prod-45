...
export default function EmptyState({ variant }: EmptyStateProps) {
  ...
  if (variant === 'allCaughtUp') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 8 }}>
        ...
        <span style={{ fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 13, color: text3 }}>You're on top of everything.</span>
      </div>
    );
  }
  ...
  if (variant === 'noWatching') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 8 }}>
        ...
        <span style={{ fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 14, fontWeight: 600, color: text1 }}>No watched items yet</span>
        <span style={{ fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 13, color: text3, textAlign: 'center', maxWidth: 280 }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '48px 20px', gap: 8 }}>
      ...
      <span style={{ fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 14, fontWeight: 600, color: text1 }}>No notifications yet</span>
      <span style={{ fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 13, color: text3, textAlign: 'center', maxWidth: 280 }}>
