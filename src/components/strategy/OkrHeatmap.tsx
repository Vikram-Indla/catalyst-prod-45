      ...
      <CardContent>
        <div className="space-y-3">
          ...
          {heatmapData.rows.map((row) => (
            <div
              key={row.themeId}
              className="grid grid-cols-[1fr_120px_160px_100px] gap-3 px-4 py-3 border rounded-md hover:bg-muted/20 cursor-pointer transition-colors focus:outline-none focus:ring-0"
