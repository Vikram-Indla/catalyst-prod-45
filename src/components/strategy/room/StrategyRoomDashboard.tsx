...
[data-srd] {
  ...
  --srd-blue:#2563EB; --srd-blue-h:#1D4ED8; --srd-blue-bg:var(--tint-blue, #EFF6FF); --srd-blue-bdr:#BFDBFE;
  --srd-teal:#0D9488; --srd-teal-t:#0A8277; --srd-teal-bg:#F0FDFA;
  --srd-green:#16A34A; --srd-green-t:#11853D; --srd-green-bg:var(--tint-green, #F0FDF4);
  --srd-red:#DC2626; --srd-red-t:#D92525; --srd-red-bg:var(--tint-red, #FEF2F2);
  --srd-purple:#2563EB;
  --srd-ai:#2563EB; --srd-ai-d:#1E40AF; --srd-ai-bg:var(--tint-blue, #EFF6FF); --srd-ai-bdr:#93C5FD;
