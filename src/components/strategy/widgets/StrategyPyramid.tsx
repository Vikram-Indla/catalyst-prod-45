...
const LAYER_COLORS: Record<string, string> = {
  mission: '#1E3A5F',
  vision: '#1E40AF',
  themes: 'var(--ds-text-brand, var(--ds-text-brand, #3B82F6))',
  goals: '#93C5FD',
  krs: '#DBEAFE',
};
              ...
              return (
                <div key={t.id} style={{ padding: '12px 0', borderBottom: '1px solid var(--exec-border, var(--bd-default, #E2E8F0))' }}>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span style={{ marginLeft: 'auto', fontSize: 12, fontWeight: 600, color: avgProgress >= 70 ? '#1E40AF' : avgProgress >= 40 ? 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' : 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))' }}>{avgProgress}%</span>
                  </div>
