      ...
      <Sheet open={open} onOpenChange={(o) => !o && handleClose()}>
        ...
        >
          ...
          {currentView === 'themes' ? (
            ...
            <>
              {/* Header - Gold bottom border only here */}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-5">
                ...
                <div>
                  ...
                  {isReady ? (
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-lg bg-brand-primary/10 border border-brand-primary/30">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button
                      ...
                      className="p-4 rounded-lg transition-all text-left group bg-muted/50 border border-border hover:border-brand-primary/30"
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="h-8 w-8 rounded-md bg-brand-primary/10 flex items-center justify-center">
                      ...
                      <div className={cn(
                        ...
                        quarterCount === 0 ? "text-brand-primary" : "text-foreground"
                      )}>
                        {quarterCount}
                        {quarterCount === 0 && <AlertTriangle className="h-3.5 w-3.5 inline ml-1 text-brand-primary" />}
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div className={cn(
                        "text-xl font-semibold tabular-nums",
                        themeCount === 0 ? "text-brand-primary" : "text-foreground"
                      )}>
                        {themeCount}
                        {themeCount === 0 && <AlertTriangle className="h-3.5 w-3.5 inline ml-1 text-brand-primary" />}
                      </div>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <button 
                      className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-colors bg-background border border-border hover:border-brand-primary/30 text-foreground"
              ...
              {!isActive && !isArchived && (
                <div className="flex-shrink-0 border-t border-border p-4">
                  <button 
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-brand-primary hover:bg-brand-primary-hover text-white text-sm font-medium transition-colors"
