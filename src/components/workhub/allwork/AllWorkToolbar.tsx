  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 h-8 text-[13px] rounded border transition-colors duration-80 hover:bg-[var(--hover)] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
        style={{
          ...
          {isLoading ? (
            ...
            options.map(opt => (
              <button
                ...
                className="w-full flex items-center gap-2 px-3 py-1.5 text-[13px] hover:bg-[var(--hover)] text-left transition-colors duration-80"
              ...
              >
                <span
                  ...
                  style={{
                    borderColor: selected.includes(opt) ? 'var(--cp-blue)' : 'var(--bd-default, var(--cp-ink-1))',
...
export function AllWorkToolbar({
  ...
  return (
    <div className="px-8 py-3 flex items-center gap-3 flex-wrap" style={{ borderBottom: '1px solid var(--bd-subtle, var(--cp-ink-1))' }}>
      <FilterDropdown
        label="Type"
        options={issueTypes ?? []}
      ...
      <div
        className="flex items-center gap-2 h-8 px-2.5 rounded border bg-[var(--bg-app)] focus-within:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] transition-colors duration-80"
        style={{ minWidth: 180, borderColor: 'var(--bd-default, var(--cp-ink-1))' }}
      >
        ...
        {searchValue && (
          <button
            ...
            title="Clear search"
            className="shrink-0 rounded p-0.5 transition-colors duration-80 hover:bg-[var(--hover)] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
      ...
      {/* View toggle */}
      <div className="inline-flex rounded border overflow-hidden" style={{ borderColor: 'var(--bd-default, var(--cp-ink-1))' }} role="radiogroup" aria-label="View mode">
        {([
