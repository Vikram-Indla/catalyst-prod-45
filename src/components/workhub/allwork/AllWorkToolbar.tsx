    ...
    <div className="px-8 py-3 flex items-center gap-3 flex-wrap" style={{ borderBottom: '1px solid var(--bd-subtle, var(--cp-ink-1, #292929))' }}>
      ...
      {hasFilters && (
        <button
          ...
          className="inline-flex items-center gap-1 px-2 h-8 text-[12px] rounded hover:bg-[rgba(220,38,38,0.06)] transition-colors duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563EB))]"
      ...
      >
        ...
        {searchValue && (
          <button
            ...
            title="Clear search"
            className="shrink-0 rounded p-0.5 transition-colors duration-[80ms] hover:bg-[var(--hover,#1F1F1F)] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563EB))]"
      ...
      <div className="inline-flex rounded border overflow-hidden" style={{ borderColor: 'var(--bd-default, var(--cp-ink-1, #2E2E2E))' }} role="radiogroup" aria-label="View mode">
        {([
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 h-8 text-[12px] transition-colors duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563EB))]"
            style={{
