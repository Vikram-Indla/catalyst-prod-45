    ...
    <div className="px-8 pt-5 pb-0" style={{ borderBottom: '1px solid var(--bd-subtle, #292929)' }}>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          <button className="p-1.5 rounded hover:bg-[var(--hover, #1F1F1F)] transition-colors duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" aria-label="Star project">
            <Star className="w-4 h-4" style={{ color: 'var(--fg-3)' }} />
          </button>
          <button className="p-1.5 rounded hover:bg-[var(--hover, #1F1F1F)] transition-colors duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" aria-label="Share project">
            <Share2 className="w-4 h-4" style={{ color: 'var(--fg-3)' }} />
          </button>
          <button className="p-1.5 rounded hover:bg-[var(--hover, #1F1F1F)] transition-colors duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" aria-label="More options">
        ...
        {TABS.map(tab => {
          ...
          return (
            <button
              ...
              className="px-4 py-2 text-[13px] transition-colors duration-[80ms] relative focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]"
              style={{
                color: isActive ? 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' : 'var(--ds-text-subtlest, #6b6e76)',
            ...
            >
              {tab.label}
              {isActive && (
                <div className="absolute bottom-0 left-0 right-0" style={{ height: 2, backgroundColor: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' }} />
              )}
            </button>
          );
        })}
