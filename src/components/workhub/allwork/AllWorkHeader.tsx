  ...
  return (
    <div className="px-8 pt-5 pb-0" style={{ borderBottom: '1px solid var(--bd-subtle, #292929)' }}>
      ...
      <nav className="flex items-center gap-1.5 mb-2" aria-label="Breadcrumb">
        <a href="#" className="text-[12px] hover:underline" style={{ color: 'var(--cp-blue)', fontFamily: 'var(--ds-font-family-body)' }}>Projects</a>
        <span className="text-[12px]" style={{ color: 'var(--fg-3)' }} aria-hidden="true">/</span>
        <span className="text-[12px]" style={{ color: 'var(--fg-3)', fontFamily: 'var(--ds-font-family-body)' }}>Senaei BAU</span>
        <span className="text-[12px]" style={{ color: 'var(--fg-3)' }} aria-hidden="true">/</span>
        <span className="text-[12px] font-medium" style={{ color: 'var(--fg-1)', fontFamily: 'var(--ds-font-family-body)' }} aria-current="page">All Work</span>
      </nav>
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[20px] font-semibold" style={{ color: 'var(--fg-1)', letterSpacing: '-0.01em', fontFamily: 'var(--ds-font-family-body)' }}>
            Senaei BAU
          </h1>
        </div>
