...
const HUB_COLORS: Record<string, { border: string; text: string; bg: string }> = {
  ...
  incident: { border: 'var(--sem-danger)', text: 'var(--sem-danger)', bg: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))' },
};
        ...
        >
          <div className="flex justify-center" role="columnheader">
            <input
              ...
              className="w-4 h-4 rounded cursor-pointer accent-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]"
          ...
          {COLUMNS.slice(1).map(col => (
            <button
              ...
              className="flex items-center gap-1 text-left focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))] focus-visible:outline-offset-2 rounded"
              style={{
                fontSize: '10.5px',
                fontWeight: 650,
    ...
    >
      ...
      <div className="flex items-center gap-1.5 px-2 min-w-0" style={{ paddingLeft: `${8 + node.depth * 28}px` }}>
        ...
        {hasChildren ? (
          <button
            ...
            className="w-4 h-4 flex items-center justify-center shrink-0 rounded hover:bg-[rgba(128,128,128,0.12)] transition-all duration-150 focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]"
      ...
      <div className="flex items-center gap-1 px-2 min-w-0">
        ...
        <div className="opacity-0 group-hover:opacity-100 flex items-center gap-0.5 shrink-0 ml-auto transition-opacity duration-[80ms]">
          <button className="p-0.5 rounded hover:bg-[rgba(128,128,128,0.12)] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" title="Open in new tab" aria-label="Open in new tab" onClick={e => e.stopPropagation()}>
            <ExternalLink className="w-3.5 h-3.5" style={{ color: 'var(--fg-3)' }} />
          </button>
          <button className="p-0.5 rounded hover:bg-[rgba(128,128,128,0.12)] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" title="Add child" aria-label="Add child item" onClick={e => e.stopPropagation()}>
      ...
      <div className="flex items-center gap-1.5 px-2 min-w-0">
        ...
        <button
          className="ml-auto opacity-0 group-hover:opacity-100 p-1 rounded hover:bg-[rgba(128,128,128,0.12)] shrink-0 transition-opacity duration-[80ms] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]"
