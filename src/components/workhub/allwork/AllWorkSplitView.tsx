...
const PRIORITY_COLORS: Record<string, string> = {
  Highest: 'var(--ds-text-danger)', High: 'var(--ds-text-warning)', Medium: 'var(--ds-text-brand)', Low: 'var(--ds-text-success)', Lowest: 'var(--ds-text-subtlest)',
};

const AVATAR_COLORS = ['var(--ds-text-discovery)', 'var(--ds-text-warning)', 'var(--ds-text-success)', 'var(--ds-text-danger)', 'var(--ds-text-discovery)'];
...
export function AllWorkSplitView({ items, selectedItemKey, onSelectItem, sortField, sortDir, onSort, projectName = 'Senaei BAU' }: Props) {
  ...
  return (
    <div className="flex h-full gap-0 rounded border overflow-hidden" style={{ borderColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--bd-default, var(--cp-ink-1))', borderRadius: 4 }}>
      {/* Left card list — 320px */}
      <div className="flex flex-col" style={{ width: 320, borderRight: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))', backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : 'var(--bg-app)' }}>
        <div className="flex items-center justify-between px-3 py-2" style={{ borderBottom: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))' }}>
          ...
          <div className="relative flex items-center gap-0.5" ref={sortRef}>
            <button
              ...
              className="flex items-center gap-1 text-[12px] px-1.5 py-0.5 rounded transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
              style={{
                color: 'var(--cp-text-secondary, var(--ds-text-subtlest))',
            ...
            <button
              ...
              className="p-1 rounded transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
              style={{
                color: 'var(--cp-text-secondary, var(--ds-text-subtlest))',
                background: 'none',
                border: 'none',
            ...
            {sortOpen && (
              <div
                ...
                style={{
                  borderColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--bd-default, var(--cp-ink-1))',
                  backgroundColor: isDark ? 'var(--cp-bg-surface, var(--cp-ink-1, var(--ds-surface)))' : 'var(--bg-app)',
                }}
                role="listbox"
                ...
                {SORT_OPTIONS.map(opt => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-1.5 text-[12px] text-left transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
                      style={{
                        color: isDark ? 'var(--ds-text, var(--cp-bg-neutral))' : 'var(--fg-1)',
                        fontFamily: 'var(--cp-font-body)',
                        background: 'none',
                        border: 'none',
                        cursor: 'pointer',
                    ...
                    >
                      <span>{opt.label}</span>
                      {isSelected && <Check className="w-3 h-3" style={{ color: 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' }} />}
                    </button>
                  );
                })}
              </div>
        ...
        <div className="px-3 py-2 text-[11px]" style={{ color: 'var(--fg-3)', borderTop: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))', fontFamily: 'var(--cp-font-mono)' }}>
      ...
      {/* Detail panel */}
      {currentItem ? (
        <div className="flex-1 flex flex-col overflow-hidden" style={{ backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : 'var(--bg-app)' }}>
          ...
          <nav
            ...
            style={{
              ...
              fontFamily: 'var(--cp-font-body)',
              borderBottom: isDark ? '1px solid var(--ds-text)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))',
              backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : 'var(--bg-app)',
              minHeight: 32,
              flexShrink: 0,
            }}
          >
            <span style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>Projects</span>
            <span aria-hidden="true" style={{ color: 'var(--cp-border-strong, var(--ds-border))' }}>/</span>
            <span style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>{projectName}</span>
            <span aria-hidden="true" style={{ color: 'var(--cp-border-strong, var(--ds-border))' }}>/</span>
            {panelStack.length > 1 ? (
              <>
                  ...
                  return (
                    <Fragment key={item.issue_key}>
                      <button
                        ...
                        className="transition-colors duration-80 hover:underline focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] rounded-sm"
                        style={{
                          background: 'none',
                          border: 'none',
                          padding: 0,
          ...
          {/* Detail header */}
          <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))' }}>
            <div className="flex items-center gap-2">
              {/* Back button */}
              {canGoBack && (
                <button
                  onClick={handleBack}
                  className="flex items-center gap-1 px-2 py-1 rounded-md transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
            ...
            <div className="flex items-center gap-1">
              {!canGoBack && (
                <>
                  <button onClick={goPrev} disabled={selectedIdx <= 0} className="p-1 rounded hover:bg-[var(--hover,var(--ds-text))] disabled:opacity-30 focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]" aria-label="Previous item">
                    <ChevronLeft className="w-4 h-4" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }} />
                  </button>
                  <span className="text-[11px]" style={{ color: 'var(--fg-3)', fontFamily: 'var(--cp-font-mono)' }}>{selectedIdx + 1}/{items.length}</span>
                  <button onClick={goNext} disabled={selectedIdx >= items.length - 1} className="p-1 rounded hover:bg-[var(--hover,var(--ds-text))] disabled:opacity-30 focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]" aria-label="Next item">
                    <ChevronRight className="w-4 h-4" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }} />
                  </button>
                </>
              )}
            </div>
          ...
          <div
            ...
            style={{ borderBottom: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))' }}
            role="tablist"
          >
            {TABS.map(tab => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2.5 transition-colors duration-80 focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
                  style={{
                    fontSize: 'var(--ds-font-size-200)', fontWeight: isActive ? 600 : 400,
                    color: isActive ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'var(--cp-text-tertiary, var(--ds-text-subtlest))',
                    borderBottom: isActive ? '2px solid var(--ds-link)' : '2px solid transparent',
                    marginBottom: -1, fontFamily: 'var(--cp-font-body)',
                    background: 'none', border: 'none', borderBottomStyle: 'solid',
                    borderBottomWidth: 2, borderBottomColor: isActive ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'transparent',
                    cursor: 'pointer',
                  }}
                  role="tab"
          ...
          <div className="flex flex-1 overflow-hidden">
            {/* Main detail content */}
            <div className="flex-1 overflow-y-auto px-5 py-4" style={{ backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : undefined }}>
              {/* ─── DETAILS TAB ─── */}
              {activeTab === 'details' && (
                <>
                  ...
                  <div className="relative mb-4" ref={addRef}>
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[12px] px-2 h-7 rounded border transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
                      style={{
                        borderColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--bd-default, var(--cp-ink-1))',
                        color: isDark ? 'var(--ds-text-subtlest)' : 'var(--fg-2)',
                        backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : 'var(--bg-app)',
                        fontFamily: 'var(--cp-font-body)',
                        cursor: 'pointer',
                      }}
                      ...
                      >
                        {[
                          ...
                          <button
                            ...
                            className="w-full flex items-center gap-2 px-3 py-1.5 text-[12px] text-left transition-colors duration-80 hover:bg-[var(--hover,var(--ds-text))] focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
                            style={{
                              color: isDark ? 'var(--ds-text, var(--cp-bg-neutral))' : 'var(--fg-1)',
                              fontFamily: 'var(--cp-font-body)',
                              background: 'none',
                            ...
                            role="menuitem"
                          >
                            <span style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>{action.icon}</span>
                  ...
                  {/* Key details */}
                  <div className="mb-6">
                    <h3 className="text-[11px] uppercase font-semibold mb-2" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em', fontFamily: 'var(--cp-font-body)' }}>
                      Key Details
                    </h3>
                  ...
                  {/* Description */}
                  <div className="mb-6">
                    <h3 className="text-[11px] uppercase font-semibold mb-2" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>
                      Description
                    </h3>
                    {currentItem.description_text ? (
                      <p className="text-[13px] leading-[20px]" style={{ color: 'var(--cp-text-secondary, var(--ds-icon))', fontFamily: 'var(--cp-font-body)' }}>
                        {currentItem.description_text}
                      </p>
                    ) : (
                  ...
                  {/* Activity section */}
                  <div>
                    <div className="flex items-center gap-4 mb-3" style={{ borderBottom: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))', paddingBottom: 8 }}>
                      {(['all', 'comments', 'history', 'worklog'] as const).map(tab => (
                        <button
                          key={tab}
                          onClick={() => setActivityTab(tab)}
                          className="text-[12px] pb-1 capitalize transition-colors duration-80 focus-visible:outline-2 focus-visible:outline-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
                          style={{
                            color: activityTab === tab ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'var(--cp-text-tertiary, var(--ds-text-subtlest))',
                            fontWeight: activityTab === tab ? 600 : 400,
                            borderBottom: activityTab === tab ? '2px solid var(--ds-link)' : '2px solid transparent',
                            fontFamily: 'var(--cp-font-body)',
                            background: 'none', border: 'none', borderBottomStyle: 'solid',
                            borderBottomWidth: 2, borderBottomColor: activityTab === tab ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'transparent',
                            cursor: 'pointer',
                          }}
                          role="tab"
                    ...
                    {activityTab === 'comments' ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-[13px]" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>No activity yet</p>
                      </div>
                    )}

                    {/* Comment input */}
                    <div className="flex items-start gap-2 mt-4">
                      <div className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-bold text-white shrink-0" style={{ backgroundColor: 'var(--ds-background-discovery-bold)' }}>
                        U
                      </div>
                      <div className="flex-1 rounded-lg border px-3 py-2 focus-within:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] transition-colors duration-80" style={{ borderColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--bd-default, var(--cp-ink-1))' }}>
                        <input
                          ref={commentInputRef}
                          id="aw-comment-input"
                          type="text"
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span className="text-[10px] px-2 py-0.5 rounded-full cursor-pointer hover:bg-[var(--bd-subtle,var(--cp-ink-1))] transition-colors duration-80" style={{ backgroundColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--hover)', color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>
                            Status update...
                          </span>
                          <span className="text-[10px] px-2 py-0.5 rounded-full cursor-pointer hover:bg-[var(--bd-subtle,var(--cp-ink-1))] transition-colors duration-80" style={{ backgroundColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--hover)', color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))' }}>
                            Thanks!
                    ...
                    <p className="text-[10px] mt-2 ml-9" style={{ color: 'var(--fg-3)' }}>
                      <b>Tip:</b> press <kbd className="px-1 py-0.5 rounded text-[10px]" style={{ backgroundColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--hover)', border: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1))' }}>M</kbd> to comment
                    </p>
                  </div>
                </>
              )}
            ...
            <div className="overflow-y-auto py-4 px-4" style={{ width: 260, borderLeft: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))', backgroundColor: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, var(--ds-surface))))' }}>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Assignee</span>
                {currentItem.assignee_display_name ? (
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold text-white" style={{ backgroundColor: 'var(--ds-background-discovery-bold)' }}>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Priority</span>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full" style={{ backgroundColor: PRIORITY_COLORS[currentItem.priority] || 'var(--cp-blue)' }} />
                  <span className="text-[13px]" style={{ color: 'var(--fg-1)' }}>{currentItem.priority}</span>
                </div>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Fix Version</span>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Reporter</span>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Labels</span>
                {currentItem.labels?.length ? (
                  <div className="flex flex-wrap gap-1">
                    {currentItem.labels.map(l => (
                      <span key={l} className="text-[11px] px-2 py-0.5 rounded" style={{ backgroundColor: isDark ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--hover)', color: 'var(--cp-text-secondary, var(--ds-icon))' }}>{l}</span>
                    ))}
                  </div>
                ) : (
              ...
              <div className="mt-6 pt-4" style={{ borderTop: isDark ? '1px solid var(--ds-background-neutral)' : '1px solid var(--bd-subtle, var(--cp-ink-1, var(--ds-text)))' }}>
                <div className="mb-2">
                  <span className="text-[11px] uppercase font-semibold block mb-0.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Created</span>
                  <span className="text-[12px]" style={{ color: 'var(--cp-text-secondary, var(--ds-icon))', fontFamily: 'var(--cp-font-mono)' }} title={currentItem.jira_created_at || ''}>
                    {formatRel(currentItem.jira_created_at)}
                  </span>
                </div>
                <div>
                  <span className="text-[11px] uppercase font-semibold block mb-0.5" style={{ color: 'var(--cp-text-tertiary, var(--ds-text-subtlest))', letterSpacing: '0.05em' }}>Updated</span>
                  <span className="text-[12px]" style={{ color: 'var(--cp-text-secondary, var(--ds-icon))', fontFamily: 'var(--cp-font-mono)' }} title={currentItem.jira_updated_at || ''}>
        ...
        <div className="flex-1 flex items-center justify-center" style={{ backgroundColor: isDark ? 'var(--cp-bg-page, var(--ds-surface))' : 'var(--bg-1)' }}>
