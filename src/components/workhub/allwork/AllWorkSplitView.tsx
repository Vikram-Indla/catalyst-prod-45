...
export function AllWorkSplitView({ items, selectedItemKey, onSelectItem }: Props) {
  ...
  return (
    <div className="flex h-full gap-0 rounded border overflow-hidden" style={{ borderColor: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(15,23,42,0.12)', borderRadius: 4 }}>
      {/* Left card list — 320px */}
      <div className="flex flex-col" style={{ width: 320, borderRight: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)', backgroundColor: isDark ? '#1A1714' : 'var(--bg-app)' }}>
        <div className="flex items-center justify-between px-3 py-2" style={{ borderBottom: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}>
          <button className="flex items-center gap-1 text-[12px]" style={{ color: isDark ? '#A09890' : '#6b6e76', fontFamily: 'Inter, sans-serif' }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  backgroundColor: isActive ? 'rgba(37,99,235,0.08)' : isDark ? '#1A1714' : 'var(--bg-app)',
        ...
        <div className="px-3 py-2 text-[11px]" style={{ color: 'var(--fg-3)', borderTop: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)', fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      {/* Detail panel */}
      {currentItem ? (
        <div className="flex-1 flex flex-col overflow-hidden" style={{ backgroundColor: isDark ? '#1A1714' : 'var(--bg-app)' }}>
          {/* Detail header */}
          <div className="flex items-center justify-between px-5 py-3" style={{ borderBottom: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}>
              ...
              {!canGoBack && (
                <>
                  <button onClick={goPrev} disabled={selectedIdx <= 0} className="p-1 rounded hover:bg-[rgba(15,23,42,0.04)] disabled:opacity-30 focus-visible:outline-2 focus-visible:outline-[#2563EB]" aria-label="Previous item">
                    <ChevronLeft className="w-4 h-4" style={{ color: isDark ? '#6B6560' : '#6b6e76' }} />
                  </button>
                  ...
                  <button onClick={goNext} disabled={selectedIdx >= items.length - 1} className="p-1 rounded hover:bg-[rgba(15,23,42,0.04)] disabled:opacity-30 focus-visible:outline-2 focus-visible:outline-[#2563EB]" aria-label="Next item">
                    <ChevronRight className="w-4 h-4" style={{ color: isDark ? '#6B6560' : '#6b6e76' }} />
                  </button>
                </>
              )}
            </div>
          ...
          {panelStack.length > 1 && (
            <div
              ...
              style={{ fontSize: 12, color: 'var(--fg-3)', borderBottom: isDark ? '1px solid rgba(255,255,255,0.05)' : '1px solid rgba(15,23,42,0.06)', backgroundColor: isDark ? '#232019' : 'var(--bg-1)' }}
            >
          ...
          <div
            ...
            style={{ borderBottom: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}
            role="tablist"
          >
            {TABS.map(tab => {
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: isActive ? '#1558bc' : isDark ? '#6B6560' : '#6b6e76',
                  ...
                  {tab.count !== undefined && (
                    <span
                      style={{
                        ...
                        backgroundColor: isActive ? 'rgba(21,88,188,0.10)' : isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.06)',
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4">
              ...
              {activeTab === 'details' && (
                <>
                  ...
                  {/* Key details */}
                  <div className="mb-6">
                    <h3 className="text-[11px] uppercase font-semibold mb-2" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em', fontFamily: 'Inter, sans-serif' }}>
                      Key Details
                    </h3>
                  ...
                  {/* Description */}
                  <div className="mb-6">
                    <h3 className="text-[11px] uppercase font-semibold mb-2" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>
                      Description
                    </h3>
                    {currentItem.description_text ? (
                      <p className="text-[13px] leading-[20px]" style={{ color: isDark ? '#A09890' : '#44546f', fontFamily: 'Inter, sans-serif' }}>
                        {currentItem.description_text}
                      </p>
                    ) : (
                  ...
                  {/* Activity section */}
                  <div>
                    <div className="flex items-center gap-4 mb-3" style={{ borderBottom: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)', paddingBottom: 8 }}>
                      {(['all', 'comments', 'history', 'worklog'] as const).map(tab => (
                        <button
                          ...
                          style={{
                            color: activityTab === tab ? '#1558bc' : isDark ? '#6B6560' : '#6b6e76',
                    ...
                    {activityTab === 'comments' ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="text-[13px]" style={{ color: isDark ? '#6B6560' : '#6b6e76' }}>No activity yet</p>
                      </div>
                    )}
                    ...
                    <div className="flex items-start gap-2 mt-4">
                      ...
                      <div className="flex-1 rounded-lg border px-3 py-2 focus-within:border-[#2563EB] transition-colors duration-[80ms]" style={{ borderColor: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(15,23,42,0.12)' }}>
                        <input
                          type="text"
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span className="text-[10px] px-2 py-0.5 rounded-full cursor-pointer hover:bg-[rgba(15,23,42,0.06)] transition-colors duration-[80ms]" style={{ backgroundColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.04)', color: isDark ? '#6B6560' : '#6b6e76' }}>
                            Status update...
                          </span>
                          <span className="text-[10px] px-2 py-0.5 rounded-full cursor-pointer hover:bg-[rgba(15,23,42,0.06)] transition-colors duration-[80ms]" style={{ backgroundColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.04)', color: isDark ? '#6B6560' : '#6b6e76' }}>
                            Thanks!
                    ...
                    <p className="text-[10px] mt-2 ml-9" style={{ color: 'var(--fg-3)' }}>
                      <b>Pro tip:</b> press <kbd className="px-1 py-0.5 rounded text-[10px]" style={{ backgroundColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.04)', border: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}>M</kbd> to comment
                    </p>
                  </div>
                </>
              )}
            ...
            <div className="overflow-y-auto py-4 px-4" style={{ width: 260, borderLeft: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}>
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Status</span>
                <StatusLozenge status={currentItem.status} />
              </div>

              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Assignee</span>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Priority</span>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full" style={{ backgroundColor: PRIORITY_COLORS[currentItem.priority] || 'var(--cp-blue)' }} />
                  <span className="text-[13px]" style={{ color: 'var(--fg-1)' }}>{currentItem.priority}</span>
                </div>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Fix Version</span>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Reporter</span>
              ...
              <div className="mb-4">
                <span className="text-[11px] uppercase font-semibold block mb-1.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Labels</span>
                {currentItem.labels?.length ? (
                  <div className="flex flex-wrap gap-1">
                    {currentItem.labels.map(l => (
                      <span key={l} className="text-[11px] px-2 py-0.5 rounded" style={{ backgroundColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(15,23,42,0.04)', color: isDark ? '#A09890' : '#44546f' }}>{l}</span>
                    ))}
                  </div>
                ) : (
              ...
              <div className="mt-6 pt-4" style={{ borderTop: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(15,23,42,0.08)' }}>
                <div className="mb-2">
                  <span className="text-[11px] uppercase font-semibold block mb-0.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Created</span>
                  <span className="text-[12px]" style={{ color: isDark ? '#A09890' : '#44546f', fontFamily: "'JetBrains Mono', monospace" }} title={currentItem.jira_created_at || ''}>
                    {formatRel(currentItem.jira_created_at)}
                  </span>
                </div>
                <div>
                  <span className="text-[11px] uppercase font-semibold block mb-0.5" style={{ color: isDark ? '#6B6560' : '#6b6e76', letterSpacing: '0.05em' }}>Updated</span>
                  <span className="text-[12px]" style={{ color: isDark ? '#A09890' : '#44546f', fontFamily: "'JetBrains Mono', monospace" }} title={currentItem.jira_updated_at || ''}>
        ...
        <div className="flex-1 flex items-center justify-center" style={{ backgroundColor: isDark ? '#1A1714' : 'var(--bg-1)' }}>
