      ...
      {minimized && (
        <div
          style={{
            ...
            boxShadow: token('elevation.shadow.overlay', '0 -2px 8px var(--ds-shadow-raised)'),
            display: 'flex',
            alignItems: 'center',
            gap: 8,
            padding: '8px 16px',
      ...
      {!minimized && (
        <div
          ...
          style={{
            ...
            inset: 0,
            zIndex: 300,
            background: token('color.blanket', 'var(--ds-shadow-raised)'),
            display: 'flex',
            alignItems: 'center',
        ...
        >
          <div
            ...
            style={{
              ...
              background: token('elevation.surface.overlay', 'var(--ds-surface)'),
              borderRadius: 8,
              boxShadow: token('elevation.shadow.overlay', '0 8px 16px -4px var(--ds-shadow-raised), 0 0 1px var(--ds-shadow-raised)'),
