  ...
  return (
    <FullscreenContext.Provider value={{
      ...
      {minimized && (
        ...
        >
          <span style={{ fontSize: 'var(--ds-font-size-400)', fontWeight: 500, color: token('color.text', 'var(--ds-text, #172B4D)'), flex: 1 }}>
            {modalTitle}
          </span>
          <button
            type="button"
      ...
      {!minimized && (
        <div
          ...
          style={{
            ...
            inset: 0,
            zIndex: 300,
            background: token('color.blanket', 'var(--ds-shadow-raised, rgba(9,30,66,0.54))'),
            display: 'flex',
            alignItems: 'center',
