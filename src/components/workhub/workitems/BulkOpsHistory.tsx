  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3" style={{ borderBottom: '1px solid var(--wh-border-light, #f1f5f9)' }}>
        <span className="text-sm font-semibold" style={{ color: 'var(--wh-text-primary, #0f172a)', fontFamily: 'var(--ds-font-family-body)' }}>
      ...
      {/* Entries */}
      <div className="overflow-y-auto flex-1" style={{ fontFamily: 'var(--ds-font-family-body)' }}>
        {isLoading ? (
