/**
 * AnalyticsPage — Analytics and reporting placeholder
 */
      ...
      <div className="flex flex-col items-center justify-center py-16 px-6">
        <div className="text-center max-w-2xl">
          ...
          <p className="text-base mb-8" style={{ color: 'var(--wh-text-secondary)' }}>
            Portfolio analytics — status distribution, velocity, trends
          </p>
          <div
          ...
          >
            <span className="text-sm font-medium">Coming in Phase 9</span>
          </div>
        </div>
      </div>
    </div>
