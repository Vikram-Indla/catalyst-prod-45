      ...
      <>
        <div className="awHeader">
          <div className="awCenterHeader">
            <div style={{ width: 80, height: 12, borderRadius: 3, background: 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))', marginBottom: 8 }} />
            <div style={{ width: '60%', height: 18, borderRadius: 3, background: 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))' }} />
          </div>
        </div>
        <div className="awBody" style={{ padding: 16 }}>
          {[1,2,3].map(i => (
            <div key={i} style={{ width: `${80 - i * 15}%`, height: 14, borderRadius: 3, background: 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))', marginBottom: 10 }} />
          ))}
        </div>
      </>
    );
      ...
      <div className="awBody">
        ...
        <div className="awSectionBody">
          ...
          <div className="awCommentRow" style={{ marginBottom: 16 }}>
            <div style={{
              width: 28, height: 28, borderRadius: '50%', background: 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))',
