      ...
      <div className="opacity-0 group-hover:opacity-100 flex items-center gap-0.5 shrink-0 transition-opacity">
        {onUnlink && (
          <button
            ...
            className={cn('p-1 rounded transition-colors', isDark ? 'hover:bg-[var(--ds-border,#292929)] text-[var(--ds-text-subtlest,#878787)]' : 'hover:bg-[var(--ds-border,var(--cp-border, #E2E8F0))] text-[var(--ds-text-accent-gray,#505258)]')}
          >
