        ...
        <div className={cn(
          ...
          <textarea
            ...
            className={cn(
              ...
              isDark ? 'text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))] placeholder:text-[var(--ds-text-subtlest,#878787)]' : 'text-[var(--ds-text,#292A2E)] placeholder:text-[var(--ds-text-subtlest,#878787)]',
            )}
            onKeyDown={(e) => {
