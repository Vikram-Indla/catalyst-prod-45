...
import { Copy, Check, X } from '@/lib/atlaskit-icons';
import {
    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          ...
          isDark
            ? 'border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] text-[var(--ds-text-subtlest,#A1A1A1)] hover:bg-[var(--ds-surface-overlay,#1F1F1F)]'
      ...
      {open && (
        <div
          ...
          className={cn(
            ...
            isDark ? 'bg-[var(--ds-surface-raised,#1A1A1A)] border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]' : 'bg-white border-[var(--ds-border,var(--cp-lozenge-grey-bg, #DFE1E6))]',
          )}
        >
            ...
            <div className="p-4">
              ...
              <textarea
                ...
                className={cn(
                  ...
                  isDark ? 'bg-[#111111] border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] text-[var(--ds-text,#EDEDED)]' : 'bg-[#F7F8F9] border-[var(--ds-border,var(--cp-lozenge-grey-bg, #DFE1E6))] text-[var(--ds-text,#292A2E)]',
                )}
              />
            </div>
          </div>
