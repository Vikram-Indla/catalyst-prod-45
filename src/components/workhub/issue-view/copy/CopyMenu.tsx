    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          ...
          isDark
            ? 'border-[var(--ds-border,var(--ds-border, #2E2E2E))] text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))] hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))]'
            : 'border-[var(--ds-border,var(--ds-border, #DFE1E6))] text-[var(--ds-text-accent-gray, #505258)] hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))]',
        )}
      >
      ...
      {open && (
        <div
          ...
          className={cn(
            ...
            isDark ? 'bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] border-[var(--ds-border,var(--ds-border, #2E2E2E))]' : 'bg-white border-[var(--ds-border,var(--ds-border, #DFE1E6))]',
          )}
        >
          {menuItems.map(({ kind, label }) => (
            <button
              ...
              className={cn(
                ...
                isDark
                  ? 'text-[var(--ds-text,var(--ds-text, #EDEDED))] hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))] disabled:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]'
                  : 'text-[var(--ds-text, #292A2E)] hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))] disabled:text-[var(--ds-text-subtlest, #6B6E76)]',
              )}
            >
              {label}
            </button>
        ...
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/40">
          <div className={cn(
            ...
            <div className={cn(
              ...
              <span className={cn('font-body text-sm font-medium', isDark ? 'text-[var(--ds-text,var(--ds-text, #EDEDED))]' : 'text-[var(--ds-text, #292A2E)]')}>
                Copy manually
              </span>
              <button onClick={() => setFallbackText(null)} className={cn('p-1 rounded', isDark ? 'hover:bg-[var(--ds-border,var(--ds-border, #292929))]' : 'hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))]')}>
                <X className="w-4 h-4" />
              </button>
            </div>
            <div className="p-4">
              <p className={cn('font-body text-xs mb-2', isDark ? 'text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]' : 'text-[var(--ds-text-subtlest, #6B6E76)]')}>
              ...
              <textarea
                ...
                className={cn(
                  ...
                  isDark ? 'bg-[#111111] border-[var(--ds-border,var(--ds-border, #2E2E2E))] text-[var(--ds-text,var(--ds-text, #EDEDED))]' : 'bg-[#F7F8F9] border-[var(--ds-border,var(--ds-border, #DFE1E6))] text-[var(--ds-text, #292A2E)]',
                )}
              />
            </div>
          </div>
