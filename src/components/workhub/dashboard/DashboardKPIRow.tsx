...
const KPI_CARDS: KPICardDef[] = [
  {
    ...
    icon: Rocket,
    iconBg: 'var(--ds-background-information, #E9F2FF)',
  ...
  },
  {
    ...
    icon: AlertTriangle,
    iconBg: 'var(--ds-background-danger, #FFECEB)',
  ...
  },
  {
    ...
    icon: FileStack,
    iconBg: 'var(--ds-background-success, #DFFCF0)',
        ...
        return (
          <div
            ...
            style={{
              background: 'var(--cp-float)',
              border: '1px solid var(--divider)',
              borderLeft: dangerBorder ? '4px solid var(--ds-background-danger-bold, #ef4444)' : '1px solid var(--divider)',
              borderRadius: 'var(--wh-radius-xl, 16px)',
              padding: 20,
