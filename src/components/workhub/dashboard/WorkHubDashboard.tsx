      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 24px 48px' }}>
        ...
        {kpisQuery.isError && (
          <div style={{
            ...
            border: '1px solid var(--ds-background-danger, #FFECEB)',
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 'var(--ds-font-size-300)', color: 'var(--ds-text-danger, #AE2A19)', marginTop: 4 }}>{(kpisQuery.error as Error)?.message}</div>
            </div>
            <button
