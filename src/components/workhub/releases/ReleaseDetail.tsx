    ...
    <div style={{ padding: '24px 32px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16, marginLeft: 52 }}>
        <span style={{
          ...
          color: statusLabel === 'Completed' ? '#047857' : statusLabel === 'Active' ? 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1d4ed8))' : statusLabel === 'At Risk' ? 'var(--ds-text-danger, var(--ds-text-danger, #991b1b))' : 'var(--fg-2)',
        }}>
          {statusLabel}
        </span>
        {release.releaseDate && (
      ...
      {release.projects.length > 0 && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginLeft: 52, marginBottom: 16, flexWrap: 'wrap' }}>
          ...
          {release.projects.map((proj, i) => {
            const colors = ['var(--ds-text-brand, var(--ds-text-brand, #2563eb))', '#7c3aed', '#0d9488', 'var(--ds-text-warning, var(--ds-text-warning, #d97706))', 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))', '#0891b2', 'var(--ds-text-success, var(--ds-text-success, #16a34a))', '#6366f1'];
