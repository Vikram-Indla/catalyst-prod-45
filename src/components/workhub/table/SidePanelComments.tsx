  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 8 }}>
        ...
        {comments.map((c: any) => (
          <div key={c.id} style={{
            background: 'var(--bg-app)', border: '1px solid rgba(15,23,42,0.06)', borderRadius: 6,
      ...
      {/* Input */}
      <div style={{ borderTop: '1px solid rgba(15,23,42,0.08)', padding: '12px 0 0', background: 'var(--bg-app)' }}>
        <textarea
