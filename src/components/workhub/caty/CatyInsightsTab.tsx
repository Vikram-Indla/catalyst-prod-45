      ...
      <div className="p-4 border-b" style={{ borderColor: 'var(--wh-border)' }}>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div
            className="p-3 rounded-lg border flex flex-col items-center justify-center"
            style={{
              backgroundColor: summary.dueThisWeek > 0 ? '#fef3c7' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #f8fafc))',
          ...
          >
            <span
              className="text-lg font-bold"
              style={{
                color: summary.dueThisWeek > 0 ? 'var(--ds-text-warning, var(--ds-text-warning, #d97706))' : 'var(--wh-text-primary)',
            ...
            <span
              className="text-xs font-medium"
              style={{
                color: summary.dueThisWeek > 0 ? 'var(--ds-text-warning, var(--ds-text-warning, #d97706))' : 'var(--wh-text-secondary)',
              }}
            >
              Due This Week
            </span>
