    ...
    <div>
      ...
      {risks.length === 0 ? (
        ...
        <div className="space-y-3">
          {risks.map((risk: any) => {
            ...
            return (
              <div key={risk.id} className={`bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border border-zinc-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] border-l-4 ${sev.border} rounded-lg p-4`}>
      ...
      {showAddRisk && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-[420px] max-w-[90vw] z-[301] bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] shadow-xl flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-5">
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowCatDropdown(v => !v)}
                  className="w-full flex items-center justify-between border border-zinc-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-lg px-3 py-2.5 text-sm text-zinc-700 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] hover:bg-zinc-50 dark:hover:bg-[var(--ds-surface,#0A0A0A)]">
