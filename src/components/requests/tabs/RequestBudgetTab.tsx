  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-sm font-semibold text-zinc-900 dark:text-[#EDEDED]">Budget</h3>
          ...
          {budgetItems.map((item: any) => {
            ...
            return (
              <div key={item.id} className="bg-white dark:bg-[#1A1A1A] border border-zinc-200 dark:border-[#2E2E2E] rounded-lg p-4 hover:border-zinc-300 transition-colors">
                ...
                <p className="text-sm font-medium text-zinc-900 dark:text-[#EDEDED] mb-2">{item.description}</p>
