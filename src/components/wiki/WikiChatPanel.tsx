  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 13, fontWeight: 700, color: 'var(--fg-1)' }}>Ask Catalyst</div>
              ...
              <div style={{ marginTop: 6, display: 'flex', flexDirection: 'column', gap: 3 }}>
                {m.sources.map((s, i) => (
                  ...
                  >
                    ...
                    {s.confidence != null && (
                      <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 9, color: 'var(--fg-3)' }}>
      ...
      <div style={{
        ...
        <input ref={inputRef} value={input} onChange={e => setInput(e.target.value)}
          ...
          style={{
            ...
            border: `0.75px solid ${border}`, outline: 'none', fontFamily: 'var(--ds-font-family-body)',
