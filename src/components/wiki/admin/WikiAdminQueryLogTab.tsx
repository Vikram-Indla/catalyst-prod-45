...
export function WikiAdminQueryLogTab() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      {rows.length === 0 ? (
        <EmptyState
          icon={<Search style={{ width: 28, height: 28, color: 'var(--cp-text-tertiary, rgba(237,237,237,0.40))' }} />}
        ...
        <>
          ...
          {totalPages > 1 && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'flex-end', fontFamily: 'Geist, -apple-system, sans-serif', fontSize: 12 }}>
              <span style={{ color: 'var(--cp-text-tertiary, rgba(237,237,237,0.40))', marginInlineEnd: 8 }}>{total} queries</span>
