        ...
        {STATUS_OPTIONS.map(s => (
          <button key={s} onClick={() => { setStatusFilter(s); setPage(0); }}
            style={{
              ...
              color: statusFilter === s ? 'var(--ds-surface, #fff)' : 'var(--cp-text-secondary, #334155)',
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: '8px 12px' }}>
                        <span style={{ fontFamily: 'var(--cp-font-mono)', fontSize: 11, padding: '2px 6px', borderRadius: 4, background: 'var(--cp-bg-sunken, #F1F5F9)', color: 'var(--cp-text-secondary, #334155)' }}>{p.domain_code ?? '—'}</span>
                      </td>
                      <td style={{ padding: '8px 12px' }}><PageStatusLoz status={p.status} /></td>
                      <td style={{ padding: '8px 12px', fontFamily: 'var(--cp-font-mono)', fontSize: 11, color: isLowConf ? 'var(--sem-danger)' : 'var(--cp-text-primary, #0F172A)', fontWeight: isLowConf ? 700 : 400 }}>
                      ...
                      <td style={{ padding: '8px 12px', display: 'flex', gap: 4, alignItems: 'center' }}>
                        ...
                        <select
                          ...
                          style={{
                            ...
                            fontFamily: 'var(--cp-font-body)', color: 'var(--cp-text-secondary, #334155)',
                            outline: 'none',
                          }}
                          onFocus={(e) => { e.currentTarget.style.boxShadow = '0 0 0 2px var(--cp-primary-60, #2563EB)'; }}
                          onBlur={(e) => { e.currentTarget.style.boxShadow = 'none'; }}
