      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <h2 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 14, fontWeight: 700, margin: 0, color: isDark ? '#EDEDED' : 'var(--fg-1)' }}>{qr.title}</h2>
            <div style={{ display: 'flex', gap: 12, marginTop: 4, fontSize: 10 }}>
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', color: 'var(--cp-blue)', fontWeight: 500 }}>{qr.domain_code}</span>
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', color: isDark ? '#878787' : 'var(--fg-3)' }}>{qr.steps} steps</span>
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', color: isDark ? '#878787' : 'var(--fg-3)', display: 'flex', alignItems: 'center', gap: 3 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
          ...
          <div style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 12, fontWeight: 600, color: isDark ? '#EDEDED' : 'var(--fg-1)', marginBottom: 16 }}>Steps</div>
            ...
            {Array.from({ length: qr.steps ?? 0 }).map((_, i) => (
              <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                <div style={{
                  ...
                  fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, fontWeight: 700, color: 'var(--cp-blue)',
                }}>{i + 1}</div>
