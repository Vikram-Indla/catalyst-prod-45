  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: isDark ? 'var(--cp-bg-surface, var(--cp-ink-1))' : 'var(--cp-float)', zIndex: 61, boxShadow: isDark ? '-4px 0 24px var(--ds-shadow-raised, rgba(0,0,0,0.3))' : '-4px 0 24px var(--ds-shadow-raised, rgba(0,0,0,0.08))',
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <h2 style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 'var(--ds-font-size-400)', fontWeight: 700, margin: 0, color: isDark ? 'var(--ds-text, var(--cp-bg-neutral))' : 'var(--fg-1)' }}>{qr.title}</h2>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
          {qr.description ? (
            <p style={{ fontSize: 'var(--ds-font-size-200)', color: isDark ? 'var(--ds-text-subtlest)' : 'var(--fg-2)', lineHeight: 1.6, marginBottom: 24 }}>{qr.description}</p>
          ) : (
            <p style={{ fontSize: 'var(--ds-font-size-200)', color: isDark ? 'var(--ds-text-subtlest, var(--cp-text-secondary))' : 'var(--fg-4)', fontStyle: 'italic', marginBottom: 24 }}>No detailed description available yet.</p>
          )}

          <div style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 'var(--ds-font-size-200)', fontWeight: 600, color: isDark ? 'var(--ds-text, var(--cp-bg-neutral))' : 'var(--fg-1)', marginBottom: 16 }}>Steps</div>
