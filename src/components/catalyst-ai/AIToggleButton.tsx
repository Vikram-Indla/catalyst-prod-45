  ...
  return (
    <button
      ...
      className={cn(
        ...
        "shadow-[0_2px_8px_var(--ds-background-success)]",
        "transition-all duration-200 ease-out",
        "hover:translate-y-[-2px] hover:shadow-[0_4px_16px_var(--ds-background-success)]",
        isActive && "shadow-[0_0_0_3px_var(--ds-background-success),0_4px_16px_var(--ds-background-success)]",
        className
      )}
    >
