  ...
  return (
    <button
      ...
      className={cn(
        ...
        "shadow-[0_2px_8px_var(--ds-background-success, rgba(13,148,136,0.3))]",
        "transition-all duration-200 ease-out",
        "hover:translate-y-[-2px] hover:shadow-[0_4px_16px_var(--ds-background-success, rgba(13,148,136,0.4))]",
        isActive && "shadow-[0_0_0_3px_var(--ds-background-success, rgba(13,148,136,0.2)),0_4px_16px_var(--ds-background-success, rgba(13,148,136,0.4))]",
        className
      )}
    >
