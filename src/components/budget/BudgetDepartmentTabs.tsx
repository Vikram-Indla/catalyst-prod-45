          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive && [
                  "border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]",
                  "bg-gradient-to-br from-[var(--ds-background-information)] via-[var(--ds-background-information)] to-[var(--ds-background-information)]",
                  "shadow-sm"
                ],
                // Inactive with budget
                !isActive && hasBudget && [
                  "border-slate-200 bg-white",
                  "hover:border-[var(--ds-background-information)]",
                  "hover:shadow-sm"
                ],
            ...
            >
              ...
              {isActive && (
                <div className="absolute left-0 top-3 bottom-3 w-1 bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] rounded-full" />
              )}
              
              {/* Department Name */}
              <span className={cn(
                "text-xs font-bold uppercase tracking-wider mb-2",
                isActive ? "text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]" : "text-slate-500"
              )}>
                {d.name}
              </span>
              ...
              <span className={cn(
                ...
                isActive ? "text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]" : hasBudget ? "text-slate-800" : "text-slate-400"
              )}>
              ...
              <div className="flex items-center justify-center gap-1.5 text-xs">
                <span className={cn(
                  isActive ? "text-[var(--ds-background-information)]" : "text-slate-500"
                )}>
