        ...
        {departments.map(d => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute left-0 top-3 bottom-3 w-1 bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] rounded-full" />
              )}
              
              {/* Department Name */}
              <span className={cn(
                "text-xs font-bold uppercase tracking-wider mb-2",
                isActive ? "text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]" : "text-slate-500"
              )}>
                {d.name}
              </span>
              ...
              <span className={cn(
                ...
                isActive ? "text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]" : hasBudget ? "text-slate-800" : "text-slate-400"
              )}>
