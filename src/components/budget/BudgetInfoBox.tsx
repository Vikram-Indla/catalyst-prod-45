  ...
  return (
    <div className="flex items-start gap-3 p-4 bg-slate-50 border border-slate-200 rounded-xl mb-6">
      ...
      <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm text-slate-600">
        <span>
          <strong className="text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]">Insourced</strong> = CTC × months (Jan 2026 to contract/assignment end)
        </span>
        ...
        <span className="text-slate-300">•</span>
        <span>
          <strong className="text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]">Outsourced</strong> = Fixed contract
        </span>
      </div>
    </div>
  );
