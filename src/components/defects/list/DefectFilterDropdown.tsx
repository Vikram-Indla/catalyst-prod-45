...
export function getSourceOptions(): FilterOption[] {
  return [
    { value: 'jira', label: 'Jira', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' },
    { value: 'native', label: 'Catalyst', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748b))' },
  ];
}
