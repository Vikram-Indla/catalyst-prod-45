...
const AVATAR_COLOURS = ['var(--ds-text-brand, #2563EB)', '#0D9488', '#0284C7', 'var(--ds-text-danger, #DC2626)', '#DB2777', 'var(--cp-purple-60, #7C3AED)', '#059669', 'var(--ds-text-warning, #D97706)'];
