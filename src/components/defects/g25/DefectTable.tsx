            ...
            return (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 13, fontWeight: 500, color: '#42526E' }}>
                    {opt.key}
                  </span>
                </div>
        ...
        return (
          <td key={colKey} style={{ width: columnWidths.key }}>
            <div className="flex items-center gap-1">
              ...
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 13, fontWeight: 600, color: '#2563EB' }}>{keyText}</span>
              {isJira && <JiraBadge />}
