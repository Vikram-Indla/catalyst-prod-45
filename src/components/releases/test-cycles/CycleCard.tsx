  ...
  const handleAction = (e: React.MouseEvent, action: string) => {
    ...
    switch (action) {
      case 'view':
        ...
        break;
      case 'execute':
        navigate(`/testhub/BAU/cycles/${cycle.cycleKey ?? cycle.id}/execute`);
        break;
      case 'edit':
        onEdit(cycle);
        break;
        ...
        <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
          <div 
            ...
            style={{ 
              ...
              backgroundColor: cycle.progress === 100 ? 'var(--quality-high)' : 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))'
            }}
          />
        </div>
      </div>
