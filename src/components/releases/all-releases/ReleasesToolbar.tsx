    ...
    <div className="flex items-center gap-4 mb-6">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <Input
          ...
          className="pl-10 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-slate-200 dark:border-[var(--ds-border,var(--cp-ink-1))]"
        />
        {filter.search && (
          <button
            onClick={() => onSearch('')}
        ...
        <button
          ...
          className={cn(
            ...
            viewMode === 'table'
              ...
              : "bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] text-slate-600 hover:bg-slate-50 dark:hover:bg-[var(--ds-surface)]"
          )}
        >
