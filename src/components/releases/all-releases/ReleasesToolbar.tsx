    ...
    <div className="flex items-center gap-4 mb-6">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <Input
          ...
          className="pl-10 bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] border-slate-200 dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))]"
        />
        {filter.search && (
          <button
            onClick={() => onSearch('')}
        ...
        <button
          ...
          className={cn(
            ...
            viewMode === 'table'
              ...
              : "bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] text-slate-600 hover:bg-slate-50 dark:hover:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]"
          )}
        >
