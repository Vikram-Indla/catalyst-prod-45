        ...
        return (
          <button
            ...
            className={cn(
              ...
              'hover:shadow-md hover:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/30 cursor-pointer',
              'focus:outline-none focus:ring-2 focus:ring-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/20'
            )}
          >
