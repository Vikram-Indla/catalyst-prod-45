  ...
  return (
    <>
      <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
        ...
        <div style={{ display: 'inline-flex', padding: 1.5, borderRadius: 20, background: 'conic-gradient(from 0deg, #FF3CAC 0deg, #784BA0 60deg, #2B86C5 120deg, #00C9FF 180deg, #92FE9D 240deg, #FFD700 300deg, #FF3CAC 360deg)' }}>
          <button
            ref={triggerRef}
            type="button"
