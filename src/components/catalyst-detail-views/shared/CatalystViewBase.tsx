...
export function CatalystViewBase({
  ...
  const MODAL: React.CSSProperties = fullPageMode ? {
    width: '100%', height: '100%', background: 'var(--ds-surface, var(--ds-surface, #FFFFFF))',
  ...
  const cardContents = (
    <>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            {moreMenuItems && moreMenuItems.length > 0 && (
              <div ref={dotsMenuRef} style={{ position: 'relative' }}>
                ...
                {showDotsMenu && (
                  <div style={{
                    position: 'absolute', right: 0, top: 32, background: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #FFF)))',
                    ...
                    {moreMenuItems.map((item, i) => (
                      <React.Fragment key={i}>
                        ...
                        <button
                          ...
                          onMouseEnter={e => (e.currentTarget.style.background = item.danger ? '#FFEBE6' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))')}
        ...
        <div className="cv-drawer-body" style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
          ...
          >
            <div style={{ width: 1.5, height: 32, borderRadius: 1, background: 'var(--ds-border, var(--ds-border, #DFE1E6))', transition: 'background 0.15s' }} />
          </div>
