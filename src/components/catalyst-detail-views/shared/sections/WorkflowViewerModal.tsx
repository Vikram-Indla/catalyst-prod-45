    ...
    <div style={{
      ...
      <div style={{
        ...
        border: isCurrent
          ...
          : isAnyHub
          ? `2px dashed ${token('color.border', 'var(--cp-lozenge-grey-bg, #DFE1E6)')}`
                      ...
                      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                        <thead>
                          <tr style={{ background: token('color.background.neutral', '#F4F5F7') }}>
                            <th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: token('color.text', '#292A2E'), borderBottom: `1px solid ${token('color.border', 'var(--cp-lozenge-grey-bg, #DFE1E6)')}` }}>Action</th>
                            <th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: token('color.text', '#292A2E'), borderBottom: `1px solid ${token('color.border', 'var(--cp-lozenge-grey-bg, #DFE1E6)')}` }}>From</th>
                            <th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: token('color.text', '#292A2E'), borderBottom: `1px solid ${token('color.border', 'var(--cp-lozenge-grey-bg, #DFE1E6)')}` }}>→ To</th>
                          </tr>
                        </thead>
                        <tbody>
