    ...
    >
      ...
      <button
        ...
        style={{
          ...
          height: 28,
          padding: '0 10px',
          border: `1px solid ${isPinned ? token('color.border.brand', 'var(--cp-primary-60, #0052CC)') : token('color.border', '#DFE1E6')}`,
          borderRadius: 3,
        ...
        onMouseEnter={(e) => {
          if (!isPinned) e.currentTarget.style.background = token('color.background.neutral.hovered', '#EBECF0');
        }}
        onMouseLeave={(e) => {
