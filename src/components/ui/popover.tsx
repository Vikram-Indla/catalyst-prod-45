...
>(({ className, align = "center", sideOffset = 4, collisionPadding = 8, style, onWheelCapture, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "z-[500] w-72 rounded-md border border-border/50 dark:border-border/30 bg-popover p-4 text-popover-foreground outline-none",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        className,
      )}
      style={{ boxShadow: 'var(--ds-shadow-overlay)', ...scrollableOverlayStyle, ...style }}
      onWheelCapture={(e) => {
