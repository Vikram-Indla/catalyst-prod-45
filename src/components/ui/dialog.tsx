...
const dialogContentVariants = cva(
  cn(
    ...
    // Dark mode: surface elevation, NO visible border, shadow for depth (ADS overlay surface token)
    "dark:bg-[var(--ds-elevation-surface-overlay)] dark:border-0 dark:shadow-2xl dark:shadow-black/50",
