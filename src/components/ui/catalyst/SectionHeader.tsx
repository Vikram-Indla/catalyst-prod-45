...
export const SectionHeader = ({ icon: Icon, title, className }: SectionHeaderProps) => (
  <div className={cn("flex items-center gap-3 mb-5", className)}>
    <div className={cn(
      ...
      <Icon className="w-3.5 h-3.5 text-[var(--ds-text-brand,#2563eb)] dark:text-[var(--ds-text-brand,#60a5fa)]" />
    </div>
    <span className="text-[11px] font-bold uppercase tracking-[0.08em] text-[var(--ds-text-brand,#2563eb)] dark:text-[var(--ds-text-brand,#60a5fa)]">
      {title}
    </span>
