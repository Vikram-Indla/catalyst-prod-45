...
export const SectionHeader = ({ icon: Icon, title, className }: SectionHeaderProps) => (
  <div className={cn("flex items-center gap-3 mb-5", className)}>
    <div className={cn(
      ...
      <Icon className="w-3.5 h-3.5 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:text-[var(--ds-text-brand,#60a5fa)]" />
    </div>
    ...
    <div className="flex-1 h-px bg-gradient-to-r from-gray-200 dark:from-[var(--ds-text, #242424)] to-transparent" />
  </div>
);
