...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-text-brand)] dark:focus-visible:ring-[var(--ds-text-brand)] focus-visible:ring-offset-2",
      // Uses semantic token
      "text-foreground",
      className,
    )}
