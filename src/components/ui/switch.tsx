...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-[var(--ds-text-success,var(--cp-success, #16A34A))] data-[state=checked]:border-[var(--ds-text-success,var(--cp-success, #16A34A))] data-[state=unchecked]:bg-[#D4D4D8] data-[state=unchecked]:border-[#D4D4D8]",
      className,
    )}
    {...props}
    ref={ref}
