...
// TODO: ads-unmapped — #D4D4D8 context unclear
      // ON state: GREEN (var(--ds-text-success, var(--cp-success, #16A34A))), OFF state: grey (#D4D4D8)
      "data-[state=checked]:bg-[var(--ds-text-success,var(--cp-success, #16A34A))] data-[state=checked]:border-[var(--ds-text-success,var(--cp-success, #16A34A))] data-[state=unchecked]:bg-[var(--ds-border, #DFE1E6)] data-[state=unchecked]:border-[var(--ds-border, #DFE1E6)]",
      className,
    )}
    {...props}
    ref={ref}
