...
const indicatorVariants = cva(
  "h-full w-full flex-1 transition-all duration-500 ease-out",
  {
    variants: {
      variant: {
        primary: "bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]",
        success: "bg-[#0d9488]",
        warning: "bg-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]",
        danger: "bg-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        teal: "bg-[#0d9488]",
      },
    },
    defaultVariants: {
