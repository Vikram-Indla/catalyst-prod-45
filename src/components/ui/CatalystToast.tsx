...
const toastConfig = {
  ...
  error: {
    icon: XCircle,
    iconColor: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))',
    bgColor: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))',
    borderColor: '#FECACA',
    titleColor: 'var(--ds-text-danger, var(--ds-text-danger, #991B1B))',
    descColor: '#B91C1C',
  },
  warning: {
    icon: AlertTriangle,
  ...
  info: {
    ...
    bgColor: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))',
    borderColor: '#BFDBFE',
    titleColor: '#1E40AF',
    descColor: 'var(--ds-background-brand-bold-hovered, var(--ds-background-brand-bold-hovered, #1D4ED8))',
  },
};
