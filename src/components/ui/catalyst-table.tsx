...
export function CatalystTable<T>({
  ...
  return (
    <div ref={containerRef} className="w-full" data-cp-table-narrow={isNarrow ? 'true' : undefined}>
      ...
      <div className="relative w-full rounded-md border border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] overflow-hidden bg-card dark:bg-[var(--ds-surface,#0A0A0A)]">
        {/* Horizontal scroll only when columns exceed container */}
        <div ref={scrollRef} className="w-full overflow-x-auto">
          {/* Header - 32px height */}
          <div
            className="grid items-center h-9 bg-muted dark:bg-[#111111] border-b-2 border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] sticky top-0 z-20"
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    col.align === 'center' && "justify-center",
                    col.align === 'right' && "justify-end",
                    stickyFirst && "sticky left-0 z-30 border-r border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] bg-muted dark:bg-[#111111]"
                  )}
                >
            ...
            visibleData.map((item) => {
              ...
              return (
                <div
                  key={rowId}
                  className={cn(
                    "grid items-center h-9 border-b border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] last:border-b-0 transition-colors",
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          CELL_STYLES,
                          "text-foreground",
                          stickyFirst && "sticky left-0 z-10 border-r border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]",
