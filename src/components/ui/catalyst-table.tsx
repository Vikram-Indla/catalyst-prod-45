    ...
    <div ref={containerRef} className="w-full" data-cp-table-narrow={isNarrow ? 'true' : undefined}>
      ...
      <div className="relative w-full rounded-md border border-border dark:border-[var(--ds-border,var(--cp-ink-1))] overflow-hidden bg-card dark:bg-[var(--ds-surface)]">
        ...
        <div ref={scrollRef} className="w-full overflow-x-auto">
          {/* Header - 32px height */}
          <div
            className="grid items-center h-9 bg-muted dark:bg-[var(--ds-elevation-surface-sunken)] border-b-2 border-border dark:border-[var(--ds-border,var(--cp-ink-1))] sticky top-0 z-20"
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    col.align === 'center' && "justify-center",
                    col.align === 'right' && "justify-end",
                    stickyFirst && "sticky left-0 z-30 border-r border-border dark:border-[var(--ds-border,var(--cp-ink-1))] bg-muted dark:bg-[var(--ds-elevation-surface-sunken)]"
                  )}
                >
