  ...
  "inline-flex items-center rounded-full border font-medium transition-colors focus:outline-none",
  {
    variants: {
      variant: {
        ...
        // Brand colors
        primary: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]",
        ...
        warning: "border-transparent bg-[#fef3c7] text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]",
        danger: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        destructive: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        info: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]",
        error: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        critical: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        muted: "border-transparent bg-[#f5f5f5] text-[#737373]",
        
        // Workflow status
        draft: "border-[#e5e5e5] bg-[#f5f5f5] text-[#737373]",
        active: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]",
        complete: "border-transparent bg-[#d1fae5] text-[#059669]",
        approved: "border-transparent bg-[#d1fae5] text-[#059669]",
        rejected: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
        blocked: "border-transparent bg-[#fef3c7] text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]",
        ready: "border-transparent bg-[#ccfbf1] text-[#0d9488]",
        review: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]",
        deprecated: "border-transparent bg-[#e5e5e5] text-[#525252]",
        
        // Test result variants
        passed: "border-transparent bg-[#d1fae5] text-[#059669]",
        failed: "border-transparent bg-[#fee2e2] text-[var(--ds-text-danger,var(--ds-text-danger, #dc2626))]",
