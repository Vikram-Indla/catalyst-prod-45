  ...
  "inline-flex items-center rounded-full border font-medium transition-colors focus:outline-none",
  {
    variants: {
      variant: {
        ...
        // Brand colors
        primary: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]",
        ...
        info: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]",
        ...
        active: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]",
        ...
        review: "border-transparent bg-[#dbeafe] text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]",
