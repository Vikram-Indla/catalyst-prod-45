...
>(({ asChild, className, ...props }, ref) => {
  ...
  return <Comp ref={ref} className={cn("text-[var(--ds-text-brand,#2563eb)] hover:text-[var(--ds-background-brand-bold-hovered,#1d4ed8)] transition-colors", className)} {...props} />;
});
