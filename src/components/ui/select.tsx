...
>(({ className, children, position = "popper", sideOffset = 4, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        "relative max-h-96 min-w-[8rem] rounded-md border border-border dark:border-[var(--ds-border-bold)] bg-popover text-popover-foreground",
      ...
      style={{ zIndex: 9999, boxShadow: 'var(--ds-shadow-overlay)', ...props.style }}
      {...props}
    >
