...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      "border-2 border-[hsl(var(--border-default))] dark:border-[var(--ds-border-bold)]",
      ...
      "data-[state=unchecked]:hover:border-[hsl(217,91%,53%)]/70 dark:data-[state=unchecked]:hover:border-[var(--ds-border)]",
