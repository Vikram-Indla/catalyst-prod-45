...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ...
    className={cn(
      ...
      "border-2 border-[hsl(var(--border-default))] dark:border-[var(--ds-border-bold,var(--ds-text-subtle))]",
      // Unchecked state - transparent background
      "data-[state=unchecked]:bg-transparent",
      // Checked state - BLUE primary (Catalyst V5 spec: var(--ds-text-brand, var(--cp-workstream-catalyst-primary)) / var(--ds-text-brand))
      ...
      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-text-brand)] dark:focus-visible:ring-[var(--ds-text-brand)] focus-visible:ring-offset-2",
      "disabled:cursor-not-allowed disabled:opacity-50",
      // Hover state for unchecked
      "data-[state=unchecked]:hover:border-[hsl(217,91%,53%)]/70 dark:data-[state=unchecked]:hover:border-[var(--ds-text-subtlest, var(--ds-text-subtlest))]",
