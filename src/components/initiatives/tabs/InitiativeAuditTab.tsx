/**
 * InitiativeAuditTab — Timeline with date grouping, filter dropdown, action icons.
 */
...
function getAuditActionText(entry: any): string {
  const map: Record<string, string> = {
    created: 'created this initiative', deleted: 'deleted this initiative',
  ...
  if (entry.action === 'updated' && entry.entity_type !== 'initiative') {
...
export function InitiativeAuditTab({ initiativeId }: InitiativeAuditTabProps) {
