            ...
            {isSearchExpanded && (
              <div className="overflow-hidden transition-all duration-300 ease-out mr-1.5" style={{ width: '180px' }}>
                <Input
                  ...
                  className="h-9 text-xs bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] dark:text-[var(--ds-text,var(--ds-text, #EDEDED))] px-3"
            ...
            <Tooltip content="Search" position="bottom" delay={200}>
              <button
                ...
                className={cn(
                  ...
                  isSearchExpanded ? "text-white" : "bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] text-[hsl(var(--roadmap-charcoal))]"
                )}
                style={{
