          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Parent Feature:{' '}
                <span className="text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:text-[var(--ds-text-brand,#60a5fa)] font-mono font-medium">{parentFeature.key}</span>
                {' '}{parentFeature.title}
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg bg-muted/50 border">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <span className="text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] font-medium">
