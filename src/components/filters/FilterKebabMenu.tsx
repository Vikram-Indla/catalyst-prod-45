          ...
          <ModalDialog onClose={() => setDeleteOpen(false)} width="small">
            ...
            <ModalBody>
              ...
              {filter.used_by_board_ids.length > 0 && (
                <p style={{ margin: '8px 0 0', fontSize: 'var(--ds-font-size-300)', color: token('color.text.warning', 'var(--ds-text-warning, #974F0C)') }}>
          ...
          <ModalDialog onClose={() => setCreateRoadmapOpen(false)} width="small">
            ...
            <ModalBody>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                {roadmapError && (
                  <p style={{ margin: 0, fontSize: 'var(--ds-font-size-300)', color: token('color.text.danger', 'var(--ds-text-danger, #AE2A19)') }}>
                    {roadmapError}
                  </p>
                )}
              </div>
            ...
            <ModalBody>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                {filterProjectMismatch && (
                  <p style={{ margin: 0, fontSize: 'var(--ds-font-size-200)', color: token('color.text.warning', 'var(--ds-text-warning, #974F0C)'), background: token('color.background.warning', 'var(--ds-background-warning, var(--ds-background-warning, #FFF7D6))'), borderRadius: 4, padding: '8px 12px' }}>
