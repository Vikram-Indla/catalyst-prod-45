    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
        ...
        {openChip === 'assignee' && (
          ...
          >
            {assignees.length === 0 ? (
              <div style={{ padding: '8px 12px', fontSize: 12, color: token('color.text.subtlest', '#6B778C'), fontStyle: 'italic' }}>
        ...
        {openChip === 'more' && (
          ...
          >
            ...
            <MoreSection label="Reporter">
              {reporters.length === 0 ? (
                <div style={{ padding: '4px 12px', fontSize: 12, color: token('color.text.subtlest', '#6B778C'), fontStyle: 'italic' }}>
            ...
            <MoreSection label="Created">
              <div style={{ padding: '4px 12px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: 8, alignItems: 'end' }}>
                  <div>
                    <div style={{ fontSize: 11, color: token('color.text.subtle', '#42526E'), marginBottom: 4 }}>From</div>
                    <DatePicker
                  ...
                  <div style={{ paddingBottom: 8, color: token('color.text.subtlest', '#6B778C'), fontSize: 12 }}>→</div>
                  <div>
                    <div style={{ fontSize: 11, color: token('color.text.subtle', '#42526E'), marginBottom: 4 }}>To</div>
                    <DatePicker
