      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto space-y-5 pr-1">
          ...
          <div className="grid grid-cols-4 gap-3">
            ...
            <div className="bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/10 rounded-lg p-3 text-center">
              <div className="text-2xl font-bold text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]">{formatFTE(committedFTE)}</div>
          ...
          <div>
            ...
            <div className="h-3 bg-muted rounded-full overflow-hidden flex">
              <div
                className="h-full bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] transition-all"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {resource.committed > 0 && (
                        <span className="text-xs font-medium px-2 py-0.5 rounded bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/10 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]">
