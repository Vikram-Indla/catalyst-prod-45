...
const lozengeVariants = cva(
  'inline-flex items-center rounded-[3px] px-1.5 py-0 text-[11px] font-bold uppercase leading-[20px] tracking-[0.03em] whitespace-nowrap',
  {
    ...
    compoundVariants: [
      ...
      { appearance: 'success', isBold: true, className: 'bg-[var(--ds-text-success, #006644)] text-[var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, var(--ds-surface, #FFFFFF))))] dark:bg-[var(--ds-background-success-bold, #57D9A3)] dark:text-[var(--ds-surface,#0A0A0A)]' },
      ...
      { appearance: 'new', isBold: true, className: 'bg-[var(--ds-text-success, #006644)] text-[var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, var(--ds-surface, #FFFFFF))))] dark:bg-[var(--ds-background-success-bold, #57D9A3)] dark:text-[var(--ds-surface,#0A0A0A)]' },
