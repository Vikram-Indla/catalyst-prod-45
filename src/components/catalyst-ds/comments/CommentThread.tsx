      ...
      <div className="mt-4">
        {isLoading ? (
          <div className="text-center py-8">
            <p className="text-[13px] text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">Loading comments...</p>
          </div>
        ) : sortedComments.length === 0 ? (
          <div className="text-center py-10">
            <MessageSquare className="h-10 w-10 mx-auto mb-3 text-[#C1C7D0] dark:text-[var(--ds-border-bold,var(--ds-border-bold, #454545))]" />
            <p className="text-[13px] text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">{emptyMessage}</p>
          </div>
        ) : (
