...
export function RoadmapFiltersDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] p-0 gap-0 bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] [&>button]:hidden rounded-xl overflow-hidden">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    localFilters.activePlatformFilter === pf.id
                      ...
                      : "bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] text-foreground border-border dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] hover:bg-muted/50 hover:border-muted-foreground/30"
                  )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={localFilters.status || 'all'} onValueChange={(v) => updateFilter('status', v)}>
                      ...
                      <SelectContent className="bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] z-[500]">
