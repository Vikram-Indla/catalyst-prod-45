...
export function RoadmapFiltersDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] p-0 gap-0 bg-white dark:bg-[var(--ds-surface-raised, #1A1A1A)] [&>button]:hidden rounded-xl overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Select value={localFilters.status || 'all'} onValueChange={(v) => updateFilter('status', v)}>
                      ...
                      <SelectContent className="bg-white dark:bg-[var(--ds-surface-raised, #1A1A1A)] z-[500]">
