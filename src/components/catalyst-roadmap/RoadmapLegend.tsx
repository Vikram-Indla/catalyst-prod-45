    ...
    <div className="flex items-center gap-6 px-5 py-2 bg-surface-0 border-t border-border shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-3">
          <LegendItem color="var(--success-fg)" label="On Track" />
          <LegendItem color="var(--warning-fg)" label="At Risk" />
          <LegendItem color="var(--danger-fg)" label="Blocked" />
          <LegendItem color="var(--fg-3)" label="Pending" />
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-3">
          <LegendMilestone color="var(--warning-fg)" label="Strategic" />
          <LegendMilestone color="var(--success-fg)" label="Release" />
          <LegendMilestone color="var(--chart-4)" label="Decision" />
        </div>
      </div>
