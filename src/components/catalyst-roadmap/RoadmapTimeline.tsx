      ...
      <div ref={ref} className="flex-1 overflow-auto relative">
        <div className="relative min-h-full" style={{ minWidth: `${zoom}%` }}>
          ...
          >
            ...
            <span 
              className="absolute bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full uppercase tracking-wide whitespace-nowrap"
              style={{
                top: '4px',
                left: '50%',
