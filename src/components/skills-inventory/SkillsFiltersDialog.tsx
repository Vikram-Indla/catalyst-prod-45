    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute z-50 top-full left-0 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] border border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-md shadow-lg max-h-48 overflow-y-auto">
            {options.map((option) => (
              <label
                key={option}
