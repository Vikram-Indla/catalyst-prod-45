  ...
  return (
    <div className="relative">
      <button
        type="button"
        className={cn(
          "flex items-center justify-between w-full h-10 px-3 border rounded-md text-sm bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] transition-colors",
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute z-50 top-full left-0 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border border-border dark:border-[var(--ds-border,var(--cp-ink-1))] rounded-md shadow-lg max-h-48 overflow-y-auto">
            {options.map((option) => (
              <label
                key={option}
...
export function SkillsFiltersDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleCancel}>
      <DialogContent className="max-w-[480px] w-[95vw] p-0 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border dark:border-[var(--ds-border,var(--cp-ink-1))] shadow-xl rounded-lg overflow-hidden gap-0 [&>button.absolute]:hidden">
        {/* Header */}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    localFilters.activeQuickFilter === sf.id
                      ...
                      : "bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-border text-foreground hover:border-brand-primary hover:bg-brand-primary/5"
                  )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 border border-border dark:border-[var(--ds-border,var(--cp-ink-1))] rounded-md text-sm bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] dark:text-[var(--ds-text,var(--cp-bg-neutral))] focus:outline-none focus:ring-1 focus:ring-brand-primary"
                    placeholder="0"
                  />
                </div>
                <div className="space-y-1.5">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-4 sm:px-5 py-3.5 border-t border-border bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))]">
