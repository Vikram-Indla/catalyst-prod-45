    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute z-50 top-full left-0 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-md shadow-lg max-h-48 overflow-y-auto">
            {options.map((option) => (
              <label
                key={option}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 border border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-md text-sm bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] dark:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))] focus:outline-none focus:ring-1 focus:ring-brand-primary"
                    placeholder="0"
                  />
                </div>
                <div className="space-y-1.5">
