...
export function AddTeamMemberModal({ open, onClose, onSave, projects }: AddTeamMemberModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white dark:bg-[var(--ds-surface)] border-border dark:border-[var(--ds-border,var(--cp-ink-1))]"
              />
            </div>
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="bg-white dark:bg-[var(--ds-surface)] border-border dark:border-[var(--ds-border,var(--cp-ink-1))]">
          ...
          <div className="space-y-3">
            ...
            {/* Quick Add Skills */}
            <div className="flex flex-wrap gap-1.5 p-3 bg-neutral-50 dark:bg-[var(--ds-surface)] rounded-lg border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1))]">
                ...
                <button
                  ...
                  className={`px-2 py-0.5 text-xs rounded border transition-colors ${
                    skills.some(s => s.skill === skill)
                      ...
                      : 'bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border-neutral-300 dark:border-[var(--ds-border,var(--cp-ink-1))] text-neutral-600 dark:text-[var(--ds-text-subtlest)] hover:border-brand-primary hover:text-brand-primary'
                  }`}
                >
                  {skill}
                </button>
            ...
            <div className="space-y-2">
              {skills.map((skillEntry, index) => (
                <div key={skillEntry.id} className="flex items-center gap-2 p-2 bg-neutral-50 dark:bg-[var(--ds-surface)] rounded-lg">
                  <div className="flex-1">
                    <Select
                      value={skillEntry.skill}
                      onValueChange={(value) => handleSkillChange(skillEntry.id, 'skill', value)}
                    >
                      <SelectTrigger className="bg-white dark:bg-[var(--ds-surface)] border-border dark:border-[var(--ds-border,var(--cp-ink-1))] h-9">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="bg-white dark:bg-[var(--ds-surface)] border-border dark:border-[var(--ds-border,var(--cp-ink-1))] resize-none"
            />
          </div>
