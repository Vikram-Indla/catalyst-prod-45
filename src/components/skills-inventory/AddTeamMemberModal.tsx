      ...
      <DialogContent className="max-w-2xl bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-white dark:bg-[var(--ds-surface,#0A0A0A)] border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-3">
            ...
            {/* Quick Add Skills */}
            <div className="flex flex-wrap gap-1.5 p-3 bg-neutral-50 dark:bg-[var(--ds-surface,#0A0A0A)] rounded-lg border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="bg-white dark:bg-[var(--ds-surface,#0A0A0A)] border-border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] resize-none"
            />
          </div>
