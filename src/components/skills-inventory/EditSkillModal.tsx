        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-background rounded-lg border border-brand-gold-border text-foreground focus:border-brand-gold focus:outline-none focus:ring-2 focus:ring-brand-gold/20 transition-all"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-background rounded-lg border border-brand-gold-border text-foreground placeholder-muted-foreground focus:border-brand-gold focus:outline-none focus:ring-2 focus:ring-brand-gold/20 transition-all resize-none"
            />
          </div>
        </div>
