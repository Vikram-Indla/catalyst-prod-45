  ...
  return (
    <div className="bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] rounded-xl border border-brand-primary/20 p-6 shadow-sm">
      ...
      {tooltip.visible && (
        ...
        >
          <div className="bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-xl px-4 py-3 shadow-xl min-w-[180px]">
