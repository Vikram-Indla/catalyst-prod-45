...
export const SkillsMatrixHeatmap: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#232019] rounded-xl border border-brand-primary/20 p-6 shadow-sm">
      {/* Header */}
          ...
          <tbody>
            {teamMembers.map((member, rowIndex) => (
              <tr key={member.id} className="border-b border-neutral-100 last:border-b-0">
                <td className="w-[200px] bg-white dark:bg-[#232019] py-4 px-4">
      ...
      {tooltip.visible && (
        ...
        >
          <div className="bg-white dark:bg-[#232019] border border-neutral-200 dark:border-[rgba(255,255,255,0.08)] rounded-xl px-4 py-3 shadow-xl min-w-[180px]">
