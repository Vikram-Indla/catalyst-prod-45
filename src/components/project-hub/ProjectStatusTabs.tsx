      ...
      {TABS.map(tab => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1.5 rounded-full transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))] ${
              isActive
