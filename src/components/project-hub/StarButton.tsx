...
export function StarButton({ isStarred, onClick, size = 16 }: StarButtonProps) {
  return (
    <button
      onClick={onClick}
      className="flex items-center justify-center rounded transition-colors hover:bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, var(--cp-bg-sunken)))] dark:hover:bg-[var(--ds-surface-overlay)]"
      style={{
        width: 28,
        height: 28,
        border: 'none',
