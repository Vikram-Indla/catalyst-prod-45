  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        <div
          ...
          style={{
            ...
            width: 36,
            backgroundColor: project.color || 'var(--ds-text-brand)',
            borderRadius: 6,
        ...
        <div className="min-w-0 flex-1">
          <div className="truncate text-sm font-semibold text-[var(--ds-text)] dark:text-[var(--ds-text)]" style={{ fontFamily: 'var(--ds-font-family-heading)' }}>
            {project.name}
          </div>
          <span className="text-[11px] font-medium font-['JetBrains_Mono',monospace] text-[var(--ds-text-subtlest)] dark:text-[var(--ds-text-subtlest)]">
            {project.key}
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <span className="text-[11px] text-[var(--ds-text-subtlest)] dark:text-[var(--ds-text-subtlest)]">
