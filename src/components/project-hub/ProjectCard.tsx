...
export function ProjectCard({ project, isStarred, onToggleStar }: ProjectCardProps) {
  ...
  return (
    <button
      ...
      className="relative flex flex-col text-left rounded-xl transition-all p-4 cursor-pointer bg-white dark:bg-[#1A1714] border border-gray-200 dark:border-gray-700 shadow-sm dark:shadow-none hover:-translate-y-0.5 hover:shadow-md dark:hover:shadow-none"
    >
      {/* Star top-right */}
