      ...
      >
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 'var(--ds-font-size-200)', color: 'var(--fg-3)', marginTop: 4 }}>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 0' }}>
          {conflicts.map(conflict => {
            ...
            return (
              <div key={conflict.id} style={{ marginBottom: 24, padding: '0 24px' }}>
                <div style={{ fontSize: 'var(--ds-font-size-100)', fontWeight: 600, color: 'var(--fg-3)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 8 }}>
                  ...
                  <div style={{ display: 'flex', borderRadius: 6, overflow: 'hidden', border: '0.75px solid var(--cp-border-default, rgba(15,23,42,0.12))' }}>
                    ...
                    <div className="bg-[var(--sem-warning-bg)]" style={{ flex: 1, borderLeft: '0.75px solid var(--sem-warning-accent)', padding: 16 }}>
                      <div className="flex items-center gap-[5px]" style={{ marginBottom: 8 }}>
                        ...
                        <span style={{ fontSize: 'var(--ds-font-size-100)', fontWeight: 700, color: 'var(--sem-warning-fg)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Jira Version</span>
                        <span style={{ fontSize: 'var(--ds-font-size-50)', color: 'var(--fg-3)', marginLeft: 4 }}>From Jira</span>
                      </div>
                      <div className="bg-[rgba(154,52,18,0.06)]" style={{ fontSize: 'var(--ds-font-size-300)', color: 'var(--fg-1)', fontWeight: 500, padding: '8px 12px', borderRadius: 4 }}>
                        {conflict.jiraValue}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        style={{
                          ...
                          fontSize: 'var(--ds-font-size-200)', fontWeight: 600, fontFamily: 'var(--cp-font-body)', cursor: 'pointer',
                        }}
                      >
                        Keep Catalyst
                      </button>
          ...
          {conflicts.length === 0 && (
            <div className="flex flex-col items-center justify-center" style={{ padding: 40 }}>
              ...
              <p style={{ color: 'var(--fg-4)', fontSize: 'var(--ds-font-size-300)' }}>No conflicts to resolve</p>
            </div>
          )}
        </div>
      </div>
