    ...
    <>
      ...
      <div className="bg-[var(--cp-float)]" style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 16, fontWeight: 700, color: 'var(--fg-1)', fontFamily: 'var(--ds-font-family-heading)', margin: 0 }}>
            Jira Sync Log
          </h2>
            ...
            {syncLogs.length === 0 ? (
              ...
              syncLogs.map(log => (
                ...
                >
                  ...
                  <span style={{ fontSize: 11, color: 'var(--fg-2)', fontFamily: 'var(--ds-font-family-monospaced)', minWidth: 90 }}>
