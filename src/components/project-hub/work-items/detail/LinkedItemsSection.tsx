        ...
        <div key={type} className="mb-2">
          ...
          {links.map(link => (
            ...
            >
              ...
              <span className="text-[10px] shrink-0" style={{ fontFamily: 'var(--ds-font-family-monospaced)', color: 'var(--fg-3)' }}>{link.item_key}</span>
          ...
          <div className="max-h-[200px] overflow-y-auto">
            {searchResults.map((item: any) => (
              ...
              >
                ...
                <span className="text-[10px] shrink-0" style={{ fontFamily: 'var(--ds-font-family-monospaced)', color: 'var(--fg-3)' }}>{item.item_key}</span>
