    ...
    <div style={{ marginTop: 16 }}>
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="flex gap-1.5">
                {quickReplies.map(q => (
                  <button
                    key={q}
                    className="text-[12px] px-2.5 py-0.5 rounded-full hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F1F5F9))]"
      ...
      {isLoading ? (
        <div className="flex justify-center py-8">
          <Loader2 size={20} className="animate-spin text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #94A3B8))]" />
        </div>
      ) : filtered.length === 0 ? (
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={onDelete}
          className="opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded hover:bg-[var(--ds-background-danger,var(--ds-background-danger, #FEF2F2))]"
          title="Delete comment"
        >
          <Trash2 size={12} className="text-[var(--ds-text-danger,var(--ds-text-danger, #DC2626))]" />
        </button>
      </div>
      ...
      <div className="flex items-center gap-1 mt-1.5 flex-wrap">
        ...
        <div className="relative">
          <button
            ...
            className="p-1 rounded hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F1F5F9))] transition-colors"
            ...
            >
              {EMOJI_OPTIONS.map(e => (
                <button
                  ...
                  className="w-7 h-7 flex items-center justify-center rounded hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F1F5F9))] text-[16px]"
                >
                  {e}
                </button>
              ))}
