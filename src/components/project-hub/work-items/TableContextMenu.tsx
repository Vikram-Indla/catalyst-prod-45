        ...
        {items.map(item => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-1.5 text-[13px] hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F8FAFC))] text-left transition-colors"
              style={{ color: 'var(--fg-2)' }}
            >
              <Icon size={13} className="text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #94A3B8))]" />
              {item.label}
            </button>
          );
        })}
        ...
        {deleteConfirm ? (
          <div className="px-3 py-1.5 flex items-center gap-2">
            ...
            <button
              ...
              className="text-[11px] font-semibold px-2 py-0.5 rounded bg-[var(--ds-text-danger,var(--ds-text-danger, #DC2626))] text-white"
            >
              Yes
            </button>
            <button
              onClick={() => setDeleteConfirm(false)}
              className="text-[11px] px-2 py-0.5 text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #64748B))]"
            >
              No
            </button>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-1.5 text-[13px] hover:bg-[var(--ds-background-danger,var(--ds-background-danger, #FEF2F2))] text-left transition-colors"
