...
const STATUS_COLORS: Record<string, string> = {
  todo: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', in_progress: 'var(--ds-text-brand, #2563EB)', done: 'var(--ds-text-success, var(--cp-success, #16A34A))', terminal: 'var(--ds-text-danger, var(--cp-danger, #DC2626))',
};
