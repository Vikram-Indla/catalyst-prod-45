            ...
            <div ref={assigneeRef} className="cursor-pointer">
              {item.assignee_name ? (
                <div className="flex items-center gap-1.5 min-w-0">
                  ...
                  <span className="truncate" style={{ fontSize: 11, fontFamily: 'var(--ds-font-family-body)', color: 'var(--fg-2)' }}>
                    {item.assignee_name}
                  </span>
                </div>
              ) : (
        ...
        return (
          <td key={col.key} style={{ width: 84, padding: '0 4px' }} onClick={e => handleCellClick('priority', e)}>
            <div ref={priorityRef} className="flex items-center gap-1 cursor-pointer">
              ...
              <span style={{ fontSize: 10, fontFamily: 'var(--ds-font-family-body)', color: 'var(--fg-2)' }}>
