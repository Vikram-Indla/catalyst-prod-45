    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5" style={{ borderBottom: '1px solid var(--cp-bd-zone)' }}>
          ...
          <button
            onClick={handleClose}
            className="w-7 h-7 flex items-center justify-center rounded-md hover:bg-[var(--ds-surface-sunken,#F1F5F9)] transition-colors"
        ...
        <div className="px-5 py-4 flex flex-col gap-4 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="w-full flex items-center justify-between rounded-md border px-2.5 text-[12px] font-medium hover:border-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] transition-colors"
              ...
              >
                ...
                <ChevronDown size={14} className="text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))]" />
              </button>
              {priorityOpen && (
                <FixedDropdown width="100%" onClick={e => e.stopPropagation()}>
                  {PRIORITIES.map(p => (
                    <button
                      key={p.value}
                      className="w-full flex items-center gap-2 px-3 py-2 text-[12px] font-medium hover:bg-[var(--ds-surface-sunken,#F1F5F9)] transition-colors"
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown size={14} className="text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] shrink-0" />
              </button>
              {assigneeOpen && (
                <FixedDropdown maxHeight={220} onClick={e => e.stopPropagation()}>
                  <div className="px-2 py-1.5" style={{ borderBottom: '1px solid var(--cp-bd-zone)' }}>
                    <div className="relative">
                      <Search size={12} className="absolute left-2 top-1/2 -translate-y-1/2 text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))]" />
                      <input
                  ...
                  <div className="overflow-y-auto flex-1">
                    <button
                      className="w-full flex items-center gap-2 px-3 py-1.5 text-[11px] hover:bg-[var(--ds-surface-sunken,#F1F5F9)]"
                      style={{ color: 'var(--fg-4)' }}
                    ...
                    {filteredProfiles.map(p => (
                      <button
                        key={p.id}
                        className="w-full flex items-center gap-2 px-3 py-1.5 text-[11px] font-medium hover:bg-[var(--ds-surface-sunken,#F1F5F9)] text-left"
                        style={{ color: 'var(--fg-2)' }}
          ...
          <div className="relative">
            ...
            <button
              ...
              className="w-full flex items-center gap-1.5 flex-wrap min-h-[50px] rounded-md border px-2.5 py-1.5 text-[12px] hover:border-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] transition-colors"
            ...
            >
              ...
              <ChevronDown size={14} className="text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] ml-auto shrink-0" />
            </button>
                ...
                <div className="overflow-y-auto">
                  {labels.map(lb => {
                    ...
                    return (
                      <button
                        key={lb.id}
                        className="w-full flex items-center gap-2 px-3 py-1.5 text-[11px] font-medium hover:bg-[var(--ds-surface-sunken,#F1F5F9)]"
                        style={{ color: 'var(--fg-2)' }}
                        onClick={() => {
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="relative">
                <Calendar size={14} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))]" />
                <input
                  type="date"
                  value={dueDate}
            ...
            <div className="relative">
              ...
              {releaseOpen && (
                <FixedDropdown maxHeight={200} onClick={e => e.stopPropagation()}>
                  <button
                    className="w-full text-left px-3 py-1.5 text-[11px] hover:bg-[var(--ds-surface-sunken,#F1F5F9)]"
                    style={{ color: 'var(--fg-4)' }}
        ...
        <div className="flex items-center justify-between px-5 py-3" style={{ borderTop: '1px solid var(--cp-bd-zone)' }}>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handleClose}
              className="px-3.5 py-1.5 text-[12px] font-medium rounded-md hover:bg-[var(--ds-surface-sunken,#F1F5F9)] transition-colors"
