...
// 2026-06-09 Spec parity — ADS B400 var(--ds-link) for the blue accent (was
  ...
  return (
    <div
      ...
      style={{
        ...
        outline: isEditing ? `1px dashed ${token('color.border.brand', 'var(--ds-link)')}` : 'none',
      ...
      <div
        ...
        style={{
          ...
          background: headerHovered && !isEditing
            ? token('color.background.neutral.subtle.hovered', 'var(--ds-background-neutral)')
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', alignItems: 'center', gap: 12, textAlign: 'left' }}>
          ...
          <div style={{ minWidth: 0, display: 'flex', flexDirection: 'column' }}>
            {/* 2026-06-09 Spec parity — semantic h2 + 16/600/var(--ds-text)
                /-0.006em letter-spacing per Filter Results gadget spec. */}
            <h2 style={{ margin: 0, fontSize: 'var(--ds-font-size-500)', fontWeight: 600, color: token('color.text', 'var(--ds-text)'), lineHeight: '20px', letterSpacing: '-0.006em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {title}
            </h2>
            {subtitle && (
              <span
