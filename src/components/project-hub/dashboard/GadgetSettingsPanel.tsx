...
export default function GadgetSettingsPanel({
  ...
  return (
    <div ref={wrapperRef} style={{ fontSize: 13, color: 'var(--ds-text, var(--ds-text, #172B4D))' }}>
      {/* HEADER */}
      <div
        style={{
          display: 'flex',
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--ds-text, var(--ds-text, #172B4D))' }}>Gadget settings</div>
          <div style={{ fontSize: 11, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', marginTop: 2 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 3, background: openField === 'date' ? 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #FAFBFC))',
          ...
          >
            ...
            <span style={{ flex: 1, textAlign: 'left', fontSize: 13,
                           color: draft.datePreset === 'all' ? '#7A869A' : 'var(--ds-text, var(--ds-text, #172B4D))',
          ...
          {openField === 'date' && (
            <div style={{ background: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))', border: '1px solid #DFE1E6',
                  ...
                  return (
                    <button key={p} type="button" onClick={() => {
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                        <span style={{ fontSize: 13, color: active ? '#0052CC' : 'var(--ds-text, var(--ds-text, #172B4D))',
              ...
              <div>
                <button type="button" onClick={() => {
                  ...
                  <span style={{ fontSize: 13, color: draft.datePreset === 'all' ? '#0052CC' : 'var(--ds-text, var(--ds-text, #172B4D))' }}>
                    All active
                  </span>
          ...
          <span style={{ fontSize: 10, color: '#7A869A', fontFamily: 'monospace',
                         background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))', padding: '2px 6px', borderRadius: 3 }}>
          ...
          {gadgetType === 'items' ? (
            <div
              ...
              style={{
                ...
                background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))', padding: '0 10px',
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: active ? '#DEEBFF' : 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F4F5F7))',
...
function GadgetSpecific({
  ...
  if (gadgetType === 'scope') {
    ...
    const numInput: React.CSSProperties = {
      ...
      padding: '0 8px', fontSize: 12, background: 'var(--ds-text-inverse, #FFFFFF)', color: 'var(--ds-text, var(--ds-text, #172B4D))',
    };
