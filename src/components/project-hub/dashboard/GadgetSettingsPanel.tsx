...
export default function GadgetSettingsPanel({
  ...
  return (
    <div ref={wrapperRef} style={{ fontSize: 13, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
      {/* HEADER */}
      <div
        style={{
          display: 'flex',
      ...
      >
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Gadget settings</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <button
            ...
            style={{
              ...
              border: openField === 'date' ? '2px solid #4C9AFF' : '2px solid var(--cp-lozenge-grey-bg, #DFE1E6)',
          ...
          >
            ...
            <span style={{ flex: 1, textAlign: 'left', fontSize: 13,
                           color: draft.datePreset === 'all' ? '#7A869A' : 'var(--ds-text, var(--cp-text-primary, #172B4D))',
          ...
          {openField === 'date' && (
            <div style={{ background: 'var(--ds-surface, #fff)', border: '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)',
                  ...
                  return (
                    <button key={p} type="button" onClick={() => {
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                        <span style={{ fontSize: 13, color: active ? 'var(--cp-primary-60, #0052CC)' : 'var(--ds-text, var(--cp-text-primary, #172B4D))',
              ...
              <div>
                <button type="button" onClick={() => {
                  ...
                  <span style={{ fontSize: 13, color: draft.datePreset === 'all' ? 'var(--cp-primary-60, #0052CC)' : 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
                    All active
                  </span>
          ...
          <label style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '6px 8px',
            ...
            <span style={{ fontSize: 11, color: '#42526E' }}>
              Apply this date to <strong style={{ color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>all gadgets</strong> on this dashboard
            </span>
          </label>
        ...
        <Field label="Status">
          {gadgetType === 'items' ? (
            <div
              ...
              style={{
                display: 'flex', alignItems: 'center', minHeight: 36,
                border: '2px solid var(--cp-lozenge-grey-bg, #DFE1E6)', borderRadius: 3,
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: 3,
                      cursor: 'pointer',
                      border: active ? '1px solid var(--cp-primary-60, #0052CC)' : '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)',
          ...
          value.map((v) => {
            ...
            const palette =
              grp?.label === 'Done'
                ...
                : grp?.label === 'Paused'
                ? { bg: '#FFF0B3', fg: '#974F0C' }
                : { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))', fg: '#42526E' };
            return (
              <span
                key={v}
                style={{
      ...
      <div style={{ ...wrapper, gap: 10 }}>
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer' }}>
          <input
            ...
            style={{ width: 13, height: 13, accentColor: 'var(--cp-primary-60, #0052CC)', cursor: 'pointer' }}
          />
          <span style={{ fontSize: 12, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Active releases only</span>
        </label>
      </div>
    );
  }
