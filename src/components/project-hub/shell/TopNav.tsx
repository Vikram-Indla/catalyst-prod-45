  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[var(--fg-1)] dark:text-[rgba(235,238,245,0.92)]" style={{ fontFamily: "'Sora', sans-serif", fontSize: 15, fontWeight: 700 }}>
          atalyst
          <span className="text-[var(--fg-4)] dark:text-[rgba(235,238,245,0.40)]" style={{ fontSize: 9, verticalAlign: 'super', fontWeight: 500 }}>™</span>
        </span>
      </button>
          ...
          return (
            <button
              ...
              style={{
                ...
                color: isActive ? 'var(--cp-blue)' : (isDark ? 'rgba(235,238,245,0.72)' : 'var(--fg-2)'),
                fontFamily: "'Inter', sans-serif",
              ...
              onMouseEnter={(e) => { if (!isActive) e.currentTarget.style.color = isDark ? 'rgba(235,238,245,0.92)' : 'var(--cp-blue)'; }}
              onMouseLeave={(e) => { if (!isActive) e.currentTarget.style.color = isDark ? 'rgba(235,238,245,0.72)' : 'var(--fg-2)'; }}
            >
              {tab.label}
            </button>
          );
      ...
      <div className="flex items-center gap-2 ml-4 flex-shrink-0">
        ...
        {/* Search bar */}
        <div
          className="flex items-center gap-2 rounded-md bg-[#F8FAFC] dark:bg-transparent border border-[#E2E8F0] dark:border-[rgba(235,238,245,0.10)]"
          style={{
            height: 32,
            padding: '0 10px',
            borderRadius: 6,
        ...
        >
          <Search size={14} className="text-[#94A3B8] dark:text-[rgba(235,238,245,0.40)]" strokeWidth={2} />
          <span className="text-[var(--fg-4)] dark:text-[rgba(235,238,245,0.40)]" style={{ fontSize: 12, userSelect: 'none', whiteSpace: 'nowrap' }}>
            Search anything...
          </span>
          <kbd
            className="bg-white dark:bg-transparent border border-[#E2E8F0] dark:border-[rgba(235,238,245,0.10)] text-[#94A3B8] dark:text-[rgba(235,238,245,0.40)]"
            style={{
              fontSize: 10,
              fontWeight: 500,
              borderRadius: 4,
        ...
        <button
          ...
          title="Notifications"
        >
          <Bell size={18} className="text-[#64748B] dark:text-[rgba(235,238,245,0.55)]" strokeWidth={1.75} />
        </button>
        ...
        <button
          ...
          title="Settings"
        >
          <Settings size={18} className="text-[#64748B] dark:text-[rgba(235,238,245,0.55)]" strokeWidth={1.75} />
        </button>
