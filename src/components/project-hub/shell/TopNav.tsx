    ...
    >
      ...
      <div className="flex items-center gap-2 ml-4 flex-shrink-0">
        ...
        >
          ...
          <kbd
            className="bg-white dark:bg-transparent border border-[var(--ds-border,var(--cp-border, #E2E8F0))] dark:border-[var(--ds-border,#2E2E2E)] text-[var(--ds-text-subtlest,#94A3B8)] dark:text-[#7D7D7D]"
            style={{
              fontSize: 10,
              fontWeight: 500,
              borderRadius: 4,
