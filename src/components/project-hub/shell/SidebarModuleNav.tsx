...
export function SidebarModuleNav({ collapsed, onToggle }: SidebarModuleNavProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="flex items-center gap-2 flex-shrink-0 border-b border-[var(--ds-border,#E2E8F0)] dark:border-[var(--ds-border,#2E2E2E)]"
        ...
        {!collapsed && (
          <>
            ...
            <div className="pt-1">
              ...
              <div
                className="flex items-center gap-2 mx-2 my-1 rounded-[6px] border border-dashed border-[var(--ds-border,#DFE1E6)] dark:border-[var(--ds-border-bold,#454545)]"
                style={{ padding: '10px 12px' }}
              >
                <Star size={14} className="text-[#C1C7D0] dark:text-[#7D7D7D] flex-shrink-0" />
                <span className="text-[var(--ds-text-subtlest,#6B778C)] dark:text-[#7D7D7D]" style={{ fontSize: 12 }}>
