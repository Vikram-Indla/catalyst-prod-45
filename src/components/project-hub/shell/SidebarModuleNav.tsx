...
export function SidebarModuleNav({ collapsed, onToggle }: SidebarModuleNavProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="flex items-center gap-2 flex-shrink-0 border-b border-[#E2E8F0] dark:border-[rgba(235,238,245,0.10)]"
      ...
      >
        ...
        {!collapsed && (
          <span
            className="flex-1 truncate text-[#0F172A] dark:text-[rgba(235,238,245,0.92)]"
        ...
        >
          {collapsed ? (
            <ChevronsRight size={16} className="text-[#64748B] dark:text-[rgba(235,238,245,0.55)]" />
          ) : (
      ...
      <div className="flex-1 py-2 px-1.5 space-y-0.5 overflow-y-auto">
        ...
        {!collapsed && (
          <div className="pt-3 pb-1">
            <div className="text-[var(--fg-3)] dark:text-[rgba(235,238,245,0.55)]" style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.05em', textTransform: 'uppercase' as const, padding: '0 10px 4px' }}>
              Resource 360°
            </div>
          </div>
        )}
        ...
        {!collapsed && (
          <div className="pt-3">
            ...
            <div className="flex items-center gap-2 px-[10px] py-2 text-[var(--fg-4)] dark:text-[rgba(235,238,245,0.40)]" style={{ fontSize: 12 }}>
              <Star size={14} />
