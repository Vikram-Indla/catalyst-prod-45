...
export function ProjectSwitcher({ projects, currentKey, isOpen, onClose, onSelect }: ProjectSwitcherProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute top-full left-0 mt-1 z-50 bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[rgba(248,244,240,0.10)]"
      style={{
        width: 280,
        borderRadius: 8,
    ...
    >
      {/* Search */}
      <div className="flex items-center gap-2 px-3 py-2 border-b border-[#E2E8F0] dark:border-[rgba(248,244,240,0.08)]">
        <Search size={13} className="flex-shrink-0 text-[#94A3B8] dark:text-[rgba(248,244,240,0.40)]" />
        <input
          autoFocus
          value={search}
          onChange={e => setSearch(e.target.value)}
          placeholder="Search projects..."
          className="flex-1 bg-transparent outline-none border-none text-[#0F172A] dark:text-[rgba(248,244,240,0.92)]"
          style={{ fontSize: 12 }}
        />
      </div>
