...
export function SidebarProjectNav({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex-shrink-0 border-b border-[#E2E8F0] dark:border-[rgba(248,244,240,0.10)]">
        <div
        ...
        >
          ...
          {!collapsed && (
            <>
              ...
              >
                ...
                <ChevronDown size={14} className="flex-shrink-0 text-[#94A3B8] dark:text-[rgba(248,244,240,0.40)]" />
              </button>
              <button
                onClick={onToggle}
          ...
          {collapsed && (
            <button
              onClick={onToggle}
              className="absolute top-2 right-1 flex items-center justify-center rounded hover:bg-[#F1F5F9] dark:hover:bg-[rgba(248,244,240,0.03)]"
              style={{ width: 20, height: 20, border: 'none', background: 'transparent', cursor: 'pointer' }}
            >
              <ChevronsRight size={14} className="text-[#64748B] dark:text-[rgba(248,244,240,0.55)]" />
            </button>
          )}
        </div>
      ...
      <div className="px-1.5 pt-2">
        <button
          ...
          className="flex items-center gap-1.5 w-full rounded-md transition-colors hover:bg-[#F1F5F9] dark:hover:bg-[rgba(248,244,240,0.03)]"
          style={{
            height: 30,
        ...
        >
          <ArrowLeft size={14} strokeWidth={1.75} className="text-[#64748B] dark:text-[rgba(248,244,240,0.55)]" />
          {!collapsed && <span className="text-[#64748B] dark:text-[rgba(248,244,240,0.55)]">All Projects</span>}
        </button>
      </div>
