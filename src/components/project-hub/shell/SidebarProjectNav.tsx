        ...
        <div className="flex items-center gap-2.5" style={{ padding: collapsed ? '12px 10px' : '12px 12px' }}>
          <div
            ...
            style={{
              ...
              fontFamily: 'var(--ds-font-family-heading)', boxShadow: '0 1px 3px rgba(0,0,0,0.12)',
            }}
          >
            ...
            <>
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="truncate text-[#172B4D] dark:text-[#EDEDED]" style={{ fontSize: 14, fontWeight: 600, fontFamily: 'var(--ds-font-family-heading)', lineHeight: '18px' }}>
                    {projectName}
                  </div>
                </div>
                ...
                {recentItems.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span style={{ fontSize: 11.5, fontWeight: 600, color: isDark ? '#A1A1A1' : '#42526E', fontFamily: 'var(--ds-font-family-monospaced)', flexShrink: 0, letterSpacing: '-0.02em' }}>
                        {item.entity_key}
                      </span>
                      ...
                      <span className="group-hover:hidden" style={{ fontSize: 10, fontWeight: 500, color: isDark ? '#7D7D7D' : '#94A3B8', flexShrink: 0, fontFamily: 'var(--ds-font-family-monospaced)' }}>
