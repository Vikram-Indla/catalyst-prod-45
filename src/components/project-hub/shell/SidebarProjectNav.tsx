...
/* ── Canonical work item type icons (inline SVG) ── */
...
export function SidebarProjectNav({
  ...
  // Get project ID for recents query
      ...
      <div className="relative flex-shrink-0 border-b border-[#EBECF0] dark:border-[#2E2E2E] flex flex-col justify-center" style={{ minHeight: 77 }}>
        ...
        >
          ...
          <div
            ...
            style={{
              width: 30, height: 30,
              backgroundColor: projectColor, color: '#FFFFFF',
        ...
        {!collapsed && recentItems.length > 0 && (
          <>
            ...
            >
              <ChevronRight
                size={12}
                className="text-[#6B778C] dark:text-[#7D7D7D] transition-transform duration-150"
                style={{ transform: recentsExpanded ? 'rotate(90deg)' : 'rotate(0deg)' }}
              />
              <Clock size={12} className="text-[#6B778C] dark:text-[#7D7D7D]" />
              <span className="dark:text-[#7D7D7D]" style={{
                fontSize: 11, fontWeight: 700, letterSpacing: '0.06em',
                ...
                {recentItems.map(item => {
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={e => {
                        e.currentTarget.style.backgroundColor = isDark ? '#1F1F1F' : '#F4F5F7';
                      }}
                      onMouseLeave={e => {
                    ...
                    >
                      ...
                      <span style={{
                        ...
                        backgroundColor: typeColor, flexShrink: 0,
                      }} />
                      ...
                      {/* Time ago — visible, remove button on hover */}
                      <span
