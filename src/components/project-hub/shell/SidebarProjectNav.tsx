...
export function SidebarProjectNav({
  ...
  return (
    <div
      className="flex flex-col h-full flex-shrink-0 bg-white dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))] border-r border-[var(--ds-border,var(--ds-border, #E2E8F0))] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))]"
      style={{
    ...
    >
      {/* Header */}
      <div className="relative flex-shrink-0 border-b border-[#EBECF0] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] flex flex-col justify-center" style={{ minHeight: 77 }}>
        <div className="flex items-center gap-2.5" style={{ padding: collapsed ? '12px 10px' : '12px 12px' }}>
            ...
            <>
              ...
              >
                <div className="min-w-0">
                  <div className="text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]" style={{ fontSize: 10.5, fontWeight: 600, letterSpacing: '0.03em', textTransform: 'uppercase' }}>{projectKey}</div>
                  <div className="truncate text-[var(--ds-text,var(--ds-text, #172B4D))] dark:text-[var(--ds-text,var(--ds-text, #EDEDED))]" style={{ fontSize: 14, fontWeight: 600, fontFamily: 'var(--cp-font-heading)', lineHeight: '18px' }}>
                    {projectName}
                  </div>
                </div>
                <ChevronDown size={14} className="flex-shrink-0 text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[#7D7D7D]" />
              </button>
              <button
                onClick={onToggle}
                className="flex items-center justify-center rounded-md hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))] dark:hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))] transition-colors flex-shrink-0"
          ...
          {collapsed && (
            <button
              onClick={onToggle}
              className="absolute top-2 right-1 flex items-center justify-center rounded hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))] dark:hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))]"
      ...
      <div style={{ padding: '8px 8px 0' }}>
        <button
          ...
          className="flex items-center gap-2 w-full rounded-md transition-colors hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F4F5F7))] dark:hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))]"
          style={{
            height: 32, padding: collapsed ? '0' : '0 12px',
            fontSize: 12.5, fontWeight: 500, border: 'none', background: 'transparent',
            cursor: 'pointer', justifyContent: collapsed ? 'center' : 'flex-start', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))',
          }}
        >
          <ArrowLeft size={14} strokeWidth={1.75} className="text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]" />
          {!collapsed && <span className="dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">All Projects</span>}
        </button>
      </div>

      <div style={{ height: 1, background: '#EBECF0', margin: '8px 12px 4px' }} className="dark:bg-[var(--ds-border,var(--ds-border, #2E2E2E))]" />
      ...
      <div className="flex-1 py-1 overflow-y-auto" style={{ padding: '4px 6px' }}>
        ...
        <div style={{ height: 1, background: '#EBECF0', margin: '8px 8px 6px' }} className="dark:bg-[var(--ds-border,var(--ds-border, #2E2E2E))]" />

        {!collapsed && (
          <div className="dark:text-[#7D7D7D]" style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '6px 12px 6px', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))' }}>
            Planning
          </div>
        )}
        ...
        <div style={{ height: 1, background: '#EBECF0', margin: '10px 8px 6px' }} className="dark:bg-[var(--ds-border,var(--ds-border, #2E2E2E))]" />
        ...
        {!collapsed && recentItems.length > 0 && (
          <>
            ...
            >
              <ChevronRight
                size={12}
                className="text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[#7D7D7D]"
                style={{ transform: recentsExpanded ? 'rotate(90deg)' : 'rotate(0deg)', transition: 'transform 150ms ease' }}
              />
              <Clock size={12} className="text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #6B778C))] dark:text-[#7D7D7D]" />
              <span className="dark:text-[#7D7D7D]" style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))' }}>
                Recents
              </span>
      ...
      <div className="border-t border-[#EBECF0] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))]" style={{ padding: '8px 6px' }}>
