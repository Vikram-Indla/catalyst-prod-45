...
export function IntegrationTab() {
  ...
  return (
    <div className="space-y-6 dark:bg-[#1A1714]">
      {/* Section 1 — Connection Status */}
      <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[#3A3530] rounded-md p-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        {statCards.map((card) => {
          ...
          return (
            <div
              key={card.label}
              className="relative bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[#3A3530] rounded-md p-4"
            >
      ...
      <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[#3A3530] rounded-md overflow-hidden">
        ...
        {logsError ? (
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-[#E2E8F0] dark:border-[#3A3530]">
            ...
            <tbody>
              {syncLogs.map((log: any) => {
                ...
                return (
                  <tr
                    key={log.id}
                    className="border-b border-[#E2E8F0] dark:border-[#3A3530]"
