    ...
    >
      <div className="bg-white dark:bg-[#232019]" style={{ width: 440, borderRadius: 12, padding: 24, fontFamily: "'Inter', sans-serif" }}>
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-[var(--fg-1)] dark:text-[rgba(248,244,240,0.92)]" style={{ fontSize: 16, fontWeight: 700, fontFamily: "'Sora', sans-serif" }}>Add Status</h3>
          <button onClick={onClose} className="flex items-center justify-center rounded-md hover:bg-[var(--cp-bd-zone)] dark:hover:bg-[rgba(248,244,240,0.03)] transition-colors" style={{ width: 28, height: 28, border: 'none', background: 'transparent', cursor: 'pointer' }}>
        ...
        <div className="space-y-4">
          <div>
            <label className="text-[var(--fg-2)] dark:text-[rgba(248,244,240,0.72)]" style={{ fontSize: 12, fontWeight: 500, display: 'block', marginBottom: 4 }}>Status Name <span style={{ color: 'var(--sem-danger)' }}>*</span></label>
          ...
          <div>
            <label className="text-[var(--fg-2)] dark:text-[rgba(248,244,240,0.72)]" style={{ fontSize: 12, fontWeight: 500, display: 'block', marginBottom: 4 }}>Category <span style={{ color: 'var(--sem-danger)' }}>*</span></label>
          ...
          <div>
            <label className="text-[var(--fg-2)] dark:text-[rgba(248,244,240,0.72)]" style={{ fontSize: 12, fontWeight: 500, display: 'block', marginBottom: 6 }}>Color</label>
