...
export function AddStatusModal({ open, onClose, onSubmit, loading }: AddStatusModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#1A1A1A]" style={{ width: 440, borderRadius: 12, padding: 24, fontFamily: 'var(--cp-font-body)' }}>
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-[var(--fg-1)] dark:text-[#EDEDED]" style={{ fontSize: 16, fontWeight: 700, fontFamily: 'var(--cp-font-heading)' }}>Add Status</h3>
