        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4 pt-2">
              ...
              >
                <span className="rounded-full bg-[var(--bg-app)] dark:bg-[var(--ds-surface,#0A0A0A)]" style={{ width: 16, height: 16, borderRadius: '50%', position: 'absolute', top: 3, left: form.feature_layer ? 21 : 3, transition: 'left 150ms ease', boxShadow: '0 1px 2px var(--ds-shadow-raised, rgba(0,0,0,0.15))' }} />
              </button>
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', position: 'relative' }}
              >
                <span className="rounded-full bg-[var(--bg-app)] dark:bg-[var(--ds-surface,#0A0A0A)]" style={{ width: 16, height: 16, borderRadius: '50%', position: 'absolute', top: 3, left: form.ai_assist ? 21 : 3, transition: 'left 150ms ease', boxShadow: '0 1px 2px var(--ds-shadow-raised, rgba(0,0,0,0.15))' }} />
              </button>
            </div>
          </div>
        </div>
