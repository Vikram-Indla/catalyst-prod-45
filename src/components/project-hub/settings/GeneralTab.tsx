        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={inputStyle} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
            </div>
            ...
            <div>
              ...
              <select value={form.department} onChange={e => setForm(f => ({ ...f, department: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler as any} onBlur={inputBlurHandler as any}>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={{ ...inputStyle, height: 'auto', padding: '8px 12px', resize: 'vertical' }}
          ...
          <div className="space-y-4">
            <div>
              ...
              <select value={form.status} onChange={e => setForm(f => ({ ...f, status: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler as any} onBlur={inputBlurHandler as any}>
                {STATUSES.map(s => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" value={form.start_date} onChange={e => setForm(f => ({ ...f, start_date: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
              </div>
              <div>
                <label style={labelStyle}>End Date</label>
                <input type="date" value={form.end_date} onChange={e => setForm(f => ({ ...f, end_date: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface)]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
              </div>
            </div>
