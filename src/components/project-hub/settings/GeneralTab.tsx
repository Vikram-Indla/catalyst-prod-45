          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4 pt-2">
              ...
              <button
                ...
                className={`flex-shrink-0 rounded-full transition-colors ${form.feature_layer ? 'bg-[var(--cp-blue)]' : 'bg-[var(--divider)] dark:bg-[#222222]'}`}
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className={`flex-shrink-0 rounded-full transition-colors ${form.ai_assist ? 'bg-[var(--cp-blue)]' : 'bg-[var(--divider)] dark:bg-[#222222]'}`}
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', position: 'relative' }}
              >
