        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={inputStyle} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="bg-[var(--cp-bd-zone)] dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))]"
            ...
            <div>
              ...
              <select value={form.department} onChange={e => setForm(f => ({ ...f, department: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler as any} onBlur={inputBlurHandler as any}>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ ...inputStyle, height: 'auto', padding: '8px 12px', resize: 'vertical' }}
          ...
          <div className="space-y-4">
            <div>
              ...
              <select value={form.status} onChange={e => setForm(f => ({ ...f, status: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler as any} onBlur={inputBlurHandler as any}>
                {STATUSES.map(s => (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" value={form.start_date} onChange={e => setForm(f => ({ ...f, start_date: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
              </div>
              <div>
                <label style={labelStyle}>End Date</label>
                <input type="date" value={form.end_date} onChange={e => setForm(f => ({ ...f, end_date: e.target.value }))} className="bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ ...inputStyle, cursor: 'pointer' }} onFocus={inputFocusHandler} onBlur={inputBlurHandler} />
              </div>
            </div>
            ...
            <div className="flex items-start justify-between gap-4 pt-2">
              ...
              <button
                ...
                className={`flex-shrink-0 rounded-full transition-colors ${form.feature_layer ? 'bg-[var(--cp-blue)]' : 'bg-[var(--divider)] dark:bg-[var(--ds-border,var(--ds-border, #292929))]'}`}
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', position: 'relative' }}
              >
                <span className="rounded-full bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ width: 16, height: 16, borderRadius: '50%', position: 'absolute', top: 3, left: form.feature_layer ? 21 : 3, transition: 'left 150ms ease', boxShadow: '0 1px 2px rgba(0,0,0,0.15)' }} />
              </button>
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className={`flex-shrink-0 rounded-full transition-colors ${form.ai_assist ? 'bg-[var(--cp-blue)]' : 'bg-[var(--divider)] dark:bg-[var(--ds-border,var(--ds-border, #292929))]'}`}
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', position: 'relative' }}
              >
                <span className="rounded-full bg-[var(--bg-app)] dark:bg-[var(--ds-surface,var(--ds-surface, #0A0A0A))]" style={{ width: 16, height: 16, borderRadius: '50%', position: 'absolute', top: 3, left: form.ai_assist ? 21 : 3, transition: 'left 150ms ease', boxShadow: '0 1px 2px rgba(0,0,0,0.15)' }} />
              </button>
            </div>
          </div>
        </div>
