      ...
      {isLoading ? (
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {components.map((c: any) => (
            <div
              key={c.id}
              className="inline-flex items-center gap-2 rounded-full transition-colors hover:opacity-80 bg-[var(--cp-bd-zone)] dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))]"
              style={{
