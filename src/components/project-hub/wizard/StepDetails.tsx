  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={leadRef} className="relative">
          ...
          {selectedLead ? (
            <div className="flex items-center gap-2 min-w-0">
              {selectedLead.avatar_url ? (
                ...
                <div className="rounded-full flex items-center justify-center shrink-0 bg-[var(--bd-default, #E2E8F0)] dark:bg-[var(--ds-border,var(--ds-border, #292929))]" style={{ width: 22, height: 22, fontSize: 9, fontWeight: 700, color: 'var(--ds-text-subtle, var(--ds-text-subtle, #475569))' }}>
        ...
        {showLeadPicker && (
          <div
            className="absolute left-0 right-0 z-50 bg-white dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] border border-[var(--bd-default, #E2E8F0)] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] rounded-lg shadow-lg"
            style={{ top: '100%', marginTop: 4, maxHeight: 260, display: 'flex', flexDirection: 'column' }}
          >
            <div className="p-2 border-b border-[var(--bd-default, #E2E8F0)] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-[13px] pl-8 pr-3 py-1.5 rounded border border-[var(--bd-default, #E2E8F0)] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] bg-transparent outline-none"
              ...
              {filteredProfiles.length === 0 ? (
                ...
                filteredProfiles.map(p => (
                  <button
                    ...
                    className="flex items-center gap-2 px-2.5 py-2 rounded-md text-sm hover:bg-[var(--ds-surface-sunken,var(--ds-surface-sunken, #F1F5F9))] dark:hover:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1F1F1F))] w-full text-left"
                  >
                    {p.avatar_url ? (
                      <img src={p.avatar_url} alt="" className="rounded-full" style={{ width: 24, height: 24, objectFit: 'cover' }} />
                    ) : (
                      <div className="rounded-full flex items-center justify-center shrink-0 bg-[var(--bd-default, #E2E8F0)] dark:bg-[var(--ds-border,var(--ds-border, #292929))]" style={{ width: 24, height: 24, fontSize: 9, fontWeight: 700, color: 'var(--ds-text-subtle, var(--ds-text-subtle, #475569))' }}>
                    ...
                    {p.id === data.lead_id && <Check size={14} className="ml-auto text-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" />}
                  </button>
                ))
              )}
            </div>
      ...
      {/* Jira Link Toggle */}
      <div className="rounded-lg border border-[var(--bd-default, #E2E8F0)] dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] p-4">
