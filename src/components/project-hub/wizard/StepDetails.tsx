  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={leadRef} className="relative">
          ...
          {selectedLead ? (
            <div className="flex items-center gap-2 min-w-0">
              {selectedLead.avatar_url ? (
                ...
                <div className="rounded-full flex items-center justify-center shrink-0 bg-[var(--bd-default, rgba(255,255,255,0.10))] dark:bg-[#292929]" style={{ width: 22, height: 22, fontSize: 9, fontWeight: 700, color: '#475569' }}>
        ...
        {showLeadPicker && (
          <div
            className="absolute left-0 right-0 z-50 bg-white dark:bg-[#1A1A1A] border border-[var(--bd-default, rgba(255,255,255,0.10))] dark:border-[rgba(255,255,255,0.08)] rounded-lg shadow-lg"
            style={{ top: '100%', marginTop: 4, maxHeight: 260, display: 'flex', flexDirection: 'column' }}
          >
            <div className="p-2 border-b border-[var(--bd-default, rgba(255,255,255,0.10))] dark:border-[rgba(255,255,255,0.08)]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-[13px] pl-8 pr-3 py-1.5 rounded border border-[var(--bd-default, rgba(255,255,255,0.10))] dark:border-[rgba(255,255,255,0.08)] bg-transparent outline-none"
              ...
              {filteredProfiles.length === 0 ? (
                ...
                filteredProfiles.map(p => (
                  <button
                    ...
                    className="flex items-center gap-2 px-2.5 py-2 rounded-md text-sm hover:bg-[#1A1A1A] dark:hover:bg-[rgba(255,255,255,0.04)] w-full text-left"
                  >
                    {p.avatar_url ? (
                      <img src={p.avatar_url} alt="" className="rounded-full" style={{ width: 24, height: 24, objectFit: 'cover' }} />
                    ) : (
                      <div className="rounded-full flex items-center justify-center shrink-0 bg-[var(--bd-default, rgba(255,255,255,0.10))] dark:bg-[#292929]" style={{ width: 24, height: 24, fontSize: 9, fontWeight: 700, color: '#475569' }}>
      ...
      {/* Jira Link Toggle */}
      <div className="rounded-lg border border-[var(--bd-default, rgba(255,255,255,0.10))] dark:border-[rgba(255,255,255,0.08)] p-4">
