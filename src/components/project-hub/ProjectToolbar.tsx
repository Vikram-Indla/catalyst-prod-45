...
export function ProjectToolbar({
  ...
  const textColor = isDark ? 'rgba(248,244,240,0.92)' : 'var(--fg-1)';
  const mutedColor = isDark ? 'rgba(248,244,240,0.40)' : 'var(--fg-4)';
  const subtleColor = isDark ? 'rgba(248,244,240,0.60)' : 'var(--fg-3)';
