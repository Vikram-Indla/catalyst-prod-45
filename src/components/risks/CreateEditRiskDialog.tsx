...
export function CreateEditRiskDialog({
  ...
  const inputClasses = "w-full px-3 py-2.5 rounded-lg text-sm bg-white dark:bg-[#0D1117] border border-[#E1E4E8] dark:border-[#30363D] text-[#24292F] dark:text-[#E6EDF3] placeholder:text-[#8B949E] dark:placeholder:text-[#6E7681] focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:ring-1 focus:ring-[rgba(37,99,235,0.3)] outline-none";
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
            ...
            <DialogFooter className="mt-4 pt-4 border-t border-[#E1E4E8] dark:border-[#30363D]">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))] text-white disabled:opacity-50"
              >
