  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 16, fontWeight: 650, color: 'var(--fg-1)', margin: '0 0 16px', fontFamily: 'var(--ds-font-family-heading)' }}>
            ...
            <div style={{
              ...
              {epics.map(e => (
                <div key={e.id} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0' }}>
                  <span style={{
                    fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 10,
