    ...
    <div style={{ marginBottom: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, padding: '20px 28px' }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ width: '100%', height: 4, background: 'var(--ds-border, var(--ds-border, #E5E7EB))', borderRadius: 4, marginTop: 8 }}>
        ...
        <div style={cardStyle}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{
              ...
              background: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', border: '0.75px solid rgba(15,23,42,0.12)',
...
function activityDotColor(eventType: string): string {
  ...
  if (eventType === 'import') return 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))';
  if (eventType === 'epic_generated' || eventType === 'published') return 'var(--ds-text-success, var(--ds-text-success, #16A34A))';
