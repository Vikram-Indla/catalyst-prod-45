...
export default function RAJiraSidePanel({ doc, onClose, onOpenPdf, onGenerate, onViewDrafts, onSyncKb }: Props) {
  ...
  const getStageLozenge = () => {
    ...
    if (stage === 'complete') return { bg: 'var(--cp-lozenge-green-bg, #1B7F37)', color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))', label: 'COMPLETE' };
    ...
    return { bg: 'var(--ds-link, #0C66E4)', color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))', label: stage.toUpperCase() };
  };
      ...
      <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <a
                ...
                style={{
                  ...
                  background: 'var(--cp-primary-5)', border: isDark ? '0.75px solid rgba(37,99,235,0.30)' : '0.75px solid var(--ds-border, #BFDBFE)', borderRadius: 4,
        ...
        {brdData.rawTextSource === 'title_only' && (
          <div style={{
            ...
            background: 'var(--cp-warning-light, #FFFBEB)', border: isDark ? '0.75px solid rgba(217,119,6,0.25)' : '0.75px solid #FDE68A',
                ...
                <span style={{ fontSize: 13, color: domain ? 'var(--fg-2)' : 'var(--fg-4)', fontFamily: 'var(--cp-font-body)' }}>
                  {domain || (
                    <span style={{
                      ...
                      background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', borderRadius: 4, fontSize: 11, color: 'var(--fg-4)',
                      fontFamily: 'var(--cp-font-body)',
                    }}>Uncategorised</span>
                  )}
                </span>
            ...
            <div style={{ marginTop: 10 }}>
              {doc.pdf_url ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '16px 0', gap: 4 }}>
                  <Paperclip size={18} color={'var(--cp-bg-sunken, #CBD5E1)'} />
            ...
            <div style={{ marginTop: 10 }}>
              {brdData.raw_text ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 0', gap: 6 }}>
                  <FileText size={20} color={'var(--cp-bg-sunken, #CBD5E1)'} />
            ...
            <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 0', borderBottom: isDark ? '0.75px solid #292929' : '0.75px solid rgba(15,23,42,0.06)' }}>
                ...
                {epicCount > 0 ? (
                  ...
                  <span style={{
                    display: 'inline-flex', alignItems: 'center', padding: '2px 10px', borderRadius: 12,
                    background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', color: 'var(--fg-4)', border: isDark ? '0.75px solid #2E2E2E' : '0.75px solid rgba(15,23,42,0.12)',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 0', borderBottom: isDark ? '0.75px solid #292929' : '0.75px solid rgba(15,23,42,0.06)' }}>
                ...
                {wikiCount > 0 ? (
                  <span style={{
                    display: 'inline-flex', alignItems: 'center', padding: '2px 10px', borderRadius: 12,
                    background: 'var(--cp-success-light, #F0FDFA)', border: isDark ? '0.75px solid rgba(13,148,136,0.25)' : '0.75px solid #99F6E4',
              ...
              <div style={{
                ...
                <div style={{ width: 28, height: 28, borderRadius: 6, background: 'var(--cp-bg-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                {uatCount > 0 ? (
                  <span style={{
                    display: 'inline-flex', alignItems: 'center', padding: '2px 10px', borderRadius: 12,
                    background: 'var(--cp-success-light, #F0FDF4)', border: isDark ? '0.75px solid rgba(22,163,74,0.25)' : '0.75px solid #BBF7D0',
        ...
        {/* ── FOOTER CTA ── */}
        <div style={{ padding: '14px 20px', borderTop: isDark ? '0.75px solid #2E2E2E' : '0.75px solid rgba(15,23,42,0.10)', flexShrink: 0, background: isDark ? 'var(--cp-bg-page, #1F1F21)' : 'var(--bg-app)' }}>
          {epicCount === 0 ? (
...
function TicketTypeBadgeDrawer({ type }: { type: string | null }) {
  ...
  const map: Record<string, { bg: string; color: string; label: string }> = {
    subtask: { bg: dark ? 'rgba(217,119,6,0.15)' : 'var(--ds-surface, #FEF3C7)', color: dark ? 'var(--ds-text-warning, #FBBF24)' : 'var(--ds-text-warning, #92400E)', label: 'SUBTASK' },
    ...
    epic: { bg: dark ? 'rgba(124,58,237,0.15)' : 'var(--ds-surface, #F3E8FF)', color: dark ? 'var(--ds-text-discovery, #A78BFA)' : 'var(--ds-text-discovery, #6B21A8)', label: 'EPIC' },
