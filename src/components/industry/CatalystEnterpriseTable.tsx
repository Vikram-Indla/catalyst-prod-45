      ...
      {showCheckboxes && (
        <td className="py-3 px-4 w-12" onClick={(e) => e.stopPropagation()}>
          <Checkbox
            ...
            className="border-[var(--ds-border,var(--ds-border, #2E2E2E))] data-[state=checked]:bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] data-[state=checked]:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]"
          />
        </td>
      )}
    ...
    <>
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          "bg-[var(--table-header-bg)] dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1a1a1a))]"
        )}>
                          ...
                          {(provided, snapshot) => (
                            <tr
                              ...
                              className={cn(
                                ...
                                rowIndex % 2 === 0 
                                  ? "bg-[var(--table-row-bg)]" 
                                  : "bg-[var(--table-row-alt-bg)] dark:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1f1f1f))]",
                                // Hover: surface tint, NOT border highlight
                                "hover:bg-[var(--table-row-hover)] dark:hover:bg-[#2a2a2a]",
                                // Selected: surface elevation with subtle brand accent
                                selectedRows.includes(row.id) && "bg-[var(--table-row-selected)] dark:bg-[var(--ds-surface-overlay,var(--ds-surface-overlay, #1f1f1f))] ring-1 ring-inset ring-[var(--brand-primary-hex)]/30",
                                // Dragging state
