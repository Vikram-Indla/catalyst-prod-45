    ...
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className={cn(
            "flex items-center justify-between w-full h-10 px-3 border rounded-md text-sm bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] transition-colors",
      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-1 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] shadow-lg rounded-md max-h-[200px] overflow-y-auto z-[100]" align="start">
        {options.map(option => (
          <div
            key={option.value}
            className={cn(
...
function DateInput({ 
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-auto p-0 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] shadow-lg rounded-md z-[100]" align="start">
        <Calendar 
          mode="single" 
          selected={value} 
          onSelect={(date) => {
...
export function FilterDemandsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleCancel}>
      <DialogContent className="max-w-[480px] w-[95vw] p-0 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] shadow-xl rounded-lg overflow-hidden gap-0 [&>button.absolute]:hidden">
        {/* Header */}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    localFilters.activeSmartFilter === sf.id
                      ...
                      : "bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border-border text-foreground hover:border-brand-primary hover:bg-brand-primary/5"
                  )}
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger className="h-10 bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border-border">
                    <SelectValue placeholder="All" />
                  </SelectTrigger>
                  <SelectContent className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] z-[100]">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between px-4 sm:px-5 py-3.5 border-t border-border bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))]">
