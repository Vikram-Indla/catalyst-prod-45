...
function MultiSelectDropdown({ 
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-1 bg-white dark:bg-[#2C2823] border dark:border-[rgba(255,255,255,0.08)] shadow-lg rounded-md max-h-[200px] overflow-y-auto z-[100]" align="start">
        {options.map(option => (
          <div
            key={option.value}
            className={cn(
...
function DateInput({ 
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-auto p-0 bg-white dark:bg-[#2C2823] border dark:border-[rgba(255,255,255,0.08)] shadow-lg rounded-md z-[100]" align="start">
        <Calendar 
          mode="single" 
          selected={value} 
          onSelect={(date) => {
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger className="h-10 bg-white dark:bg-[#232019] border-border">
                    <SelectValue placeholder="All" />
                  </SelectTrigger>
                  <SelectContent className="bg-white dark:bg-[#2C2823] z-[100]">
