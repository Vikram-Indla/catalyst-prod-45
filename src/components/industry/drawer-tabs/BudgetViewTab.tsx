  ...
  return (
    <div className="space-y-2">
      ...
      <div className={cn(
        ...
        "border-gray-200 dark:border-gray-700",
        "focus-within:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus-within:ring-1 focus-within:ring-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/20"
      )}>
        {tags.map((tag, index) => (
          <span key={index} className="inline-flex items-center gap-1">
            ...
            <button
              ...
              className="hover:bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/20 rounded-full p-0.5"
            >
              <X className="h-3 w-3" />
            </button>
          </span>
