  ...
  return (
    <div className={cn(
      ...
      <h3 className="
        ...
        text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:text-blue-400
        mb-5
...
export function CatalystCreateDemand({ data, onChange }: DemandDetailsTabProps) {
  ...
  const premiumInputClass = cn(
    ...
    "focus:outline-none",
    "focus:ring-2 focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/20",
    "focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]",
    "transition-all"
  );
