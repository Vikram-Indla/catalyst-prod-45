        ...
        <div key={group.key}>
          {group.label && (
            <div className="flex items-center gap-3 mb-3">
              <h3 className="text-sm font-semibold text-zinc-700 dark:text-[#EDEDED]">{group.label}</h3>
              <span className="text-xs font-medium text-zinc-400 dark:text-[#888888] bg-zinc-100 dark:bg-transparent dark:border dark:border-[rgba(255,255,255,0.08)] px-2 py-0.5 rounded-full">
                {group.items.length}
              </span>
