...
function getPriorityLabel(score: number | null): { label: string; color: string } {
  ...
  if (score >= 3.0) return { label: 'Medium', color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' };
  if (score >= 2.0) return { label: 'Low', color: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' };
  return { label: 'Rejected', color: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))' };
}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'border-zinc-200 dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))]',
        'hover:shadow-lg hover:border-zinc-300 hover:-translate-y-0.5 dark:hover:shadow-none dark:hover:border-[var(--ds-border,var(--ds-border, #2E2E2E))]',
    ...
    >
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span
            className={cn(
              ...
              status.label === 'New' && 'bg-gray-100 text-gray-700 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] dark:text-[var(--ds-text,var(--ds-text, #EDEDED))]',
              ...
              !['Done','New','Under Implementation','Portfolio Review','In Progress'].includes(status.label) && 'bg-gray-100 text-gray-700 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] dark:text-[var(--ds-text,var(--ds-text, #EDEDED))]',
            )}
          >
            {status.label}
          </span>
      ...
      {gridSize === 'large' && request.description && (
        <p className="px-4 pb-2 text-xs text-zinc-500 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))] leading-relaxed line-clamp-3">
          {request.description}
        </p>
      )}
      ...
      <div className="px-4 pb-3">
        {gridSize === 'small' ? (
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1.5">
              <div className="w-10 h-1.5 bg-zinc-100 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] rounded-full overflow-hidden">
                <div
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-zinc-500 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">{request.progress}%</span>
            </div>
          </div>
        ) : (
          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1 min-w-0 space-y-1.5">
              ...
              <span className="text-xs font-semibold text-zinc-700 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))]">
              ...
              <span className="text-[10px] text-zinc-500 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))] w-16 truncate">{s.label}</span>
                      <div className="flex-1 h-1.5 bg-zinc-100 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] rounded-full overflow-hidden">
                        <div
                          className="h-full rounded-full bg-blue-500"
              ...
              <div>
                <div className="flex items-center justify-between mb-0.5">
                  <span className="text-[10px] text-zinc-500 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))]">Progress</span>
                  <span className="text-[10px] font-medium text-zinc-700 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">{request.progress}%</span>
                </div>
                <div className="w-full h-1.5 bg-zinc-100 dark:bg-[var(--ds-surface-raised,var(--ds-surface-raised, #1A1A1A))] rounded-full overflow-hidden">
                  <div
      ...
      {/* Meta row */}
      <div className="px-4 pb-2">
        <div className="flex items-center gap-1.5 text-xs text-zinc-500 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))] flex-wrap">
      ...
      {gridSize !== 'small' && (
        <div className="px-4 pb-2">
          <div className="flex items-center gap-2 text-xs text-zinc-600 dark:text-[var(--ds-text,var(--ds-text, #EDEDED))]">
        ...
        <div className="px-4 pb-2 space-y-1">
          {[
            ...
            <div key={r.label} className="flex items-center text-xs">
              <span className="text-zinc-400 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #A1A1A1))] w-28">{r.label}</span>
      ...
      {/* Footer */}
      <div className="border-t border-zinc-100 dark:border-[var(--ds-border,var(--ds-border, #2E2E2E))] px-4 py-2">
        <span className="text-[10px] text-zinc-400 dark:text-[var(--ds-text-subtlest,var(--ds-text-subtlest, #878787))]">
          {gridSize === 'large'
