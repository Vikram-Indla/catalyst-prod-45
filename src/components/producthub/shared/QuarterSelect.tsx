...
export function QuarterSelect({ value, onChange, disabled }: QuarterSelectProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border border-zinc-200 dark:border-[var(--ds-border,var(--cp-ink-1))] rounded-lg shadow-lg py-1 max-h-64 overflow-y-auto">
          {/* Clear option */}
          <button
            type="button"
