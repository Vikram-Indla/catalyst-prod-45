  ...
  business_request: {
    ...
    svg: (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        <path d="M8 3.5L4.5 5.5V10.5L8 12.5L11.5 10.5V5.5L8 3.5Z" stroke="#FFFFFF" strokeWidth="1.2" fill="none" strokeLinejoin="round"/>
        <path d="M4.5 5.5L8 7.5M8 7.5L11.5 5.5M8 7.5V12.5" stroke="#FFFFFF" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
  },
};
