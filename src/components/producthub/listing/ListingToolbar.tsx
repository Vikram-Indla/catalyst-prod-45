...
export function ListingToolbar({
  ...
  const toolbarBtnDefault = `${toolbarBtnClass} text-zinc-700 border-zinc-300 bg-white dark:bg-[#1A1A1A] dark:text-[#EDEDED] dark:border-[rgba(255,255,255,0.08)] hover:bg-zinc-50 dark:hover:bg-[#1A1A1A] hover:border-zinc-400`;
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`${toolbarBtnClass} text-zinc-700 border-zinc-300 bg-white dark:bg-[#1A1A1A] dark:text-[#EDEDED] dark:border-[rgba(255,255,255,0.08)] hover:bg-zinc-50 dark:hover:bg-[#1A1A1A] hover:border-zinc-400`}
          >
          ...
          <button
            ...
            className={`${toolbarBtnClass} ${
              groupBy !== 'none'
                ...
                : 'text-zinc-700 border-zinc-300 bg-white dark:bg-[#1A1A1A] dark:text-[#EDEDED] dark:border-[rgba(255,255,255,0.08)] hover:bg-zinc-50 dark:hover:bg-[#1A1A1A] hover:border-zinc-400'
            }`}
          >
      ...
      <div className="flex items-center gap-3 pb-3">
        ...
        <div className="relative w-56">
          ...
          <input
            ...
            className="w-full h-8 pl-8 pr-8 text-[13px] bg-white dark:bg-[#1A1A1A] dark:text-[#EDEDED] border border-zinc-300 dark:border-[rgba(255,255,255,0.08)] rounded-md outline-none transition-all placeholder:text-zinc-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
          />
          {localSearch && (
              ...
              <button
                ...
                className={`h-7 px-3 text-[12px] font-medium rounded-full whitespace-nowrap border transition-colors ${
                  isActive
                    ...
                    : 'bg-white dark:bg-[#1A1A1A] text-zinc-600 dark:text-[#A1A1A1] border-zinc-300 dark:border-[rgba(255,255,255,0.08)] hover:bg-zinc-50 dark:hover:bg-[#1A1A1A] hover:border-zinc-400 hover:text-zinc-700'
                }`}
              >
                {f.label}
              </button>
