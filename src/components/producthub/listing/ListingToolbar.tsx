...
export function ListingToolbar({
  ...
  const toolbarBtnDefault = `${toolbarBtnClass} text-zinc-700 border-zinc-300 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] dark:text-[var(--ds-text,#EDEDED)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] hover:bg-zinc-50 dark:hover:bg-[var(--ds-surface-raised,#1A1A1A)] hover:border-zinc-400`;
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`${toolbarBtnClass} text-zinc-700 border-zinc-300 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] dark:text-[var(--ds-text,#EDEDED)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] hover:bg-zinc-50 dark:hover:bg-[var(--ds-surface-raised,#1A1A1A)] hover:border-zinc-400`}
          >
          ...
          <button
            ...
            className={`${toolbarBtnClass} ${
              groupBy !== 'none'
                ...
                : 'text-zinc-700 border-zinc-300 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] dark:text-[var(--ds-text,#EDEDED)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] hover:bg-zinc-50 dark:hover:bg-[var(--ds-surface-raised,#1A1A1A)] hover:border-zinc-400'
            }`}
          >
