...
export function KeyHistorySection({ workItemId, workItemType, currentKey }: KeyHistorySectionProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-xl shadow-none">
