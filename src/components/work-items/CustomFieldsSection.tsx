...
export function CustomFieldsSection({ entityType, entityId }: CustomFieldsSectionProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-xl shadow-none">
