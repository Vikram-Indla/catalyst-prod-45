...
export function CustomFieldsSection({ entityType, entityId }: CustomFieldsSectionProps) {
  ...
  if (isLoading) {
    return (
      <Card className="bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1))] border border-neutral-200 dark:border-[var(--ds-border,var(--cp-ink-1))] rounded-xl shadow-none">
