    ...
    >
      <defs>
        <marker
          ...
          orient="auto"
        >
          <polygon points="0 0, 8 3, 0 6" fill="var(--ds-text-warning)" />
        </marker>
        <marker
          ...
          orient="auto"
        >
          <polygon points="0 0, 8 3, 0 6" fill="var(--ds-chart-teal-bold)" />
        </marker>
      </defs>
      {paths.map((p) => (
        <path
          ...
          d={p.path}
          fill="none"
          stroke={p.isResolved ? 'var(--ds-chart-teal-bold)' : 'var(--ds-text-warning)'}
          strokeWidth={2}
