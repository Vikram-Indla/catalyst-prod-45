...
export function TimelineBar({ feature, left, width, onClick }: TimelineBarProps) {
  ...
  return (
    ...
    >
      ...
      {hasBlocker && (
        <div 
          className="absolute right-1 top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))] flex items-center justify-center"
