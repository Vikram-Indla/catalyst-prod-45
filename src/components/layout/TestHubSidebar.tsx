...
const sections: SidebarSection[] = [
  {
    ...
    items: [
      ...
      { id: 'team-status', title: 'Team Perf ✦', path: '/testhub/reports/team-status', icon: FileText, exact: false },
      { id: 'defects-incidents', title: 'Defects & Incidents ✦', path: '/testhub/reports/defects-incidents', icon: FileText, exact: false },
      { id: 'governance', title: 'Governance ✦', path: '/testhub/reports/governance', icon: FileText, exact: false },
      { id: 'product-status', title: 'Product Status ✦', path: '/testhub/reports/product-status', icon: FileText, exact: false },
