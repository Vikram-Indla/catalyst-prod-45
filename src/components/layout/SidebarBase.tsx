...
export function SidebarBase({
  ...
  const sidebarBorder = 'var(--cp-border, var(--ds-border, #DFE1E6))';
  const dividerColor = 'var(--cp-border, var(--ds-border, #DFE1E6))';
    ...
    <aside
      className={cn(
        ...
        style={{
          ...
          scrollbarColor: isDark ? '#454545 transparent' : 'var(--ds-border, #DFE1E6) transparent',
        }}
      >
