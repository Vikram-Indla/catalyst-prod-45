...
const ideasSidebarConfig: SidebarConfig = {
  ...
  items: [
    { id: 'Ideas Hub', title: 'Ideas Hub', path: '/ideas/hub', exact: true },
    { id: 'All Ideas', title: 'All Ideas', path: '/ideas/all', exact: false },
    { id: 'Submit Idea', title: 'Submit Idea', path: '/ideas/submit', exact: true },
    { id: 'Initiatives', title: 'Initiatives', path: '/ideas/initiatives', exact: false },
    { id: 'Scoring', title: 'Scoring Queue', path: '/ideas/scoring', exact: true },
    { id: 'Priority Matrix', title: 'Priority Matrix', path: '/ideas/matrix', exact: true },
  ],
};
