            ...
            const menuButton = (
              <button
                ...
                style={{
                  ...
                  background: active ? 'var(--ds-background-information)' : 'transparent',
                ...
                onMouseLeave={(e) => { 
                  e.currentTarget.style.background = active ? 'var(--ds-background-information)' : 'transparent';
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        if (!starred) {
                          ...
                          e.currentTarget.style.background = 'var(--ds-background-warning-bold)';
                        }
                      }}
                      onMouseLeave={(e) => {
                        if (!starred) {
