...
const allNavItems: NavItem[] = [
  ...
  { id: 'workstreams', label: 'Workstreams', path: '/task/workstreams', icon: Layers },
  { id: 'my-tasks', label: 'My Tasks', path: '/task/my-tasks', icon: CheckSquare },
  { id: 'boards', label: 'Boards', path: '/task/boards', icon: LayoutGrid },
  { id: 'task-list', label: 'Task List', path: '/task/task-list', icon: List },
  { id: 'timeline', label: 'Timeline', path: '/task/timeline', icon: GanttChartSquare },
  { 
    id: 'task10', 
    label: (
  ...
  { id: 'settings', label: 'Settings', path: '/task/settings', icon: Settings },
];
