...
/* ─── Light-mode hex (V3 Canonical White Canvas) ──────────────────────────
   ...
   Both canvas and panel are now 'var(--ds-surface, #FFFFFF)'. Paired with CatalystShell's
   JIRA_CANVAS_BG which was patched in the same pass.
   ──────────────────────────────────────────────────────────────────────── */
const JIRA_CANVAS = 'var(--ds-surface, #FFFFFF)';
const JIRA_PANEL  = 'var(--ds-surface, #FFFFFF)';
