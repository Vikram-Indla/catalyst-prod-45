...
const workItems = [
  { key: 'themes', label: 'Themes', icon: Layers, path: '/themes', color: 'bg-emerald-500' },
  { key: 'epics', label: 'Epics', icon: Diamond, path: '/epics', color: 'bg-blue-500' },
  { key: 'capabilities', label: 'Capabilities', icon: Box, path: '/items/capabilities', color: 'bg-amber-500' },
  { key: 'features', label: 'Features', icon: Zap, path: '/features', color: 'bg-purple-500' },
  { key: 'stories', label: 'Stories', icon: BookOpen, path: '/work-items/stories', color: 'bg-teal-500' },
...
const otherItems = [
  { key: 'objectives', label: 'Objectives', icon: Target, path: '/pi-objectives', color: 'bg-slate-600' },
  { key: 'dependencies', label: 'Dependencies', icon: GitBranch, path: '/dependencies', color: 'bg-slate-600' },
  { key: 'ideation', label: 'Ideation', icon: Lightbulb, path: '/items/ideation', color: 'bg-slate-600' },
  { key: 'risks', label: 'Risks', icon: AlertTriangle, path: '/roam', color: 'bg-slate-600' },
  { key: 'impediments', label: 'Impediments', icon: Shield, path: '/items/impediments', color: 'bg-slate-600' },
  { key: 'sprints', label: 'Sprints', icon: Calendar, path: '/sprints', color: 'bg-slate-600' },
  { key: 'program-increments', label: 'Program Increments', icon: Package, path: '/pis', color: 'bg-slate-600' },
