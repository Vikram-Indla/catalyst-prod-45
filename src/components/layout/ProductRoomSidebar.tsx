...
import { ChevronLeft, ChevronRight, Box, ListTree, Map, BookOpen, Lock, Users, BarChart3 } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Dashboard', path: '/industry/dashboard', icon: BarChart3, exact: true },
