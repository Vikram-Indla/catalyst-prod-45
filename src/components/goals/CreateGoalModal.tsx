/**
 * CreateGoalModal — Fix 3: field labels var(--fg-3, #94A3B8), Fix 13: section dividers, slider labels, weight helper
 */
...
// Fix 3: All labels var(--fg-3, #94A3B8), 10px, uppercase, 600
