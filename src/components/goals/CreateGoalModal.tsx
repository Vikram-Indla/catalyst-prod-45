/**
 * CreateGoalModal — Fix 3: field labels var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8)), Fix 13: section dividers, slider labels, weight helper
 */
...
// Fix 3: All labels var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8)), 10px, uppercase, 600
