...
function statusBadge(status: string, isDark = false) {
  const map: Record<string, { dot: string; bg: string; text: string; bgDk: string; txtDk: string; label: string }> = {
    ...
    draft:       { dot: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', bg: 'var(--ds-surface-sunken, #F1F5F9)',               text: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', bgDk: 'var(--ds-surface-raised, #1A1A1A)', txtDk: 'var(--ds-text-subtlest, #A1A1A1)', label: 'Draft' },
    not_started: { dot: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', bg: 'var(--ds-surface-sunken, #F1F5F9)',               text: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', bgDk: 'var(--ds-surface-raised, #1A1A1A)', txtDk: 'var(--ds-text-subtlest, #A1A1A1)', label: 'Not Started' },
    cancelled:   { dot: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', bg: 'var(--ds-surface-sunken, #F1F5F9)',               text: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', bgDk: 'var(--ds-surface-raised, #1A1A1A)', txtDk: 'var(--ds-text-subtlest, #A1A1A1)', label: 'Cancelled' },
  };
