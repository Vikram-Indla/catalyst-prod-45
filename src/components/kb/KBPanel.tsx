      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 'var(--cp-type-body, 14px)', fontWeight: 'var(--cp-weight-bold, 650)', color: 'var(--cp-text-primary, var(--fg-1))', letterSpacing: 'var(--cp-tracking-tight, -0.02em)', fontFamily: 'var(--ds-font-family-heading)' }}>Intelligence</span>
          </div>
        ...
        >
          ...
          {messages.length === 0 && (
            <div style={{ textAlign: 'center', paddingTop: 48, flex: 1 }}>
              <p style={{ fontSize: 'var(--cp-type-heading-sm, 20px)', fontWeight: 'var(--cp-weight-bold, 650)', color: 'var(--cp-text-primary, var(--fg-1))', margin: 0, fontFamily: 'var(--ds-font-family-heading)' }}>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  textTransform: 'uppercase', margin: 0, fontFamily: 'var(--ds-font-family-heading)',
