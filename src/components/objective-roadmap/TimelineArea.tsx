      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          ...
          {todayPosition >= 0 && todayPosition <= 100 && (
            ...
            >
              <span 
                className="px-1.5 py-0.5 text-[9px] font-semibold text-primary-foreground rounded whitespace-nowrap bg-primary"
              >
                TODAY
              </span>
            </div>
    ...
    >
      ...
      <div 
        ...
        style={{ 
          left: `${barLeft}%`, 
          width: `${barWidth}%`,
          background: 'var(--ds-border, var(--ds-border, #E5E7EB))',
          minWidth: '24px'
        }}
      >
        {/* Progress Fill - Gold */}
                ...
                return (
                  <div key={kr.id} className="flex items-center gap-2 text-[10px]">
                    <div 
                      ...
                      style={{ 
                        background: statusStyle.filled ? statusStyle.color : 'var(--ds-surface, var(--ds-surface, #ffffff))',
