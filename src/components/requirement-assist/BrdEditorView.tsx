...
const DEMO_SECTIONS: { number: string; title: string; qualityGood: boolean; content: string }[] = [
  ...
  { number: '8', title: 'Integration Points', qualityGood: true, content: 'The portal shall integrate with: (1) National Address API for address validation; (2) Absher for identity verification; (3) SADAD for payment processing; (4) Internal GIS system for factory location mapping; (5) Email/SMS gateway for notifications.' },
  { number: '9', title: 'User Interface Requirements', qualityGood: true, content: 'The portal shall provide a responsive web interface supporting Arabic (RTL) and English. Design shall follow the MIM digital brand guidelines. Accessibility: WCAG 2.1 Level AA compliance. Mobile-responsive design with minimum support for Chrome, Safari, and Edge browsers.' },
