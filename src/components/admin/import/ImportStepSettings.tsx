      ...
      <div className="border-t pt-6 space-y-6">
        ...
        {moduleConfig.requiresProject && projects.length > 0 && (
          <div className="space-y-2">
            <label htmlFor="target-project-select" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
        ...
        {/* File Encoding */}
        <div className="space-y-2">
          <label htmlFor="encoding-select" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>File encoding</label>
          <div style={{ maxWidth: '320px' }}>
            <AdsSelect
        ...
        {/* Delimiter */}
        <div className="space-y-2">
          <label htmlFor="delimiter" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
        ...
        {/* Date Format */}
        <div className="space-y-2">
          <label htmlFor="date-format-select" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
