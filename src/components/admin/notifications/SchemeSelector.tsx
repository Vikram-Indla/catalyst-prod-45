        ...
        <SelectContent>
          <SelectItem value="global">
            <span className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[var(--ds-text-success,var(--ds-text-success, #16A34A))]" />
              Global Defaults
            </span>
          </SelectItem>
          {schemes?.map((s) => (
            <SelectItem key={s.id} value={s.id}>
              <span className="flex items-center gap-2">
                {s.is_default && <span className="h-2 w-2 rounded-full bg-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]" />}
                {s.name}
              </span>
            </SelectItem>
          ))}
            ...
            {!selectedScheme.is_default && (
              <>
                ...
                <DropdownMenuItem
                  ...
                  className="text-[var(--ds-text-danger,var(--ds-text-danger, #DC2626))] focus:text-[var(--ds-text-danger,var(--ds-text-danger, #DC2626))]"
                >
