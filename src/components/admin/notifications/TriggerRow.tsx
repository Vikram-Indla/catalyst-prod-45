...
export const TriggerRow = memo(function TriggerRow({
  ...
  return (
    <div
      className={`grid grid-cols-[32px_1fr_90px_80px_52px_52px_52px_52px_48px] gap-2 px-4 items-center border-b border-[var(--ds-surface-sunken,#F1F5F9)] transition-colors duration-150 group ${
        isSelected
    ...
    >
      ...
      <div className="min-w-0 flex items-center gap-1.5">
        ...
        >
          ...
          >
            <span className="text-xs font-medium text-[var(--ds-text,#0F172A)] truncate leading-none">
              {displayName}
            </span>
          </button>
        </Tooltip>
