      ...
      <DialogContent className="sm:max-w-[480px]">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="scheme-name" className="text-xs font-medium text-[var(--ds-text,var(--ds-text, #0F172A))]">
              Scheme Name
            </Label>
            <Input
              id="scheme-name"
          ...
          {/* Description */}
          <div className="space-y-1.5">
            <Label htmlFor="scheme-desc" className="text-xs font-medium text-[var(--ds-text,var(--ds-text, #0F172A))]">
              Description
            </Label>
            <Textarea
              id="scheme-desc"
          ...
          <div className="flex items-center justify-between rounded-md border border-[var(--bd-default, #E2E8F0)] px-3 py-2.5">
            <div>
              <p className="text-xs font-medium text-[var(--ds-text,var(--ds-text, #0F172A))]">Set as Default Scheme</p>
              <p className="text-[11px] text-[var(--ds-text-subtle,var(--ds-text-subtle, #475569))] mt-0.5">
            ...
            <Switch
              ...
              className="data-[state=checked]:bg-[var(--ds-text-brand,var(--ds-text-brand, #2563EB))]"
            />
          </div>
        </div>
