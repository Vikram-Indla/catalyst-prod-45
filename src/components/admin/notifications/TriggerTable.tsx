    ...
    <div style={{ background: 'var(--ds-surface, #FFFFFF)', border: '1px solid var(--ds-border, #DCDFE4)', borderRadius: '3px', overflow: 'hidden' }}>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-[var(--ds-text,var(--cp-ink-1, #0F172A))] font-['Inter']">
            {group.label}
          </span>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] w-8 text-right font-['JetBrains_Mono']">
