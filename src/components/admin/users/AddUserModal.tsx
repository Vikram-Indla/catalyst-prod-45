        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <label htmlFor="firstName" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>First Name *</label>
              <Textfield
                id="firstName"
                value={firstName}
                onChange={(e) => {
            ...
            <div className="space-y-2">
              <label htmlFor="lastName" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Last Name *</label>
              <Textfield
                id="lastName"
                value={lastName}
                onChange={(e) => {
          ...
          <div className="space-y-2">
            <label style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Product Roles *</label>
