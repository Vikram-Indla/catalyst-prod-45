      ...
      <div style={{ background: 'var(--ds-surface, #FFFFFF)', border: '1px solid var(--ds-border, #DCDFE4)', borderRadius: '3px', padding: '32px' }}>
          ...
          {currentStep === 2 && (
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="app_id" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>App ID</label>
                ...
                <div>
                  <label htmlFor="client_id" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
                ...
                <div>
                  <label htmlFor="client_secret" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>
                ...
                <div>
                  <label htmlFor="signing_secret" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Signing Secret (optional)</label>
                  <div className="mt-1.5">
                    <Textfield
                      id="signing_secret"
                      type="password"
          ...
          {currentStep === 4 && (
            <div className="max-w-2xl mx-auto space-y-6">
              ...
              <div>
                <label style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Redirect URL</label>
