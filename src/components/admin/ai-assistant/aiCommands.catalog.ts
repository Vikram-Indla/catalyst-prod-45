...
export const COMMANDS: Command[] = [
  // Users
  { cat: 'Users', title: 'Invite a new user', desc: 'Send an invite to an email address', example: 'Invite n.alfassam.c@mim.gov.sa as Product Owner', risk: 'Low', slug: 'invite user', keywords: 'invite add email product owner' },
  { cat: 'Users', title: 'Create an account', desc: 'Add a person directly, no invite', example: 'Add Yazeed Daraz, y.daraz.c@mim.gov.sa', risk: 'Low', slug: 'add user', keywords: 'create account person add' },
  ...
  { cat: 'Users', title: 'Update a user email', desc: 'Change the email on an account', example: 'Change email for Arslan Malik to a.malik@mim.gov.sa', risk: 'Medium', slug: 'update email', keywords: 'email change address update' },
  ...
  { cat: 'Users', title: 'Resend an invitation', desc: 'Send the invite email again', example: 'Resend invite to n.alfassam.c@mim.gov.sa', risk: 'Low', slug: 'resend invite', keywords: 'resend invite again' },
  ...
  { cat: 'Roles', title: "Replace a user's role", desc: 'Swap one role for another', example: "Change Sikander Ahmad's role to React Lead", risk: 'Medium', slug: 'replace role', keywords: 'replace swap change role' },
  ...
  // Bulk operations
  { cat: 'Bulk operations', title: 'Invite multiple users', desc: 'Invite a list of people at once', example: 'Invite Nada Alfassam, Yazeed Daraz as React Developer', risk: 'Low', bulk: true, slug: 'invite users', keywords: 'invite bulk multiple users people csv' },
  ...
  { cat: 'Bulk operations', title: 'Assign a role to many users', desc: 'Give many people the same role', example: 'Make Nada Alfassam, Yazeed Daraz React Developers', risk: 'Medium', bulk: true, slug: 'assign role', keywords: 'assign bulk role multiple many' },
  ...
  { cat: 'Bulk operations', title: 'Move many users to a department', desc: 'Reassign many people at once', example: 'Move Nada Alfassam and Yazeed Daraz to Platform', risk: 'Low', bulk: true, slug: 'move to department', keywords: 'move bulk department multiple many' },
];
