...
export const COMMANDS: Command[] = [
  ...
  { cat: 'Users', title: 'Rename a user', desc: 'Change a person’s display name', example: 'Rename vikram@catalyst.io to Vikram Indla', risk: 'Low', slug: 'rename user', keywords: 'rename change name' },
  { cat: 'Users', title: 'Update a user email', desc: 'Change the email on an account', example: 'Change maria@catalyst.io to maria.k@catalyst.io', risk: 'Medium', slug: 'update email', keywords: 'email change address update' },
  { cat: 'Users', title: 'Deactivate a user', desc: 'Suspend access without deleting', example: 'Deactivate jon@acme.com', risk: 'Medium', slug: 'deactivate user', keywords: 'disable suspend off deactivate' },
  { cat: 'Users', title: 'Delete a user', desc: 'Permanently remove an account', example: 'Delete jon@acme.com', risk: 'High', slug: 'delete user', keywords: 'remove delete destroy' },
  { cat: 'Users', title: 'Send a password reset link', desc: 'Email a secure reset link', example: 'Reset password for vikram@catalyst.io', risk: 'Low', slug: 'reset password', keywords: 'reset password forgot' },
  { cat: 'Users', title: 'Resend an invitation', desc: 'Send the invite email again', example: 'Resend invite to priya@acme.com', risk: 'Low', slug: 'resend invite', keywords: 'resend invite again' },
  { cat: 'Users', title: 'Look up a user', desc: 'View a person’s roles and details', example: 'Look up vikram@catalyst.io', risk: 'Low', slug: 'lookup user', keywords: 'lookup find profile search view' },
  // Roles
