        ...
        {hasLinkedItems ? (
          <div className="space-y-4">
            ...
            {linkedEpics.length > 0 && (
              <div>
                <span className="text-sm font-medium mb-2 block" style={{ color: 'var(--ds-text, var(--cp-text-primary, #172B4D))' }}>Linked Epics:</span>
            ...
            <div>
              <label htmlFor="target-theme-select" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, #172B4D))', display: 'block', marginBottom: '8px' }}>Move epics to:</label>
              <AdsSelect
