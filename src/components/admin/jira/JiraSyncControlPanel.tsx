    ...
    <span
      ...
      style={
        enabled
          ...
          : { background: '#DFE1E6', color: '#253858' }   // StatusLozenge grey
      }
    >
      <span
        className="h-1.5 w-1.5 rounded-full"
        style={{ background: enabled ? '#006644' : '#253858' }}
      />
      {enabled ? 'LIVE' : 'FROZEN'}
    </span>
  );
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          borderColor: isFrozen ? '#DFE1E6' : '#DEEBFF',
          background: isFrozen ? '#F8FAFC' : '#DEEBFF22',
        }}
      >
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="flex items-start gap-3">
            <div
              ...
              style={{ background: isFrozen ? '#DFE1E6' : '#DEEBFF' }}
            >
              {isFrozen ? (
                <Lock style={{ width: 18, height: 18, color: '#253858' }} />
              ) : (
      ...
      {isFrozen && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
            <StatCard icon={Database}    label="Work Items"  value={config?.preserved_work_items} colour="#2563EB" />
            <StatCard icon={FolderSync}  label="Projects"    value={config?.preserved_projects}    colour="#2563EB" />
            <StatCard icon={Users}       label="Users Mapped" value={config?.preserved_users}      colour="#2563EB" />
          </div>
        </>
      )}
              ...
              <div className="flex items-center gap-3">
                ...
                {row.dormant ? (
                  <span
                    ...
                    style={{ fontSize: 10, background: '#DFE1E6', color: '#253858' }}
                  >
                    DORMANT
                  </span>
                ) : (
      ...
      <div
        ...
        style={{ background: '#F8FAFC', border: '1px solid var(--cp-border-default)' }}
      >
            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex items-center gap-2">
                  <Lock style={{ width: 16, height: 16, color: '#253858' }} />
                  Freeze Jira Sync
                </DialogTitle>
                <DialogDescription>
              ...
              <div className="space-y-4 py-1">
                <div className="rounded-md border px-4 py-3 space-y-1"
                  style={{ borderColor: '#DFE1E6', background: '#F8FAFC' }}>
                  <div className="flex items-center gap-2">
