    ...
    <span
      ...
      style={
        enabled
          ...
          : { background: 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))', color: 'var(--ds-text, #253858)' }   // StatusLozenge grey
      }
    >
      <span
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          borderColor: isFrozen ? 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))' : '#DEEBFF',
        ...
        <div className="flex items-start justify-between flex-wrap">
          <div className="flex items-start gap-3">
            <div
              ...
              style={{ background: isFrozen ? 'var(--ds-border, var(--cp-lozenge-grey-bg, var(--cp-border-neutral, #DFE1E6)))' : '#DEEBFF' }}
            >
              {isFrozen ? (
          ...
          {pendingState === 'disable' ? (
            <>
              ...
              <div className="space-y-4 py-1">
                ...
                <div>
                  <label htmlFor="freeze-note" style={{ fontSize: '12px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, #172B4D)))' }}>
