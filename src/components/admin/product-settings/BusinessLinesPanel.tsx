        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label htmlFor="bl-name" style={{ fontSize: '16px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, var(--ds-text, #172B4D))))' }}>Name</label>
              <Textfield
                id="bl-name"
                value={formData.name}
            ...
            <div className="space-y-2">
              <label htmlFor="bl-key" style={{ fontSize: '16px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, var(--ds-text, #172B4D))))' }}>Key</label>
              <Textfield
                id="bl-key"
                value={formData.key}
            ...
            <div className="space-y-2">
              <label htmlFor="bl-description" style={{ fontSize: '16px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, var(--ds-text, #172B4D))))' }}>Description</label>
              <TextArea
                id="bl-description"
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                />
                <label style={{ fontSize: '16px', color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, var(--ds-text, #172B4D))))' }}>Set as default</label>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label style={{ fontSize: '16px', color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, var(--ds-text, #172B4D))))' }}>Active</label>
              </div>
            </div>
          </div>
