        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <label htmlFor="ws-name" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, #172B4D)))' }}>Name</label>
              <Textfield
                id="ws-name"
                value={formData.name}
            ...
            <div className="space-y-2">
              <label htmlFor="ws-key" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, #172B4D)))' }}>Key</label>
              <Textfield
                id="ws-key"
            ...
            <div className="space-y-2">
              <label htmlFor="ws-category-select" style={{ fontSize: '14px', fontWeight: 500, color: 'var(--ds-text, var(--cp-text-primary, var(--cp-text-inverse, #172B4D)))' }}>Category</label>
              <AdsSelect
