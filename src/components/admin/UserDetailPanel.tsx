...
const monoSmall: React.CSSProperties = { fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '10px' };
const Code: React.FC<{ children: React.ReactNode; isDark?: boolean }> = ({ children, isDark = false }) => (
  <code style={{
    fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '10px',
                  ...
                  >
                    ...
                    <td style={{ padding: '6px 9px' }}>
                      <span className="jus-project-key-chip" style={{
                        fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '9px',
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 5, background: T.surface, borderBottom: `1px solid ${T.border}` }}>
        <div style={{ padding: '16px 16px 12px', display: 'flex', gap: '12px', position: 'relative' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: '15px', fontWeight: 700, color: T.text1, letterSpacing: '-0.2px' }}>
              {user.display_name}
            </div>
          ...
          <>
            ...
            <div className="jus-section-border" style={{ padding: '12px 16px', borderBottom: `1px solid ${T.border}` }}>
              ...
              <div className="jus-pwd-box" style={{
                ...
                <span style={{
                  flex: 1, fontFamily: showPwd ? 'var(--ds-font-family-monospaced)' : 'inherit',
