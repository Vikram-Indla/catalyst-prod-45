        ...
        <div className="w-full md:w-auto flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
          ...
          <Button 
            ...
            className={cn(
              ...
              "w-full md:w-auto",
              "text-white border-0",
              "shadow-[0_2px_8px_var(--ds-background-information, rgba(37,99,235,0.18))]",
              "hover:-translate-y-px hover:shadow-[0_4px_16px_var(--ds-background-information, rgba(37,99,235,0.25))]",
              "active:translate-y-0 active:shadow-[0_1px_4px_var(--ds-background-information, rgba(37,99,235,0.15))]",
