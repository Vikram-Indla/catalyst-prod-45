  ...
  return (
    ...
    <div className="bg-card border border-border rounded-lg p-4">
      ...
      <Button 
        variant="ghost" 
        size="sm" 
        className="w-full mt-2 h-8 text-[var(--ds-text-brand,var(--ds-text-brand, #3b82f6))] hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:bg-[rgba(59,130,246,0.1)] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] dark:hover:text-[#93c5fd]"
