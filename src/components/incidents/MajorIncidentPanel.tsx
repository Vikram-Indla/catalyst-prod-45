    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <AlertTriangle className={cn("w-4 h-4", isMajorIncident ? "text-red-600" : "text-[var(--ds-text-subtlest)]")} />
          <h4 className={cn(
            "text-sm font-semibold",
            isMajorIncident ? "text-red-700" : "text-[var(--ds-text,var(--cp-text-primary, var(--cp-text-inverse)))]"
          )}>
            Major Incident
          </h4>
        </div>
