  ...
  return (
    ...
    >
      <div className="p-4">
              ...
              {STATUS_OPTIONS.map((status) => (
                <div
                  ...
                  className={`px-3 py-2 text-sm cursor-pointer hover:bg-muted ${
                    incident.status === status.value ? 'bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/10 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]' : 'text-foreground'
                  }`}
                  onClick={() => {
        ...
        {isDetailsExpanded && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <div 
                className="text-sm text-foreground p-1.5 -mx-1.5 rounded border-2 border-transparent hover:bg-muted hover:border-border cursor-text focus-within:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] focus-within:shadow-[0_0_0_2px_rgba(37,99,235,0.3)] focus-within:bg-card"
                contentEditable
            ...
            <div>
              ...
              <a className="text-sm text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] dark:text-[var(--ds-text-brand,#60a5fa)] hover:underline cursor-pointer mt-1 inline-block">
                Assign to me
              </a>
            </div>
        ...
        {/* Configure Link */}
        <a className="flex items-center gap-1 text-[11px] text-muted-foreground hover:text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] mt-4 cursor-pointer">
