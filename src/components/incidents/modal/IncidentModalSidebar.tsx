        ...
        {isDetailsExpanded && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <div 
                className="text-sm text-foreground p-1.5 -mx-1.5 rounded border-2 border-transparent hover:bg-muted hover:border-border cursor-text focus-within:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] focus-within:shadow-[0_0_0_2px_var(--ds-background-information, rgba(37,99,235,0.3))] focus-within:bg-card"
                contentEditable
