  ...
  return (
    ...
    >
      <div className="p-4">
              ...
              {STATUS_OPTIONS.map((status) => (
                <div
                  ...
                  className={`px-3 py-2 text-sm cursor-pointer hover:bg-muted ${
                    incident.status === status.value ? 'bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/10 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]' : 'text-foreground'
                  }`}
                  onClick={() => {
        ...
        {isDetailsExpanded && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <a className="text-sm text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] dark:text-[var(--ds-text-brand)] hover:underline cursor-pointer mt-1 inline-block">
                Assign to me
              </a>
            </div>
        ...
        {/* Configure Link */}
        <a className="flex items-center gap-1 text-[11px] text-muted-foreground hover:text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] mt-4 cursor-pointer">
