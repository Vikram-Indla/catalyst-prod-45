          ...
          {!isComposerExpanded ? (
            ...
            >
              ...
              <div className="flex gap-2 flex-wrap">
                <button className="text-sm text-[#42526E] dark:text-[#A09890] bg-white dark:bg-[#232019] border border-[#DFE1E6] dark:border-[rgba(255,255,255,0.08)] px-3 py-1 rounded hover:bg-[#F4F5F7] dark:hover:bg-[#2C2823]">
                  Suggest a reply...
                </button>
                <button className="text-sm text-[#42526E] dark:text-[#A09890] bg-white dark:bg-[#232019] border border-[#DFE1E6] dark:border-[rgba(255,255,255,0.08)] px-3 py-1 rounded hover:bg-[#F4F5F7] dark:hover:bg-[#2C2823]">
                  Status update...
              ...
              <div className="text-[11px] text-[#A5ADBA] mt-2">
                Pro tip: press <kbd className="inline-block bg-white dark:bg-[#232019] border border-[#DFE1E6] dark:border-[rgba(255,255,255,0.08)] px-1 rounded text-[11px]">M</kbd> to comment
              </div>
            </div>
          ) : (
            <div>
            ...
            <div className="flex-1">
              ...
              {activity.changeType === 'status' && (
                <div className="flex items-center gap-2 mt-1.5">
                  <span className="text-[11px] font-medium px-2 py-0.5 rounded border border-[#DFE1E6] dark:border-[rgba(255,255,255,0.08)] bg-white dark:bg-[#232019] text-[#172B4D] dark:text-[#F5F3F0]">
                    {activity.oldValue}
                  </span>
