  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 bg-card">
      ...
      <div className="mb-4">
        <h1 
          ...
          className={`text-2xl font-semibold text-foreground leading-7 p-1 rounded border-2 transition-all cursor-text ${
            isTitleFocused 
              ? 'border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] shadow-[0_0_0_2px_rgba(37,99,235,0.3)] bg-card' 
        ...
        <div className="flex gap-1 mt-2">
          <button 
            className="w-8 h-8 flex items-center justify-center border border-border rounded bg-card text-muted-foreground hover:bg-muted hover:border-border focus:outline-none focus:border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus:shadow-[0_0_0_1px_rgba(37,99,235,0.5)]"
            title="Add"
          >
      ...
      <div className="mb-6">
        ...
        <a className="text-sm text-muted-foreground hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:underline cursor-pointer">
