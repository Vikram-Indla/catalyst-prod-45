  ...
  return (
    <div className="bg-white dark:bg-card border border-[#E8E8E8] dark:border-border rounded-lg p-4">
          ...
          linkedItems.map(item => (
            ...
            >
              <div className="flex items-center gap-2 flex-1 min-w-0">
                ...
                <span className="text-xs font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]">{item.id}</span>
      ...
      <Button 
        variant="ghost" 
        size="sm" 
        className="w-full mt-2 h-8 text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] hover:text-[var(--ds-background-brand-bold-hovered,var(--ds-background-brand-bold-hovered, #1d4ed8))] dark:hover:text-[#93c5fd] hover:bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/10 dark:hover:bg-[var(--ds-text-brand,var(--ds-text-brand, #3b82f6))]/10"
        onClick={onAddItem}
      >
