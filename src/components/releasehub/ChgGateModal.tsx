            ...
            <div className="space-y-3">
              <div>
                ...
                <input type="text" value={workItemKey} onChange={e => setWorkItemKey(e.target.value)} placeholder="e.g. BAU-4612"
                  className="w-full h-9 px-3 rounded-md border border-[var(--bd-default,var(--cp-border, #E2E8F0))] text-[13px] font-mono" />
              </div>
              <div>
                ...
                <input type="text" value={workItemTitle} onChange={e => setWorkItemTitle(e.target.value)} placeholder="Describe the work item"
                  className="w-full h-9 px-3 rounded-md border border-[var(--bd-default,var(--cp-border, #E2E8F0))] text-[13px]" />
              </div>
