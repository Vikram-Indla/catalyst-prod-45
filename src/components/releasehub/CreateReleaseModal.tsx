...
export function CreateReleaseModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-white dark:bg-[#111111] rounded-xl shadow-2xl w-[480px] max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
        <div className="sticky top-0 bg-white dark:bg-[#111111] z-10 flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)]">
        ...
        <div className="sticky bottom-0 bg-white dark:bg-[#111111] border-t border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] px-6 py-3 flex justify-end gap-2">
