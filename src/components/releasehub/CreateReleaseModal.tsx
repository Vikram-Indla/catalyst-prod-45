...
const errStyle: React.CSSProperties = {
  fontFamily: RH.fontBody, fontSize: 'var(--ds-font-size-100)', color: 'var(--ds-text-danger)', marginTop: 4,
};
  ...
  return (
    <ModalTransition>
      <Modal onClose={onClose} width="medium">
        ...
        <ModalBody>
          {formError && (
            <div style={{ fontFamily: RH.fontBody, fontSize: 'var(--ds-font-size-200)', fontWeight: 500, color: 'var(--ds-text-danger)', background: 'var(--ds-background-danger)', padding: 8, borderRadius: 4, marginBottom: 16 }}>
              {formError}
            </div>
          )}
