  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      <div className="relative bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] rounded-xl shadow-2xl w-[520px] max-h-[85vh] overflow-y-auto" style={{ borderRadius: 8 }} onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <button onClick={() => setCatOpen(!catOpen)} className="w-full h-9 px-3 rounded-md border border-[rgba(15,23,42,0.12)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] text-[13px] text-left flex items-center justify-between hover:bg-[var(--ds-surface-sunken,#F8FAFC)] dark:hover:bg-[var(--ds-surface-raised,#1A1A1A)]">
              ...
              {catOpen && (
                <div className="absolute top-full left-0 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] rounded-md shadow-lg border border-[rgba(15,23,42,0.12)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] z-50 py-1">
                  {CATEGORIES.map(c => (
          ...
          <div>
            ...
            <div className="relative">
              ...
              {relOpen && (
                <div className="absolute top-full left-0 mt-1 w-full bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] rounded-md shadow-lg border border-[rgba(15,23,42,0.12)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] z-50 py-1 max-h-48 overflow-y-auto">
        ...
        <div className="sticky bottom-0 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] border-t border-[rgba(15,23,42,0.12)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] px-6 py-3 flex justify-end gap-2">
