        ...
        <div className="sticky top-0 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)] z-10 border-b border-[rgba(15,23,42,0.12)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] px-6 py-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-1.5">
              <button className="w-7 h-7 rounded flex items-center justify-center text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] hover:bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, #F1F5F9))]"><Download size={14} /></button>
              <button className="w-7 h-7 rounded flex items-center justify-center text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] hover:bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, #F1F5F9))]"><RefreshCw size={14} /></button>
              <button onClick={onClose} aria-label="Close drawer" className="w-7 h-7 rounded flex items-center justify-center text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))] hover:bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, #F1F5F9))]"><XIcon size={14} /></button>
            </div>
          </div>
            ...
            {editingDate ? (
              <span className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="w-6 h-6 flex items-center justify-center rounded border border-[var(--ds-border,var(--cp-border, #E2E8F0))] text-[var(--ds-text-subtlest,var(--cp-ink-3, #64748B))] hover:bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, #F1F5F9))]"
                  title="Cancel"
                >
                  <X size={11} />
                </button>
...
Do not use jargon. Do not hallucinate features not listed above.`;
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="border border-[var(--bd-default,var(--cp-border, #E2E8F0))] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))] rounded-md p-4 bg-white dark:bg-[var(--ds-surface-raised,#1A1A1A)]">
        ...
        return (
          <div key={s.stage} className="flex items-center gap-3 py-3 border-b border-[rgba(15,23,42,0.06)] last:border-0">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[12px] font-bold shrink-0 ${
              ...
              'bg-[var(--ds-surface-sunken,var(--cp-bg-sunken, #F1F5F9))] text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))]'
            }`}>
