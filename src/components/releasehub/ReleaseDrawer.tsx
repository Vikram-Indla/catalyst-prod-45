            ...
            {editingDate ? (
              <span className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="w-6 h-6 flex items-center justify-center rounded border border-[var(--ds-border,var(--cp-border, #E2E8F0))] text-[var(--ds-text-subtlest,var(--cp-ink-3, #64748B))] hover:bg-[var(--ds-surface-sunken,#F1F5F9)]"
                  title="Cancel"
                >
                  <X size={11} />
                </button>
    ...
    <div>
      ...
      <Dialog open={showLinkModal} onOpenChange={setShowLinkModal}>
        <DialogContent className="sm:max-w-[480px]">
          ...
          <DialogFooter>
            <button onClick={() => setShowLinkModal(false)} className="h-8 px-4 rounded-md text-[13px] font-medium text-[var(--ds-text-subtlest,var(--cp-ink-3, #64748B))] hover:bg-[var(--ds-surface-sunken,#F1F5F9)]">Close</button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
