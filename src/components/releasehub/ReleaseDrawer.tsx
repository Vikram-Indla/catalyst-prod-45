...
export function ReleaseDrawer({ release, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      ...
      <div className="relative w-[700px] h-full bg-white dark:bg-[#111111] shadow-2xl flex flex-col animate-in slide-in-from-right duration-300"
        onClick={e => e.stopPropagation()}>
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-[#111111] z-10 border-b border-[rgba(15,23,42,0.12)] dark:border-[rgba(255,255,255,0.08)] px-6 py-4">
...
Do not use jargon. Do not hallucinate features not listed above.`;
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="border border-[#E2E8F0] dark:border-[rgba(255,255,255,0.08)] rounded-md p-4 bg-white dark:bg-[#111111]">
