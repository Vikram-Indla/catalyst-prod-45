      ...
      <div className="grid grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-[var(--bd-default, #E2E8F0)] dark:border-[rgba(255,255,255,0.08)] p-5 relative overflow-hidden">
            ...
            <div className="h-2.5 w-16 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
          </div>
        ))}
      </div>
    );
          ...
          <div key={i} className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-[var(--bd-default, #E2E8F0)] dark:border-[rgba(255,255,255,0.08)] overflow-hidden">
            <div className="p-4 pl-5 space-y-3">
              <div className="flex gap-2">
                ...
                <div className="h-4 w-10 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
              </div>
              <div className="h-5 w-3/4 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
              <div className="flex gap-2">
                <div className="h-5 w-20 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
                <div className="h-5 w-16 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
                <div className="h-5 w-16 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
              </div>
              <div className="flex gap-2">
                <div className="h-5 w-14 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
                <div className="h-5 w-14 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
              </div>
            </div>
          </div>
    ...
    <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-[var(--bd-default, #E2E8F0)] dark:border-[rgba(255,255,255,0.08)] overflow-hidden">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 px-4 h-9 border-b border-[#F1F5F9] dark:border-[rgba(255,255,255,0.05)] last:border-0">
          ...
          <div className="h-3 w-14 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
          <div className="h-3 w-10 bg-[var(--bd-default, #E2E8F0)] dark:bg-[#292929] rounded animate-pulse" />
        </div>
      ))}
    </div>
  );
