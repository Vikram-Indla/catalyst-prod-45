...
const Q_COLORS: Record<string, string> = { Q1: '#7C3AED', Q2: 'var(--ds-text-brand, #2563EB)', Q3: '#0D9488', Q4: 'var(--ds-text-warning, #D97706)' };
...
function CoverSlide({ committed, ideas }: { committed: RoadmapIdea[]; ideas: RoadmapIdea[] }) {
  ...
  const qColors = ['#7C3AED', 'var(--ds-text-brand, #2563EB)', '#0D9488', 'var(--ds-text-warning, #D97706)'];
