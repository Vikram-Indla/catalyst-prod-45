  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ color: 'var(--fg-3)', fontSize: 11, marginLeft: 8, fontFamily: 'var(--ds-font-family-monospaced)' }}>
  ...
  return (
    <div style={{ display: 'flex', gap: 60, alignItems: 'center', maxWidth: 1200, width: '100%' }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: 48, fontWeight: 800, color: 'var(--bg-app)', fontFamily: 'var(--ds-font-family-heading)', lineHeight: 1.1, marginBottom: 8 }}>
          MIM Digital
        </div>
        <div style={{ fontSize: 48, fontWeight: 800, color: 'var(--sem-success)', fontFamily: 'var(--ds-font-family-heading)', lineHeight: 1.1, marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          {[
            ...
            <div key={s.label} style={{
              ...
              <div style={{ fontSize: 32, fontWeight: 800, color: 'var(--bg-app)', fontFamily: 'var(--ds-font-family-heading)' }}>{s.value}</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          {(['Q1', 'Q2', 'Q3', 'Q4'] as const).map((q, i) => (
            <div key={q} style={{
              ...
              <div style={{ fontSize: 36, fontWeight: 800, color: qColors[i], fontFamily: 'var(--ds-font-family-heading)' }}>{qs[q]}</div>
        ...
        return (
          <div key={idea.id} style={{
            ...
            <div style={{ width: 240, paddingRight: 16 }}>
              <div style={{ fontSize: 10, color: 'var(--fg-3)', fontFamily: 'var(--ds-font-family-monospaced)' }}>{idea.ideaKey}</div>
