...
export function RoadmapSidePanel({
  ...
  const labelStyle: React.CSSProperties = {
    ...
    letterSpacing: '0.05em', fontFamily: 'var(--ds-font-family-body)',
  };

  const fieldRowStyle: React.CSSProperties = {
    display: 'flex', alignItems: 'center', justifyContent: 'space-between',
    height: 32, fontSize: 13, color: '#0F172A', fontFamily: 'var(--ds-font-family-body)',
  };
      ...
      <div ref={panelRef} style={{
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <span style={{ fontSize: 12, fontFamily: 'var(--ds-font-family-monospaced)', color: 'var(--fg-4)' }}>
              {idea.ideaKey}
            </span>
            <div style={{
              fontSize: 14, fontWeight: 700, color: 'var(--fg-1)', fontFamily: 'var(--ds-font-family-heading)',
                ...
                {QUARTERS.map(q => {
                  ...
                  return (
                    <button key={q} onClick={() => onQuarterChange(idea, q)} style={{
                      ...
                      fontSize: 12, fontWeight: 700, fontFamily: 'var(--ds-font-family-body)',
            ...
            isConverted(idea.status) ? (
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 13, fontWeight: 650, fontFamily: 'var(--ds-font-family-body)',
                  transition: 'all 150ms',
                }}
              >
                ...
                <div key={m.key} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      padding: '0 10px', fontSize: 12, fontFamily: 'var(--ds-font-family-body)',
