...
function WorkflowSvg({ workflow, currentStateId }: { workflow: Workflow; currentStateId: string }) {
  ...
  return (
    <div style={{ overflowX: 'auto', border: '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)', borderRadius: 6, padding: 8, background: 'var(--ds-surface-sunken, #FAFBFC)' }}>
...
function TransitionTable({ workflow }: { workflow: Workflow }) {
  ...
  return (
    <div style={{ border: '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)', borderRadius: 6, overflow: 'hidden' }}>
