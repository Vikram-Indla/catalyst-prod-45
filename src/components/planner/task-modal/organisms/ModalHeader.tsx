          ...
          >
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
              ...
              <button
                ...
                style={{
                  padding: '10px 20px',
                  backgroundColor: 'var(--ds-text-danger, var(--ds-text-danger, #dc2626))',
                  border: 'none',
                  borderRadius: '12px',
                  fontSize: '14px',
                  fontWeight: 500,
    ...
    return (
      <div
        ...
        style={{
          ...
          backgroundColor: isHovered && !disabled ? (danger ? 'var(--ds-background-danger, var(--ds-background-danger, #fef2f2))' : COLORS.surfaceHover) : 'transparent',
          color: danger ? 'var(--ds-text-danger, var(--ds-text-danger, #dc2626))' : COLORS.textPrimary,
          fontSize: '14px',
