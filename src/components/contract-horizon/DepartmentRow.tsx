        ...
        <div className="p-5 border-r border-border bg-card">
          <div className="space-y-0">
            <div className="flex justify-between items-center py-3 border-b border-border">
              ...
              <span className="text-[18px] font-extrabold tracking-[-0.02em] text-[var(--ds-text-danger,var(--ds-text-danger, #ef4444))]">{stats.critical}</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-border">
              <span className="text-[12px] font-medium text-muted-foreground">Warning (60-90d)</span>
              <span className="text-[18px] font-extrabold tracking-[-0.02em] text-[var(--ds-text-warning,var(--ds-text-warning, #d97706))]">{stats.warning}</span>
            </div>
