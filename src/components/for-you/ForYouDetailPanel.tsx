  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 650, color: T.primary, flexShrink: 0 }}>{item.key}</span>
        <JiraSyncChip jiraKey={item.key} size="sm" />
        <span style={{ fontSize: 13, fontWeight: 500, color: T.ink, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flex: 1, fontFamily: 'var(--ds-font-family-body)' }}>{item.summary}</span>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, paddingLeft: 26 }}>
        ...
        {item.assigneeName && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
            ...
            <span style={{ fontSize: 12, fontWeight: 500, color: T.inkTertiary, fontFamily: 'var(--ds-font-family-body)' }}>{item.assigneeName}</span>
          </div>
        )}
        <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 500, color: T.inkMuted, marginLeft: 'auto', fontFamily: 'var(--ds-font-family-monospaced)' }}>{formatTimeAgo(item.updatedAt)}</span>
      </div>
    </button>
  );
}
      ...
      <div className="fy-detail-panel" style={{ position: 'fixed', top: 0, right: 0, width: 'min(58%, 880px)', minWidth: 520, height: '100vh', background: T.surface, borderLeft: `1px solid ${T.border}`, boxShadow: '-12px 0 48px rgba(0,0,0,0.12)', zIndex: 201, display: 'flex', flexDirection: 'column', animation: 'fy-slideIn .2s ease' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 20px', borderBottom: `1px solid ${T.border}`, background: T.surfaceSecondary, flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 600, color: T.primary, background: T.primaryBg, padding: '4px 12px', borderRadius: 4 }}>{currentItem.key}</span>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 10, fontWeight: 700, color: T.primary, background: T.primaryBg, padding: '3px 8px', borderRadius: 4, fontFamily: 'var(--ds-font-family-monospaced)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>JIRA SYNC</span>
        ...
        {panelStack.length > 1 && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '8px 24px', fontSize: 12, color: T.inkMuted, borderBottom: `1px solid ${T.border}`, backgroundColor: T.surfaceSecondary }}>
            {panelStack.slice(0, -1).map((stackItem, i) => (
              <Fragment key={stackItem.key}>
                <button
                  ...
                  style={{ background: 'none', border: 'none', cursor: 'pointer', color: T.primary, fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, fontWeight: 650, padding: 0 }}
                >
                  {stackItem.key}
                </button>
            ...
            <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, fontWeight: 650, color: T.ink }}>{currentItem.key}</span>
          </div>
        )}
        ...
        <div style={{ padding: '20px 24px 0', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
            ...
            <div style={{ flex: 1 }}>
              <h2 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 18, fontWeight: 700, color: T.ink, letterSpacing: '-0.025em', lineHeight: 1.35 }}>{currentItem.summary}</h2>
          ...
          {tabs.map(t => {
            ...
            return (
              <button key={t.id} onClick={() => setTab(t.id)} style={{
                ...
                cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)', display: 'flex', alignItems: 'center', gap: 6,
              }}>
                {t.icon}{t.label}
            ...
            <>
              ...
              {currentItem.parentKey && (
                <div className="fy-parent-banner" style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', marginBottom: 16, background: T.surfaceTertiary, borderRadius: 8, border: `1px solid ${T.border}` }}>
                  ...
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 600, color: T.primary }}>{currentItem.parentKey}</span>
              ...
              <div style={{ border: `1px solid ${T.border}`, borderRadius: 8, overflow: 'hidden' }}>
                ...
                <FieldRow icon={<GitBranch size={13} />} label="Fix Version"><span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12 }}>{currentItem.fixVersion || '—'}</span></FieldRow>
              ...
              <div className="fy-jira-sync" style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 16, padding: '10px 14px', background: T.primaryBg, borderRadius: 8, border: `1px solid ${T.border}` }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: T.primary, fontFamily: 'var(--ds-font-family-monospaced)' }}>JIRA SYNC</span>
              ...
              <div style={{ marginTop: 24 }}>
                <h3 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 14, fontWeight: 600, color: T.ink, paddingBottom: 8, borderBottom: `1px solid ${T.border}`, marginBottom: 12 }}>Description</h3>
              ...
              <div className="fy-activity" style={{ marginTop: 24 }}>
                <h3 style={{ fontFamily: 'var(--ds-font-family-heading)', fontSize: 14, fontWeight: 600, color: T.ink, paddingBottom: 8, borderBottom: `1px solid ${T.border}`, marginBottom: 16 }}>Recent Activity</h3>
                      ...
                      <div key={link.id} className="fy-link-card" style={{ display: 'flex', alignItems: 'flex-start', gap: 12, padding: '12px 14px', border: `1px solid ${T.border}`, borderRadius: 8, marginBottom: 8 }}>
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 4, flexWrap: 'wrap' }}>
                            ...
                            <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 600, color: T.primary }}>{linkedKey}</span>
