...
const TL = {
  ...
  success: 'var(--ds-text-success, #16A34A)', successText: '#11853D', successBg: '#F0FDF4',
  warning: 'var(--ds-text-warning, #D97706)', warningText: '#AF6003', warningBg: '#FFFBEB',
  danger: 'var(--ds-text-danger, #DC2626)', dangerText: '#D92525', dangerBg: 'var(--ds-background-danger, #FEF2F2)',
};

// Design tokens — dark mode (DARK MODE)
const TD = {
  ink: 'var(--ds-text, #EDEDED)', inkSecondary: 'rgba(255,255,255,0.82)', inkTertiary: 'rgba(255,255,255,0.60)',
  inkMuted: 'rgba(255,255,255,0.45)', inkMutedStrong: 'rgba(255,255,255,0.50)',
  surface: 'var(--ds-surface-raised, #1A1A1A)', surfaceSecondary: 'var(--ds-surface, #0A0A0A)', surfaceTertiary: 'var(--ds-surface-overlay, #1F1F1F)',
  border: 'var(--ds-border, #2E2E2E)', borderStrong: 'var(--ds-border-bold, #454545)',
  primary: 'var(--ds-text-brand, #60A5FA)', primaryHover: '#93C5FD', primaryBg: 'rgba(59,130,246,0.12)',
  ...
  danger: 'var(--ds-border-danger, #FCA5A5)', dangerText: 'var(--ds-border-danger, #FCA5A5)', dangerBg: 'rgba(220,38,38,0.15)',
};
