/**
 * For You Components Index
 * IMPORTANT: ForYouDetailPanel is NOT re-exported here to avoid pulling
 * its 888-line dependency tree into the main ForYouPage bundle.
 * Import it directly with React.lazy when needed.
 */
