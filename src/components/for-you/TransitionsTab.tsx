...
function SummaryCard({ label, value, sub, color }: { label: string; value: string; sub: string; color: string }) {
  return (
    <div style={{ flex: 1, padding: '12px 14px', background: T.surface, borderRadius: 8, border: `1px solid ${T.border}`, borderTop: `3px solid ${color}` }}>
      ...
      <div style={{ fontSize: 20, fontWeight: 700, color: T.ink, fontFamily: 'var(--ds-font-family-monospaced)', marginTop: 4 }}>{value}</div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 6, background: T.surfaceTertiary, border: `1px solid ${T.border}` }}>
            ...
            <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 600, color: T.ink }}>{step.durationLabel}{step.isCurrent ? '+' : ''}</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, gap: 12, flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 2 }}>
            <span style={{ fontSize: 11, fontWeight: 500, color: T.inkTertiary, fontFamily: 'var(--ds-font-family-monospaced)' }}>{formatDateTime(step.enteredAt)}</span>
            <span style={{ fontSize: 11, fontWeight: 500, color: T.inkMuted, fontFamily: 'var(--ds-font-family-monospaced)' }}>→ {step.exitedAt ? formatDateTime(step.exitedAt) : 'In progress…'}</span>
          </div>
        </div>
    ...
    <div style={{ marginTop: 24, padding: '16px', border: `1px solid ${T.border}`, borderRadius: 12, background: T.surface }}>
      <div style={{ marginBottom: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 700, color: T.ink, fontFamily: 'var(--ds-font-family-heading)' }}>Person Accountability</span>
        </div>
            ...
            <div key={person.name} style={{ padding: '10px 12px', border: `1px solid ${T.border}`, borderRadius: 8, background: T.surfaceSecondary }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontSize: 14, fontWeight: 700, color: T.ink, fontFamily: 'var(--ds-font-family-monospaced)' }}>{formatDuration(person.totalMs)}</div>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 20, padding: '8px 12px', background: T.surfaceTertiary, borderRadius: 6, border: `1px solid ${T.border}` }}>
        ...
        <span style={{ fontSize: 10, fontWeight: 700, color: T.inkMuted, fontFamily: 'var(--ds-font-family-monospaced)', letterSpacing: '0.06em' }}>JIRA SYNC</span>
