...
function TabButton({
  ...
  // use shadow elevation (invisible on dark canvas) and elevation.surface (var(--ds-surface))
  ...
  const background = isActive
    ? (isDark ? token('color.background.selected', 'var(--ds-text)') : token('elevation.surface', 'var(--ds-surface)'))
    : hover
