...
const TEXT = token('color.text', '#172B4D');
const SUBTLE = token('color.text.subtle', '#44546F');
const SUBTLEST = token('color.text.subtlest', '#626F86');
const LINK = token('color.link', '#0052CC');
const BORDER = token('color.border', '#DFE1E6');
const TILE_BG = token('color.background.neutral', 'rgba(5,21,36,0.06)');
const PILL_BG = token('color.background.neutral', '#F1F2F4');
