  ...
  return (
    <>
      <Sheet open={open} onOpenChange={(isOpen) => !isOpen && handleAttemptClose()}>
        <SheetContent side="right" hideClose className={`executive-drawer ${drawerWidthClass} p-0 flex flex-col overflow-hidden bg-white dark:bg-[#232019]`}>
          ...
          {/* Status Row */}
          <div className="px-4 md:px-5 py-2 flex items-center bg-white dark:bg-[#232019] shrink-0">
            <button 
