...
export function EpicDetailsViewTab({ data, onChange }: EpicDetailsViewTabProps) {
  ...
  return (
    <div className="flex flex-col h-full space-y-5 bg-muted/30 p-1">
      {/* DETAILS Section */}
      <div className="border border-border rounded-xl bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] p-5 space-y-5 shadow-sm">
      ...
      <div className="border border-border rounded-xl bg-white dark:bg-[var(--ds-surface-raised,var(--cp-ink-1, #1A1A1A))] p-5 space-y-5 shadow-sm flex-1">
