...
export function EpicKanbanCustom({ epics, onEpicClick, onContextMenu }: EpicKanbanCustomProps) {
  ...
  const [newColumnColor, setNewColumnColor] = useState('var(--ds-text-subtlest)');
  ...
  const columns = customColumns.length > 0
    ? customColumns
    : [
        { id: 'new', column_id: 'new', label: 'New', color: 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light)))', wip_limit: null },
        { id: 'in_progress', column_id: 'in_progress', label: 'In Progress', color: 'var(--ds-text-brand)', wip_limit: null },
        { id: 'review', column_id: 'review', label: 'Review', color: 'var(--ds-text-warning, var(--cp-amber))', wip_limit: null },
        { id: 'completed', column_id: 'completed', label: 'Completed', color: 'var(--ds-background-success-bold)', wip_limit: null },
      ];
  ...
  const addColumnMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setNewColumnLabel('');
      setNewColumnColor('var(--ds-text-subtlest)');
