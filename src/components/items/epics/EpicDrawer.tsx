                ...
                <div className="flex items-center gap-1.5 group">
                  {isEditingName ? (
                    <Input
                      ...
                      className="text-[22px] font-semibold h-auto py-1.5 px-2 max-w-[480px] border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] focus-visible:ring-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))]/20 transition-smooth"
                      style={{ 
              ...
              {EPIC_TABS.map((tab) => (
                <TabsTrigger
                  ...
                  className={cn(
                    ...
                    "data-[state=active]:after:bg-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] data-[state=active]:after:opacity-100"
                  )}
                >
                  {tab.label}
                </TabsTrigger>
