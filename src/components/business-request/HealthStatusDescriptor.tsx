...
const STATUS_DESCRIPTIONS: Record<string, string> = {
  'Uncommitted': 'No target date or linked work set. Delivery timeline unknown.',
...
export function HealthStatusDescriptor({ health }: HealthStatusDescriptorProps) {
  const description = health.health_descriptor || STATUS_DESCRIPTIONS[health.health_status] || '';
