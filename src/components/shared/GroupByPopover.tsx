...
export function GroupByPopover<K extends string>({
  ...
  const tk = {
    ...
    selectedBorder: 'var(--ds-text-brand, #2563EB)',
    shadow: isDark
    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          color: isActive ? 'var(--ds-text-brand, #2563EB)' : tk.text,
          ...
          <div ref={listRef} style={{ padding: '4px 0', maxHeight: 260, overflowY: 'auto' }}>
            ...
            {filtered.map((opt, idx) => {
              ...
              return (
                  ...
                  style={{
                    ...
                    background: isSelected
                      ...
                      : isFocused
                        ? tk.hover
                        : 'transparent',
                    color: isSelected ? 'var(--ds-text-brand, #2563EB)' : tk.text,
                ...
                >
                  <IconComp size={15} strokeWidth={1.8} style={{ color: isSelected ? 'var(--ds-text-brand, #2563EB)' : tk.textSecondary, flexShrink: 0 }} />
                  <span style={{ flex: 1, textAlign: 'left' }}>{opt.label}</span>
                  {isSelected && <Check size={14} style={{ color: 'var(--ds-text-brand, #2563EB)', flexShrink: 0 }} />}
                </button>
              );
            })}
          ...
          {isActive && (
            <div style={{ padding: '6px 12px', borderTop: `1px solid ${tk.borderSubtle}` }}>
              <button
                ...
                onMouseEnter={e => (e.currentTarget.style.color = 'var(--ds-text-brand, #2563EB)')}
