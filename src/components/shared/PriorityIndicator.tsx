...
export const PRIORITY_MAP: Record<PriorityLevel, PriorityConfig> = {
  ...
  low:      { label: 'Low',      level: 1, filledColor: 'var(--ds-text-subtlest, #94A3B8)', textColor: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', textColorDark: 'var(--ds-text-subtlest, #94A3B8)' },
};
