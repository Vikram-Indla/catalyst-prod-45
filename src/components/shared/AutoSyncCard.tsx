...
export function AutoSyncCard({ scheduleKeys, lastSyncTable, lastSyncColumn, title = 'Automated Sync' }: AutoSyncCardProps) {
  ...
  return (
    <div style={{
      ...
      border: '1px solid var(--wh-bdr, #E2E8F0)',
      padding: 20,
    }}>
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <Timer size={15} style={{ color: 'var(--wh-tx3, #64748B)' }} />
          <span style={{
      ...
      {lastSyncTable && (
        <div style={{
          ...
          background: isStale ? '#FFFBEB' : isFresh ? '#F0FDF4' : '#F8FAFC',
          border: `1px solid ${isStale ? '#FDE68A' : isFresh ? '#BBF7D0' : '#E2E8F0'}`,
        }}>
          {isStale ? (
          ...
          <div style={{ flex: 1 }}>
            <span style={{
              ...
              color: isStale ? '#92400E' : isFresh ? '#166534' : '#475569',
            }}>
              {lastSyncTime
        ...
        {schedules.map(s => {
          ...
          return (
            <div key={s.schedule_key} style={{
              ...
              background: edit.enabled ? '#F0F9FF' : '#F8FAFC',
              border: `1px solid ${edit.enabled ? '#BAE6FD' : '#E2E8F0'}`,
              transition: 'all 0.2s',
            }}>
              {/* Toggle */}
              <button
              ...
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  color: edit.enabled ? 'var(--wh-tx, #1E293B)' : '#94A3B8',
                  fontFamily: "var(--wh-fh, 'Inter')",
                }}>
                  {s.schedule_label}
                </div>
                <div style={{ fontSize: 10, color: '#94A3B8', fontFamily: "var(--wh-fn, 'Inter')", marginTop: 1 }}>
                  {s.timezone_label}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                <select
                  ...
                  style={{
                    ...
                    border: '1px solid #E2E8F0', fontFamily: "var(--wh-mo, monospace)",
                    fontWeight: 600, background: '#fff', color: edit.enabled ? '#1E293B' : '#94A3B8',
                ...
                <span style={{ fontSize: 10, color: '#94A3B8', fontFamily: "var(--wh-fn, 'Inter')", marginLeft: 4 }}>
                  UTC
                </span>
              </div>
            </div>
      ...
      {/* Help text */}
      <div style={{
        marginTop: 14, fontSize: 10, color: '#94A3B8',
