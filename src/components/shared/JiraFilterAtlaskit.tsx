    ...
    <>
      <button
        ...
        style={{
          ...
          padding: '0 12px',
          borderRadius: 3,
          border: `1px solid ${isOpen ? token('color.border.selected', '#0C66E4') : 'var(--ds-border, #DFE1E6)'}`,
  ...
  return (
    <div
      style={{
        ...
        borderBottom: noBorder ? 'none' : `1px solid ${'var(--ds-border, #DFE1E6)'}`,
      }}
    >
      <div
        style={{
        ...
        return (
          <label
            ...
            style={{
              ...
              padding: '6px 12px',
              borderRadius: 16,
              border: `1px solid ${isSel ? token('color.border.selected', '#0C66E4') : 'var(--ds-border, #DFE1E6)'}`,
