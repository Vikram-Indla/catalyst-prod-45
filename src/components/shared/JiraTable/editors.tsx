    ...
    <div style={{ padding: 8 }}>
      ...
      <div style={{ marginTop: 8, display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
        <button
          type="button"
          onClick={close}
          style={{ fontSize: 12, padding: '4px 8px', border: `1px solid ${'var(--ds-border, #DFE1E6)'}`, borderRadius: 3, background: 'transparent', cursor: 'pointer', color: token('color.text', '#172B4D') }}
        >
          Done
        </button>
      </div>
