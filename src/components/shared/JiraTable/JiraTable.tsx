  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      .jira-table-grid table tbody > tr > td {
        box-shadow: inset 0 -1px 0 0 var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6)) !important;
      }
      ...
      .jira-table-grid .jira-table-row-focused > td:first-child {
        box-shadow: inset 3px 0 0 #0C66E4, inset 0 -1px 0 0 var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6)) !important;
      }
      ...
      */
      ...
      .jira-table-grid table tbody > tr > td:first-child {
        ...
        border-right: 1px solid var(--cp-lozenge-grey-bg, #DFE1E6) !important;
      }
      ...
      /* ─────────────────────────────────────────────────────────────────────
         ...
         var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6)) grid line) need explicit .dark companions per Rule 3.
         ───────────────────────────────────────────────────────────────────── */
      ...
      {isOpen && anchor && createPortal(
        ...
        >
          ...
          <div style={{
            ...
            borderTop: '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)', marginTop: 4,
          }}>
