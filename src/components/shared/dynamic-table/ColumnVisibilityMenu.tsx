  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="inline-flex h-7 w-7 items-center justify-center rounded text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-text-brand)] focus-visible:ring-offset-1"
      >
