    ...
    <>
      <Sheet open={open} onOpenChange={(isOpen) => !isOpen && handleAttemptClose()}>
        <SheetContent
          side="right"
          hideClose
          className={`executive-drawer ${drawerWidthClass} p-0 flex flex-col overflow-hidden bg-white dark:bg-[#232019] border-l border-[#E1E4E8] dark:border-[rgba(255,255,255,0.08)]`}
        >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
            ...
            <div className="executive-drawer-content flex-1 flex flex-col min-h-0 overflow-y-auto bg-white dark:bg-[#232019]">
              {tabs.map((tab) => (
                <TabsContent
                  key={tab.value}
                  value={tab.value}
