  ...
  const bar = (
    ...
    >
      <div
        ...
        style={{
          backgroundColor: 'var(--cp-text-secondary, var(--cp-text-secondary))',
      ...
      >
        ...
        >
          <X size={18} color="var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated)))" strokeWidth={2} />
        </button>

        {/* Divider */}
        <div style={{ width: 1, height: 20, backgroundColor: 'var(--ds-surface)' }} />
        ...
        <button
          ...
          style={{ height: 44, padding: '0 14px', color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated)))', fontSize: 'var(--ds-font-size-400)', fontWeight: 500 }}
          ...
          <div className="flex items-center gap-1" style={{ padding: '0 8px' }}>
            <button
              ...
              style={{
                height: 32,
                padding: '0 12px',
                backgroundColor: 'var(--ds-text-danger, var(--cp-danger))',
                color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated)))',
            ...
            <button
              ...
              style={{ height: 32, padding: '0 10px', color: 'var(--ds-surface)', fontSize: 'var(--ds-font-size-300)' }}
            >
              Cancel
            </button>
          </div>
