...
export function DescriptionViewMode({
  ...
  if (!value) {
    return (
      <div style={{ padding: '12px 16px', backgroundColor: '#F7F8F9', borderRadius: '4px', border: '1px solid var(--ds-border, #DFE1E6)' }}>
  ...
  return (
    <div style={{ padding: '12px 16px', backgroundColor: '#FFFFFF', borderRadius: '4px', border: '1px solid var(--ds-border, #DFE1E6)' }}>
