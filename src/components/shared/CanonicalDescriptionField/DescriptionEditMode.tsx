    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <textarea
        ...
        style={{
          ...
          border: error ? '2px solid #AE2A19' : isNearLimit ? '2px solid #974F0C' : '2px solid var(--ds-border, #DFE1E6)',
          borderRadius: '4px',
        ...
        onBlur={(e) => {
          e.currentTarget.style.borderColor = error ? '#AE2A19' : isNearLimit ? '#974F0C' : 'var(--ds-border, #DFE1E6)';
        }}
      />
