    ...
    <Dialog open={open} onOpenChange={v => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-[520px] p-0" style={{ fontFamily: 'var(--cp-font-body)' }}>
        ...
        <div className="px-5 pb-2">
          <p className="text-[var(--ds-text-subtlest,var(--cp-ink-3, var(--cp-text-secondary, #64748B)))] dark:text-[var(--ds-text-subtlest,#878787)]" style={{ fontSize: 12, marginBottom: 12 }}>
          ...
          <div className="flex items-center gap-2 rounded-lg bg-white dark:bg-transparent border border-[var(--ds-text-disabled,#CBD5E1)] dark:border-[var(--ds-border,var(--cp-ink-1, #2E2E2E))]" style={{ height: 40, padding: '0 14px' }}>
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-[var(--ds-text,var(--cp-ink-1, #0F172A))] dark:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))] placeholder:text-[var(--ds-text-subtlest,var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))] dark:placeholder:text-[#7D7D7D]"
              style={{ fontSize: 13 }}
              autoFocus
            />
          </div>
              ...
              {available.map(u => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[var(--ds-text,var(--cp-ink-1, #0F172A))] dark:text-[var(--ds-text,var(--cp-bg-neutral, #EDEDED))]" style={{ fontSize: 13, fontWeight: 600, lineHeight: '18px' }}>{u.name}</div>
