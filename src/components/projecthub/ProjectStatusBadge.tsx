 ...
 * Grey  → bg:var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))  text:var(--ds-text, #253858)  → Planning / On Hold / Archived
...
const COLORS: Record<ColorCategory, { bg: string; text: string }> = {
  grey:  { bg: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))', text: 'var(--ds-text, #253858)' },
