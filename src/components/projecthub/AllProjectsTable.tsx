      ...
      case 'backlogs': return (
        <td key={colKey}>
          <div className="flex items-center justify-center gap-2.5" style={{ pointerEvents: 'auto' }}>
            <Tooltip><TooltipTrigger asChild><span className="cursor-pointer rounded p-0.5 hover:bg-slate-100 dark:hover:bg-white/5 transition-colors" onClick={e => { e.stopPropagation(); navigate(`/project-hub/${p.project_key}/hierarchy/allwork`); }}><JiraIssueTypeIcon type="story" size={18} /></span></TooltipTrigger><TooltipContent side="top" className="text-xs font-medium">Go to All Work</TooltipContent></Tooltip>
