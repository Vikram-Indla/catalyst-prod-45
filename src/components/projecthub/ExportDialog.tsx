  ...
  return (
    <Dialog open={open} onOpenChange={v => { if (!v) onClose(); }}>
      <DialogContent className="sm:max-w-[400px]" style={{ fontFamily: 'var(--cp-font-body)' }}>
        ...
        <p className="text-[var(--ds-text-subtlest,#64748B)] dark:text-[var(--ds-text-subtlest,#878787)]" style={{ fontSize: 13, marginTop: -4, marginBottom: 12 }}>
        ...
        <div className="grid grid-cols-3 gap-3">
          {FORMATS.map(f => (
            <button
              ...
              className="flex flex-col items-center gap-2 rounded-lg transition-all hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-[var(--ds-surface-overlay,#1F1F1F)] bg-[var(--ds-surface-sunken,#F8FAFC)] dark:bg-[var(--ds-surface-overlay,#1F1F1F)] border border-[var(--bd-default,#E2E8F0)] dark:border-[var(--ds-border,#2E2E2E)]"
