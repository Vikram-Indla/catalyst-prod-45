        ...
        <div className="grid grid-cols-3 gap-3">
          {FORMATS.map(f => (
            <button
              ...
              className="flex flex-col items-center gap-2 rounded-lg transition-all hover:border-blue-300 hover:bg-blue-50"
              style={{ padding: '20px 12px', background: '#F8FAFC', border: '1px solid #E2E8F0', cursor: 'pointer' }}
            >
