...
function FilterDropdown({ label, placeholder, options, selected, onToggle }: {
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      {open && (
        <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[rgba(235,238,245,0.10)]" style={{
...
export function ProjectAdvancedFilters({ filters, onChange, departments, onClose }: AdvancedFiltersProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[rgba(235,238,245,0.10)]" style={{ borderRadius: 8, padding: 16, marginBottom: 12 }}>
