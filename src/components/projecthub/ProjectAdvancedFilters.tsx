...
function FilterDropdown({ label, placeholder, options, selected, onToggle }: {
  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      <div className="text-[#64748B] dark:text-[rgba(248,244,240,0.55)]" style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: 4 }}>{label}</div>
      <button
        onClick={() => setOpen(!open)}
        className="bg-white dark:bg-transparent border-[1.5px] border-[#E2E8F0] dark:border-[rgba(248,244,240,0.10)]"
        style={{
      ...
      >
        ...
        <ChevronDown size={14} className="text-[#94A3B8] dark:text-[rgba(248,244,240,0.40)]" style={{ transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 150ms', flexShrink: 0 }} />
      </button>
      {open && (
        <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[rgba(248,244,240,0.10)]" style={{
...
export function ProjectAdvancedFilters({ filters, onChange, departments, onClose }: AdvancedFiltersProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#232019] border border-[#E2E8F0] dark:border-[rgba(248,244,240,0.10)]" style={{ borderRadius: 8, padding: 16, marginBottom: 12 }}>
