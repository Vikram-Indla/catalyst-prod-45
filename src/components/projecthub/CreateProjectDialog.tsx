...
export function CreateProjectDialog({ open, onClose }: Props) {
  ...
  const surface = dk ? 'var(--ds-surface-raised, var(--cp-ink-1, #1A1A1A))' : 'var(--bg-app)';
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <span style={{ fontFamily: 'var(--cp-font-heading)', fontSize: 18, fontWeight: 600, color: textPrimary, display: 'block' }}>
              Create new project
            </span>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Popover open={showLeadPicker} onOpenChange={o => { setShowLeadPicker(o); if (!o) setLeadFilter(''); }}>
              ...
              <PopoverContent
                ...
                style={{ background: dk ? 'var(--ds-surface-raised, var(--cp-ink-1, #1A1A1A))' : 'var(--ds-surface, #FFF)', border: `1px solid ${border}`, borderRadius: 6, zIndex: 9999, minWidth: 260 }}
                align="start"
              >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <textarea
              ...
              style={{
                ...
                border: `1.5px solid ${border}`, borderRadius: 6,
                fontSize: 14, fontFamily: 'var(--cp-font-body)', color: textPrimary,
