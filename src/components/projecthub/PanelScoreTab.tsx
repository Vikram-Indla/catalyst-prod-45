                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: sel ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'transparent',
                      color: sel ? 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated)))' : 'var(--fg-2)',
                      border: `1px solid ${sel ? 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary))' : 'var(--divider)'}`,
                      cursor: 'pointer',
                    }}
                  >
                    {n}
