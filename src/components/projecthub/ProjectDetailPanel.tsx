  ...
  return (
    <Sheet open={open} onOpenChange={v => { if (!v) onClose(); }}>
      <SheetContent side="right" className="p-0 w-[540px] max-w-full flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ borderBottom: '1px solid #E2E8F0', padding: '16px 20px' }}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <div style={{ fontSize: 16, fontWeight: 600, color: '#0F172A', fontFamily: "'Sora', sans-serif" }}>{project.name}</div>
              <div style={{ fontSize: 12, color: '#64748B' }}>{project.department || 'No department'} · {project.project_key}</div>
            </div>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full" style={{ padding: '2px 10px', background: '#F8FAFC', fontSize: 11, fontWeight: 500, color: '#475569', border: '1px solid #E2E8F0' }}>
          ...
          {/* Tabs */}
          <div className="flex gap-0 mt-3" style={{ borderBottom: '1px solid #E2E8F0' }}>
        ...
        {/* Footer */}
        <div className="flex items-center gap-3 p-4" style={{ borderTop: '1px solid #E2E8F0' }}>
          <button onClick={onClose} className="flex-1 rounded-md transition-colors" style={{ height: 36, background: '#FFF', border: '1px solid #E2E8F0', fontSize: 13, fontWeight: 500, color: '#475569', cursor: 'pointer' }}>
            Close
          </button>
          <button
            ...
            style={{ height: 36, background: '#2563EB', border: 'none', fontSize: 13, fontWeight: 600, color: '#FFF', cursor: 'pointer' }}
          >
