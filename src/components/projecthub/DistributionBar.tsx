...
export function DistributionBar({ todo, inProgress, done, showNumbers = false }: DistributionBarProps) {
  ...
  if (total === 0) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {showNumbers && <span className="text-[#94A3B8] dark:text-[#878787]" style={{ fontSize: 10, fontFamily: 'var(--ds-font-family-monospaced)', whiteSpace: 'nowrap' }}>—</span>}
      </div>
    );
  }
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 120 }}>
      ...
      {showNumbers && (
        <span className="text-[#64748B] dark:text-[#A1A1A1]" style={{ fontSize: 10, fontFamily: 'var(--ds-font-family-monospaced)', whiteSpace: 'nowrap' }}>
