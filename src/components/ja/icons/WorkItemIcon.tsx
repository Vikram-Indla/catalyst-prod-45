...
const ICON_COLORS: Record<string, string> = {
  // Enterprise
  theme: '#0d9488',      // Teal
  objective: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))',  // Blue
  
  // Product
  'business-request': 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))', // Blue
  
  // Program
  epic: '#904EE2',       // Purple
  
  // Project
  feature: 'var(--ds-text-warning, var(--ds-text-warning, #F59E0B))',    // Amber
  story: '#36B37E',      // Green
  task: '#0065FF',       // Blue
  defect: '#FF5630',     // Red
  incident: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))',   // Red-500
  
  // Other
  dependency: 'var(--ds-text-brand, var(--ds-text-brand, #3B82F6))', // Blue
  risk: '#F97316',       // Orange
};
...
const OUTLINE_COLORS: Record<string, string> = {
  theme: '#14b8a6',
  objective: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))',
  'business-request': '#9c8466',
  epic: '#a060f0',
  feature: '#fbbf24',
  story: '#4ade80',
  task: 'var(--ds-text-brand, var(--ds-text-brand, #3b82f6))',
  defect: '#f87171',
  incident: '#f87171',
  dependency: 'var(--ds-text-brand, var(--ds-text-brand, #60a5fa))',
  risk: '#fb923c',
};
