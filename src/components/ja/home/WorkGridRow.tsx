    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[13px] font-mono font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]">{item.key}</span>
        </div>

        {/* Summary - hover changes to olive */}
        <div className="min-w-0 pr-4">
          <div className="text-sm font-medium leading-5 text-[var(--text-1)] truncate group-hover:text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:group-hover:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))] transition-colors">
            {item.summary}
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-mono font-medium text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] dark:text-[var(--ds-text-brand,var(--ds-text-brand, #60a5fa))]">{item.key}</span>
        </div>
