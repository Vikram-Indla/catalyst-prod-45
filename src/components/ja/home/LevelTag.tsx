...
const LEVEL_STYLES: Record<string, { base: string; dark: string }> = {
  Enterprise: {
    base: 'bg-[var(--ds-text-brand,#2563eb)]/12 text-[var(--ds-background-brand-bold-hovered,#1d4ed8)]',
    dark: 'dark:bg-[var(--ds-text-brand,#2563eb)]/20 dark:text-[var(--ds-text-brand,#60a5fa)]',
  },
  Portfolio: {
  ...
  Program: {
    base: 'bg-[var(--ds-text-brand,#2563eb)]/12 text-[var(--ds-text-brand,#2563eb)]',
    dark: 'dark:bg-[var(--ds-text-brand,#2563eb)]/20 dark:text-[var(--ds-text-brand,#60a5fa)]',
  },
  Project: {
    base: 'bg-[#0d9488]/12 text-[#0f766e]',
