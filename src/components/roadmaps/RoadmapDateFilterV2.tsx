...
import { Calendar, ChevronDown } from '@/lib/atlaskit-icons';
...
export const RoadmapDateFilterV2: React.FC<RoadmapDateFilterV2Props> = ({
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent 
        className="w-[360px] p-0 bg-white dark:bg-[var(--ds-surface-overlay,var(--cp-ink-1))] border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50"
        align="end"
        sideOffset={8}
      >
        {/* View Scale Section */}
              ...
              <button
                ...
                className={cn(
                  ...
                  draftViewport.scale === opt.value
                    ? "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] text-white border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]"
              ...
              return (
                ...
                >
                  ...
                  {isCurrent && !isSelected && (
                    <div className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]" />
                  )}
                </button>
              );
            })}
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  "text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:text-[var(--ds-background-brand-bold-hovered)] dark:text-[var(--ds-text-brand)] dark:hover:text-[var(--ds-background-information)]"
                )}
              >
                All
              </button>
            ...
            <button
              ...
              className={cn(
                ...
                hasChanges || draftViewport.selectedYears.length === 0
                  ? "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))] hover:bg-[var(--ds-background-brand-bold-hovered)] text-white border-0"
                  : "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary))]/50 text-white/70 cursor-not-allowed"
              )}
            >
              Apply
            </button>
