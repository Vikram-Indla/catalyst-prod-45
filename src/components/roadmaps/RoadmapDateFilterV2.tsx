              ...
              return (
                ...
                >
                  ...
                  {isCurrent && !isSelected && (
                    <div className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[var(--ds-text-brand,#2563eb)]" />
                  )}
                </button>
              );
            })}
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className={cn(
                  ...
                  "text-[var(--ds-text-brand,#2563eb)] hover:text-[var(--ds-background-brand-bold-hovered,#1d4ed8)] dark:text-[var(--ds-text-brand,#60a5fa)] dark:hover:text-[#93c5fd]"
                )}
              >
                All
              </button>
            ...
            <button
              ...
              className={cn(
                ...
                hasChanges || draftViewport.selectedYears.length === 0
                  ? "bg-[var(--ds-text-brand,#2563eb)] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white border-0"
                  : "bg-[var(--ds-text-brand,#2563eb)]/50 text-white/70 cursor-not-allowed"
              )}
            >
              Apply
            </button>
