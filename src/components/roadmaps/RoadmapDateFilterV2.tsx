              ...
              <button
                ...
                className={cn(
                  ...
                  draftViewport.scale === opt.value
                    ? "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] text-white border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]"
              ...
              return (
                ...
                >
                  ...
                  {isCurrent && !isSelected && (
                    <div className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 w-1.5 h-1.5 rounded-full bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]" />
                  )}
                </button>
              );
            })}
            ...
            <button
              ...
              className={cn(
                ...
                hasChanges || draftViewport.selectedYears.length === 0
                  ? "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white border-0"
                  : "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/50 text-white/70 cursor-not-allowed"
              )}
            >
              Apply
            </button>
