...
export function EmptyProjectState({ 
  ...
  return (
    <div className="h-full flex items-center justify-center p-8 bg-white dark:bg-[#1A1714]">
      <div className="text-center max-w-lg">
        {/* Icon */}
        <div className="w-20 h-20 mx-auto mb-8 rounded-full bg-[rgba(37,99,235,0.1)] flex items-center justify-center">
          <Rocket className="w-10 h-10 text-[#2563eb]" />
        </div>
        ...
        {/* Getting Started */}
        <div className="p-6 rounded-xl bg-white dark:bg-[#232019] border dark:border-[rgba(255,255,255,0.08)] shadow-sm text-left">
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              <div className="w-6 h-6 rounded-full bg-[#2563eb] text-white flex items-center justify-center text-xs font-semibold flex-shrink-0">
                1
              </div>
              <div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-white dark:bg-[#232019] border dark:border-[rgba(255,255,255,0.08)] text-center">
          ...
          <div className="p-4 rounded-lg bg-white dark:bg-[#232019] border dark:border-[rgba(255,255,255,0.08)] text-center">
            ...
            <p className="text-xs text-neutral-500">Story mapping</p>
          </div>
        </div>
      </div>
    </div>
