...
export function EmptyProjectState({ 
  ...
  return (
    <div className="h-full flex items-center justify-center p-8 bg-white dark:bg-[#0A0A0A]">
      <div className="text-center max-w-lg">
        ...
        {/* Getting Started */}
        <div className="p-6 rounded-xl bg-white dark:bg-[#111111] border dark:border-[rgba(255,255,255,0.08)] shadow-sm text-left">
        ...
        <div className="mt-8 grid grid-cols-3 gap-4">
          <div className="p-4 rounded-lg bg-white dark:bg-[#111111] border dark:border-[rgba(255,255,255,0.08)] text-center">
