...
import { Calendar, ChevronLeft, ChevronRight } from '@/lib/atlaskit-icons';
  ...
  return (
    <div className="r3-week-nav" role="toolbar" aria-label="Week navigation">
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <span style={{ fontSize: 'var(--ds-font-size-300)', fontWeight: 700, color: 'var(--ds-text, #172B4D)' }}>
          {isThisWeek ? 'This Week' : `Week of ${fmt(startOfWeek).split(',')[0]}`}
        </span>
        <span style={{ fontSize: 'var(--ds-font-size-200)', color: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))' }}>
