  ...
  return (
    <div style={{ fontFamily: 'var(--cp-font-body)' }}>
      ...
      <div style={{ padding: '12px 16px' }}>
        {filtered.length === 0 && <div style={{ padding: 40, textAlign: 'center' }}><p style={{ fontSize: 'var(--ds-font-size-400)', fontWeight: 600, color: T.text3 }}>No items match filters</p></div>}
          ...
          return (
            <div key={date} style={{ marginBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                ...
                <span style={{ fontSize: 'var(--ds-font-size-50)', color: T.text4 }}>{dTotal} item{dTotal !== 1 ? 's' : ''}</span>
              </div>
                  ...
                  <React.Fragment key={item.work_item_id}>
                    <div onClick={() => onItemClick(item)} style={{
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 'var(--ds-font-size-200)', fontWeight: 500, color: T.text1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          <HighlightText text={item.title} query={searchTerm} />
                        </div>
                        {item.parent_key && (
                          <div style={{ fontSize: 'var(--ds-font-size-50)', color: T.text4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
