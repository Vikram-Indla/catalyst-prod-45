          ...
          <>
            ...
            {profile.resource_pattern && (
              <Section title="Resource Pattern">
                <p style={{ fontSize: 13, lineHeight: 1.7, color: '#334155', margin: 0 }}>{profile.resource_pattern}</p>
              </Section>
            )}
            ...
            <Section title="Delivery Pattern">
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
                <MetricCard label="Avg Subtask" value={deliveryMetrics.avg_subtask_days != null ? `${deliveryMetrics.avg_subtask_days.toFixed(1)}d` : '—'} />
                <MetricCard label="Avg Story" value={deliveryMetrics.avg_story_days != null ? `${deliveryMetrics.avg_story_days.toFixed(1)}d` : '—'} />
                <MetricCard label="Avg Bug" value={deliveryMetrics.avg_bug_days != null ? `${deliveryMetrics.avg_bug_days.toFixed(1)}d` : '—'} />
                <MetricCard label="Pickup Speed" value={deliveryMetrics.pickup_speed_hours != null ? `${deliveryMetrics.pickup_speed_hours.toFixed(0)}h` : '—'} />
              </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '160px 1fr', gap: 20 }}>
                  ...
                  <div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginBottom: 16 }}>
                      <MiniStat label="Done" value={standing.done_count ?? 0} color="#059669" />
                      <MiniStat label="In Progress" value={standing.progress_count ?? 0} color="#2563EB" />
                      <MiniStat label="To Do" value={standing.todo_count ?? 0} color="#DC2626" />
                    </div>
