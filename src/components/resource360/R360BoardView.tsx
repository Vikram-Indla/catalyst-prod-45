...
const SC: Record<string, { dot: string; bg: string; tx: string; label: string }> = {
  ...
  'Ready for Production': { dot: 'var(--ds-text-success, var(--cp-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done' },
  'Beta Ready':           { dot: 'var(--ds-text-success, var(--cp-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done' },
...
const SCD = { dot: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', tx: 'var(--cp-ink-2, var(--cp-ink-2, #334155))', label: 'Unknown' };
...
const PRI_DOT: Record<string, string> = {
  critical: 'var(--ds-text-danger, #EF4444)', highest: 'var(--ds-text-danger, #EF4444)', high: 'var(--ds-text-warning, var(--cp-warning, #D97706))', medium: 'var(--ds-text-warning, var(--cp-warning, #D97706))', low: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', lowest: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))',
};
        ...
        <div key={col.key}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: 'var(--cp-bg-elevated, var(--cp-bg-elevated, var(--cp-bg-elevated, #ffffff)))', background: col.color, marginLeft: 'auto',
