  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-1">
        <span style={{ fontSize: 11, fontWeight: 600, color: 'rgba(237,237,237,0.40)', fontFamily: "'Inter', monospace" }}>
          {item.item_key}
        </span>
        <span style={{
      ...
      <div style={{
        fontSize: 12, fontWeight: 600, color: 'var(--fg-1, rgba(237,237,237,0.93))',
        lineHeight: 1.35,
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span style={{ fontSize: 9, color: 'rgba(237,237,237,0.40)' }}>
