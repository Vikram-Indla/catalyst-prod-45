...
const SCD = { dot: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', tx: 'var(--ds-text-subtle, #334155)', label: 'Unknown', accent: 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))' };
