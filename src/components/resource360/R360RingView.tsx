...
export const R360RingView: React.FC<Props> = ({ member, items, doneCount, onItemClick }) => {
  ...
  return (
    <div style={{
      ...
      background: isDark
        ? 'radial-gradient(circle at center, #232019 0%, #1A1714 55%, #1A1714 100%)'
        : 'radial-gradient(circle at center, #fff 0%, #F8FAFC 55%, #F1F5F9 100%)',
      backgroundImage: isDark
        ? 'radial-gradient(circle at center, #232019 0%, #1A1714 55%, #1A1714 100%), radial-gradient(circle, rgba(255,255,255,0.05) 1px, transparent 1px)'
      ...
      {activeItems.map((item, i) => {
        ...
        return (
          ...
          >
            ...
            <div style={{
              fontSize: '12.5px', fontWeight: 500, color: isDark ? '#F5F3F0' : '#020617', lineHeight: '1.35', marginBottom: '5px',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ fontSize: '13.5px', fontWeight: 600, color: isDark ? '#F5F3F0' : '#020617' }}>
                    Completed This Week
                  </span>
                </div>
                <span style={{
                ...
                {doneItems.map(item => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{
                        fontSize: '12.5px', fontWeight: 500, color: isDark ? '#F5F3F0' : '#020617', lineHeight: '1.3',
