...
const SC: Record<string, { dot: string; bg: string; tx: string; label: string; accent: string }> = {
  'To Do':                { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'To Do',       accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'Open':                 { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'To Do',       accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'Backlog':              { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'Backlog',     accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'Re-Open':              { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'Re-Open',     accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'In Requirements':      { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'Requirements',accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'Awaiting Info':        { dot: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: '#FFFBEB', tx: '#78350F', label: 'Awaiting',    accent: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' },
  'In Progress':          { dot: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', bg: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', tx: '#1E3A5F', label: 'In Progress', accent: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' },
  'In Development':       { dot: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', bg: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', tx: '#1E3A5F', label: 'In Progress', accent: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' },
  'Under Implementation': { dot: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', bg: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', tx: '#1E3A5F', label: 'In Progress', accent: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' },
  ...
  'Done':                 { dot: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done',        accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
  'Closed':               { dot: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done',        accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
  'Resolved':             { dot: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done',        accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
  'Ready for Production': { dot: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done',        accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
  'Beta Ready':           { dot: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', bg: '#F0FDF4', tx: '#14532D', label: 'Done',        accent: 'var(--ds-text-success, var(--ds-text-success, #16A34A))' },
  'Blocked':              { dot: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))', bg: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', tx: '#7F1D1D', label: 'Blocked',     accent: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))' },
  'Rejected':             { dot: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))', bg: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', tx: '#7F1D1D', label: 'Rejected',    accent: 'var(--ds-text-danger, var(--ds-text-danger, #EF4444))' },
};
const SCD = { dot: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', bg: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', tx: 'var(--ds-text-subtle, var(--ds-text-subtle, #334155))', label: 'Unknown', accent: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))' };
  ...
  if (activeItems.length === 0 && doneCount === 0) {
    return (
      <div style={{
        ...
        background: 'radial-gradient(circle at center, var(--ds-surface, var(--ds-surface, #fff)) 0%, var(--bg-1) 55%, var(--bg-3) 100%)',
  ...
  return (
    <div style={{
      ...
      background: isDark
        ...
        : 'radial-gradient(circle at center, var(--ds-surface, var(--ds-surface, #fff)) 0%, var(--ds-surface-sunken, #F8FAFC) 55%, var(--ds-surface-sunken, #F1F5F9) 100%)',
      backgroundImage: isDark
        ...
        : 'radial-gradient(circle at center, var(--ds-surface, var(--ds-surface, #fff)) 0%, var(--ds-surface-sunken, #F8FAFC) 55%, var(--ds-surface-sunken, #F1F5F9) 100%), radial-gradient(circle, var(--ds-text-disabled, #CBD5E1) 1px, transparent 1px)',
        ...
        {activeItems.map((_, i) => {
          ...
          return (
            <line key={`spoke-${i}`} x1="50%" y1={`${centerTopPct}%`} x2={`${cx}%`} y2={`${cy}%`}
              stroke="var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))" strokeWidth="2" strokeDasharray="8 5" strokeLinecap="round" />
          );
        })}
      </svg>
      ...
      {doneCount > 0 && (
        <div ref={doneRef} style={{
          ...
          >
            <div style={{
              width: '48px', height: '48px', borderRadius: '50%', background: 'var(--ds-text-success, var(--ds-text-success, #16A34A))', color: 'var(--ds-text-inverse, #FFFFFF)',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <div style={{
                    width: '22px', height: '22px', borderRadius: '50%', background: 'var(--ds-text-success, var(--ds-text-success, #16A34A))',
                    color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #FFF)))', fontSize: '12px', fontWeight: 700,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>✓</div>
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <svg width="12" height="12" viewBox="0 0 12 12">
                        <path d="M2.5 6l2.5 2.5 4.5-4.5" stroke="var(--ds-text-success, var(--ds-text-success, #16A34A))" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </div>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '2px' }}>
                        ...
                        <span style={{
                          ...
                          borderRadius: '4px', color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #FFF)))', background: 'var(--ds-text-success, var(--ds-text-success, #16A34A))',
                        }}>
                          DONE
                        </span>
                      </div>
