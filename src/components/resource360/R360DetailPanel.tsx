      ...
      <div ref={panelRef} style={{
        ...
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--divider)', background: 'var(--bg-app)', position: 'sticky', top: 0, zIndex: 10 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            <span style={{ fontSize: '14px', fontWeight: 700, color: 'var(--cp-blue)', fontFamily: 'var(--ds-font-family-monospaced)' }}>{item.item_key}</span>
            ...
            {item.parent_key ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 8px', borderRadius: '6px', border: '1px solid var(--divider)', background: 'var(--bg-app)' }}>
                  ...
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '11px', color: 'var(--fg-3)', whiteSpace: 'nowrap', flexShrink: 0, minWidth: '72px', fontWeight: 600 }}>{item.parent_key}</span>
                ...
                <div style={{
                  ...
                  <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: '11px', color: 'var(--cp-blue)', whiteSpace: 'nowrap', flexShrink: 0, minWidth: '72px', fontWeight: 600 }}>{item.item_key}</span>
                  <span style={{
                ...
                {siblings.map(sib => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span style={{ fontSize: '11px', fontFamily: 'var(--ds-font-family-monospaced)', color: 'var(--cp-blue)', fontWeight: 600, width: '72px', flexShrink: 0 }}>{sib.item_key}</span>
