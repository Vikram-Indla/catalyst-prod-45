      ...
      >
        ...
        <div className="r3-panel-header">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            ...
            <button
              onClick={onClose}
              style={{ width: 28, height: 28, border: '1px solid #E2E8F0', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#FFF', cursor: 'pointer', color: '#64748B' }}
            >
              <X size={14} />
            </button>
          </div>
        ...
        <div style={{ padding: 20 }}>
            ...
            <div className="r3-meta-cell">
              ...
              <div>
                ...
                <div className="r3-days-bar" style={{ background: '#F1F5F9' }}>
                  <div style={{ width: `${daysBarPct}%`, height: '100%', borderRadius: 2, background: daysBarColor }} />
                </div>
              </div>
            </div>
            <div className="r3-meta-cell">
          ...
          {item.parent_key && (
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: '#64748B', marginBottom: 8 }}>Hierarchy</div>
          ...
          {siblings.length > 0 && (
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                <span style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.06em', color: '#64748B' }}>Siblings</span>
                ...
                {siblings.map(sib => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="r3-age-badge" style={{ color: getAgeColor(sib.age_days) }}>{sib.age_days}d</span>
                    </div>
                  );
                })}
              </div>
