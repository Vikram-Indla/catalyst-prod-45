...
export const R360ProfileHeader: React.FC<Props> = ({ member, kpis, activeTab, onTabChange }) => {
  ...
  return (
    <div className="r3-profile-card" role="banner">
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 16, paddingTop: 14, borderTop: '1px solid var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9))' }}>
