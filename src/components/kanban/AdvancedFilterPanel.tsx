    ...
    >
      ...
      <div className="flex items-center justify-between" style={{
        ...
        <div className="flex items-center gap-2">
          ...
          <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--ds-text, #172B4D)', letterSpacing: '-0.01em' }}>
            Advanced Filters
          </span>
          {activeCount > 0 && (
            <span style={{
    ...
    <div style={{ borderBottom: '1px solid #EBECF0' }}>
      <button
        ...
        style={{
          ...
          cursor: 'pointer', fontSize: 13, fontWeight: 700, color: 'var(--ds-text, #172B4D)',
        ...
        <div style={{ padding: '0 16px 10px' }}>
          {options.length > 5 && (
            <div className="relative" style={{ marginBottom: 8 }}>
              <Search size={13} color="var(--ds-text-subtlest, #94A3B8)" className="absolute left-2.5 top-1/2 -translate-y-1/2 pointer-events-none" />
              <input
                ...
                style={{
                  ...
                  fontSize: 13, color: 'var(--ds-text, #172B4D)', background: 'var(--ds-surface-sunken, #FAFBFC)',
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: 'var(--ds-text, #172B4D)', textAlign: 'left', borderRadius: 4,
                ...
                >
                  <span style={{
                    ...
                    {isSelected && <Check size={12} color="var(--ds-surface, #fff)" strokeWidth={3} />}
                  </span>
