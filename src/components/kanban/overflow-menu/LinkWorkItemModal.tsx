              ...
              <div style={{
                ...
                {filtered.map((r: any) => (
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, color: textM, flexShrink: 0 }}>
                      {r.issue_key}
                    </span>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontSize: 13, color: tk.textSecondary, fontFamily: 'var(--ds-font-family-body)',
            }}
          >
            Cancel
          </button>
