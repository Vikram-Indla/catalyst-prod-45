        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 4, background: selected.length > 0 ? 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))' : tk.chipBg,
              cursor: selected.length > 0 ? 'pointer' : 'not-allowed',
              fontSize: 13, color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))', fontWeight: 600,
              fontFamily: 'var(--cp-font-body)',
