      ...
      >
        ...
        <div style={{ padding: '14px 14px 12px', flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <div style={{ fontSize: 11, color: 'var(--fg-4)', fontFamily: 'var(--ds-font-family-body)' }}>Kanban Board</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            fontSize: 11.5, color: 'var(--fg-3)', fontFamily: 'var(--ds-font-family-body)',
          }}>
        ...
        <div style={{
          ...
          <button onClick={e => { e.stopPropagation(); handleOpen(); }} style={{
            ...
            fontSize: 11.5, fontWeight: 600, color: '#FFFFFF', fontFamily: 'var(--ds-font-family-body)',
          }}>
      ...
      {deleteModal && (
        <>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: 15, fontWeight: 700, color: 'var(--fg-1)', margin: '0 0 8px', fontFamily: 'var(--ds-font-family-heading)' }}>
              Delete Board
            </h3>
            <p style={{ fontSize: 13, color: 'var(--fg-3)', margin: '0 0 16px', lineHeight: 1.5, fontFamily: 'var(--ds-font-family-body)' }}>
