      ...
      <div onClick={e => e.stopPropagation()} style={{
                    ...
                    <button key={opt.value} onClick={() => setVisibility(opt.value)} style={{
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                          ...
                          {opt.warning && <AlertTriangle size={12} color="var(--ds-text-warning, var(--ds-text-warning, #D97706))" />}
                        </div>
              ...
              <Section label="Danger Zone">
                {!showDelete ? (
                  <button onClick={() => setShowDelete(true)} style={{
                    ...
                    background: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', border: '0.75px solid var(--sem-danger)',
                  ...
                  <div style={{ padding: 10, background: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', borderRadius: 6, border: '0.75px solid var(--sem-danger)' }}>
            ...
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {columns.map((col) => (
                  <div key={col.id} style={{
                    ...
                    <GripVertical size={13} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))" style={{ cursor: 'grab', flexShrink: 0 }} />
                    <span style={{
                      fontSize: 12, fontWeight: 500, color: 'var(--fg-1)',
                      fontFamily: 'var(--cp-font-body)', flex: 1, minWidth: 0,
                      overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                    }}>{col.name}</span>
                    {col.isBacklog && <Badge bg="rgba(37,99,235,0.06)" color="var(--ds-text-brand, var(--ds-text-brand, #2563EB))">Backlog</Badge>}
                    ...
                    <button onClick={() => deleteCol.mutate({ columnId: col.id, boardId: board.id })} style={{
                      ...
                      <Trash2 size={12} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))" />
                    </button>
                  </div>
                ))}
              </div>
              <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                ...
                <button onClick={handleAddColumn} disabled={!newColName.trim()} style={{
                  ...
                  fontSize: 11.5, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))', fontFamily: 'var(--cp-font-body)',
                }}>
                  <Plus size={13} /> Add
                </button>
              </div>
          ...
          {tab === 'access' && (
            <>
              ...
              <button style={{
                ...
                cursor: 'pointer', fontSize: 11.5, fontWeight: 600, color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))',
                fontFamily: 'var(--cp-font-body)',
              }}>
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            fontSize: 11.5, fontWeight: 500, color: 'var(--ds-text-subtle, var(--ds-text-subtle, #334155))',
          ...
          <button onClick={handleSave} disabled={!isDirty || updateBoard.isPending} style={{
            ...
            color: isDirty ? 'var(--ds-surface, var(--ds-surface, #FFFFFF))' : 'var(--fg-4)',
            fontFamily: 'var(--cp-font-body)',
