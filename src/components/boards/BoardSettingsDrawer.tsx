      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            <X size={16} color="rgba(237,237,237,0.40)" />
          </button>
        </div>
              ...
              <Section label="Danger Zone">
                {!showDelete ? (
                  <button onClick={() => setShowDelete(true)} style={{
                    ...
                    background: 'rgba(248,113,113,0.06)', border: '0.75px solid var(--sem-danger)',
                  ...
                  <div style={{ padding: 10, background: 'rgba(248,113,113,0.06)', borderRadius: 6, border: '0.75px solid var(--sem-danger)' }}>
            ...
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {columns.map((col) => (
                  <div key={col.id} style={{
                    ...
                    <GripVertical size={13} color="rgba(237,237,237,0.40)" style={{ cursor: 'grab', flexShrink: 0 }} />
                    <span style={{
                    ...
                    {col.isDone && <Badge bg="rgba(74,222,128,0.06)" color="var(--sem-success)">Done</Badge>}
                    <button onClick={() => deleteCol.mutate({ columnId: col.id, boardId: board.id })} style={{
                      width: 22, height: 22, borderRadius: 4, border: 'none',
                      background: 'transparent', cursor: 'pointer',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                    }}>
                      <Trash2 size={12} color="rgba(237,237,237,0.40)" />
                    </button>
                  </div>
                ))}
              </div>
              <div style={{ display: 'flex', gap: 6, marginTop: 8 }}>
                ...
                <button onClick={handleAddColumn} disabled={!newColName.trim()} style={{
                  ...
                  fontSize: 11.5, color: 'rgba(237,237,237,0.40)', fontFamily: "'Inter', sans-serif",
                }}>
                  <Plus size={13} /> Add
                </button>
              </div>
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{
            ...
            fontSize: 11.5, fontWeight: 500, color: 'rgba(237,237,237,0.53)',
