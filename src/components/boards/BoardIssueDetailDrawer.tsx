...
const STATUS_PILL: Record<string, { text: string; bg: string; bdr: string }> = {
  todo:        { text: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', bg: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', bdr: 'rgba(100,116,139,0.2)' },
  backlog:     { text: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', bg: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', bdr: 'rgba(100,116,139,0.2)' },
  new:         { text: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))', bg: 'var(--ds-surface-sunken, var(--ds-surface-sunken, #F1F5F9))', bdr: 'rgba(100,116,139,0.2)' },
  'in progress': { text: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', bg: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', bdr: 'rgba(37,99,235,0.2)' },
  inprogress:  { text: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', bg: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', bdr: 'rgba(37,99,235,0.2)' },
  ...
  blocked:     { text: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))', bg: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', bdr: 'rgba(220,38,38,0.2)' },
};
        ...
        <div style={{ borderTop: '1px solid var(--divider)', paddingTop: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button style={{
              ...
              background: 'var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))', color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))', fontSize: 13, fontWeight: 600,
              cursor: 'not-allowed',
            }}>
              Post
            </button>
