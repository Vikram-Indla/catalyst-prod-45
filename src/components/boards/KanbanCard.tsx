...
const PRIORITY_COLORS: Record<string, string> = {
  ...
  low: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))',
};
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6 }}>
        ...
        <button style={{
          ...
          <MoreHorizontal size={14} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))" />
        </button>
      </div>
      ...
      <div style={{
        ...
        color: 'var(--fg-1)', fontFamily: 'var(--cp-font-body)',
      ...
      {card.epic && (
        <div style={{
          ...
          background: 'var(--ds-background-selected, var(--ds-background-selected, #EFF6FF))', border: '0.75px solid #DBEAFE',
          maxWidth: '100%', overflow: 'hidden',
        }}>
          <span style={{
            width: 5, height: 5, borderRadius: '50%',
            background: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))', flexShrink: 0,
          }} />
          <span style={{
            fontSize: 10.5, fontWeight: 500, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563EB))',
            fontFamily: 'var(--cp-font-body)',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
          ...
          {card.priority && (
            <span style={{
              ...
              background: PRIORITY_COLORS[card.priority.name] ?? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))',
              flexShrink: 0,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
          ...
          {card.release && (
            <span style={{
              ...
              fontSize: 10.5, fontFamily: 'var(--cp-font-mono)', color: 'var(--fg-3)',
              overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
          ...
          {card.assignee && (
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 9, fontWeight: 700, color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))',
...
function hashColor(id: string): string {
  const colors = ['var(--ds-text-brand, var(--ds-text-brand, #2563EB))', 'var(--ds-text-success, var(--ds-text-success, #16A34A))', '#7C3AED', 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))', 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', '#0D9488', '#0284C7', '#525252'];
  let hash = 0;
