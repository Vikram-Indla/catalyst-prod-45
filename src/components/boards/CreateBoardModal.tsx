...
const COLOR_SWATCHES = [
  'var(--ds-text-brand, #2563EB)', 'var(--ds-text-success, #16A34A)', 'var(--cp-purple-60, #7C3AED)', 'var(--ds-text-danger, #DC2626)', 'var(--ds-text-warning, #D97706)', 'var(--cp-teal-60, #0D9488)', '#525252', '#0284C7',
];
