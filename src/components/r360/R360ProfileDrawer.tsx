...
const R360ProfileDrawer = memo(function R360ProfileDrawer({ resourceId, onClose }: R360ProfileDrawerProps) {
  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', fontFamily: 'var(--cp-font-body)', position: 'relative' }}>
        ...
        {resLoading ? (
          ...
          <>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 'var(--ds-font-size-200)', color: INK4, flexWrap: 'wrap', marginTop: 0 }}>
                ...
                {resourceRid && <><span>·</span><span style={{
                  ...
                  padding: '0px 7px', fontFamily: 'var(--cp-font-mono)',
