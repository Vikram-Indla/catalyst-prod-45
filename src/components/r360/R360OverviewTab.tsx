    ...
    <>
      ...
      <div style={{ padding: 16, borderBottom: `1px solid ${BORDER_LIGHT}` }}>
        ...
        <div style={{ display: 'flex', gap: 16 }}>
          ...
          <svg width={110} height={110} viewBox="0 0 110 110" style={{ flexShrink: 0 }}>
            ...
            <circle cx={55} cy={55} r={44} fill="none" stroke="var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))" strokeWidth={2}
            ...
            <text x={55} y={82} textAnchor="middle" fontFamily='var(--cp-font-body)' fontSize={11} fill="var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))">avg {roleAvg}</text>
          </svg>
      ...
      <div style={{ padding: 16, borderBottom: `1px solid ${BORDER_LIGHT}` }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {workMix.map(row => {
            const tc = TYPE_COLORS[row.type] || { color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))', opacity: 0.6 };
            return (
              <div
                key={row.type}
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
              ...
              <span style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: 'var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))' }} />
              <span style={{ width: 8, height: 8, borderRadius: '50%', backgroundColor: 'var(--ds-text-disabled, var(--ds-text-disabled, #CBD5E1))' }} />
            </div>
          </div>
