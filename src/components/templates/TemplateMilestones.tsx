...
const MILESTONE_TYPES = [
  { value: 'checkpoint', label: 'Checkpoint', icon: Flag, color: 'var(--ds-text-brand, var(--ds-text-brand, #2563eb))' },
  { value: 'review', label: 'Review', icon: CheckCircle, color: '#0d9488' },
  { value: 'deadline', label: 'Deadline', icon: AlertCircle, color: 'var(--ds-text-danger, var(--ds-text-danger, #ef4444))' },
] as const;
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="text-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] border-[var(--ds-text-brand,var(--ds-text-brand, #2563eb))] hover:bg-[var(--ds-background-selected,var(--ds-background-selected, #eff6ff))]"
          >
