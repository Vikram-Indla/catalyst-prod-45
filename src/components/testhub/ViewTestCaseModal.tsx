                      ...
                      {addingGherkin ? (
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 4 }}>
                          <button
                            ...
                            style={{ display: 'flex', alignItems: 'center', gap: 6, height: 32, padding: '0 12px', borderRadius: 6, fontSize: 13, fontWeight: 500, cursor: 'pointer', border: '1px solid var(--cp-border, #E2E8F0)', background: 'var(--ds-text-inverse, #FFFFFF)', color: 'var(--ds-text, var(--cp-text-primary, #172B4D))', fontFamily: 'var(--cp-font-body)' }}>
                      ...
                      {addingStep ? (
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', marginTop: 8 }}>
                          ...
                          <div style={{ position: 'relative' }} data-add-step-menu>
                            ...
                            {isAddStepMenuOpen && (
                              <div style={{ position: 'absolute', right: 0, top: 36, background: 'var(--ds-text-inverse, #FFFFFF)', border: '1px solid var(--cp-border, #E2E8F0)', borderRadius: 6, boxShadow: '0 4px 16px rgba(9,30,66,0.15)', zIndex: 100, minWidth: 180, overflow: 'hidden' }}>
                                <button
