  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      >
        ...
        />
        <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 14, fontWeight: 600, color: 'var(--fg-1)', flex: 1 }}>{label}</span>
        {count != null && count > 0 && (
          <span style={{
    ...
    <div onClick={onClose} style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1100 }}>
      <div onClick={e => e.stopPropagation()} style={{ width: 480, maxWidth: '95vw', maxHeight: '80vh', backgroundColor: 'var(--cp-float)', borderRadius: 12, boxShadow: '0 20px 60px rgba(0,0,0,0.15)', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1px solid var(--divider)' }}>
          <h3 style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 16, fontWeight: 600, color: 'var(--fg-1)', margin: 0 }}>Add Link</h3>
        ...
        <div style={{ padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input
              ...
              style={{ width: '100%', height: 40, padding: '8px 12px 8px 36px', fontSize: 14, fontFamily: 'var(--ds-font-family-body)', border: '1.5px solid var(--divider)', borderRadius: 8, outline: 'none', boxSizing: 'border-box', background: 'var(--cp-float)', color: 'var(--fg-1)' }}
            />
          </div>
        </div>
              ...
              {results.map(item => (
                <button key={item.id} onClick={() => { onAdd(item, linkType); onClose(); }}
                  ...
                  <div style={{ minWidth: 0, flex: 1 }}>
                    <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 12, fontWeight: 500, color: 'var(--cp-blue)' }}>{item.key}</span>
                    {item.name !== item.key && (
  ...
  return (
    <div style={{ borderRadius: 4, border: '0.75px solid var(--divider)', overflow: 'hidden' }}>
      ...
      >
        ...
        <span style={{ fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 500, color: 'var(--fg-2)', flex: 1 }}>{label}</span>
        <span style={{
          display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
      ...
      {expanded && links.length > 0 && (
        <div>
          {links.map(link => (
            ...
            >
              <span style={{ fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 11, fontWeight: 500, color: 'var(--cp-blue)' }}>
                {link.linked_item_key}
              </span>
              <span style={{
                flex: 1, fontFamily: 'var(--ds-font-family-body)', fontSize: 12, fontWeight: 400, color: 'var(--fg-1)',
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <span style={{ fontSize: 12, fontFamily: 'var(--ds-font-family-monospaced)', color: '#5E6C84', fontWeight: 500 }}>
                {testCase.case_key}
              </span>
              <span style={{ fontSize: 13, fontFamily: 'var(--ds-font-family-body)', color: '#172B4D', fontWeight: 500, maxWidth: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {testCase.title}
              </span>
            </div>
          </div>
                        ...
                        <div style={{ padding: 12, border: '1.5px solid #E2E8F0', borderRadius: 8, background: '#FAFBFC' }}>
                          <div style={{ marginBottom: 10 }}>
                            ...
                            <textarea
                              ...
                              placeholder="Feature: ..."
                              style={{ width: '100%', minHeight: 60, padding: 10, fontSize: 13, fontFamily: 'var(--ds-font-family-monospaced)', border: '1.5px solid #E2E8F0', borderRadius: 4, resize: 'vertical', boxSizing: 'border-box', outline: 'none' }}
                            />
                          </div>
                          <div>
                            ...
                            <textarea
                              ...
                              style={{ width: '100%', minHeight: 80, padding: 10, fontSize: 13, fontFamily: 'var(--ds-font-family-monospaced)', border: '1.5px solid #E2E8F0', borderRadius: 4, resize: 'vertical', boxSizing: 'border-box', outline: 'none' }}
                            />
                          </div>
                        </div>
                      )}
                      ...
                      {gherkinScenarios.map((sc, idx) => (
                        <div key={sc.id} className="group" style={{ padding: 12, border: '1.5px solid #E2E8F0', borderRadius: 8, background: '#FAFBFC', position: 'relative' }}>
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                            <span style={{ fontSize: 12, fontWeight: 600, color: '#475569', fontFamily: 'var(--ds-font-family-body)' }}>Scenario {idx + 1}</span>
                            <button
                      ...
                      {addingGherkin ? (
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 4 }}>
                          <button
                            ...
                            style={{ display: 'flex', alignItems: 'center', gap: 6, height: 32, padding: '0 12px', borderRadius: 6, fontSize: 13, fontWeight: 500, cursor: 'pointer', border: '1px solid #E2E8F0', background: '#FFFFFF', color: '#172B4D', fontFamily: 'var(--ds-font-family-body)' }}>
                      ...
                      {freeTextBlocks.map((block, idx) => (
                        <div key={block.id} className="group" style={{ position: 'relative' }}>
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
                            <span style={{ fontSize: 12, fontWeight: 600, color: '#475569', fontFamily: 'var(--ds-font-family-body)' }}>Text Block {idx + 1}</span>
                            <button
                          ...
                          <textarea
                            ...
                            style={{ width: '100%', minHeight: 120, padding: 12, fontSize: 14, fontFamily: 'var(--ds-font-family-body)', border: '1.5px solid #E2E8F0', borderRadius: 4, resize: 'vertical', boxSizing: 'border-box', outline: 'none' }}
                          />
                        </div>
                      ))}
                      ...
                      {addingFreeText ? (
                        <div style={{ padding: 12, border: '1.5px dashed #2563EB', borderRadius: 8, background: '#F8FAFC' }}>
                          <textarea
                            ...
                            placeholder="Describe the test in free text..."
                            style={{ width: '100%', minHeight: 120, padding: 12, fontSize: 14, fontFamily: 'var(--ds-font-family-body)', border: '1.5px solid #E2E8F0', borderRadius: 4, resize: 'vertical', boxSizing: 'border-box', outline: 'none', marginBottom: 10 }}
                          />
                          <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                            ...
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 8 }}>
                              <div>
                                ...
                                <textarea value={editStepAction} onChange={e => setEditStepAction(e.target.value)} autoFocus rows={2}
                                  style={{ width: '100%', padding: '6px 8px', fontSize: 14, lineHeight: 1.5, fontFamily: 'var(--ds-font-family-body)', border: '1.5px solid #2563EB', borderRadius: 6, outline: 'none', resize: 'vertical', boxSizing: 'border-box', background: 'var(--cp-float)', color: 'var(--fg-1)', marginTop: 4 }} />
                              </div>
                              <div>
                                ...
                                <textarea value={editStepExpected} onChange={e => setEditStepExpected(e.target.value)} rows={2}
                                  style={{ width: '100%', padding: '6px 8px', fontSize: 14, lineHeight: 1.5, fontFamily: 'var(--ds-font-family-body)', border: '1.5px solid var(--divider)', borderRadius: 6, outline: 'none', resize: 'vertical', boxSizing: 'border-box', background: 'var(--cp-float)', color: 'var(--fg-1)', marginTop: 4 }} />
                              </div>
                              <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                            ...
                            {isAddStepMenuOpen && (
                              <div style={{ position: 'absolute', right: 0, top: 36, background: '#FFFFFF', border: '1px solid #E2E8F0', borderRadius: 6, boxShadow: '0 4px 16px rgba(9,30,66,0.15)', zIndex: 100, minWidth: 180, overflow: 'hidden' }}>
                                <button
                                  ...
                                  style={{ width: '100%', textAlign: 'left', padding: '10px 14px', fontSize: 13, background: 'transparent', border: 'none', cursor: 'pointer', color: '#172B4D', fontFamily: 'var(--ds-font-family-body)' }}
                                  onMouseEnter={e => (e.currentTarget.style.background = 'rgba(0,0,0,0.04)')}
                                  onMouseLeave={e => (e.currentTarget.style.background = 'transparent')}
                                >
                                  Add New Step
