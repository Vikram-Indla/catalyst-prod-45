            ...
            <div key={att.id} style={{ backgroundColor: 'var(--cp-float)', border: '1px solid var(--divider)', borderRadius: 12, overflow: 'hidden' }}>
              ...
              <div style={{ padding: 10 }}>
                ...
                <div style={{ display: 'flex', gap: 4, marginTop: 8 }}>
                  ...
                  {!disabled && (
                    <button onClick={() => handleDelete(att)} title="Delete" style={{ flex: 1, height: 28, padding: 0, border: '1px solid color-mix(in srgb, var(--sem-danger) 20%, transparent)', borderRadius: 6, backgroundColor: 'rgba(248,113,113,0.06)', color: 'var(--sem-danger)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Trash2 size={14} />
                    </button>
                  )}
                </div>
