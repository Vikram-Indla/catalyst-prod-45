              ...
              <div style={{ position: 'relative' }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: 14, color: isDark ? '#EDEDED' : '#334155', backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF',
                ...
                {statusDropdownOpen && (
                  <div style={{
                    ...
                    marginTop: 4, backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF',
                    border: `1px solid ${isDark ? '#2E2E2E' : '#E2E8F0'}`, borderRadius: 6,
                    ...
                    {CYCLE_STATUS_OPTIONS.map(opt => (
                      <button
                        ...
                        style={{
                          ...
                          backgroundColor: cycleStatus === opt.value ? (isDark ? 'var(--cp-bg-surface, #242528)' : '#F1F5F9') : 'transparent',
                          display: 'flex', alignItems: 'center', gap: 8,
                          cursor: 'pointer', fontSize: 14, color: isDark ? '#EDEDED' : '#334155',
                          fontFamily: 'var(--cp-font-body)',
                        }}
                        onMouseEnter={(e) => { (e.target as HTMLElement).style.backgroundColor = isDark ? 'var(--cp-bg-surface, #242528)' : '#F8FAFC'; }}
                        onMouseLeave={(e) => { (e.target as HTMLElement).style.backgroundColor = cycleStatus === opt.value ? (isDark ? 'var(--cp-bg-surface, #242528)' : '#F1F5F9') : 'transparent'; }}
                      >
                        <span style={{
                          display: 'inline-block', padding: '0 6px', height: 20,
                          lineHeight: '20px', fontSize: 11, fontWeight: 700,
          ...
          <div style={{ display: 'flex', gap: 16, marginBottom: 20 }}>
            <div style={{ flex: 1 }}>
              ...
              <input
                ...
                style={{ width: '100%', height: 40, padding: '8px 12px', border: `1.5px solid ${isDark ? '#2E2E2E' : '#E2E8F0'}`, borderRadius: 4, fontSize: 14, color: isDark ? '#EDEDED' : '#1E293B', backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', fontFamily: 'var(--cp-font-body)', outline: 'none', boxSizing: 'border-box' } as React.CSSProperties}
              />
            </div>
            <div style={{ flex: 1 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 13, fontWeight: 600, color: 'var(--fg-1)', marginBottom: 6 }}>
              ...
              <input
                ...
                onBlur={(e) => { if (!(e.target as HTMLInputElement).value) { (e.target as HTMLInputElement).type = 'text'; } }}
                style={{ width: '100%', height: 40, padding: '8px 12px', border: `1.5px solid ${errors.endDate ? '#EF4444' : (isDark ? '#2E2E2E' : '#E2E8F0')}`, borderRadius: 4, fontSize: 14, color: isDark ? '#EDEDED' : '#1E293B', backgroundColor: isDark ? 'var(--cp-bg-surface, #242528)' : '#FFFFFF', fontFamily: 'var(--cp-font-body)', outline: 'none', boxSizing: 'border-box' } as React.CSSProperties}
              />
