    ...
    <div onClick={onClose} style={{
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--divider)', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: 'var(--fg-1)', margin: 0, fontFamily: 'var(--ds-font-family-body)' }}>Create Category</h2>
            <p style={{ fontSize: 13, color: 'var(--fg-3)', margin: '4px 0 0', fontFamily: 'var(--ds-font-family-body)' }}>Organize your shared steps with categories</p>
          </div>
        ...
        {/* Body */}
        <div style={{ padding: 24, overflowY: 'auto', flex: 1, display: 'flex', flexDirection: 'column', gap: 20, fontFamily: 'var(--ds-font-family-body)' }}>
          {/* Preview */}
          ...
          <div>
            ...
            <input
              ...
              style={{ width: '100%', height: 40, padding: '8px 12px', border: `1.5px solid ${error ? 'var(--sem-danger)' : 'var(--divider)'}`, borderRadius: 8, fontSize: 14, color: 'var(--fg-1)', fontFamily: 'var(--ds-font-family-body)' }}
            />
          ...
          <div>
            ...
            <input
              ...
              style={{ width: '100%', height: 40, padding: '8px 12px', border: '1.5px solid var(--divider)', borderRadius: 8, fontSize: 14, color: 'var(--fg-1)', fontFamily: 'var(--ds-font-family-body)' }}
            />
          </div>
        ...
        <div style={{ padding: '16px 24px', borderTop: '1px solid var(--divider)', display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
          <button onClick={onClose} style={{ height: 40, padding: '0 20px', backgroundColor: 'var(--cp-float)', border: '1.5px solid var(--divider)', borderRadius: 8, fontSize: 14, fontWeight: 500, color: 'var(--fg-2)', cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)' }}>Cancel</button>
          <button onClick={handleSubmit} disabled={isSubmitting} style={{
            height: 40, padding: '0 24px', background: 'linear-gradient(135deg, var(--cp-blue) 0%, var(--cp-primary-70) 100%)',
            border: 'none', borderRadius: 8, color: '#FFFFFF', fontSize: 14, fontWeight: 600, cursor: isSubmitting ? 'not-allowed' : 'pointer', fontFamily: 'var(--ds-font-family-body)', opacity: isSubmitting ? 0.7 : 1,
