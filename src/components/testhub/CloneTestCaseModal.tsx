        ...
        <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 14, color: 'var(--fg-1)' }}>Include test steps</span>
            </label>
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 14, color: 'var(--fg-1)' }}>Include attachments</span>
            </label>
          </div>
        </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              height: 40,
              padding: '0 20px',
              background: !newTitle.trim() || isSaving ? 'var(--fg-4)' : 'linear-gradient(135deg, var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB)) 0%, var(--ds-background-brand-bold-hovered, #1D4ED8) 100%)',
              border: 'none',
              borderRadius: 8,
              fontFamily: 'var(--cp-font-body)',
              fontSize: 14,
