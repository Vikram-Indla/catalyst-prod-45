        ...
        {tests.map((test, index) => {
          ...
          return (
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', backgroundColor: '#FEF2F2', borderRadius: 10, cursor: 'pointer', border: '1px solid color-mix(in srgb, var(--sem-danger) 20%, transparent)', transition: 'all 0.15s' }}
