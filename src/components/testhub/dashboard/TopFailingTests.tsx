  ...
  return (
    <div style={{ backgroundColor: 'var(--bg-app)', border: '1px solid var(--divider)', borderRadius: 12, padding: 24 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
        <div style={{ width: 36, height: 50, borderRadius: 12, backgroundColor: 'rgba(248,113,113,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      {/* Warning banner */}
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', backgroundColor: '#FFFBEB', border: '1px solid color-mix(in srgb, var(--sem-warning) 30%, transparent)', borderRadius: 8, marginBottom: 16, fontSize: 12, color: '#FBBF24' }}>
        ...
        {tests.map((test, index) => {
          ...
          return (
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', backgroundColor: 'rgba(248,113,113,0.06)', borderRadius: 12, cursor: 'pointer', border: '1px solid color-mix(in srgb, var(--sem-danger) 20%, transparent)', transition: 'all 0.15s' }}
              onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = 'rgba(248,113,113,0.10)'; e.currentTarget.style.borderColor = 'color-mix(in srgb, var(--sem-danger) 30%, transparent)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'rgba(248,113,113,0.06)'; e.currentTarget.style.borderColor = 'color-mix(in srgb, var(--sem-danger) 20%, transparent)'; }}
            >
              {/* Left */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 14, minWidth: 0, flex: 1 }}>
                <div style={{ width: 28, height: 28, borderRadius: '50%', backgroundColor: 'rgba(248,113,113,0.10)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: 'var(--sem-danger)', flexShrink: 0 }}>
                  {index + 1}
                </div>
                <div style={{ minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2 }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--sem-danger)', backgroundColor: 'rgba(248,113,113,0.10)', padding: '1px 8px', borderRadius: 6 }}>{test.case_key}</span>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexShrink: 0, marginLeft: 16 }}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ fontSize: 11, color: '#FBBF24', margin: 0 }}>{test.failure_count === 1 ? 'failure' : 'failures'}</p>
                </div>
                <div style={{ textAlign: 'center' }}>
