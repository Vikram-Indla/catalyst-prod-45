        ...
        {tests.map((test, index) => {
          ...
          return (
            <div
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', backgroundColor: 'var(--tint-red, #FEF2F2)', borderRadius: 12, cursor: 'pointer', border: '1px solid color-mix(in srgb, var(--sem-danger) 20%, transparent)', transition: 'all 0.15s' }}
              ...
              onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'var(--tint-red, #FEF2F2)'; e.currentTarget.style.borderColor = 'color-mix(in srgb, var(--sem-danger) 20%, transparent)'; }}
            >
              {/* Left */}
