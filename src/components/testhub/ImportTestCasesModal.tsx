    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: 24 }}>
          {error && (
            <div style={{
              padding: '12px 16px', backgroundColor: 'var(--ds-background-danger, var(--ds-background-danger, #FEF2F2))', border: '1px solid color-mix(in srgb, var(--sem-danger) 20%, transparent)',
