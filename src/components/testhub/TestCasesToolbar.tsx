  ...
  return (
    <div style={{
        ...
        <div style={{ position: 'relative', width: 280 }}>
          <input
            ...
            style={{
              ...
              fontFamily: 'var(--ds-font-family-body)', color: 'var(--fg-1)', backgroundColor: 'var(--cp-float)',
        ...
        <div ref={filterRef} style={{ position: 'relative' }}>
          <button
            ...
            style={{
              ...
              borderRadius: 8, fontSize: 14, fontFamily: 'var(--ds-font-family-body)', fontWeight: 500,
        ...
        <div ref={sortRef} style={{ position: 'relative' }}>
          <button
            ...
            style={{
              ...
              fontFamily: 'var(--ds-font-family-body)', fontWeight: 500, color: 'var(--fg-2)',
              cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8, transition: 'all 0.15s',
            }}
          >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
        <span style={{ fontSize: 13, color: 'var(--fg-3)', fontFamily: 'var(--ds-font-family-body)' }}>
