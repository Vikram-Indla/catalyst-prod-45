        ...
        >
          ...
          <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--divider)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
              <h3 style={{ fontFamily: 'var(--cp-font-body)', fontSize: 18, fontWeight: 600, color: 'var(--fg-1)', margin: 0 }}>
            ...
            <p style={{ fontFamily: 'var(--cp-font-body)', fontSize: 14, color: 'var(--fg-3)', margin: 0 }}>
                ...
                {filteredSteps.map(step => (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 8 }}>
                      <h4 style={{ fontFamily: 'var(--cp-font-body)', fontSize: 14, fontWeight: 600, color: 'var(--fg-1)', margin: 0 }}>
                        {step.name}
                      </h4>
                      <span style={{ fontFamily: 'var(--cp-font-body)', fontSize: 12, color: 'var(--fg-4)', whiteSpace: 'nowrap' }}>
