...
import { X, Clock, FileCheck, CheckCircle, Archive, Loader2 } from '@/lib/atlaskit-icons';
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '12px 16px',
                  borderRadius: 8,
                  border: isSelected ? `2px solid ${status.color}` : '1.5px solid var(--bd-default, var(--cp-border, #E2E8F0))',
