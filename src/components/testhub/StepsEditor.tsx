        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <div>
            ...
            <textarea value={step.action} onChange={(e) => onUpdate('action', e.target.value)} placeholder="Describe the action to perform..."
              style={{ width: '100%', minHeight: 80, padding: '10px 12px', fontSize: 14, fontFamily: 'var(--ds-font-family-body)', color: 'var(--fg-1)', backgroundColor: 'var(--cp-float)', border: '1.5px solid var(--divider)', borderRadius: 8, resize: 'vertical', outline: 'none', transition: 'border-color 0.15s, box-shadow 0.15s' }}
