            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                ...
                <textarea
                  ...
                  style={{ ...textareaStyle, minHeight: 60, fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 13 }}
              ...
              <div>
                ...
                <textarea
                  ...
                  style={{ ...textareaStyle, minHeight: 160, fontFamily: 'var(--ds-font-family-monospaced)', fontSize: 13 }}
                  onFocus={(e) => { e.target.style.borderColor = 'var(--cp-blue)'; e.target.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.12)'; }}
                  onBlur={(e) => { e.target.style.borderColor = 'var(--divider)'; e.target.style.boxShadow = 'none'; }}
                />
              </div>
