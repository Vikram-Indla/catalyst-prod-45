          ...
          {executionHistory.step_results.length === 0 ? (
            ...
            executionHistory.step_results.map((step, i) => {
              const stepColors: Record<string, { text: string; bg: string; border: string }> = isDark ? {
                ...
                skipped: { text: 'var(--ds-text-subtlest, var(--cp-text-secondary, #878787))', bg: 'var(--ds-surface-raised, var(--cp-ink-1, #1A1A1A))', border: 'var(--ds-border, var(--cp-ink-1, #2E2E2E))' },
                not_run: { text: 'var(--ds-text-subtlest, var(--cp-text-secondary, #878787))', bg: 'var(--ds-surface-raised, var(--cp-ink-1, #1A1A1A))', border: 'var(--ds-border, var(--cp-ink-1, #2E2E2E))' },
              } : {
                ...
                skipped: { text: 'var(--ds-text-subtle, #475569)', bg: 'var(--ds-surface-sunken, #F8FAFC)', border: 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))' },
                not_run: { text: 'var(--ds-text-subtlest, var(--cp-ink-3, var(--cp-text-secondary, #64748B)))', bg: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', border: 'var(--ds-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))' },
              };
              ...
              return (
                <div key={i} style={{
                  ...
                  border: `0.75px solid ${'var(--cp-border, var(--cp-border, var(--cp-bg-sunken, #E2E8F0)))'}`, borderRadius: 6,
