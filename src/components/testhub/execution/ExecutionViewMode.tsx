  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ padding: '16px 24px', borderBottom: '1px solid hsl(var(--border))', backgroundColor: 'hsl(var(--card))' }}>
        ...
        <p style={{ fontSize: 11, color: 'var(--ds-text-subtlest, #94A3B8)', margin: '8px 0 0' }}>
          ...
          {executionHistory.step_results.length === 0 ? (
            ...
            executionHistory.step_results.map((step, i) => {
              const stepColors: Record<string, { text: string; bg: string; border: string }> = isDark ? {
                ...
                failed:  { text: 'var(--ds-text-danger, #DC2626)', bg: 'rgba(248,113,113,0.12)', border: 'rgba(248,113,113,0.3)' },
              ...
              return (
                <div key={i} style={{
                  ...
                  {step.notes ? (
                    ...
                    <p style={{ fontSize: 11, color: 'var(--ds-text-subtlest, #94A3B8)', margin: '8px 0 0', fontStyle: 'italic' }}>No notes</p>
                  )}
                </div>
              );
            })
