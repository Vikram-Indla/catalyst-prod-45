    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{
        ...
        {[
          ...
          { key: 'skipped', label: 'Skip', shortcut: 'S', icon: SkipForward, onClick: onSkip, color: 'var(--cp-text-tertiary, var(--cp-ink-3, #64748B))', bg: 'hsl(var(--muted) / 0.3)', activeBg: 'linear-gradient(135deg, var(--ds-text-subtlest, var(--cp-ink-3, #64748B)), var(--ds-text-subtle, #475569))' },
        ].map(btn => {
          const Icon = btn.icon;
