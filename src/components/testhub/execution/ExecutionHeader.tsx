      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <button
          ...
          style={{
            ...
            color: fastTrackMode ? 'var(--ds-text-warning, var(--ds-text-warning, #D97706))' : 'hsl(var(--muted-foreground))',
          }}
        >
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          {[
            ...
            { count: cycle.failed_count, color: 'var(--ds-text-danger, var(--ds-text-danger, #DC2626))', bg: 'var(--cp-danger-light, #FEF2F2)', Icon: XCircle },
            { count: cycle.blocked_count, color: 'var(--ds-text-warning, var(--ds-text-warning, #D97706))', bg: 'var(--cp-warning-light, #FFFBEB)', Icon: AlertTriangle },
          ].map((s, i) => (
