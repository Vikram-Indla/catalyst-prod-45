...
const SEVERITY_OPTIONS = [
  { value: 'critical', label: 'Critical', color: 'var(--ds-text-danger, #DC2626)', desc: 'System crash, data loss', mapped: 'CRITICAL' as DefectSeverity },
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <input
              ...
              style={{
                ...
                border: `1.5px solid ${errors.title ? 'var(--ds-text-danger, #DC2626)' : 'var(--divider)'}`,
                borderRadius: 12, fontSize: 14, backgroundColor: 'var(--bg-app)',
                color: 'var(--fg-1)',
              }}
            />
            {errors.title && <p style={{ fontSize: 12, color: 'var(--ds-text-danger, #DC2626)', margin: '4px 0 0' }}>{errors.title}</p>}
          </div>
            ...
            <div>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--fg-1)', marginBottom: 6 }}>
                <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <AlertCircle size={14} style={{ color: 'var(--ds-text-danger, #DC2626)' }} /> Actual Result
                </span>
              </label>
              <textarea
                value={actualResult}
