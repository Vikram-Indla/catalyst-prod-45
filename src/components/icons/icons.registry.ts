...
export const WORK_TYPE_REGISTRY: Record<WorkItemType, WorkTypeMeta> = {
  'business-request':    { id: 'business-request',    label: 'Business Request',    color: 'var(--ds-text-warning)',   light: businessRequestLight,    dark: businessRequestLight },
  'story':               { id: 'story',               label: 'Story',               color: 'var(--ds-text-success)',   light: storyLight,               dark: storyLight },
  'task':                { id: 'task',                label: 'Task',                color: 'var(--ds-link)',           light: taskLight,                dark: taskLight },
  'epic':                { id: 'epic',                label: 'Epic',                color: 'var(--ds-text-discovery)', light: epicLight,                dark: epicLight },
  'sub-task':            { id: 'sub-task',            label: 'Sub-task',            color: 'var(--ds-link)',           light: subTaskLight,             dark: subTaskLight },
  'qa-bug':              { id: 'qa-bug',              label: 'QA Bug',              color: 'var(--ds-text-danger)',    light: qaBugLight,               dark: qaBugLight },
  'feature':             { id: 'feature',             label: 'Feature',             color: 'var(--ds-link)',           light: featureLight,             dark: featureLight },
  'change-request':      { id: 'change-request',      label: 'Change Request',      color: 'var(--ds-link)',           light: changeRequestLight,       dark: changeRequestLight },
  'production-incident': { id: 'production-incident', label: 'Production Incident', color: 'var(--ds-text-warning)',   light: productionIncidentLight,  dark: productionIncidentLight },
  'business-gap':        { id: 'business-gap',        label: 'Business Gap',        color: 'var(--ds-text-discovery)', light: businessGapLight,         dark: businessGapLight },
  'api-requirement':     { id: 'api-requirement',     label: 'API Requirement',     color: 'var(--ds-text-success)',   light: apiRequirementLight,      dark: apiRequirementLight },
  'frontend':            { id: 'frontend',            label: 'Frontend',            color: 'var(--ds-link)',           light: frontendLight,            dark: frontendLight },
  'backend':             { id: 'backend',             label: 'Backend',             color: 'var(--ds-link)',           light: backendLight,             dark: backendLight },
  'integration':         { id: 'integration',         label: 'Integration',         color: 'var(--ds-link)',           light: integrationLight,         dark: integrationLight },
  'figma':               { id: 'figma',               label: 'Figma',               color: 'var(--ds-text)',           light: figmaLight,               dark: figmaDark },
  'brd-task':            { id: 'brd-task',            label: 'BRD Task',            color: 'var(--ds-text-discovery)', light: brdTaskLight,             dark: brdTaskDark },
  'uat-finding':         { id: 'uat-finding',         label: 'UAT Finding',         color: 'var(--ds-text-discovery)', light: uatFindingLight,          dark: uatFindingDark },
  'release':             { id: 'release',             label: 'Release',             color: 'var(--ds-icon-success)',                            light: releaseLight,             dark: releaseLight },
  'test-case':           { id: 'test-case',           label: 'Test Case',           color: 'var(--ds-text-success)',   light: testCaseLight,            dark: testCaseLight },
};

export const PRIORITY_REGISTRY: Record<PriorityLevel, PriorityMeta> = {
  highest: { id: 'highest', label: 'Highest', color: 'var(--ds-text-danger)',  light: priorityHighestLight, dark: priorityHighestLight },
  high:    { id: 'high',    label: 'High',    color: 'var(--ds-text-danger)',  light: priorityHighLight,    dark: priorityHighLight },
  medium:  { id: 'medium',  label: 'Medium',  color: 'var(--ds-text-warning)', light: priorityMediumLight,  dark: priorityMediumLight },
  low:     { id: 'low',     label: 'Low',     color: 'var(--ds-link)',         light: priorityLowLight,     dark: priorityLowLight },
  lowest:  { id: 'lowest',  label: 'Lowest',  color: 'var(--ds-link)',         light: priorityLowestLight,  dark: priorityLowestLight },
  none:    { id: 'none',    label: 'None',    color: 'var(--ds-text)',         light: priorityNoneLight,    dark: priorityNoneDark },
};
