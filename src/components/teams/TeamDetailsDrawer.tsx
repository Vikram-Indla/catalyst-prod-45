...
export function TeamDetailsDrawer({ teamId, open, onOpenChange }: TeamDetailsDrawerProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="executive-drawer w-full sm:max-w-2xl p-0 flex flex-col overflow-hidden bg-white dark:bg-[#1A1A1A]">
        {isLoading ? (
          <div className="flex items-center justify-center h-full bg-white dark:bg-[#1A1A1A]">
