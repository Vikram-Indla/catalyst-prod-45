 ...
 * Catalyst Design System: Primary Blue (var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563eb)))
 */
      ...
      <DropdownMenuTrigger asChild disabled={disabled}>
        <button
          className={cn(
            ...
            "cursor-pointer transition-colors bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-background-brand-bold-hovered,#1d4ed8)] text-white",
          ...
          return (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                isActive && "bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/10 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]"
              )}
            >
              <span className="flex-1">{step.label}</span>
              {isActive && (
                <Check className="h-4 w-4 shrink-0 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]" />
              )}
            </DropdownMenuItem>
          );
        })}
