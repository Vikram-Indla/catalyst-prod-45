  ...
  if (isLoading || !request) {
    return (
      <div style={{ position: 'fixed', inset: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(9, 30, 66, 0.54)' }} onClick={onClose}>
        <div style={{ width: 48, height: 48, border: '3px solid var(--cp-lozenge-grey-bg, #DFE1E6)', borderTopColor: 'var(--cp-primary-60, #0052CC)', borderRadius: '50%', animation: 'spin 0.8s linear infinite' }} />
      </div>
    );
  }
      ...
      >
        ...
        >
              ...
              <div ref={dotsMenuRef} style={{ position: 'relative' }}>
                ...
                {showDotsMenu && (
                  <div style={{
                    ...
                    border: '1px solid var(--cp-lozenge-grey-bg, #DFE1E6)', borderRadius: 6,
          ...
          <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
            ...
            >
              <div style={{ width: 1.5, height: 32, borderRadius: 1, background: 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))' }} />
            </div>
              ...
              <div style={{ marginBottom: 14 }} ref={statusDropdownRef}>
                <div style={{ position: 'relative' }}>
                  <button onClick={() => setShowStatusDropdown(!showStatusDropdown)} style={{
                    backgroundColor: statusCategory === 'done' ? '#E3FCEF' : statusCategory === 'in_progress' ? '#DEEBFF' : 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))',
                  ...
                  {showStatusDropdown && (
                    <div style={{
                      ...
                      {processSteps.map((step: any) => {
                        ...
                        const bg = cat === 'done' ? '#E3FCEF' : cat === 'in_progress' ? '#DEEBFF' : 'var(--ds-border, var(--cp-lozenge-grey-bg, #DFE1E6))';
