      ...
      case 'checkbox':
        return (
          <Checkbox
            ...
            className="data-[state=checked]:bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563EB))] data-[state=checked]:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563EB))]" /* V12 */
    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'var(--ds-surface-sunken, var(--cp-bg-sunken, var(--cp-bg-sunken, #F1F5F9)))', /* V12 */
