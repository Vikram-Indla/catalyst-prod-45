...
export function BacklogTableView({ data, isLoading, onRowClick }: BacklogTableViewProps) {
  ...
  /* V12 */ const renderSortIcon = (column: TableColumn) => {
    ...
    return (
      <span className={cn("inline-flex ml-1", isActive ? "text-[var(--ds-text-brand,#2563EB)]" : "text-[var(--ds-text-subtlest,var(--cp-ink-4, #94A3B8))]")}>
    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'var(--ds-surface-sunken, var(--cp-bg-sunken, #F1F5F9))', /* V12 */
                    ...
                    return (
                      <th
                        ...
                        style={{
                          ...
                          color: isActive ? 'var(--ds-text-brand, #2563EB)' : 'var(--ds-text-subtlest, var(--cp-ink-3, #64748B))', /* V12 */
