...
/* V12 — ID column: JetBrains Mono, var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB)), underline on hover */
  ...
  return (
    <button
      ...
      style={{
        ...
        color: 'var(--ds-text-brand, var(--cp-workstream-catalyst-primary, #2563EB))', /* V12 */
        background: 'none',
        border: 'none',
        padding: '2px 4px',
        borderRadius: 4,
