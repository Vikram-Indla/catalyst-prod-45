...
export function CatalystCreateDemand({ data, onChange }: DemandDetailsTabProps) {
  ...
  const compactInputClass = cn(
    ...
    "focus:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] focus:ring-2 focus:ring-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/10",
    "transition-colors"
  );
  ...
  const SectionHeader = ({ icon: Icon, title }: { icon: React.ElementType; title: string }) => (
    <div className="flex items-center gap-2 pb-2 mb-3 border-b border-gray-200 dark:border-gray-700">
      ...
      <h3 className="text-xs font-semibold uppercase tracking-wide text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]">
        {title}
      </h3>
    </div>
  );
            ...
            <div className="space-y-2">
              ...
              <Button 
                ...
                className={cn(
                  ...
                  "border-gray-200 dark:border-gray-600",
                  "border-dashed hover:border-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] hover:bg-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))]/5"
                )}
              ...
              {attachments.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {attachments.map((file, index) => (
                    ...
                    >
                      <FileText className="h-3 w-3 text-[var(--ds-text-brand,var(--cp-workstream-catalyst-primary, #2563eb))] shrink-0" />
