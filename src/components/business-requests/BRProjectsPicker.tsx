        ...
        return (
          <div style={{ ...ATLASSIAN_DROPDOWN, position: 'fixed', top: dropTop, left: dropLeft, width: dropWidth, overflow: 'hidden' }}>
            ...
            <div style={{ maxHeight: 300, overflowY: 'auto' }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 14, color: 'var(--ds-text, var(--ds-text, #172B4D))', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{p.name}</div>
                      {p.key && <div style={{ fontSize: 11, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))' }}>{p.key}</div>}
                    </div>
              ...
              {filtered.length === 0 && (
                <div style={{ padding: '12px', fontSize: 13, color: 'var(--ds-text-subtlest, var(--ds-text-subtlest, #6B778C))', textAlign: 'center' }}>No projects found</div>
              )}
            </div>
          </div>
        );
