  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button
        ...
        onMouseEnter={e => { e.currentTarget.style.borderColor = dk ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : 'var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))'; }}
        onMouseLeave={e => { e.currentTarget.style.borderColor = dk ? 'var(--ds-border, var(--ds-border, #2E2E2E))' : 'var(--bd-default, #E2E8F0)'; }}
      >
      ...
      {open && (
        <div style={{
          ...
          background: dk ? 'var(--ds-surface-raised, var(--ds-surface-raised, #1A1A1A))' : 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))', border: `1px solid ${dk ? 'var(--ds-border, var(--ds-border, #2E2E2E))' : 'var(--ds-border, var(--ds-border, #e5e7eb))'}`,
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 2 }}>
              ...
              <span style={{ color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))', fontSize: 14, fontWeight: 700 }}>Export Work Items</span>
            </div>
          ...
          <div style={{ padding: '14px 16px 8px' }}>
            <div style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', color: dk ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : '#6B6B6B', letterSpacing: '0.06em', marginBottom: 10 }}>
              SELECT PERIOD
            </div>
            ...
            {monthOptions.map(opt => {
              ...
              return (
                <label
                  ...
                  onMouseEnter={e => { if (!checked) e.currentTarget.style.background = dk ? 'var(--ds-surface-overlay, var(--ds-surface-overlay, #1F1F1F))' : '#f8f9fa'; }}
                ...
                >
                  ...
                  <div style={{
                    ...
                    border: `2px solid ${checked ? 'var(--sem-success)' : (dk ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #A1A1A1))' : 'var(--ds-text-disabled, var(--ds-text-disabled, #cbd5e1))')}`,
                    background: checked ? (dk ? 'rgba(74, 222, 128, 0.15)' : 'var(--ds-background-success, var(--ds-background-success, #DCFCE7))') : (dk ? 'transparent' : 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))'),
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    flexShrink: 0, transition: 'all 150ms',
                  }}>
                    {checked && <Check size={12} strokeWidth={3} color="var(--ds-text-success, var(--ds-text-success, #16A34A))" />}
                  </div>
                  <span style={{ fontSize: 13, fontWeight: 500, color: dk ? 'var(--ds-text, var(--ds-text, #EDEDED))' : '#1e293b', flex: 1 }}>{opt.label}</span>
                  {opt.isCurrent && (
                    <span style={{
                      fontSize: 10, fontWeight: 700, color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))',
          ...
          <div style={{ padding: '8px 16px 14px' }}>
            <button
              ...
              style={{
                ...
                fontSize: 13, fontWeight: 700, color: 'var(--ds-surface, var(--ds-surface, var(--ds-surface, #fff)))',
            ...
            {totalSelected > 0 && (
              <div style={{ textAlign: 'center', fontSize: 11, color: dk ? 'var(--ds-text-subtlest, var(--ds-text-subtlest, #878787))' : '#6B6B6B', marginTop: 6 }}>
