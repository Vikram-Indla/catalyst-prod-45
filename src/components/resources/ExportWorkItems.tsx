  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      <button
        ...
        onMouseLeave={e => { e.currentTarget.style.borderColor = dk ? 'var(--ds-border, var(--cp-ink-1))' : 'var(--bd-default, var(--cp-border, var(--cp-bg-sunken)))'; }}
      >
              ...
              return (
                ...
                >
                  ...
                  <div style={{
                    ...
                    {checked && <Check size={12} strokeWidth={3} color="var(--ds-text-success, var(--cp-success))" />}
                  </div>
                  <span style={{ fontSize: 'var(--ds-font-size-300)', fontWeight: 500, color: dk ? 'var(--ds-text, var(--cp-bg-neutral))' : 'var(--ds-text)', flex: 1 }}>{opt.label}</span>
                  {opt.isCurrent && (
                    <span style={{
            ...
            <button
              ...
              style={{
                ...
                background: genState === 'done'
                  ? 'linear-gradient(135deg, var(--ds-background-success-bold), var(--sem-success))'
                  : totalSelected > 0
                    ? 'linear-gradient(135deg, var(--ds-background-brand-bold-hovered), var(--cp-blue))'
                    : 'var(--divider)',
