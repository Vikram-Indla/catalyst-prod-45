...
export function InlineEditTitle({ value, onSave, fontSize = 13, fontWeight = 500, color = 'var(--fg-1, var(--cp-ink-1, #0F172A))', style, forceEdit, onCancelForceEdit }: InlineEditTitleProps) {
  ...
  return (
    ...
    >
      ...
      <Pencil
        ...
        style={{
          marginLeft: 4, color: 'var(--ds-text-subtlest, var(--cp-ink-4, #94A3B8))', flexShrink: 0,
