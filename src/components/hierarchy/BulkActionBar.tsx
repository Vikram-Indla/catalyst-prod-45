  ...
  return (
    <div style={{
      ...
      <button onClick={onClear} style={{
        ...
        display: 'flex', alignItems: 'center', gap: 4, color: 'var(--fg-4, #94A3B8)', fontSize: 12,
      }}>
        <X size={14} /> Clear
      </button>
      ...
      {confirmDelete ? (
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <button onClick={() => setConfirmDelete(false)} style={{
            ...
            background: 'transparent', color: 'var(--fg-4, #94A3B8)', border: '1px solid #475569', cursor: 'pointer',
          }}>Cancel</button>
        </div>
      ) : (
