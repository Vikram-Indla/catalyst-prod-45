      ...
      <div style={{
        ...
        <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--divider)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <button onClick={onClose} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4 }}>
            <X size={18} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #64748B))" />
          </button>
        </div>
                ...
                {!search && hasChildren ? (
                  <button onClick={e => { e.stopPropagation(); toggle(item.id); }}
                    ...
                    {expanded.has(item.id)
                      ...
                      : <ChevronRight size={14} color="var(--ds-text-subtlest, var(--ds-text-subtlest, #94A3B8))" />}
                  </button>
                ) : <div style={{ width: 14 }} />}
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: 'var(--ds-surface, var(--ds-surface, #FFFFFF))', background: selected ? 'var(--cp-blue)' : 'var(--fg-4)',
