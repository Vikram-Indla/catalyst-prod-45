...
export function DetailPanelSkeleton() {
  const dk = useIsDark();
  const shimmerBg = dk ? '#2E2E2E' : '#F1F5F9';
  return (
...
function FieldRow({ label, children }: { label: string; children: React.ReactNode }) {
  ...
  return (
    <div style={{ padding: '8px 20px', borderBottom: `1px solid ${dk ? '#292929' : '#F1F5F9'}` }}>
      <div style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', color: 'var(--fg-3)', letterSpacing: '0.06em', marginBottom: 4, fontFamily: 'var(--ds-font-family-body)' }}>
        {label}
      </div>
    ...
    <div>
      <button
        ...
        style={{
          ...
          background: 'none', border: 'none', borderBottom: '1px solid var(--divider)', cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)',
        }}
      >
        ...
        {count !== undefined && (
          <span style={{ fontSize: 10, fontWeight: 600, color: 'var(--fg-3)', background: dk ? '#2E2E2E' : '#F1F5F9', borderRadius: 9999, padding: '1px 6px' }}>{count}</span>
        )}
      </button>
      {open && children}
    </div>
  ...
  if (!item) {
    return (
      <div style={{
        ...
        color: 'var(--fg-3)', fontSize: 13, fontFamily: 'var(--ds-font-family-body)',
      }}>
    ...
    <AnimatePresence mode="wait">
      <motion.div
        ...
        style={{
          ...
          position: 'sticky', top: 16, fontFamily: 'var(--ds-font-family-body)',
          ...
          {item.stats.totalDescendants > 0 && (
            <FieldRow label="Progress">
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{ flex: 1, height: 6, background: dk ? '#2E2E2E' : '#F1F5F9', borderRadius: 4, overflow: 'hidden' }}>
            ...
            <div style={{ padding: '8px 20px', borderBottom: '1px solid var(--divider)' }}>
              <button
                ...
                style={{
                  ...
                  fontSize: 12, color: 'var(--fg-3)', fontFamily: 'var(--ds-font-family-body)',
        ...
        <Section title="Activity" defaultOpen={false}>
          <div style={{ padding: '8px 20px', borderBottom: '1px solid var(--divider)' }}>
            <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
              {['All', 'Comments', 'History'].map((tab, i) => (
                <button key={tab} style={{
                  ...
                  color: i === 0 ? 'var(--cp-blue)' : 'var(--fg-3)', cursor: 'pointer', fontFamily: 'var(--ds-font-family-body)',
                }}>
                  {tab}
                </button>
              ))}
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: dk ? '#2E2E2E' : '#F1F5F9', flexShrink: 0 }} />
              <textarea
                placeholder="Add a comment..."
                rows={2}
                style={{
                  flex: 1, padding: 8, fontSize: 13, fontFamily: 'var(--ds-font-family-body)',
