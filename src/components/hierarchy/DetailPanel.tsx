 ...
 * Stage C: Sticky, no shadow, fields with dividers
 */
      ...
      <FieldRow label="Status">
        <span
          style={{
            ...
            padding: '0 8px',
            borderRadius: 9999,
            background: `${item.status.color}14`,
            border: `1px solid ${item.status.color}33`,
          }}
        >
        ...
        {item.stats.totalDescendants > 0 ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ flex: 1, height: 6, background: '#F1F5F9', borderRadius: 3, overflow: 'hidden' }}>
              <div style={{ height: '100%', width: `${pct}%`, background: fillColor, borderRadius: 3 }} />
            </div>
