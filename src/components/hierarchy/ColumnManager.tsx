            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: '6px 12px', fontSize: 13, color: col.alwaysVisible ? 'var(--ds-text-subtlest, var(--cp-ink-4, var(--cp-border-neutral-light, #94A3B8)))' : 'var(--cp-ink-2, var(--cp-ink-2, #334155))',
