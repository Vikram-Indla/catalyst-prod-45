...
export const STATUS_CONFIG: Record<WorkflowStatus, {
  ...
  backlog: {
    ...
    label: 'Backlog',
    color: '#42526E',
    bgColor: 'var(--cp-lozenge-grey-bg, #DFE1E6)',
    textColor: '#42526E'
  },
  design: {
...
export const WORK_ITEM_PRIORITY_CONFIG: Record<WorkItemPriority, {
  ...
  low:      { label: 'Low',      color: 'var(--cp-ink-3, #64748B)', bgColor: 'var(--bg-1, #F8FAFC)', borderColor: 'var(--bd-default, var(--cp-border, #E2E8F0))', icon: 'ArrowDown',     sortWeight: 4 },
  none:     { label: 'None',     color: 'var(--cp-ink-4, #94A3B8)', bgColor: 'var(--bg-1, #F8FAFC)', borderColor: 'var(--bd-default, var(--cp-border, #E2E8F0))', icon: 'Minus',         sortWeight: 5 },
};
