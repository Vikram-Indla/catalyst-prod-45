...
export const WORK_ITEM_PRIORITY_CONFIG: Record<WorkItemPriority, {
  ...
  low:      { label: 'Low',      color: 'var(--fg-3, #64748B)', bgColor: '#F8FAFC', borderColor: 'var(--divider, #E2E8F0)', icon: 'ArrowDown',     sortWeight: 4 },
  none:     { label: 'None',     color: 'var(--fg-4, #94A3B8)', bgColor: '#F8FAFC', borderColor: 'var(--divider, #E2E8F0)', icon: 'Minus',         sortWeight: 5 },
};
