...
export const STATUS_COLORS = {
  critical: {
    bg: 'var(--ds-surface)',
    bgDark: 'var(--ds-background-danger)',
    border: 'var(--ds-border)',
    borderDark: 'var(--ds-background-danger)',
  ...
  warning: {
    bg: 'var(--ds-surface)',
    bgDark: 'var(--ds-background-warning)',
    border: 'var(--ds-border)',
    borderDark: 'var(--ds-background-warning)',
    text: 'var(--ds-text-warning)',
  ...
  safe: {
    bg: 'var(--ds-surface)',
    bgDark: 'var(--ds-background-success)',
    border: 'var(--ds-border)',
    borderDark: 'var(--ds-background-success)',
    text: 'var(--ds-text-success)',
