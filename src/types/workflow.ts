...
export const WORKFLOW_STATUSES: WorkflowStatus[] = [
  { id: 'backlog', name: 'Backlog', color: '#42526E', bgColor: 'var(--ds-border, #DFE1E6)', description: 'Awaiting prioritization' },
  ...
  { id: 'on_hold', name: 'On Hold', color: '#42526E', bgColor: 'var(--ds-border, #DFE1E6)', description: 'Paused or blocked' },
];
