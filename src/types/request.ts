...
export const STATUS_DISPLAY: Record<RequestStatus, { label: string; lozenge: LozengeColor; dot: string; bg: string; border: string; text: string }> = {
  new:                     { label: 'New',                    lozenge: 'grey',  dot: '#DFE1E6', bg: '#DFE1E6', border: 'var(--ds-border, #DFE1E6)', text: '#42526E' },
  ...
  on_hold:                 { label: 'On Hold',                lozenge: 'grey',  dot: '#DFE1E6', bg: '#DFE1E6', border: 'var(--ds-border, #DFE1E6)', text: '#42526E' },
  ...
  cancelled:               { label: 'Cancelled',              lozenge: 'grey',  dot: '#DFE1E6', bg: '#DFE1E6', border: 'var(--ds-border, #DFE1E6)', text: '#42526E' },
};
