      ...
      const kpis: KPITile[] = [
        {
          ...
          filterUrl: '/incident-hub?status=open,triage,in_progress,to_committee',
          color: openIncidents.length > 20 ? 'warning' : 'default',
        },
        {
          label: 'Active Major Incidents',
          value: majorIncidentsActive.length,
          filterUrl: '/incident-hub?is_major=true&status=open,triage,in_progress',
        ...
        },
        {
          ...
          filterUrl: '/incident-hub?sla_breached=true',
          color: slaBreaches.length > 0 ? 'critical' : 'success',
        },
        {
          label: 'Awaiting CAP Approval',
          value: awaitingCAP,
          filterUrl: '/incident-hub?status=to_committee',
        ...
        },
        {
          ...
          deltaLabel: 'vs last week',
          filterUrl: '/incident-hub?status=converted',
          color: 'success',
        },
        {
          ...
          filterUrl: '/incident-hub?deployment_planned=true',
          color: 'default',
        },
      ];
