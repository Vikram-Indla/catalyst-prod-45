...
// ─── Linked Cycles ───────────────────────────────────────────────
// P1-S8: usePlanLinkedCycles/useLinkCycleToPlan/useUnlinkCycleFromPlan removed.
// They queried a plan-cycle join table that never existed (D-001 ghost-relation
// probe), had zero callers anywhere in src/, and no /testhub/plan* route exists to
// host a consumer. The real spine is tm_test_cycles.test_plan_id (FK confirmed live,
// already read by useDefects.ts for defect plan provenance) — see D-008.
