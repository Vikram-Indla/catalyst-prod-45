...
export const ROUTE_REGISTRY: Record<string, RouteConfig> = {
  ...
  '/strata/strategy': { section: 'Strategy Execution', pageTitle: 'Strategy Room' },
  '/strata/strategy/map': { section: 'Strategy Execution', pageTitle: 'Strategy Map' },
  '/strata/scorecards': { section: 'Balanced Scorecard', pageTitle: 'Scorecards' },
  '/strata/scorecards/:slug': { section: 'Balanced Scorecard', pageTitle: 'Scorecard' },
  '/strata/kpis': { section: 'Balanced Scorecard', pageTitle: 'KPI & OKR Library' },
  '/strata/kpis/:slug': { section: 'Balanced Scorecard', pageTitle: 'KPI Detail' },
  '/strata/execution': { section: 'Strategy Execution', pageTitle: 'Project Cards' },
  ...
  '/producthub/ideas/requests': { section: 'IDEAS', pageTitle: 'Business Requests' },
  '/producthub/ideas/requests/:id': { section: 'IDEAS', pageTitle: 'Business Request Details' },
