...
| STRATA-E2E-010 | P0 | FIXED (D-4 resolved) — verified live | Added `is_strategic` marker (migration `20260712170000`, applied to staging). Strategic KPIs: approval requires ≥1 strategy-element link (transitively cycle/theme/objective/perspective); linking relaxed to allow strategic drafts (breaks chicken-and-egg); operational KPIs unchanged. UI: create/edit toggle, "Strategic" tag, association-required banner. Browser-verified |
