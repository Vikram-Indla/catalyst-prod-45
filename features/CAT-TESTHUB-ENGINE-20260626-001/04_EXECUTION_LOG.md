...
| 2026-06-27 | P3 · FLAG enum case | app filters status on UPPERCASE 'PLANNED'/'IN_PROGRESS' but enum is lowercase → SetDetailPage "Add to cycle" matches 0 (check CyclesPage) | not fixed (separate) | 08 open | — |
