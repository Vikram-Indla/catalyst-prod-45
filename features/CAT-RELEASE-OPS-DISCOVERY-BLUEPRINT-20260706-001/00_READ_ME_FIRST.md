# CAT-RELEASE-OPS-DISCOVERY-BLUEPRINT-20260706-001 — Read Me First
...
```
continue feature CAT-RELEASE-OPS-DISCOVERY-BLUEPRINT-20260706-001
```

or:

```bash
node scripts/catalyst-feature.mjs continue CAT-RELEASE-OPS-DISCOVERY-BLUEPRINT-20260706-001
```
