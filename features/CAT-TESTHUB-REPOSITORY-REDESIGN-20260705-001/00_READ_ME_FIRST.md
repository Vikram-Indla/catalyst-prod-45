# CAT-TESTHUB-REPOSITORY-REDESIGN-20260705-001 — Read Me First
...
```
continue feature CAT-TESTHUB-REPOSITORY-REDESIGN-20260705-001
```

or:

```bash
node scripts/catalyst-feature.mjs continue CAT-TESTHUB-REPOSITORY-REDESIGN-20260705-001
```
