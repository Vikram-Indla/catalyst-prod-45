# CAT-SOP-SMOKE-TEST-20260626-001 — Read Me First
...
## Feature Work ID
CAT-SOP-SMOKE-TEST-20260626-001
...
```
continue feature CAT-SOP-SMOKE-TEST-20260626-001
```

or:

```bash
node scripts/catalyst-feature.mjs continue CAT-SOP-SMOKE-TEST-20260626-001
```
