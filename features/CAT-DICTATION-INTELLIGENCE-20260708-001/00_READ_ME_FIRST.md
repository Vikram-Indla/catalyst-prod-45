# CAT-DICTATION-INTELLIGENCE-20260708-001 — Read Me First
...
## Feature Work ID
CAT-DICTATION-INTELLIGENCE-20260708-001
...
```
continue feature CAT-DICTATION-INTELLIGENCE-20260708-001
```

or:

```bash
node scripts/catalyst-feature.mjs continue CAT-DICTATION-INTELLIGENCE-20260708-001
```
